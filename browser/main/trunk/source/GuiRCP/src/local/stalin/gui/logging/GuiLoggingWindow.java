...
import local.stalin.gui.views.LoggingView;
 ...
 *
 */
public class GuiLoggingWindow extends WriterAppender implements ILoggingWindow {

	private final String pluginID = "local.stalin.gui.logging.GuiLoggingWindow";
	...
	private LoggingView getEditor() {
		...
		try {
			...
			//return (LoggingView)window.getActivePage().openEditor(new LoggingEditorInput(this), LoggingView.ID, false);
