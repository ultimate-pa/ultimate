...
import local.stalin.gui.advisors.ApplicationWorkbenchAdvisor;
import local.stalin.gui.dialogs.AnalysisChooseDialog;
import local.stalin.gui.dialogs.ModelChooseDialog;
import local.stalin.gui.dialogs.ParserChooseDialog;
...
public class GuiController implements IController {
	...
	public static final String s_PLUGIN_ID = "STALINGui";//"local.stalin.gui.GuiController";
	public static final String s_PLUGIN_NAME = "Gui Controller";
	private static Logger m_Logger = StalinServices.getInstance().getControllerLogger();
