...
import local.stalin.gui.provider.AnnotationTreeProvider;
import local.stalin.gui.provider.AnnotationsLabelProvider;
...
public class NodeView extends ViewPart implements ISelectionListener {
	...
	public static final String ID = "local.stalin.plugins.output.graphview2d.views.NodeView";
