...
public class GraphHandler { //thread-safe singleton
	...
	private HashMap<Object,VisualizationViewer<INode, IEdge>> visualizationViewers;
	...
	private GraphHandler(){
		this.visualizationViewers = new HashMap<Object,VisualizationViewer<INode, IEdge>>();
	}
	 ...
	 */	
	public void addVisualizationViewer(VisualizationViewer<INode, IEdge> vv){
	 ...
	 * the key is not in the HashMap.
	 */
	public VisualizationViewer<INode, IEdge> getVisualizationViewer(Object key){
	 ...
	 * @return
	 */
	public VisualizationViewer<INode, IEdge> getVisualizationViewer(){
	 ...
	 * 
	 * @return HashMap<Object,VisualizationViewer<INode, String>>
	 */
	public HashMap<Object,VisualizationViewer<INode, IEdge>> getVisualizationViewers(){
