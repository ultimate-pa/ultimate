...
public final class AIntersectAbstractjoinedautomaton extends PAbstractjoinedautomaton
{
    private PAbstractjoinedautomaton _auto1_;
    private PAbstractjoinedautomaton _auto2_;

    public AIntersectAbstractjoinedautomaton()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIntersectAbstractjoinedautomaton(
    ...
    {
        ((Analysis) sw).caseAIntersectAbstractjoinedautomaton(this);
    }
