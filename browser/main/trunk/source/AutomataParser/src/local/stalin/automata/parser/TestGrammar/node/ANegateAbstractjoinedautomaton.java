...
public final class ANegateAbstractjoinedautomaton extends PAbstractjoinedautomaton
{
    private PAbstractjoinedautomaton _abstractjoinedautomaton_;

    public ANegateAbstractjoinedautomaton()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANegateAbstractjoinedautomaton(
            cloneNode(this._abstractjoinedautomaton_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseANegateAbstractjoinedautomaton(this);
    }
