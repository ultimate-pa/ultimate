...
public final class ADeterminizeAbstractjoinedautomaton extends PAbstractjoinedautomaton
{
    private PAbstractjoinedautomaton _abstractjoinedautomaton_;

    public ADeterminizeAbstractjoinedautomaton()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADeterminizeAbstractjoinedautomaton(
            cloneNode(this._abstractjoinedautomaton_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseADeterminizeAbstractjoinedautomaton(this);
    }
