...
public final class AReturnTaggedSymbol extends PTaggedSymbol
{
    private TId _symbol_;

    public AReturnTaggedSymbol()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AReturnTaggedSymbol(
            cloneNode(this._symbol_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAReturnTaggedSymbol(this);
    }
