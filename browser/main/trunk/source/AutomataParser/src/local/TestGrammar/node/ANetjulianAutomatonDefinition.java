...
public final class ANetjulianAutomatonDefinition extends PAutomatonDefinition
{
    ...
    private final LinkedList<TId> _acceptingPlaces_ = new LinkedList<TId>();
    ...
    public ANetjulianAutomatonDefinition(
        ...
        @SuppressWarnings("hiding") List<TId> _acceptingPlaces_)
    {
        // Constructor
        setName(_name_);
    ...
    public LinkedList<TId> getAcceptingPlaces()
    {
        return this._acceptingPlaces_;
    }

    public void setAcceptingPlaces(List<TId> list)
    {
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<TId> i = this._acceptingPlaces_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
