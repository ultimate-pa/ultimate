...
//		this.m_Depth = -1;
	...
	public Payload(Location loc, String name){
		this();
		this.m_Location = loc;
		this.m_Name = name;
	}
	
	public Payload(Location loc, String name, boolean isValue){
		this();
		this.m_Location = loc;
		this.m_Name = name;
	...
	public StalinUID getID() {
		if(m_ID == null){
			this.m_ID = new StalinUID();
		}
		return this.m_ID;
	}
