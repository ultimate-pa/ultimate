...
import local.stalin.model.repository.DataAccessException;
import local.stalin.model.repository.IRepository;
import local.stalin.model.repository.PersistentObjectNotFoundException;
import local.stalin.model.repository.PersistentObjectTypeMismatchException;
import local.stalin.model.repository.SerializationRepository;
...
public class PersistenceAwareModelManager implements IModelManager {
	 ...
	 */
	private String createFileNameFromNode(INode node) {
		if (node == null)
			return "";
	 ...
	 *         vault in this case; true otherwise
	 */
	public boolean addItem(INode rootNode, GraphType graphtype) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#getItemNames()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#getLastAdded()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * local.stalin.model.IModelManager#getRootNode(local.stalin.model.GraphType
	 * )
	 */
	@Override
	public INode getRootNode(GraphType graph) throws GraphNotFoundException {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#isEmpty()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#persistAll(boolean)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * local.stalin.model.IModelManager#persistExistingGraph(local.stalin.model
	 * .GraphType)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#removeAll()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * local.stalin.model.IModelManager#removeItem(local.stalin.model.GraphType)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#removeItem(java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * local.stalin.model.IModelManager#removeItem(local.stalin.model.ModelContainer
	 * )
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#search(java.lang.String,
	 * java.lang.String, java.lang.Object, local.stalin.model.INode)
	 */
	@Override
	public INode search(String outerAnnotationKey, String innerAnnotationKey,
			Object innerAnnotationValue, INode node) {
		return ModelContainer.findNode(outerAnnotationKey, innerAnnotationKey,
				innerAnnotationValue, node);
	}
	 ...
	 * 
	 * @see
	 * local.stalin.model.IModelManager#search(local.stalin.model.GraphType,
	 * local.stalin.model.StalinUID)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#search(local.stalin.model.INode,
	 * java.lang.String)
	 */
	@Override
	public IPayload search(INode rootNode, String id) {
		return ModelContainer.findNode(id, rootNode);
	}

	/*
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#searchGraphType(java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * local.stalin.model.IModelManager#getGraphTypeByGeneratorPluginId(java
	 * .lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * local.stalin.model.IModelManager#setLastAdded(local.stalin.model.GraphType
	 * )
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#showStatus(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#size()
	 */
	@Override
	public int size() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see local.stalin.model.IModelManager#getItemKeys()
	 */
	@Override
