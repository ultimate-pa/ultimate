...
public interface ITool extends IStalinPlugin{
	 ...
	 * 
	 * @see local.stalin.model.TokenMap
	 * @see local.stalin.ep.interfaces.ISource
	 * @param tokenMap
	 *            The tokenMap
	 */
	...
	/**
	 * Beforce calling a plugins processing method the core calls
	 * setInputDefinition to tell the plugin what kind of modell has to be
	 * processed
	 * 
	 * @param graphType
	 *            The Description of the Modell. Contains informations about the
