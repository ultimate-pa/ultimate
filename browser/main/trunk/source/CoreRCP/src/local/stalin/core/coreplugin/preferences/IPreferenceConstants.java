...
public interface IPreferenceConstants {
	 ...
	 */
	public static final String PREFID_ROOT = "stalin.logging.root";
	public static final String PREFID_CORE = "stalin.logging.core";
	public static final String PREFID_CONTROLLER = "stalin.logging.controller";
	public static final String PREFID_TOOLS = "stalin.logging.tools";
	public static final String PREFID_PLUGINS = "stalin.logging.plugins";
	public static final String PREFID_DETAILS = "stalin.logging.details";
	public static final String PREFID_TOOLDETAILS = "stalin.logging.tooldetails";
	public static final String s_NAME_SHOWUSABLEPARSER = "showuseableparser";
	public static final String PREFID_MM_DROP_MODELS = "stalin.modelmanager.dropmodels";
	public static final String PREFID_MM_TMPDIRECTORY = "stalin.modelmanager.tmpdirectory";
	 ...
	 */
	public static final boolean s_VALUE_SHOWUSABLEPARSER_DEFAULT = true;
	...
	public static final String LABEL_MM_DROPMODELS = "Drop models when Stalin exits";
