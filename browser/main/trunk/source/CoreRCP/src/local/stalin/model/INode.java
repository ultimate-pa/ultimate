...
public interface INode extends IElement  {
     ...
     * @param element the new target node
     ...
     * @param element the new source node
     * @return boolean flag showing success
     */
     ...
     * @param element target node of the outgoing edge to remove 
     * @return boolean flag showing success
     */
     ...
     * @param element the source node of the incoming edge to be removed
     * @return boolean flag showing success
     */
     ...
     * @param element the edge to be added as outgoing edge
     * @return boolean flag showing success
     */
     ...
     * @param element the edge to be added as incoming edge
     * @return boolean flag showing success
     */
     ...
     * @param element the edge to be removed
     * @return boolean flag showing success
     */
