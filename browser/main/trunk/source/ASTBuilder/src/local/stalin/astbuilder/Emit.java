...
public class Emit {
    ...
    private static void formatComment(PrintWriter writer, String indent,
                                      String comment) {
    ...
    public String getConstructorParentParam(Node node, boolean optional) {
        String parent = node.getParent();
        if (parent == null)
            return null;
        Node parentNode = grammar.getNodeTable().get(parent);
        StringBuffer sb = new StringBuffer();
        String comma = "";
        String pparent = getConstructorParentParam(parentNode, optional);
        if (pparent != null) {
            sb.append(pparent);
            comma = ", ";
        }
        
        for (Parameter parameter : parentNode.getParameters()) {
    ...
    private void fillConstructorParamComment(Node node,
                                             StringBuffer param, 
    ...
    {
        String name = node.getName();
        String parentParams = getConstructorParentParam(node, optional);
