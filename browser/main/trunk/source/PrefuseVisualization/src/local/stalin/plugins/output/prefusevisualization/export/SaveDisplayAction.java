...
public class SaveDisplayAction extends Action implements
	...
	public static final String ID = "local.stalin.plugins.output.prefusevisualization.export.SaveDisplayAction";

	private IWorkbenchWindow workbenchWindow;
	private static Logger logger = StalinServices.getInstance().getLogger(Activator.PLUGIN_ID);
