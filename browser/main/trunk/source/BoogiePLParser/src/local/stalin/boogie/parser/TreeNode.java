...
import local.stalin.model.AbstractUnlabeledEdgeNodeTreeFactory;
...
public class TreeNode extends AbstractNoEdgeNode {
	...
	/**
	 * Constructor with a Stalin payload
	 * 
	 * @param payload
	 */
	 ...
	 * @see org.antlr.runtime.tree.Tree#getLine()
	 */
	 ...
	 * @see org.antlr.runtime.tree.Tree#getText()
	 */
	...
	public void setPayload(IPayload payload) {
		this.m_Node.setPayload(payload);
