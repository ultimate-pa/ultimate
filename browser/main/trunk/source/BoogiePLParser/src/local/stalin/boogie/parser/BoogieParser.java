...
public class BoogieParser implements ISource {
    ...
    protected static Logger s_Logger = StalinServices.getInstance().getLogger(Activator.s_PLUGIN_ID);;
    ...
    /**
     * This method is required by IStalinPlugin
     * 
     * @see local.stalin.ep.interfaces.IStalinPlugin#getPluginID()
     */
     ...
     * @see local.stalin.ep.interfaces.IParser#getName()
     */
     ...
     * @see local.stalin.ep.interfaces.IParser#getTokens()
     */
	 ...
	 * @return the tree
	 * @see local.stalin.ep.interfaces.IParser#parseAST(java.io.File[])
	 */
    ...
    /**
     * Gets a fils and checks whether it is
     * parseable by this parser. 
     * 
	...
	/* (non-Javadoc)
	 * @see local.stalin.ep.interfaces.IOutputDefinition#getOutputDefinition()
	 */
	...
	private INode reflectiveParse(String fileName) throws IOException
	{
		...
		try {
			...
			s_Logger.fatal("Unexpected error while parsing: ", e);
