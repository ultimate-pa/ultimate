...
def main_classic(property_file, architecture, input_files, verbose, validate_witness, extras):
...
def main():
    ...
    while True:
        ...
        if ultimate_process.returncode is not None and not ult_line and z3_process.returncode is not None and not z3_line:
