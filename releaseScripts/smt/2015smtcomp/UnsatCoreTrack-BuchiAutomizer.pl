...
while (<>) {
  ...
  if (/^\(set-info :category \"industrial\"\)/) {
    ...
    print "(exit)\n"
     ...
     print 'SMT script generated by Ultimate Buchi Automizer [1,2].
Ultimate Buchi Automizer is a tool that analyzes termination of C programs. The 
tool implements a novel automata-theoretic approach where the analyzed program 
is decomposed into modules [3].
...
This script contains the SMT commands that were used by Ultimate Buchi Automizer
