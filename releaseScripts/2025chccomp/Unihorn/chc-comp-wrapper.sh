...
java  -Dosgi.configuration.area=config/  -Xmx32000M -Xss4m -jar ./Ultimate/plugins/org.eclipse.equinox.launcher_1.6.800.v20240513-1750.jar  -data "$TMPDIR" -tc ./AutomizerCHC.xml -s ./chccomp-Unihorn_Default.epf -i "$1" &> "$2"/output.txt
# popd > /dev/null
