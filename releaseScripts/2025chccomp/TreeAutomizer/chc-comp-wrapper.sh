...
java  -Dosgi.configuration.area=config/  -Xmx32000M -Xss4m -jar ./Ultimate/plugins/org.eclipse.equinox.launcher_1.6.800.v20240513-1750.jar  -data "$TMPDIR" -tc ./TreeAutomizer.xml -s ./TreeAutomizerHopcroftMinimization.epf -i "$1" &> "$2"/output.txt

RESULT_UNSAT=`cat "$2"/output.txt | grep "ChcUnsatResult"`
RESULT_SAT=`cat "$2"/output.txt | grep "ChcSatResult"`
