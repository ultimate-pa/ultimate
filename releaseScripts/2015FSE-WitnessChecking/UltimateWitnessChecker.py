...
if (len(sys.argv) != 6):
    print('Wrong number of arguments: use ./Ultimate.py <propertyfile> <C file> [32bit|64bit] [simple|precise] <witnessfile>')
    sys.exit(0)
