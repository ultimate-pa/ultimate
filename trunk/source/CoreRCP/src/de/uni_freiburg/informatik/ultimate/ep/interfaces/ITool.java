...
public interface ITool extends IToolchainPlugin {
	...
	/**
	 * Provides Keywords for model selection. Depending on a Keyword and the params in {@link ITool#getDesiredToolID()}
	 ...
	 * <li>TOOL - Core calls {@link ITool#getDesiredToolID()} and expects the PLUGIN_ID (or an array of PLUGIN_IDs) of
