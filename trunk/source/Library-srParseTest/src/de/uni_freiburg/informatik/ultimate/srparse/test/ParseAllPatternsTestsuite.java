...
public class ParseAllPatternsTestsuite {
	...
	public void testPatternParse() throws Exception {
		...
		final Class<? extends SrParseScope> scopeClazz = mActualTest.getScope().getClass();
		final Class<? extends PatternType> patternClazz = mActualTest.getClass();
	...
	private PatternType[] genPatterns(final String testInput) throws Exception {
		...
		final ReqParser parser = new ReqParser(mServices, mLogger, sr, "");
	...
	public static Collection<Object[]> data() {
		return PatternUtil.createAllPatterns().stream().map(a -> new Object[] { a, a.getClass().getSimpleName() })
