...
public class Starter {
	...
	public Starter(IIcfg<IcfgLocation> icfg) {
		...
		Map<String, Map<DebugIdentifier, IcfgLocation>> locations = mIcfg.getProgramPoints();
		int numberOfLocations = locations.size();
		
		
		List<IcfgEdge> edges = new ArrayList<>();
		for (final Entry<String, Map<DebugIdentifier, IcfgLocation>> entry : mIcfg.getProgramPoints().entrySet()) {
