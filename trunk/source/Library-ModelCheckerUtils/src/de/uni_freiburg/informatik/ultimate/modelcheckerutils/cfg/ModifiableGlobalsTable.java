...
/**
 * Provides information which global variables are modifiable by which 
 * procedure.
...
public class ModifiableGlobalsTable {
	...
	/**
	 * Return the set of all global {@link IProgramNonOldVar}s that may be 
	 * modified by procedure proc.
	 */
