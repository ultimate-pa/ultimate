...
/**
 * Find all application terms with zero parameters (this is our representation of a constant). In the future we may
 * extend this class to all uninterpreted functions.
 *
