...
public class LocalReplacementVar extends LocalProgramVar implements IReplacementVar {
	...
	public LocalReplacementVar(final String identifier, final String proc, final TermVariable tv,
			final ApplicationTerm defaultConstant, final ApplicationTerm primedContant, final Term definition) {
