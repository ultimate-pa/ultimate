...
public class CallReturnPyramideInstanceProvider {
	...
	public enum Instance { BEFORE_CALL, AFTER_CALL, BEFORE_RETURN, AFTER_RETURN };
	...
	public CallReturnPyramideInstanceProvider(final ManagedScript mgdScript, final Set<IProgramVar> varsAssignedOnReturn,
			final Set<IProgramVar> calleeInParams, final Set<IProgramNonOldVar> modifiableGlobals, final Instance nonAuxVarInstance) {
		super();
