...
/**
 * 
 * Provides auxiliary methods for our normal form in which the parameter
 * of commutative functions are sorted wrt. their hash code.
 * 
...
public class CommuhashUtils {
	...
	/**
	 * Dangerous! A function may be commutative in some theory but it is not
	 * in e.g., QF_UF
	...
	public static Term term(final Script script, final String funcname, 
			final BigInteger[] indices, final Sort returnSort, final Term[] params) {
