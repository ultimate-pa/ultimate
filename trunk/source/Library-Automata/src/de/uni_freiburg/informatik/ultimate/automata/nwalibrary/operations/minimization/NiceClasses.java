...
/**
 * A partition of a number of (integer) states into
 * equivalence classes.
 * 
...
public class NiceClasses {
	 ...
	 * <ul>
	 * <li>0 <= x < numClasses</code> for all <code>x</code> in <code>classOf</code>
