...
public interface IFullMultipebbleAuxiliaryGameState {
	...
	public enum AuxiliaryGameStateType {
		SPOILER_WINNING_SINK, EMPTY_STACK, DEFAULT_SINK_FOR_AUTOMATA_OPERATIONS,
	}

	AuxiliaryGameStateType getAuxiliaryGameStateType();

	static <STATE, GS extends FullMultipebbleGameState<STATE>> boolean isSpoilerWinningSink(final GS gs) {
		if ((gs instanceof IFullMultipebbleAuxiliaryGameState) && (((IFullMultipebbleAuxiliaryGameState) gs)
