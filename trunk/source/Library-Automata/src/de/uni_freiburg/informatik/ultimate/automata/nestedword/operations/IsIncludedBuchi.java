 ...
 *            state type
 */
public final class IsIncludedBuchi<LETTER, STATE> extends BinaryNwaOperation<LETTER, STATE, IStateFactory<STATE>> {
	 ...
	 */
	public IsIncludedBuchi(final AutomataLibraryServices services, final INwaInclusionStateFactory<STATE> stateFactory,
		...
		final BuchiIsEmpty<LETTER, STATE> emptinessCheck =
				new BuchiIsEmpty<>(services, (new BuchiDifferenceFKV<>(mServices,
						(IBuchiNwaInclusionStateFactory) stateFactory, fstOperand, sndOperand)).getResult());
