...
public class GetRandomNwaTv extends GeneralOperation<String, String> {
	...
	public GetRandomNwaTv(final AutomataLibraryServices services, final int numberOfStates,
			final int numberOfInternalLetters, final int transitionDensityPercent,
	...
	public GetRandomNwaTv(final AutomataLibraryServices services, final int numberOfStates,
		...
		this(services, numberOfStates, numberOfInternalLetters, ZERO_INT, ZERO_INT, transitionDensity, ZERO, ZERO,
				ZERO, acceptanceDensity);
	}
	...
	private NestedWordAutomaton<String, String> generateAutomaton() {
