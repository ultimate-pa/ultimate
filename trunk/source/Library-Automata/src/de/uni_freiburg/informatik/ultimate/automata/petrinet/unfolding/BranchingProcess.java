...
public final class BranchingProcess<LETTER, PLACE> implements IAutomaton<LETTER, PLACE> {
	...
	private final HashRelation<Transition<LETTER, PLACE>, Event<LETTER, PLACE>> mTransitions2Events;
	 ...
	 */
	public Set<Event<LETTER, PLACE>> getEvents(final Transition<LETTER, PLACE> transition) {
