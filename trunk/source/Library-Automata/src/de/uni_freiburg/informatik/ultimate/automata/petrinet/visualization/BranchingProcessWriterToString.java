...
public final class BranchingProcessWriterToString<LETTER, STATE> extends BranchingProcessWriter<LETTER, STATE> {
	public BranchingProcessWriterToString(final PrintWriter writer, final String name,
	...
	@Override
	protected Map<Condition<LETTER, STATE>, String>
			getConditionsMapping(final Collection<Condition<LETTER, STATE>> conditions) {
