...
/**
 * State factory for intersecting two automata.
 * 
...
public interface ISenwaStateFactory<STATE> extends IEmptyStackStateFactory<STATE> {
	 ...
	 * @param state
	 *            state
	 * @return state representing a {@link de.uni_freiburg.informatik.ultimate.automata.nestedword.senwa.Senwa Senwa}
	 *         state
	 */
	STATE senwa(final STATE entry, final STATE state);
}
