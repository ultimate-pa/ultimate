...
/**
 * State factory for Buchi complementation in the <tt>FKV</tt> style.
 * 
 * @author Christian Schilling (schillic@informatik.uni-freiburg.de)
 * @param <STATE>
 *            state type
 */
public interface IBuchiComplementFkvStateFactory<STATE> extends IEmptyStackStateFactory<STATE>, ISinkStateFactory<STATE> {
	/**
	 ...
	 */
	STATE buchiComplementFkv(final LevelRankingState<?, STATE> complementState);
}
