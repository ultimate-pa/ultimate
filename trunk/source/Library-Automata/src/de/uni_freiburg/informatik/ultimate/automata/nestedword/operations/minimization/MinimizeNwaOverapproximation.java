...
public final class MinimizeNwaOverapproximation<LETTER, STATE> extends AbstractMinimizeNwa<LETTER, STATE> {
	 ...
	 */
	public <FACTORY extends IMergeStateFactory<STATE> & ISinkStateFactory<STATE>> MinimizeNwaOverapproximation(
	...
	public boolean checkResult(final IStateFactory<STATE> stateFactory) throws AutomataLibraryException {
		...
		correct =
				new IsIncluded<>(mServices, (ISinkStateFactory<STATE>) stateFactory, mOperand, getResult()).getResult();
		assert correct;
	...
	private void constructResult(final boolean wasInterrrupted,
			...
			final Collection<? extends INestedWordAutomatonSimple<LETTER, STATE>> forbiddenLanguages,
			final ISinkStateFactory<STATE> stateFactoryIntersect)
			throws AutomataOperationCanceledException {
