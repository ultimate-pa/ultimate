 ...
 *            state type
 */
public final class NetWriterToString<LETTER, STATE> extends NetWriter<LETTER, STATE> {
	/**
	 * @param writer
	 *            Print writer.
	 * @param name
	 ...
	 *            Petri net
	 */
	public NetWriterToString(final PrintWriter writer, final String name, final BoundedPetriNet<LETTER, STATE> net) {
