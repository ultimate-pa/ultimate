 ...
 * as a modification and uses the input automaton as back-end. For all LETTERs
 * that are in the set mUniversalLoopers the
...
public class AutomatonWithImplicitSelfloops<LETTER, STATE>
	...
	protected final Set<LETTER> mUniversalLoopers;
	...
	public Iterable<OutgoingInternalTransition<LETTER, STATE>> internalSuccessors(final STATE state,
			final LETTER letter) {
		if (mUniversalLoopers.contains(letter)) {
