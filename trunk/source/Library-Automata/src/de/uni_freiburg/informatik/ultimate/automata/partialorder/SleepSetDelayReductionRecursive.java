 ...
 * 		state type
 */
public class SleepSetDelayReductionRecursive<L, S> extends UnaryNwaOperation<L, S, IStateFactory<S>> {
	 ...
	 * 
	 */
	public SleepSetDelayReductionRecursive(final INwaOutgoingLetterAndTransitionProvider<L, S> operand,
