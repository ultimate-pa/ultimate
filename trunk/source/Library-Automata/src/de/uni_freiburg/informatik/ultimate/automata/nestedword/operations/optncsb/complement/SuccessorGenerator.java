...
public class SuccessorGenerator {
	...
	public SuccessorGenerator(final boolean isBEmpty, final NCSB succ, final IntSet minusFSuccs,
			final IntSet interFSuccs, final IntSet f) {
		mIsCurrBEmpty = isBEmpty;
		mSuccNCSB = succ;
	...
	public NCSB next() {
		final IntSet toS = mPs.next(); // extra states to be added into S'
		final IntSet left = mInterFSuccs.clone();
		left.andNot(toS);
