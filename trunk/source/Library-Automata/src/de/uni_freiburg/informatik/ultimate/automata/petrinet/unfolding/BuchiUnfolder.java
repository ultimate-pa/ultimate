...
import de.uni_freiburg.informatik.ultimate.automata.buchipetrinet.operations.IsEmptyBuchi;
...
public final class BuchiUnfolder<L, P> extends PetriNetUnfolderInfinite<L, P> {
	...
	@Override
	void setupChild() {
		mLassoChecker = new IsEmptyBuchi<>(mServices, mUnfolding, (IPetriNetTransitionProvider<L, P>) mOperand);
		mLassoRun = null;
	}
}
