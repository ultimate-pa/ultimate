 ...
 *            state type
 */
public final class BuchiIsIncludedNCSBSimple<LETTER, STATE>
	 ...
	 */
	public <FACTORY extends IBuchiIntersectStateFactory<STATE> & IBuchiComplementNcsbStateFactory<STATE>> BuchiIsIncludedNCSBSimple(
		...
		final INwaOutgoingLetterAndTransitionProvider<LETTER, STATE> sndComplement =
				(new BuchiComplementNCSBSimple<>(mServices, stateFactory, mSndOperand)).getResult();
