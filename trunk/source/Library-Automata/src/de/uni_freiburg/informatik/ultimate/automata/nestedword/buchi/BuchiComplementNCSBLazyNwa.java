 ...
 *            state type
 */
public final class BuchiComplementNCSBLazyNwa<LETTER, STATE> implements INwaSuccessorStateProvider<LETTER, STATE> {
	 ...
	 */
	public BuchiComplementNCSBLazyNwa(final AutomataLibraryServices services,
