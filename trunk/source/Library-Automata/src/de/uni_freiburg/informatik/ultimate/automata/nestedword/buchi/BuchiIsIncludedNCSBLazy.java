 ...
 *            state type
 */
public final class BuchiIsIncludedNCSBLazy<LETTER, STATE>
	 ...
	 */
	public <FACTORY extends IBuchiIntersectStateFactory<STATE> & IBuchiComplementNcsbStateFactory<STATE>> BuchiIsIncludedNCSBLazy(
		...
		final INwaOutgoingLetterAndTransitionProvider<LETTER, STATE> sndComplement =
				(new BuchiComplementNCSBLazy<>(mServices, stateFactory, mSndOperand)).getResult();
