 ...
 *            state type
 */
public final class NwaWriterToStringWithHash<LETTER, STATE> extends NwaWriter<LETTER, STATE> {
	/**
	 ...
	 */
	public NwaWriterToStringWithHash(final PrintWriter writer, final String name,
