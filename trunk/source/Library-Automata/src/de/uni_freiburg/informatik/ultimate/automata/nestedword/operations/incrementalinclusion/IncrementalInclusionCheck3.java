...
public class IncrementalInclusionCheck3<LETTER, STATE> extends AbstractIncrementalInclusionCheck<LETTER, STATE>
	...
	public IncrementalInclusionCheck3(final AutomataLibraryServices services, final IStateFactory<STATE> sf,
	...
	@SuppressWarnings("unchecked")
	private boolean NestedRunAcceptanceChk(final INestedWordAutomatonSimple<LETTER, STATE> bn,
