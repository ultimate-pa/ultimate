...
public class PreferenceInitializer extends UltimatePreferenceInitializer {
	...
	protected UltimatePreferenceItem<?>[] initDefaultPreferences() {
		return new UltimatePreferenceItem<?>[] {
				new UltimatePreferenceItem<String>(LABEL_SyntaxErrorCommand,
						DEF_SyntaxErrorCommand, PreferenceType.String),
				new UltimatePreferenceItem<Boolean>(LABEL_DoSyntaxWarningCheck,
						DEF_DoSyntaxWarningCheck, PreferenceType.Boolean),
				new UltimatePreferenceItem<String>(LABEL_SyntaxWarningCommand,
						DEF_SyntaxWarningCommand, PreferenceType.String),
				new UltimatePreferenceItem<Boolean>(LABEL_RemoveFilename,
						DEF_RemoveFilename, PreferenceType.Boolean),
