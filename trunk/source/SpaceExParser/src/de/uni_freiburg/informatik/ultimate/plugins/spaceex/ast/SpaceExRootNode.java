...
public class SpaceExRootNode extends SpaceExNode {
	...
	public SpaceExRootNode(final String math, final String version, final ILogger logger) {
	...
	public void addComponent(final ComponentType component) {

	}

	public void addSystem(final ComponentType system) {
	...
	public ComponentType getSystem(final String name) {
