...
public class ParallelCompositionGeneratorTest {
	...
	public void testComputeParallelComposition() throws Exception {
		...
		assertEquals("{1=loc_1(1), Invariant: y <= 10 && x <= 10, Flow: y' == 10 && x' == 10}",merge.getLocations().toString());
		...
		assertEquals("{1=loc_1(1), Invariant: y <= 4 && x <= 4, Flow: y'==1 && x'==1, "
				+ "2=loc_2(2), Invariant: y <= 5 && x <= 5, Flow: y'==1 && x'==1, "
				+ "3=loc_3(3), Invariant: y <= 5 && x <= 6, Flow: y'==1 && x'==1, "
				+ "4=loc_4(4), Invariant: y <= 6 && x <= 5, Flow: y'==1 && x'==1, "
				+ "5=loc_5(5), Invariant: y <= 6 && x <= 6, Flow: y'==1 && x'==1}",merge.getLocations().toString());
		assertEquals("[(1) === (); {y:=0 && x:=0}; Label: jump1 ===> (2), "
				+ "(2) === (); {} ===> (3), "
				+ "(2) === (); {} ===> (4), "
				+ "(4) === (); {} ===> (5), "
