...
public class HybridSystemHelper {
	...
	public static void addParameter(final ParamType param, final Collection<String> localParameters,
			final Collection<String> globalParameters, final Collection<String> localConstants,
			final Collection<String> globalConstants, final Collection<String> labels, final ILogger logger) {
	...
	private static void addParameterToSet(final String name, final Collection<String> collection,
