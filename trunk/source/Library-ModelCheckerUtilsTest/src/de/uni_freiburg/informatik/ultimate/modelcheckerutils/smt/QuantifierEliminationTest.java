...
public class QuantifierEliminationTest {
	...
	public void varStilThereBug() {
		...
		final TermVariable var_v_probe3_6_p9base_40 = mScript.variable("v_probe3_6_~p~9.base_40",
				SmtSortUtils.getIntSort(mMgdScript));
	...
	public void plrTest1() {
		...
		final LBool checkSatResult = SmtUtils.checkSatTerm(mScript,
				mScript.term("distinct", mScript.term("true"), formulaAsTerm));
	...
	public void plrTest5() {
		...
		final String formulaAsString = "(exists ((A Int) (B Int) (C Bool) (D Bool) (E Bool) (F Bool) (G Bool) (H Bool) (I Bool) (J Bool) "
	...
	/**
	 * Example for "ApplicationTerm cannot be cast to
	 * de.uni_freiburg.informatik.ultimate.logic.QuantifiedFormula"
	 */
	@Test
	public void plrTest6() {
		final Sort arraySort = SmtSortUtils.getArraySort(mScript, SmtSortUtils.getIntSort(mMgdScript),
				SmtSortUtils.getIntSort(mMgdScript));
	...
	/**
	 * Quantifier elimination use case that comes from using constant arrays to
	 * initialize array variables in the C to Boogie translation. Variant where the
	...
	public void constantArrayTest01() {
		...
		final String formulaAsString = "(exists ((v_a (Array Int (Array Int Int)))) "
	...
	/**
	 * Quantifier elimination use case that comes from using constant arrays to
	 * initialize array variables in the C to Boogie translation. Variant where a
	 * helper function is used that is defined via define-function. (Perhaps this
	 * makes no difference.)
	 *
	 * @author Alexander Nutz (nutz@informatik.uni-freiburg.de)
	 */
	...
	public void constantArrayTest02() {
		final Sort arrayFromIntToIntToInt = SmtSortUtils.getArraySort(mScript, SmtSortUtils.getIntSort(mMgdScript),
				SmtSortUtils.getArraySort(mScript, SmtSortUtils.getIntSort(mMgdScript),
						SmtSortUtils.getIntSort(mMgdScript)));
		...
		final String formulaAsString = "(exists ((v_a (Array Int (Array Int Int)))) "
				+ "(= b (~initToZeroAtPointerBaseAddress~int v_a j)))";
		final Term formulaAsTerm = TermParseUtils.parseTerm(mScript, formulaAsString);
	...
	public void selectOverStoreTest01() {
		...
		final String formulaAsString = "(forall ((a (Array Int Int))) (or (not (= (select (store a k v) i) 7)) (not (= i k))))";
	...
	public void selectOverStoreTest03() {
		...
		mScript.declareFun("k", new Sort[0], SmtSortUtils.getIntSort(mMgdScript));
		mScript.declareFun("v", new Sort[0], SmtSortUtils.getIntSort(mMgdScript));
		final String formulaAsString = "(forall ((a (Array Int Int))) (or (not (= (select (store a k v) i) 7)) (= i k)))";
	...
	public void derPreprocessingBug() {
		final Sort intSort = SmtSortUtils.getIntSort(mMgdScript);
		final Sort intintArraySort = SmtSortUtils.getArraySort(mScript, intSort, intSort);
		final Sort intintintArraySort = SmtSortUtils.getArraySort(mScript, intSort,
				SmtSortUtils.getArraySort(mScript, intSort, intSort));
	...
	public void nestedSelfUpdateTest() {
		...
		final String formulaAsString = "(exists ((a (Array Int Int))) (and (not (= i k)) (= (select a i) ai) (= (select a j) aj) (= (select a k) ak)  (= (store (store (store a i vi) j vj) k vk) a)))";
	...
	public void nestedStoresTest() {
		...
		mScript.declareFun("vk", new Sort[0], SmtSortUtils.getIntSort(mMgdScript));
		mScript.declareFun("b", new Sort[0], intintArraySort);
		final String formulaAsString = "(exists ((a (Array Int Int))) (and (= (select a k) vk) (= (store (store a i vi) j vj) b)))";
		final String expectedResultAsString = "(let ((.cse2 (= vk (select b k))) (.cse0 (= vi (select b i))) (.cse3 (= i j)) (.cse1 (= vj (select b j))) (.cse4 (= j k))) (or (and .cse0 .cse1 .cse2) (and .cse3 .cse1 .cse2) (and (= i k) .cse0 .cse1) (and .cse0 .cse1 .cse4) (and .cse3 .cse1 .cse4)))";
		runQuantifierEliminationTest(formulaAsString, expectedResultAsString, true, mServices, mLogger, mMgdScript,
				mCsvWriter);
	}
	...
	public void varStillThere02() {
		...
		final String expectedResultAsString = "(= 23 (select (select |#memory_int| nonMain_~dstPlusTwo~0.base) nonMain_~dstPlusTwo~0.offset))";
		runQuantifierEliminationTest(formulaAsString, expectedResultAsString, true, mServices, mLogger, mMgdScript,
				mCsvWriter);
	}
	...
	/**
	 * 20190828 Matthias: @Test commented because this shows a bug. Might not be a
	 * good regression test for revealing this bug.
	 */
	// @Test
	...
	/**
	 * Special method for partial quantifier elimination that applies only local
	 * elimination techniques and replaces the outermost quantifier by an
