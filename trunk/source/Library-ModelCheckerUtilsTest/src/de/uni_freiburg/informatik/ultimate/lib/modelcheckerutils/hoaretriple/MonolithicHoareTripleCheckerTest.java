...
/**
 * A test suite for {@link MonolithicHoareTripleChecker}.
 *
 * This test suite does not declare any tests directly. Instead, it inherits tests from
 * {@link AbstractHoareTripleCheckerTest} and runs them on an {@link MonolithicHoareTripleChecker}.
 *
...
public class MonolithicHoareTripleCheckerTest extends AbstractHoareTripleCheckerTest {
	...
	protected IHoareTripleChecker getHtc() {
		return new MonolithicHoareTripleChecker(mCsToolkit);
	}
}
