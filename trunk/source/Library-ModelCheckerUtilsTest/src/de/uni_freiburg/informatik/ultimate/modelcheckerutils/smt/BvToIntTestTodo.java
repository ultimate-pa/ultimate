...
public class BvToIntTestTodo {
	...
	public void BV_2017_Preiner_scholl_smt08_model_model_6_64() {
		final FunDecl[] funDecls = {
				new FunDecl(SmtSortUtils::getBoolSort, "bool.b22", "bool.b7", "bool.b5", "bool.b6", "bool.b23",
	...
	public void arrayEliminationRushingMountaineer02() {
		final FunDecl[] funDecls = { new FunDecl(QuantifierEliminationTest::getBitvectorSort32, "~#a~0.base"),
	...
	public void heap_data_cart2() {
		final FunDecl[] funDecls = { new FunDecl(QuantifierEliminationTest::getBitvectorSort32, "idxDim1", "idxDim2"),
	...
	public void arrayEliminationRushingMountaineer01Reduced() {
		final FunDecl[] funDecls = { new FunDecl(QuantifierEliminationTest::getArrayBv32Bv1Sort, "a"), };
		final String inputSTR =
	...
	public void arrayEliminationRushingMountaineer03() {
		final FunDecl[] funDecls = { new FunDecl(QuantifierEliminationTest::getBitvectorSort32, "main_~x0~0.base"),
				new FunDecl(QuantifierEliminationTest::getArrayBv32Bv1Sort, "#valid"), };
		final String inputSTR =
	...
	public void list_simple_dll2cupdateall() {
		final FunDecl[] funDecls = {
				new FunDecl(QuantifierEliminationTest::getBitvectorSort32, "main_~s~0.base", "main_~s~0.offset",
	...
	public void sll_circular_traversal_2() {
		final FunDecl[] funDecls = {
				new FunDecl(QuantifierEliminationTest::getBitvectorSort32, "sll_circular_create_~new_head~0.base",
	...
	/**
	 * TODO Matthias 2023-03-14: After switching to the new elimination for div and mod (DML) we cannot eliminate all
	 * auxiliary variables.
	 */
	@Test
	public void bvTirBug07() {
		final FunDecl[] funDecls =
				{ new FunDecl(QuantifierEliminationTest::getBitvectorSort32, "main_~a~0", "main_~b~0") };
		final String inputSTR =
