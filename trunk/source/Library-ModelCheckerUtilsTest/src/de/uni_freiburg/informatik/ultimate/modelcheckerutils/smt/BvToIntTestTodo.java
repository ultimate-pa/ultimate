...
public class BvToIntTestTodo {
	...
	public void arrayEliminationRushingMountaineer02() {
		final FunDecl[] funDecls =
				new FunDecl[] { new FunDecl(QuantifierEliminationTest::getBitvectorSort32, "~#a~0.base"),
	...
	public void heap_data_cart2() {
		final FunDecl[] funDecls =
				new FunDecl[] { new FunDecl(QuantifierEliminationTest::getBitvectorSort32, "idxDim1", "idxDim2"),
	...
	public void memleaks_test1_3() {
		final FunDecl[] funDecls =
				new FunDecl[] { new FunDecl(QuantifierEliminationTest::getArrayBv32Bv1Sort, "#valid", "old(#valid)"), };
		final String inputSTR =
	...
	public void arrayEliminationRushingMountaineer01Reduced() {
		final FunDecl[] funDecls = new FunDecl[] { new FunDecl(QuantifierEliminationTest::getArrayBv32Bv1Sort, "a"), };
		final String inputSTR =
	...
	public void arrayEliminationRushingMountaineer03() {
		final FunDecl[] funDecls =
				new FunDecl[] { new FunDecl(QuantifierEliminationTest::getBitvectorSort32, "main_~x0~0.base"),
						new FunDecl(QuantifierEliminationTest::getArrayBv32Bv1Sort, "#valid"), };
		final String inputSTR =
