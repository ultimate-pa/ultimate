...
public class QuantifierEliminationRegressionTest {
	...
	public void plrTest07ExistsPositive() {
		...
		QuantifierEliminationTest.runQuantifierPusherTest(funDecls, formulaAsString, expextedResultAsString, true, mServices, mLogger, mMgdScript, mCsvWriter);
	}
	...
	public void divByZero() {
		...
		QuantifierEliminationTest.runQuantifierPusherTest(funDecls, formulaAsString, expectedResultAsString, true, mServices, mLogger, mMgdScript, mCsvWriter);
	}
