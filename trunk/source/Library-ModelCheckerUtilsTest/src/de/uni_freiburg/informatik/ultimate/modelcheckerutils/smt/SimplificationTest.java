...
//	private static final String SOLVER_COMMAND = "INTERNAL_SMTINTERPOL:10000";
	...
	public void ddaExample6() {
		...
		runSimplificationTest(funDecls, formulaAsString, expectedResultAsString, SimplificationTechnique.POLY_PAC, mServices, mLogger, mMgdScript, mCsvWriter);
	}
	...
	public void mcrPthreadWmm01() {
		...
		runSimplificationTest(funDecls, formulaAsString, null, SimplificationTechnique.POLY_PAC, mServices, mLogger, mMgdScript, mCsvWriter);
	}
	...
	public void missingConjuncts() {
		...
		runSimplificationTest(funDecls, formulaAsString, simplified, SimplificationTechnique.POLY_PAC, mServices, mLogger, mMgdScript, mCsvWriter);
	}
	...
	public void bvToIntBadgerExists01() {
		...
		runSimplificationTest(funDecls, formulaAsString, simplified, SimplificationTechnique.SIMPLIFY_DDA, mServices, mLogger, mMgdScript, mCsvWriter);
	}
	...
	static void runSimplificationTest(final FunDecl[] funDecls, final String eliminationInputAsString,
			...
			QuantifierEliminationTestCsvWriter csvWriter) {
