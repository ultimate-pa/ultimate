...
public class SimplificationTest {
	...
	public void dda2TestExample04() {
		final FunDecl[] funDecls =
				{ new FunDecl(SmtSortUtils::getBoolSort, "B"), new FunDecl(SmtSortUtils::getIntSort, "y", "x"), };
	...
	public void dda2TestExample05() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getIntSort, "X", "c", "d"),
	...
	public void distinctAndLess1() {
		final FunDecl[] funDecls =
				{ new FunDecl(SmtSortUtils::getRealSort, "x"), new FunDecl(SmtSortUtils::getBoolSort, "A"), };
	...
	public void mcrPthreadWmm01() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getIntSort, "x0", "x1"), };
		final String formulaAsString =
	...
	public void mcrPthreadWmm02() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getIntSort, "~x~0", "~x$r_buff0_thd2~0",
	...
	public void mcrPthreadWmm02Inner() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getIntSort, "~x$r_buff1_thd2~0",
	...
	public void reqchecker_vacuity_test82() {
		final FunDecl[] funDecls =
				{ new FunDecl(SmtSortUtils::getIntSort, "Constraint_assumption_ct0_pc", "req1_ct0_pc"), };
		final String formulaAsString =
	...
	public void rtinconsistency_test112() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getRealSort, "req1_ct0_X4", "req2_ct0_X4"),
	...
	public void nonConstraining01() {
		final FunDecl[] funDecls =
				{ new FunDecl(SmtSortUtils::getIntSort, "x"), new FunDecl(SmtSortUtils::getBoolSort, "A", "B") };
	...
	public void directFusionForConjunctionReal() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getRealSort, "x") };
	...
	public void bvToIntBadgerForall01() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getIntSort, "m", "n"), };
		final String formulaAsString =
	...
	public void bvToIntFoxExists04AfterTir() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getIntSort, "v_y_3", "v", "m", "n") };
		final String formulaAsString =
	...
	public void quantifierTest01() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getIntSort, "a"), };
	...
	public void simplifyMod01() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getIntSort, "x", "y", "z", "c"), };
		final String formulaAsString =
	...
	@Test
	public void simplifyMod01PolyPac() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getIntSort, "x", "y", "z", "c"), };
		final String formulaAsString =
				"(and (= x (mod (+ (mod y 23) (mod z 256) c) 737)) (>= y 1) (<= y 20) (>= z 5) (<= z 255) (<= c 200) (>= c 13))";
		final String expectedResultAsString =
	...
	@Test
	public void simplifyMod02() {
		final FunDecl[] funDecls = { new FunDecl(SmtSortUtils::getIntSort, "x", "y", "z", "c"), };
		final String formulaAsString =
				"(and (= x (mod (+ (mod y 23) (mod z 256) c) 737)) (>= y 1) (<= y 20) (>= z 5) (<= z 255))";
		final String expectedResultAsString = "(and (<= 1 y) (<= y 20) (<= 5 z) (= x (mod (+ c y z) 737)) (<= z 255))";
		runSimplificationTest(funDecls, formulaAsString, expectedResultAsString, SimplificationTechnique.SIMPLIFY_DDA2,
				mServices, mLogger, mMgdScript, mCsvWriter);
	}
