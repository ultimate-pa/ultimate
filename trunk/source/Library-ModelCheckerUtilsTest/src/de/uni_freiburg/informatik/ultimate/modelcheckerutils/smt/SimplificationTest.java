...
//	private static final String SOLVER_COMMAND = "INTERNAL_SMTINTERPOL:10000";
	...
	public void ddaExample6() {
		...
		runSimplificationTest(funDecls, formulaAsString, expectedResultAsString, SimplificationTechnique.POLY_PAC, mServices, mLogger, mMgdScript);
	}
	...
	public void mcrPthreadWmm01() {
		...
		runSimplificationTest(funDecls, formulaAsString, null, SimplificationTechnique.POLY_PAC, mServices, mLogger, mMgdScript);
	}
	...
	public void missingConjuncts() {
		...
		runSimplificationTest(funDecls, formulaAsString, simplified, SimplificationTechnique.POLY_PAC, mServices, mLogger, mMgdScript);
	}
	...
	public void creditSuisse01() {
		final FunDecl[] funDecls = new FunDecl[] {
				new FunDecl(SmtSortUtils::getIntSort, "x", "y", "z"),};
		final String formulaAsString = "(and (or (= (mod (+ x 1) 2) 0) (and (or (< (+ (div x 2) 1) 0) (< (* 2 z) (+ 2 x))) (or (< (+ 2 x) 0) (< x (+ 2 (* 2 z)))))) (<= x 2) (< 0 y) (= z 1) (or (and (or (< (+ x 1) 0) (< x (+ (* 2 z) 1))) (or (< (* 2 z) (+ 3 x)) (< (div (+ x 1) 2) 0))) (= (mod x 2) 0)))";
