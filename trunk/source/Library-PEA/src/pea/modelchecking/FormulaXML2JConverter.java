...
/**
 * The class <code>FormulaXML2JConverter</code> offers functionality to
 * convert a <code>FormulaTree</code> as specified in
 * <code>pea.modelchecking.schemas.BasicTypes.xsd</code> into a
 * <code>CDD</code> object.
 * 
 * @author Roland Meyer
 * 
 * @see pea.CDD
...
public class FormulaXML2JConverter {
    ...
    /**
     * Initialises the FormulaXML2JConverter object. Takes as parameter a string
     * that defines the loggername for the built in log4j logger. If the string
     * is empty, the default name <code>FormulaXML2JConverter</code> is used.
     * An application using a FormulaXML2JConverter object has to make sure that
     ...
     */
    public FormulaXML2JConverter(boolean useZDecision) {
        this("",useZDecision);
    }

    /**
     * Creates a <code>CDD</code> object for the given
     * <code>formulaNode</code> element by a recursive algorithm using the
     * <code>createFormulaCDD</code> method.
     * 
     * @param formulaNode
    ...
    /**
     * Returns the <code>CDD</code> representation of <code>formula</code>.
     * Recursively calls this method for children of <code>formula</code>.
     * 
     * @param formula
     *            The <code>org.w3c.dom.Element</code> to convert
     * @return The <code>CDD</code> representation of <code>formula</code>
     * @throws <code>RuntimeException</code> if
     *             <ul>
     *             <li>A formulaTree with operator
     *             <code>pea.modelchecking.XMLTags.NOT_CONST</code> has not
     *             exactly one operand
     *             <li>A formulaTree with operator
     *             <code>pea.modelchecking.XMLTags.AND_CONST</code> or
     *             <code>pea.modelchecking.XMLTags.OR_CONST</code> has less
     *             than two operands
     *             <li>A formulaTree has an operator different from
     *             <code>pea.modelchecking.XMLTags.NOT_CONST</code>,
     *             <code>pea.modelchecking.XMLTags.AND_CONST</code>,
     *             <code>pea.modelchecking.XMLTags.OR_CONST</code>.
        ...
        if (formulaName.equals(XMLTags.BOOLEANEXPRESSION_TAG)) {
            ...
            if (operator.equals(XMLTags.NOT_CONST)) {
                ...
                if (children.length < 2) {
                    throw new RuntimeException("\"" + XMLTags.OR_CONST
                            + "\" formulae with < 2 operands are not allowed");
                }
                ...
                if (children.length < 2) {
                    throw new RuntimeException("\"" + XMLTags.AND_CONST
                            + "\" formulae with < 2 operands are not allowed");
                }
            ...
            throw new RuntimeException("Formula tree operator has to be \""
                    + XMLTags.NOT_CONST + "\", \"" + XMLTags.AND_CONST
                    + "\", or \"" + XMLTags.OR_CONST + "\"");
        }
        throw new RuntimeException("Formula has to be \""
                + XMLTags.BOOLEANEXPRESSION_TAG + "\", \""
                + XMLTags.EVENTEXPRESSION_TAG + "\", or \""
                + XMLTags.RANGEEXPRESSION_TAG + "\"");
    }

    /**
     * Returns the children with tag name
     * <code>pea.modelchecking.XMLTags.RANGEEXPRESSION_TAG</code>,
     * <code>pea.modelchecking.XMLTags.BOOLEANEXPRESSION_TAG</code>,
     * <code>pea.modelchecking.XMLTags.EVENTEXPRESSION_TAG</code>,
     ...
     * @return The array of operands as <code>org.w3c.dom.Element</code>
     *         objects
     * @throws <code>RuntimeException</code> if the number of operands is 0.
     * 
    ...
    /**
     * Converts the string <code>operator</code> from
     * <code>pea.modelchecking.XMLTags</code> constants
     * <code>XMLTags.GREATEREQUAL_CONST</code>,
     * <code>XMLTags.GREATER_CONST</code>,<code>XMLTags.LESS_CONST</code>,
     * <code>XMLTags.LESSEQUAL_CONST</code>,<code>XMLTags.EQUAL_CONST</code>,
     * <code>XMLTags.NOTEQUAL_CONST</code> to the according int constant in
     * <code>pea.RangeDecision</code>.
     * 
     * @param operator
     *            String of operator to be translated
     * @return The <code>pea.RangeDecision</code> constant
     * @throws <code>RuntimeException</code> if the string does not match one of
     *             the constants above.
     * 
     * @see pea.modelchecking.XMLTags
    ...
    private int getOperator(String operator) {
        ...
        throw new RuntimeException("Operator needs to be " + "\""
                ...
                + XMLTags.GREATER_CONST + "\", " + "\"" + XMLTags.EQUAL_CONST
                + "\", " + "\"" + XMLTags.NOTEQUAL_CONST + "\", " + "\""
                + XMLTags.LESS_CONST + "\", or " + "\""
                + XMLTags.LESSEQUAL_CONST + "\"");
    }

    /**
     * Returns a <code>CDD</code> object representing the BooleanDecision for
     * <code>booleanExpressionNode</code>. Uses
     * <code>BooleanDecision.create</code>.
     * 
     * @param booleanExpressionNode
     *            The BooleanExpression element a <code>CDD</code> needs to be
     *            constructed for
     * @return The constructed <code>CDD</code>
     * @throws <code>RuntimeException</code> if the booleanExpressionNode
     *             attribute <code>expression</code> is empty, meaning
...
//    }
    ...
    /**
     * Returns a <code>CDD</code> object representing the RangeDecision for
     * <code>rangeExpressionNode</code>. Uses
     * <code>RangeDecision.create</code>.
     * 
     * @param rangeExpressionNode
     *            The RangeExpression element a <code>CDD</code> needs to be
     *            constructed for
     * @return The constructed <code>CDD</code>
     * @throws <code>RuntimeException</code> if the rangeExpressionNode attribute
     *             <code>variable</code> is empty, meaning
    ...
    /**
     * Returns a <code>CDD</code> object representing the EventDecision for
     * <code>eventNode</code>. Uses <code>EventDecision.create</code>.
     * 
     * @param eventNode
     *            The EventExpression element a <code>CDD</code> needs to be
     *            constructed for
     * @return The constructed <code>CDD</code>
     * @throws <code>RuntimeException</code> if the eventNode attribute
     *             <code>name</code> is empty, meaning
     *             <code>name.equals("")</code>.
     * 
     * @see pea.CDD
