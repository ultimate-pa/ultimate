...
public class FormulaJ2XMLConverter {
	...
	public FormulaJ2XMLConverter(final String loggerName) {
		if (loggerName.equals("")) {
			logger = ILogger.getLogger(FormulaJ2XMLConverter.DEFAULT_LOGGER);
		} else {
	...
	private Element createDecisionAndChildTree(final Element decisionNode, final Element childNode) {
		final Element formulaTreeAND = document.createElement(XMLTags.FORMULATREE_TAG);
	...
	private Element createBooleanExpressionNode(final String expression) {
		...
		final Element expressionNode = document.createElement(XMLTags.BOOLEANEXPRESSION_TAG);
	...
	private Element createRangeExpressionNode(final RangeDecision decision, final int i) {
		final Element rangeExpressionNode = document.createElement(XMLTags.RANGEEXPRESSION_TAG);
		...
		final Element formulaTreeNode = document.createElement(XMLTags.FORMULATREE_TAG);
	...
	private Element createEventExpressionNode(final String event) {
		...
		final Element eventNode = document.createElement(XMLTags.EVENTEXPRESSION_TAG);
