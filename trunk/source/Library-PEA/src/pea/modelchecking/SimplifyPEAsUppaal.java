...
/**
 * This class is another version of SimplifyPEAs. It produces <code>Uppaal</code>-output
 * instead of Phase Event Automata.
 * 
...
public class SimplifyPEAsUppaal extends SimplifyPEAs {
	...
	/**
	 * The main-method applies the simplifying methods from its
	 * superclass to the documents gives as parameter.
	 * It reads a Phase Event Automata network and optionally a test formula,
	 * builds the parallel product for them and writes the <code>Uppaal</code>-output to an
	 * XML-file.
	 * <br>
	 * Note: All paths have to be absolut!
	 * <br>
	 * @param args
	 * <code>Usage: input-file [formula-file] output-file [--write-ta testautomaton-file]</code><br>
	 * <br>
	 * <code>input-file</code> contains PEA's in the syntax of
    ...
    public static void main(String[] args) {
		...
		try	 {
			if(args.length == 2){
				...
				System.out.println("Usage: java pea.modelchecking.SimplifyPEAsUppaal " +
				"input-file [formula-file] output-file ");
				return;
			}
