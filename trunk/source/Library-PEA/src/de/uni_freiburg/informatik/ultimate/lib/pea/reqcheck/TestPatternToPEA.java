...
public class TestPatternToPEA {
	...
	public void testSeeping() {
		...
		final CounterTrace ct2 = new CounterTrace(
				new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(), new CounterTrace.DCPhase(Q.and(R.negate())),
	...
	public void testSeeping2() {
		...
		final CounterTrace ct = new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(R.negate()),
				...
				new CounterTrace.DCPhase() });
		final CounterTrace ct2 = new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(R.negate()),
				new CounterTrace.DCPhase(P.and(R.negate())), new CounterTrace.DCPhase(P.negate().and(R.negate())),
				new CounterTrace.DCPhase(P.and(R.negate())),
	...
	public void testSeeping3() {
		...
		final CounterTrace ct = new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(),
				...
				new CounterTrace.DCPhase(P.negate()), new CounterTrace.DCPhase(P), new CounterTrace.DCPhase(P.negate()),
	...
	public void testVacuous4() {
		...
		a1 = patternToPEA.absencePattern("", P.negate().and(Q.negate().and(R.negate().and(S.negate()))), Q, R,
				"Globally");
	...
	public void testVacuousProperty3() {
		...
		final CounterTrace ct =
				new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(), new CounterTrace.DCPhase(Q),
		...
		final CounterTrace ct2 =
				new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(), new CounterTrace.DCPhase(Q),
						new CounterTrace.DCPhase(), new CounterTrace.DCPhase(S.negate()), new CounterTrace.DCPhase() });
	...
	public void testVacuous() {
		...
		final CounterTrace ct = new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(),
				...
				new CounterTrace.DCPhase(S.negate(), CounterTrace.BOUND_GREATER, 10), new CounterTrace.DCPhase() });
		ctA = compiler.compile("1", ct);

		final CounterTrace ct2 = new CounterTrace(
				new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(), new CounterTrace.DCPhase(P.and(S.negate())),
	...
	public void testVacuous2() {
		...
		final CounterTrace ct = new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(P.negate()),
				new CounterTrace.DCPhase(S), new CounterTrace.DCPhase(),
				new CounterTrace.DCPhase(T, CounterTrace.BOUND_GREATER, 10), new CounterTrace.DCPhase() });
		ctA = compiler.compile("1", ct);
	...
	public void testVacuous3() {
		...
		// PhaseEventAutomata ctA, ctA2, ctA3;
		final CounterTrace ct = new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(),
				new CounterTrace.DCPhase(P), new CounterTrace.DCPhase(CounterTrace.BOUND_LESS, 6),
				new CounterTrace.DCPhase(Q), new CounterTrace.DCPhase() });
		ctA = compiler.compile("1", ct);

		final CounterTrace ct2 = new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(),
				new CounterTrace.DCPhase(P), new CounterTrace.DCPhase(T), new CounterTrace.DCPhase() });
		ctA2 = compiler.compile("2", ct2);
	...
	public void testVacuous5() {
		...
		final CounterTrace ct3 = new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(),
				new CounterTrace.DCPhase(P), new CounterTrace.DCPhase(S), new CounterTrace.DCPhase() });
		ctA3 = compiler.compile("3", ct3);
	...
	public void testZeno() {
		...
		final CounterTrace ct = new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(),
				...
				new CounterTrace.DCPhase(P, CounterTrace.BOUND_GREATEREQUAL, 6), new CounterTrace.DCPhase() });
		ctA = compiler.compile("z1", ct);

		final CounterTrace ct2 = new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(),
				new CounterTrace.DCPhase(P.negate()), new CounterTrace.DCPhase(P, CounterTrace.BOUND_LESS, 10),
				new CounterTrace.DCPhase(P.negate()), new CounterTrace.DCPhase() });
		ctA2 = compiler.compile("z2", ct2);

		final CounterTrace ct3 =
				new CounterTrace(new CounterTrace.DCPhase[] { new CounterTrace.DCPhase(), new CounterTrace.DCPhase(Q),
						new CounterTrace.DCPhase(), new CounterTrace.DCPhase(P.negate()), new CounterTrace.DCPhase() });
