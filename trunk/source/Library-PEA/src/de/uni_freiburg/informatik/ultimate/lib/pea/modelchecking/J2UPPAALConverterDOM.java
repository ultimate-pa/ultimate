...
public class J2UPPAALConverterDOM {
	...
	public void create(String file, PhaseEventAutomata<CDD> pea) {
	...
	private void addPEATransitions(PhaseEventAutomata<CDD> pea) throws IOException {
		...
		for (int j = 0; j < transCount; j++) {
			final Transition<CDD> trans = transitions.elementAt(j);
			createPEATransitionString(trans);
		}

	}

	private void createPEATransitionString(Transition<CDD> transition) throws IOException {
