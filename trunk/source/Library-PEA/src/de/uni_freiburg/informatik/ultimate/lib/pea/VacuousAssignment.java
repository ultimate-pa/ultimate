...
public class VacuousAssignment extends TCSWriter {
	...
	public VacuousAssignment(final String fileName, final PhaseEventAutomata<CDD> pea) {
		super(fileName);
		pea2write = pea;
	...
	public VacuousAssignment(final String destfile, final boolean rename, final PhaseEventAutomata<CDD> pea) {
		this(destfile, pea);
		this.rename = rename;
		setVacuous(new Vector<CDD>());
		setPossibleVacuousMaker(new Vector<CDD>());
	...
	public void checkVacuousSatisfiability(final PhaseEventAutomata<CDD> pea) {
	...
	private void checkPossibleVacuousMaker(final PhaseEventAutomata<CDD> pea) {
	...
	public void writePEA(final PhaseEventAutomata<CDD> pea) {
		try {
