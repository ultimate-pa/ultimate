...
/**
 * The class <code>XMLWriter</code> offers functionality to write the XML representation of a given
 * <code>Document</code> into a specified file.
 *
 * @author Roland Meyer
...
public class XMLWriter {
	/**
	 * Writes the XML representation of <code>node</code> and the children of <code>node</code> into a string by
	 ...
	 */
	private String traverse(final Node node, final int depth) {
	...
	/**
	 * Checks whether a given <code>Text</code> object contains a letter or a digit.
	 *
	 * @param text
	 *            The text object
	 * @return <code>true</code>, if the text object contains a letter or a digit, <code>false</code> otherwise
	 */
	private boolean containsData(final Text text) {
	...
	/**
	 * Checks whether a given element has only children that are <code>Text</code> nodes
	 *
	 * @param node
	 *            Node that needs to be checked
	 * @return <code>true</code> if the node has <code>Text</code> children only, <code>false</code> otherwise
	 */
	private boolean elementOnlyHasTextChildren(final Element node) {
	...
	/**
	 * Traverses the given <code>document</code> and writes the result into the file given by <code>fileName</code>.
	 *
	 * @param document
