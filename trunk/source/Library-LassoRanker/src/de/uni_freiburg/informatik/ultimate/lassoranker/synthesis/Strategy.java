...
public class Strategy {
	...
	private final DisjunctionTemplate mDisjunction;
	...
	public Strategy(final IIcfg<IcfgLocation> icfg) {
		mDisjuncts = 2;
		...
		final Script s = icfg.getCfgSmtToolkit().getManagedScript().getScript();
