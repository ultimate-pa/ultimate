...
public class TransFormulaLRWithArrayInformation {
	...
	public HashRelation<TermVariable, List<Term>> getArray2Indices() {
		return m_Array2Indices;
	}
	...
	public ArrayGenealogy[] getArrayGenealogy() {
		return m_ArrayGenealogy;
	}
