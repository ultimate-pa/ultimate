...
/**
 * Represents a single test-case that corresponds to an object generated by a
 * \@TestFactory method. Is only used internally by the FactoryTestRunner and
 * named to be consistent with JUnit naming conventions.
 * 
