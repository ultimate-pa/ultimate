...
public final class Dec<E1, E2, E3, E4, E5, E6, E7, E8, E9, E10> {
	...
	/**
	 * Creates a new Decuple with given elements.
	 *
	 * @param first
	 *            First element of the tuple
	 * @param second
	 ...
	 *            Tenth element of the tuple
	 */
	public Dec(final E1 first, final E2 second, final E3 third, final E4 fourth, final E5 fifth, final E6 sixth,
			final E7 seventh, final E8 eighth, final E9 ninth, final E10 tenth) {
		mFirst = first;
		mSecond = second;
		mThird = third;
		mFourth = fourth;
	...
	public boolean equals(final Object obj) {
		...
		if (mTenth == null) {
			if (other.mTenth != null) {
				return false;
			}
		} else if (!mTenth.equals(other.mTenth)) {
			return false;
		}
		if (mThird == null) {
	...
	/**
	 * Gets the tenth element of the tuple.
	 *
	 * @return Tenth element of the tuple.
	 */
	public E10 getTenth() {
		return mTenth;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(mEighth, mFifth, mFirst, mFourth, mNinth, mSecond, mSeventh, mSixth, mTenth, mThird);
	}
	...
	public String toString() {
		return "Dec [mEighth=" + mEighth + ", mFifth=" + mFifth + ", mFirst=" + mFirst + ", mFourth=" + mFourth
				+ ", mNinth=" + mNinth + ", mSecond=" + mSecond + ", mSeventh=" + mSeventh + ", mSixth=" + mSixth
				+ ", mThird=" + mThird + ", mTenth=" + mTenth + "]";
	}
}
