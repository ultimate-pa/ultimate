...
/**
 * A bidirectional map is a 1:1 mapping, having unique keys and unique values. Every bidirectional map can be inverted
 * to receive a map from values to keys.
 *
 * @author schaetzc@informatik.uni-freiburg.de
 *
 * @param <K>
 *            type of keys inside this map / type of values inside this map's inverse
 * @param <V>
 *            type of values inside this map / type of keys inside this map's inverse
 */
public class BidirectionalMap<K, V> extends HashMap<K, V> {
	 ...
	 *            map to be copied
	 */
	public BidirectionalMap(final BidirectionalMap<K, V> biMap) {
		super(biMap);
		mInverse = new BidirectionalMap<>(biMap.mInverse, this);
	}

	private BidirectionalMap(final HashMap<K, V> map, final BidirectionalMap<V, K> inverse) {
		super(map);
		mInverse = inverse;
	}

	/**
	 * Returns the inverse of this map. The inverse is a map where this map's values are mapped to this map's keys.
	 *
	...
	/**
	 * Adds the specified mapping to this map. Every existing mapping of the form {@code (key, *)} or {@code (*, value)}
	 * will be replaced.
	 *
	 * @param key
	...
	public V putAsymmetric(final K key, final V value) {
	...
	public V removeAsymmetric(final Object key) {
		return super.remove(key);
	}

	/**
	 * Returns a read-only {@link Set} view of this map's keys. This map's key set is equal to the value set of this
	 * map's inverse.
	 *
	...
	/**
	 * Returns a read-only {@link Set} view of this map's values. This map's value set is equal to the key set of this
	 * map's inverse.
	 * <p>
	 ...
	 * <p>
	 * <b>Do not use {@link Map.Entry#setValue(Object)}!</b> {@code setValue} changes only one side of this
	 * BidirectionalMap. Changing values using {@code setValue} breaks this map.
	 *
	...
	/**
	 * Copies all mappings from the specified map to this map. Existing mappings from this map with keys or values
	 * occurring in the the specified map will be overwritten.
	 * <p>
	 * <b>The outcome may depend on the iteration order of the specified map</b> unless all of the following
	 * propositions hold:
	 * <ul>
