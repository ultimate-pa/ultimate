 ...
 * better than the current result or not. The most important property is that each step is immutable so a lookahead at
 * following states is easily possible without affecting the current state. This also ensures thread safety.
 *
 * @param <T>
 *            variant type
 * @param <S>
