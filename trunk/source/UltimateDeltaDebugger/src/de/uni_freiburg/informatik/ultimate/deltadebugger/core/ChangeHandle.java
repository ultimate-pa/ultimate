...
/**
 * Represents a change instance that can be independently enabled and disabled
 * by a VariantGenerator.
 *
 */
public interface ChangeHandle extends HasSequenceIndex {
	 ...
	 * 
	 * This value can be used to to memoize the test result for a certain subset
	 * active of changes in a more memory efficient way than by storing the list
	 * itself. Besides that it can be used to assert that a certain subset of
