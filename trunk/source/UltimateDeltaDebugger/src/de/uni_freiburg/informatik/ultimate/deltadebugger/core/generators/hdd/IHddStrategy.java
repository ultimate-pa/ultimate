...
public interface IHddStrategy {
	...
	/**
	 * Determines if the changes generated by the node will be tested with other changes on the same level or not. If
	 * true is returned for a node, all changes that are generated for the children of this node (not the node itself!)
	 * will have their own {@link IVariantGenerator} instance and will effectively be search on their own.<br>
	...
	/**
	 * Determines if a node without changes will be expanded immediately instead on the next level. The search tree
