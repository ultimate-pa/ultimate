...
/**
 * A regular node is an IASTNode from the original AST, i.e. it is not a preprocessor node.
 * getASTNode() is never null.
 */
public interface IPSTRegularNode extends IPSTNode {
	
	/**
	 * @param astNode immediate child node to find
