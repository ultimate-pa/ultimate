...
public class PSTBuilder {
	 ...
	 * trailing tokens that belong to the parent node. This method decides if an ast-node that cleanly maps to a macro
	 * expansion is added as regular or macro expansions node.
	 *
	 * @param expansion
	 *            macro expansion
	 * @param astNode
