...
/**
 * A conditional block groups nodes within a conditional preprocessor region,
 * i.e. the source text enclosed in #if/#else/#endif directives. Only nodes in
 * the active branch are children of this node.
 */
