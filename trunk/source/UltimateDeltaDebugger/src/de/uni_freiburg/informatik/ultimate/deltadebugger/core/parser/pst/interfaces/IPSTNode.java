 ...
 * <li>Comments, preprocessor directives and conditional blocks are part of the AST hiearachy (where possible), e.g. a
 * comment between two statements is actually located between the two siblings. This allows to take advantage of
 * locality.
 * <li>The PST structure is strictly hierarchical: Each node has it's own source range that is only shared with
 * descendent nodes. A child node is always contained in the range of it's parent and siblings never overlap. Whenever
 ...
 * <ul>
 * <li>Regular AST nodes which are generated by the C-parser as descendents of IASTTranslationUnit, e.g. a function
 ...
 * of the strictly hiearchical PST.
 * </ul>
 *
