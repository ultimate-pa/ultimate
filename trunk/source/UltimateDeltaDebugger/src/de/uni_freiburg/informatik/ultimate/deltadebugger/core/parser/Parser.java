...
/**
 * Simplified Parser interface to remove configuration and boilerplate from
 * variant generators. Ensures a consistent parser configuration and default
 * settings.
 */
public interface Parser {
	 ...
	 * 
	 * Default options are {@link ILanguage#OPTION_IS_SOURCE_UNIT} and
	 * {@link ILanguage#OPTION_NO_IMAGE_LOCATIONS} The most interesting
	 * additional option should be {@link ILanguage#OPTION_SKIP_FUNCTION_BODIES}
