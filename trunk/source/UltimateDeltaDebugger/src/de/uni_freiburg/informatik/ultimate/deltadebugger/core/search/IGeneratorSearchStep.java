...
/**
 * Holds the state of one search step for the best reduced source code variant. Combines the VariantGenerator and
 * MinimizerStep interfaces into a single iterable search step that supports speculative searching.
 */
