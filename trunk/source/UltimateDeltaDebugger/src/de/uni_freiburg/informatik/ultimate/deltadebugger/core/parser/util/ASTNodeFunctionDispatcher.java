...
public final class ASTNodeFunctionDispatcher<T> {
    ...
    public ASTNodeFunctionDispatcher(IASTNodeFunction<T> func) {
        this.func = func;
    }

    public T dispatch(IASTArrayModifier arrayModifier) {
    ...
    public T dispatch(IASTAttributeSpecifier attributeSpecifier) {
    ...
    public T dispatch(IASTDeclSpecifier declSpecifier) {
    ...
    public T dispatch(IASTDeclaration declaration) {
    ...
    public T dispatch(IASTDeclarator declarator) {
    ...
    public T dispatch(IASTExpression expression) {
    ...
    public T dispatch(IASTInitializer initializer) {
    ...
    public T dispatch(IASTName name) {
    ...
    public T dispatch(IASTPointerOperator pointerOperator) {
    ...
    public T dispatch(IASTPreprocessorStatement preprocessorStatement) {
    ...
    public T dispatch(IASTStatement statement) {
    ...
    public T dispatch(IASTToken token) {
    ...
    public T dispatch(IASTTypeId typeId) {
    ...
    public T dispatch(ICASTDesignator cDesignator) {
     ...
     */
    public T dispatch(IASTNode node) {
    ...
    /**
     * Invokes the function by using an ASTVisitor instead 
     * of multiple instanceof checks in order to detect the first
     * first level of subtypes faster.
     *
     * Note that this is not the default implementation of dispatch(),
     * because calling IASTNode.accept() is not guaranteed to be
     * concurency safe. The caller has to explicitly decide if calling
     * IASTNode methods is safe.
     */
    public T dispatchByVisitor(IASTNode node) {
