...
public final class HddPass {
	...
	public static final PassDescription DEFAULT =
			PassDescription.builder(new HddGeneratorFactory(DEFAULT_STRATEGY, false)::analyze).name("HDD")
	...
	public static final PassDescription REPARSING =
			PassDescription.builder(new HddGeneratorFactory(DEFAULT_STRATEGY, true)::analyze).name("HDD (Reparsing)")
