...
public class CivlFailureResult implements IFailedAnalysisResult {
	private final String mSummary;
	private final String mOutput;
	private final String mError;

	public CivlFailureResult(final String summary, final String output, final String error) {
		mSummary = summary;
		mOutput = output;
		mError = error;
	}
