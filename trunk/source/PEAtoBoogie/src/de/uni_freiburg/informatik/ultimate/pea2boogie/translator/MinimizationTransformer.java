...
public class MinimizationTransformer implements IReq2PeaTransformer {

	private final ILogger mLogger;
	private final IUltimateServiceProvider mServices;
	private Map<PhaseEventAutomata, ReqEffectStore> mPea2EffectStore;

	public MinimizationTransformer(final IUltimateServiceProvider services, final ILogger logger) {
		mLogger = logger;
		mServices = services;
	}
	...
	public IReq2Pea transform(final IReq2Pea req2pea, final List<DeclarationPattern> init,
		...
		final MinimizationTransformerReq2Pea minimizationTransformerReq2Pea =
				new MinimizationTransformerReq2Pea(mServices, mLogger, init);
		minimizationTransformerReq2Pea.transform(req2pea);
		return minimizationTransformerReq2Pea;
	}
}
