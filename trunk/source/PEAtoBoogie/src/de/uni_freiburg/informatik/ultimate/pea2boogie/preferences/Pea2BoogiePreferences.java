...
public class Pea2BoogiePreferences extends UltimatePreferenceInitializer {
	...
	private static final String DESC_GUESS_INITIAL = """
			Allow for the test generator to initially guess an arbitrary\
		...
		return new BaseUltimatePreferenceItem[] {
				...
				new UltimatePreferenceItemGroup("Rt-Inconsistency",
						...
						new UltimatePreferenceItem<>(LABEL_USE_EPSILON, DEF_USE_EPSILON, DESC_USE_EPSILON,
								PreferenceType.Boolean),
						new UltimatePreferenceItem<>(LABEL_REPORT_TRIVIAL_RT_CONSISTENCY,
								DEF_REPORT_TRIVIAL_RT_CONSISTENCY, DESC_REPORT_TRIVIAL_RT_CONSISTENCY,
								PreferenceType.Boolean),
