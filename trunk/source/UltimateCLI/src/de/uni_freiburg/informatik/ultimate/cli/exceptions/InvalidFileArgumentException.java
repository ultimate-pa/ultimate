...
/**
 * An {@link InvalidFileArgumentException} exception is thrown if a file or a path to a file is not as expected: maybe
 * the file does not exist or the file is malformed.
 *
