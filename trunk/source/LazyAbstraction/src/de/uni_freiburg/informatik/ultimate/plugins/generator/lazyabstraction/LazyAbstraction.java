...
/**
 * Main class of Plug-In LazyAbstraction
 * 
 *
 * TODO: refine comments
 * 
 */
public class LazyAbstraction implements IGenerator {
	...
	private LazyAbstractionObserver m_Observer;
    ...
    public int init(Object param) {
    	m_Observer = new LazyAbstractionObserver();
    	return 0;
    }
