...
public class LAAnnotations extends AbstractAnnotations {
	...
	/* (non-Javadoc)
	 * @see de.uni_freiburg.informatik.ultimate.model.AbstractAnnotations#getFieldNames()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.uni_freiburg.informatik.ultimate.model.AbstractAnnotations#getFieldValue(java.lang.String)
	 */
	@Override
