...
public class Allocator {
	...
	public static int [] allocateIntArray(int size) {
		...
		try {
			// System.gc();
			return new int[size];
		} catch(final OutOfMemoryError ex) {fail(size*4L,"int",ex);return null;}
	}
	...
	public static double [] allocateDoubleArray(int size) {
		...
		} catch(final OutOfMemoryError ex) {fail(size*8L,"double",ex);return null;}
	}
	...
	public static short [] allocateShortArray(int size) {
		...
		} catch(final OutOfMemoryError ex) {fail(size*2L,"short",ex);return null;}
	}
	...
	public static char [] allocateCharArray(int size) {
		...
		} catch(final OutOfMemoryError ex) {fail(size*2L,"char",ex);return null;}
	}
	...
	public static byte [] allocateByteArray(int size) {
		...
		} catch(final OutOfMemoryError ex) {fail(size,"byte",ex);return null;}
	}
