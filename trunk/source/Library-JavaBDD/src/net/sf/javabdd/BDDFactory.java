...
public abstract class BDDFactory {
	 ...
	 * type is a string that can be "j", "java", "jdd", "test", or a name of a class that has an init() method
	 * that returns a BDDFactory. If it fails, it falls back to the "java" factory.
	 * </p>
	 * 
	 * @param bddpackage
	 ...
	 * @param typed
	 *            create a typed factory (i.e., wrap a typed factory around the bddpackage factory)
