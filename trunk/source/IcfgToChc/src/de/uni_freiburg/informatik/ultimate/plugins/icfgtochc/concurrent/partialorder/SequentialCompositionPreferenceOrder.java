...
public class SequentialCompositionPreferenceOrder implements IThreadModularPreferenceOrder {
	private final Script mScript;

	public SequentialCompositionPreferenceOrder(final Script script) {
		mScript = script;
	}
