...
public abstract class ExtensibleHornClauseProvider {
	...
	protected final HornClauseBuilder createBuilder(final PredicateInfo predicate) {
		return new HornClauseBuilder(mManagedScript, mSymbolTable, Objects.requireNonNull(predicate));
	}

	protected final HornClauseBuilder createBuilder() {
		return new HornClauseBuilder(mManagedScript, mSymbolTable);
	}
