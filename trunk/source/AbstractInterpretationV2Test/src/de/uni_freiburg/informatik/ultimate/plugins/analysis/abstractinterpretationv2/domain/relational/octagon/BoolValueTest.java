...
public class BoolValueTest {
	...
	public void testJoin() {
		final BoolValue[][] expected = { { BOT, FALSE, TRUE, TOP }, { FALSE, FALSE, TOP, TOP },
				{ TRUE, TOP, TRUE, TOP }, { TOP, TOP, TOP, TOP }, };
		testBinaryOperation(expected, BoolValue::union);
	}

	@Test
	public void testMeet() {
		final BoolValue[][] expected = { { BOT, BOT, BOT, BOT }, { BOT, FALSE, BOT, FALSE }, { BOT, BOT, TRUE, TRUE },
				{ BOT, FALSE, TRUE, TOP }, };
	...
	@Test
	public void testAnd() {
		final BoolValue[][] expected = { { BOT, BOT, BOT, BOT }, { BOT, FALSE, FALSE, FALSE },
				{ BOT, FALSE, TRUE, TOP }, { BOT, FALSE, TOP, TOP }, };
		testBinaryOperation(expected, BoolValue::and);
	}

	@Test
	public void testOr() {
		final BoolValue[][] expected = { { BOT, BOT, BOT, BOT }, { BOT, FALSE, TRUE, TOP }, { BOT, TRUE, TRUE, TRUE },
				{ BOT, TOP, TRUE, TOP }, };
	...
	private void testBinaryOperation(final BoolValue[][] expected,
			final BiFunction<BoolValue, BoolValue, BoolValue> op) {
