 ...
 *
 */
public class InvarianceBoundL2Pattern extends PatternType<InvarianceBoundL2Pattern> {

	public InvarianceBoundL2Pattern(final SrParseScope<?> scope, final String id, final List<CDD> cdds,
