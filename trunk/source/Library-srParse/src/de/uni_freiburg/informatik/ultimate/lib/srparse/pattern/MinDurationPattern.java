...
public class MinDurationPattern extends PatternType {
	...
	public void transform(final Map<String, Integer> id2bounds) {
		...
		mPea = mPeaTransformator.minDurationPattern(mId, p_cdd, q_cdd, r_cdd, parseDuration(getDuration(), id2bounds),
				mScope.toString());
	}
	...
	public String toString() {
		...
		res = "it is always the case that once \"" + mCdds.get(0) + "\" becomes satisfied, it holds for at least \""
