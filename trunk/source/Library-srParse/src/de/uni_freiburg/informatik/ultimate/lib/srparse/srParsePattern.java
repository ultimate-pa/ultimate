...
public class srParsePattern {
	...
	private boolean subExpressionsContained(final CDD cdd, final Vector<CDD> list) {
	...
	public class InvariantPattern extends PatternType {
		...
		public String toString() {
			...
			res = "it is always the case that if \"" + cdds.get(1) + "\" holds, then \"" + cdds.get(0)
					+ "\" holds as well";
	...
	public class PrecedenceChain12Pattern extends PatternType {
		...
		public String toString() {
			...
			res = "it is always the case that if \"" + cdds.get(2) + "\" holds and is succeeded by \"" + cdds.get(1)
					+ "\", then \"" + cdds.get(0) + "\" previously held";
	...
	public class PrecedenceChain21Pattern extends PatternType {
		...
		public String toString() {
			...
			res = "it is always the case that if \"" + cdds.get(2) + "\" holds, then \"" + cdds.get(1)
					+ "\" previously held and was preceded by \"" + cdds.get(0) + "\"";
	...
	public class ResponseChain12Pattern extends PatternType {
		...
		public String toString() {
			...
			res = "it is always the case that if \"" + cdds.get(2) + "\" holds, then \"" + cdds.get(1)
					+ "\" eventually holds and is succeeded by \"" + cdds.get(0) + "\"";
	...
	public class ResponseChain21Pattern extends PatternType {
		...
		public String toString() {
			...
			res = "it is always the case that if \"" + cdds.get(3) + "\" holds and is succeeded by \"" + cdds.get(2)
					+ "\", then \"" + cdds.get(1) + "\" eventually holds after \"" + cdds.get(0) + "\"";
	...
	public class ConstrainedChainPattern extends PatternType {
		...
		public String toString() {
			...
			res = "it is always the case that if \"" + cdds.get(5) + "\" holds, then \"" + cdds.get(4)
					+ "\" eventually holds and is succeeded by \"" + cdds.get(3) + "\", where \"" + cdds.get(2)
					+ "\" does not hold between \"" + cdds.get(1) + "\" and \"" + cdds.get(0) + "\"";
	...
	public class MinDurationPattern extends PatternType {
		...
		public String toString() {
			...
			res = "it is always the case that once \"" + cdds.get(0) + "\" becomes satisfied, it holds for at least \""
					+ duration + "\" time units";
	...
	public class MaxDurationPattern extends PatternType {
		...
		public String toString() {
			...
			res = "it is always the case that once \"" + cdds.get(0) + "\" becomes satisfied, it holds for less than \""
					+ duration + "\" time units";
	...
	public class BndReccurrencePattern extends PatternType {
		...
		public String toString() {
			...
			res = "it is always the case that \"" + cdds.get(0) + "\" holds at least every \"" + duration
					+ "\" time units";
	...
	public class BndResponsePattern extends PatternType {
		...
		public String toString() {
			...
			res = "it is always the case that if \"" + cdds.get(1) + "\" holds, then \"" + cdds.get(0)
					+ "\" holds after at most \"" + duration + "\" time units";
	...
	public class BndInvariancePattern extends PatternType {
		...
		public String toString() {
			...
			res = "it is always the case that if \"" + cdds.get(1) + "\" holds, then \"" + cdds.get(0)
					+ "\" holds for at least \"" + duration + "\" time units";
	...
	public class PossibilityPattern extends PatternType {
		...
		public String toString() {
			...
			res = "if \"" + cdds.get(1) + "\" holds, then there is at least one execution sequence such that \""
					+ cdds.get(0) + "\" eventually holds";
	...
	public class BndPossResponsePattern extends PatternType {
		...
		public String toString() {
			...
			res = "if \"" + cdds.get(1) + "\" holds, then there is at least one execution sequence such that \""
					+ cdds.get(0) + "\" holds after at most \"" + duration + "\" time units";
	...
	public class BndPossInvariancePattern extends PatternType {
		...
		public String toString() {
			...
			res = "if \"" + cdds.get(1) + "\" holds, then there is at least one execution sequence such that \""
					+ cdds.get(0) + "\" holds for at least \"" + duration + "\" time units";
	...
	public void setPattern(final PatternType pattern) {
	...
	public srParsePattern(final srParseScope scope) {
		setScope(scope);
		pattern = null;
	}

	public srParsePattern(final srParseScope scope, final PatternType pattern) {
		setScope(scope);
		this.pattern = pattern;
	}
