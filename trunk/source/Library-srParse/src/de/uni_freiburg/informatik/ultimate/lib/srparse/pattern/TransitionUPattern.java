...
/**
 * Globally, if in location {R} for at most {T} time units transition to {S} is enabled.
 *
 * CDDs (reverse order): S = cdds[0], R = cdds[1]. Duration: T = durations[0].
 */
public class TransitionUPattern extends AutomatonPatternType<TransitionUPattern> {

	public TransitionUPattern(final SrParseScope<?> scope, final String id, final List<CDD> cdds,
	...
	public String toString() {
		...
		sb.append("if in location \"").append(getCdds().get(1).toBoogieString()).append("\" for at most ")
