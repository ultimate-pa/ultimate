...
public class PatternBuilder {
	...
	private static final Class<?>[] PATTERNS =
			new Class<?>[] { BndDelayedResponsePatternUT.class, BndEdgeResponsePattern.class,
					BndEdgeResponsePatternDelayed.class, BndEntryConditionPattern.class, BndExistencePattern.class,
					...
					PrecedencePattern.class, ResponseChain12Pattern.class, ResponsePattern.class,
					UniversalityPattern.class, UniversalityPatternDelayed.class };
