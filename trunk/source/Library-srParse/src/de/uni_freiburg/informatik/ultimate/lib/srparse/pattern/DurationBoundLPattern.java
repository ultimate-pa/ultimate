 ...
 *
 */
public class DurationBoundLPattern extends PatternType<DurationBoundLPattern> {
	public DurationBoundLPattern(final SrParseScope<?> scope, final String id, final List<CDD> cdds,
