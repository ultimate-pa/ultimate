 ...
 *
 */
public class SingleTermPolynomialRelation implements PolynomialRelation {
	...
	/**
	 * Create {@link SingleTermPolynomialRelation} from {@link IPolynomialTerm} and {@link RelationSymbol}.
	 *
	 * Resulting relation is then <code><term> <symbol> 0</code>.
	 *
	 */
	private SingleTermPolynomialRelation(final AbstractGeneralizedAffineTerm<?> agat,
	...
	public static SingleTermPolynomialRelation of(final AbstractGeneralizedAffineTerm<?> agat,
			final RelationSymbol relationSymbol) {
		return new SingleTermPolynomialRelation(agat, relationSymbol);
	}

	public static SingleTermPolynomialRelation of(final Script script, final Term term) {
	...
	public static SingleTermPolynomialRelation of(final Script script, final RelationSymbol relationSymbol,
		...
		return SingleTermPolynomialRelation.of(TransformInequality.NO_TRANFORMATION, relationSymbol,
				(AbstractGeneralizedAffineTerm<?>) lhsPoly, (AbstractGeneralizedAffineTerm<?>) rhsPoly);
	}

	public static SingleTermPolynomialRelation of(final TransformInequality transformInequality,
		...
		return new SingleTermPolynomialRelation(polyTerm, relationSymbolAfterTransformation);
	}
	...
	@Override
	public SingleTermPolynomialRelation negate() {
		return new SingleTermPolynomialRelation(mPolynomialTerm, mRelationSymbol.negate());
	}

	@Override
	public SingleTermPolynomialRelation mul(final Script script, final Rational r) {
		final RelationSymbol resultRelationSymbol =
				ExplicitLhsPolynomialRelation.swapOfRelationSymbolRequired(r, mPolynomialTerm.getSort())
						...
						: mRelationSymbol;
		return new SingleTermPolynomialRelation(
	...
	public boolean equals(final Object obj) {
		...
		final SingleTermPolynomialRelation other = (SingleTermPolynomialRelation) obj;
	 ...
	 */
	@Override
	public SingleTermPolynomialRelation tryToConvertToEquivalentNonStrictRelation() {
		if (SmtSortUtils.isIntSort(mPolynomialTerm.getSort()) && mRelationSymbol.isStrictRelation()) {
			...
			return new SingleTermPolynomialRelation(mPolynomialTerm.add(offset),
