...
public class VariableNotZeroAssumption extends AbstractAssumption {
	...
	public VariableNotZeroAssumption(final Script script, final Sort sort,
			final VariableNotZeroAssumption... assumptions) {
	...
	private static Term notEqualZeroReal(final Script script, final Term term) {
		return SmtUtils.not(script, SmtUtils.binaryEquality(script, term,
				SmtUtils.rational2Term(script, Rational.ZERO, SmtSortUtils.getRealSort(script))));
	}
