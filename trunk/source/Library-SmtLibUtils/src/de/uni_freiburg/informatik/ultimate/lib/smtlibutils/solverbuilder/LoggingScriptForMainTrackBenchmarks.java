...
public class LoggingScriptForMainTrackBenchmarks extends LoggingScriptForNonIncrementalBenchmarks {
	...
	public static final String SOURCE_AUTOMIZER = "|" + System.lineSeparator()
			...
			+ System.lineSeparator() + "applying Ultimate Automizer to benchmarks [4] from the SV-COMP 2023 [5,6]."
			+ System.lineSeparator() + "This script may not contain all SMT commands that Ultimate Automizer"
			+ System.lineSeparator() + "issued. In order to meet the restrictions for SMT-COMP benchmarks "
			+ System.lineSeparator() + "we dropped the commands for getting values (resp. models), "
			+ System.lineSeparator() + "unsatisfiable cores, and interpolants." + System.lineSeparator() + ""
			+ System.lineSeparator() + "2023-03-21, Matthias Heizmann (heizmann@informatik.uni-freiburg.de)"
			+ System.lineSeparator() + "" + System.lineSeparator()
			...
			+ "[5] Dirk Beyer: Competition on Software Verification and" + System.lineSeparator()
			+ "     Witness Validation: SV-COMP 2023.  TACAS 2023" + System.lineSeparator()
			+ "[6] https://sv-comp.sosy-lab.org/2023/" + System.lineSeparator() + "|";
