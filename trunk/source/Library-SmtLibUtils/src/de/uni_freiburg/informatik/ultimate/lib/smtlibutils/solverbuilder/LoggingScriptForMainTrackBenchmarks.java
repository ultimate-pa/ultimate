...
public class LoggingScriptForMainTrackBenchmarks extends LoggingScriptForNonIncrementalBenchmarks {
	...
	public static final String SOURCE_AUTOMIZER = "|" + System.lineSeparator()
			...
			+ "applying Ultimate Automizer to benchmarks [4] from the SV-COMP 2026 [5,6]." + System.lineSeparator()
			...
			+ "" + System.lineSeparator()
			+ "May 2026, Matthias Heizmann (matthias.heizmann@iste.uni-stuttgart.de)" + System.lineSeparator()
			+ "" + System.lineSeparator()
			+ "[1] https://ultimate.informatik.uni-freiburg.de/automizer/" + System.lineSeparator()
			+ "[2] Manuel Bentele, Max Barth, Marcel Ebbinghaus, Jan Körner, Daniel Dietsch," + System.lineSeparator()
			+ "     Matthias Heizmann, Dominik Klumpp, Frank Schüssele, Andreas Podelski:" + System.lineSeparator()
			+ "     Ultimate Automizer with a One-Dimensional Memory Model - (Competition" + System.lineSeparator()
			+ "     Contribution). TACAS 2026" + System.lineSeparator()
			+ "[3] Matthias Heizmann, Jochen Hoenicke, Andreas Podelski: Software Model" + System.lineSeparator()
			...
			+ "[5] Dirk Beyer, Jan Strejcek: Evaluating Software Verifiers for C, Java," + System.lineSeparator()
			+ "     and SV-LIB - (Report on SV-COMP 2026). TACAS 2026" + System.lineSeparator()
			+ "[6] https://sv-comp.sosy-lab.org/2026/" + System.lineSeparator() + "|";
