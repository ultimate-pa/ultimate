 ...
 *
 */
public class ParallelHistoryScript extends WrapperScript {
	...
	private final Script mMainThreadScript;
	private final Script mWorkerThreadScript;

	boolean mSwitchedToMainScript = false;

	/**
	 * Has two scripts, one is the main script the other is a fresh Copy of the main script.
	 *
	 * @param mainThreadScript
	 * @param workerThreadScript
	 */
	public ParallelHistoryScript(final HistoryRecordingScript mainThreadScript,
			final HistoryRecordingScript workerThreadScript) {
		super(mainThreadScript);
		mMainThreadScript = mainThreadScript;
		mWorkerThreadScript = workerThreadScript;
	...
	/*
	 * From this point on, we only
	 */
	public void switchToMainScript() {
		mSwitchedToMainScript = true;
	}
	...
	public Term term(final String funcname, final Term... params) throws SMTLIBException {
		final TermTransferrer tf = new TermTransferrer(mWorkerThreadScript, mMainThreadScript);
