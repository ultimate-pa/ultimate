...
public class AssumptionMapBuilder {
	...
	private static DivisibleByAssumption castAndCreateDivByAssu(final Script script, final IAssumption assu1,
	...
	private static VariableNotZeroAssumption castAndCreateVarNotZeroAssu(final Script script, final IAssumption assu1,
			final IAssumption assu2) {
	...
	/**
	 * Get a Term, that represents all the assumptions of type "assu" so far, in explicit form, i. e. the conjunction of
	 * all assumptions. Returns true if no such assumptions exist. An example would be: Assumptions so far x != 0, y !=
	 * 0 Explicit form x != 0 and y != 0
	 */
	...
	/**
	 * Get a Term, that represents all the assumptions of type "assu" so far, in contracted form if possible. If the
	 * assumptions do not have such a form, the explicit form is returned. Returns true if no such assumptions exist. An
	 * example of a contracted form would be: Assumptions so far x != 0, y != 0 Contracted form x*y != 0
	 */
	...
	public interface BiAssumptionConstructor<S> {
		S apply(Script script, IAssumption assu1, IAssumption assu2);
	}
}
