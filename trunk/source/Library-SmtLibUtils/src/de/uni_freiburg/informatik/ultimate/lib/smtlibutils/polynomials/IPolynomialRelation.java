 ...
 * <ul>
 * <li>{@link PolynomialRelation} - the original representation. Reduces the relation to a single
 ...
 */
public interface IPolynomialRelation extends IBinaryRelation, ITermProvider {
	...
	static IPolynomialRelation of(final Script script, final Term term) {
		return PolynomialRelation.of(script, term);
	}

	static IPolynomialRelation of(final Script script, final Term term,
			final TransformInequality transformInequality) {
		return PolynomialRelation.of(script, term, transformInequality);
	}

	static IPolynomialRelation of(final Script script, final RelationSymbol relationSymbol, final Term lhs,
			final Term rhs) {
		return PolynomialRelation.of(script, relationSymbol, lhs, rhs);
	}

	static IPolynomialRelation of(final TransformInequality transformInequality, final RelationSymbol relationSymbol,
	...
	IPolynomialRelation tryToConvertToEquivalentNonStrictRelation();
