...
public interface ISpec {
	...
	enum Type {
		 ...
		 */
		private static final String FALLBACK_POSITIVE_MESSAGE =
				"a specification is correct but has no positive message";
		/**
		 ...
		 */
		Type(final Group group, final String defaultPosMsg, final String defaultNegMsg) {
			mGroup = group;
		 ...
		 */
		public boolean isInGroups(final Set<Group> groups) {
		 ...
		 * 
		 * If the given default message is a valid message of the specification type, then return the given default
		 * message. Otherwise return the specified fallback message.
		 * 
		 * @param defaultMsg
