...
/**
 * Edge in a recursive control flow graph that represents a set of 
 * CodeBlocks of which only one is executed.
 */
public class ParallelComposition extends CodeBlock {
	...
	private final Map<TermVariable,CodeBlock> m_BranchIndicator2CodeBlock = 
			new HashMap<TermVariable,CodeBlock>();
	...
	private final static String[] s_AttribFields = {
		"CodeBlocks (Parallely Composed)", "PrettyPrintedStatements", "TransitionFormula",
	...
	public ParallelComposition(ProgramPoint source, ProgramPoint target,
