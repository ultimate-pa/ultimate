 ...
 * procedure, including execution of the procedure, returning to the caller 
 * and update of the left hand side of a call statement.
 *  
...
public class Summary extends CodeBlock {
	...
	public Summary(ProgramPoint source, ProgramPoint target, 
	...
	public CodeBlock getCopy(ProgramPoint source, ProgramPoint target) {
		CodeBlock copy;
		copy = new Summary(source, target, m_CallStatement, m_CalledProcedureHasImplementation);
