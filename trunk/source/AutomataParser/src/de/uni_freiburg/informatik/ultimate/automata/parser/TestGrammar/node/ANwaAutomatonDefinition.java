...
public final class ANwaAutomatonDefinition extends PAutomatonDefinition
{
    ...
    private final LinkedList<PIdentifier> _callAlphabet_ = new LinkedList<PIdentifier>();
    private final LinkedList<PIdentifier> _internalAlphabet_ = new LinkedList<PIdentifier>();
    private final LinkedList<PIdentifier> _returnAlphabet_ = new LinkedList<PIdentifier>();
    private final LinkedList<PIdentifier> _states_ = new LinkedList<PIdentifier>();
    private final LinkedList<PIdentifier> _initialStates_ = new LinkedList<PIdentifier>();
    private final LinkedList<PIdentifier> _finalStates_ = new LinkedList<PIdentifier>();
    ...
    public ANwaAutomatonDefinition(
        ...
        @SuppressWarnings("hiding") List<PIdentifier> _callAlphabet_,
        @SuppressWarnings("hiding") List<PIdentifier> _internalAlphabet_,
        @SuppressWarnings("hiding") List<PIdentifier> _returnAlphabet_,
        @SuppressWarnings("hiding") List<PIdentifier> _states_,
        @SuppressWarnings("hiding") List<PIdentifier> _initialStates_,
        @SuppressWarnings("hiding") List<PIdentifier> _finalStates_,
    ...
    public LinkedList<PIdentifier> getCallAlphabet()
    {
        return this._callAlphabet_;
    }

    public void setCallAlphabet(List<PIdentifier> list)
    {
    ...
    public LinkedList<PIdentifier> getInternalAlphabet()
    {
        return this._internalAlphabet_;
    }

    public void setInternalAlphabet(List<PIdentifier> list)
    {
    ...
    public LinkedList<PIdentifier> getReturnAlphabet()
    {
        return this._returnAlphabet_;
    }

    public void setReturnAlphabet(List<PIdentifier> list)
    {
    ...
    public LinkedList<PIdentifier> getStates()
    {
        return this._states_;
    }

    public void setStates(List<PIdentifier> list)
    {
        this._states_.clear();
    ...
    public LinkedList<PIdentifier> getInitialStates()
    {
        return this._initialStates_;
    }

    public void setInitialStates(List<PIdentifier> list)
    {
    ...
    public LinkedList<PIdentifier> getFinalStates()
    {
        return this._finalStates_;
    }

    public void setFinalStates(List<PIdentifier> list)
    {
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PIdentifier> i = this._callAlphabet_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
        ...
        for(ListIterator<PIdentifier> i = this._internalAlphabet_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
        ...
        for(ListIterator<PIdentifier> i = this._returnAlphabet_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
        ...
        for(ListIterator<PIdentifier> i = this._states_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
        ...
        for(ListIterator<PIdentifier> i = this._initialStates_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
        ...
        for(ListIterator<PIdentifier> i = this._finalStates_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
