...
public interface Analysis extends Switch
{
    ...
    void caseAUnquotedIdentifier(AUnquotedIdentifier node);
    void caseAQuotedIdentifier(AQuotedIdentifier node);
    ...
    void caseTIdUnquoted(TIdUnquoted node);
    void caseTIdQuoted(TIdQuoted node);
