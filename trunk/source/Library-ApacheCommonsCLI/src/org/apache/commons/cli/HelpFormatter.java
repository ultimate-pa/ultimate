...
public class HelpFormatter {
	...
	/**
	 * Print the help for <code>options</code> with the specified command line syntax to the specified print writer.
	 *
	 * @param pw
	...
	/**
	 * Finds the next text wrap position after <code>startPos</code> for the text in <code>text</code> with the column
	 * width <code>width</code>. The wrap point is the last position before startPos+width having a whitespace character
