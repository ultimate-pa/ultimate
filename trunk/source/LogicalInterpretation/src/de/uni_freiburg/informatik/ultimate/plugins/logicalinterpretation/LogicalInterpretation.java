...
import de.uni_freiburg.informatik.ultimate.plugins.logicalinterpretation.preferences.LogicalInterpretationPreferences;

/**
 * @author Daniel Dietsch (dietsch@informatik.uni-freiburg.de)
 * @author Claus Schätzle (schaetzc@tf.uni-freiburg.de)
 */
public class LogicalInterpretation implements IAnalysis {

	private ILogger mLogger;
	private LogicalInterpretationObserver mObserver;
	...
	public List<IObserver> getObservers() {
		mObserver = new LogicalInterpretationObserver(mLogger, mServices);
	...
	public IPreferenceInitializer getPreferences() {
		return new LogicalInterpretationPreferences();
	}
