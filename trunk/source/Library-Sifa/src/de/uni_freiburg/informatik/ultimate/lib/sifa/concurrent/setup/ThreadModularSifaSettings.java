...
public record ThreadModularSifaSettings(LocationAbstractionType locationAbstractionType,
		InterferenceApplicatorType interferenceApplicatorType, int outerWideningThreshold, int innerWideningThreshold,
		boolean joinPrecision, boolean useBuckets, boolean locksetAwareInterference, boolean publishOnAcquire,
