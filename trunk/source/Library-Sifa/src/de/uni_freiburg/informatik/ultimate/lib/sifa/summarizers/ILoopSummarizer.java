...
public interface ILoopSummarizer {
	 ...
	 * <p>
	 * A loop summary over-approximates the states obtained by executing the loop body arbitrarily often (this includes
	 ...
	 *
	 * @param regex
	 *            A regex of the form {@code (inner)*}
	 * @param input
	 *            Input before executing {@code inner}
