 ...
 */
public class GeometricNonTerminationArgumentResult<P extends IElement, E> extends NonTerminationArgumentResult<P, E> implements IResult {
	/**
	...
	public GeometricNonTerminationArgumentResult(final P position, final String plugin, final Map<E, Rational> stateInit,
