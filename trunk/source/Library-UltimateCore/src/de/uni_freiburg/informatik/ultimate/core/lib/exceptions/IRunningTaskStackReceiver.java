...
public interface IRunningTaskStackReceiver {
	 ...
	 *            {@link RunningTaskInfo} instance that describes which task is currently running.
	 */
	void addRunningTaskInfo(final RunningTaskInfo runningTaskInfo);
}