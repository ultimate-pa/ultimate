...
public class IntegerTranslation extends ExpressionTranslation {
	...
	private AssumeStatement constructAssumeInRangeStatement(final TypeSizes typeSizes, final ILocation loc,
		...
		return new AssumeStatement(loc, ExpressionFactory.newBinaryExpression(loc, BinaryExpression.Operator.LOGICAND,
				biggerMinInt, smallerMaxValue));
	}
	...
	public Pair<Expression, Expression> constructOverflowCheckForLeftShiftExpression(final ILocation loc,
		...
		final Expression operationResult =
				constructLeftShiftExpression(loc, lhsOperand, lhsType, rhsOperand, rhsType, hook);
