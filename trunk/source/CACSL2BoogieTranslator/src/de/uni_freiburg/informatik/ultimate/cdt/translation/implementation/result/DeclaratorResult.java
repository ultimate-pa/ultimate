 ...
 * .. or more general: whenever we have something declaration-like where we know that only one symbol is declared/one type is involved
 *  --> a typeIdExpression is such a case, a SimpleDeclaration is not, for example.
 */
