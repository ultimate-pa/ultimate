...
public class CACSLPreferenceInitializer extends UltimatePreferenceInitializer {
	...
	protected BaseUltimatePreferenceItem[] initDefaultPreferences() {
		...
		return new BaseUltimatePreferenceItem[] { new UltimatePreferenceItemGroup("Specification",
				...
				new UltimatePreferenceItem<>(LABEL_CHECK_POINTER_VALIDITY, CheckMode.CHECK, PreferenceType.Combo,
						CheckMode.values()),
				new UltimatePreferenceItem<>(LABEL_CHECK_POINTER_ALLOC, CheckMode.CHECK, PreferenceType.Combo,
						CheckMode.values()),
				new UltimatePreferenceItem<>(LABEL_CHECK_ARRAYACCESSOFFHEAP, CheckMode.CHECK, PreferenceType.Combo,
						CheckMode.values()),
