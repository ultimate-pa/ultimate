...
public class VariadicStandardFunctionHandler extends StandardFunctionHandler2 {
	public VariadicStandardFunctionHandler(final ILogger logger, final Map<String, IASTNode> functionTable,
