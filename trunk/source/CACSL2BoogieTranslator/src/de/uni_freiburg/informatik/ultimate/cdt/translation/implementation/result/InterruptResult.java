...
public class InterruptResult extends Result {
	...
	/**
	 * List of interrupt annotations.
	 */
	private final InterruptStatement[] mIntAnnot;

	/**
	 * Create new result with interrupt annotations.
	 *
	 * @param intAnnot
	 *            List of interrupt annotations.
	 */
	public InterruptResult(final InterruptStatement[] intAnnot) {
		super(null);
		mIntAnnot = intAnnot;
	}

	/**
	 * Return the interrupt annotations.
	 *
	 * @return List of interrupt annotations.
	 */
	public InterruptStatement[] getInterruptAnnotation() {
		return mIntAnnot;
	}
