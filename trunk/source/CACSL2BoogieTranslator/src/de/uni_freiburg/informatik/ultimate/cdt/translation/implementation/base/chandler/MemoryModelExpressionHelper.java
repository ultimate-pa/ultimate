...
public class MemoryModelExpressionHelper {
	...
	public static Expression getValidArray(final ILocation loc,
			final RequiredMemoryModelFeatures requiredMemoryModelFeatures,
			final MemoryModelDeclarationsHandler memoryModelDeclarationsHandler) {
		return getMemoryModelFeatureExpression(loc, MemoryModelDeclarations.ULTIMATE_VALID, requiredMemoryModelFeatures,
	...
	public static Expression getStackAllocCounter(final ILocation loc,
			final RequiredMemoryModelFeatures requiredMemoryModelFeatures,
			final MemoryModelDeclarationsHandler memoryModelDeclarationsHandler) {
		return getMemoryModelFeatureExpression(loc, MemoryModelDeclarations.ULTIMATE_STACK_ALLOCATIONS,
				requiredMemoryModelFeatures, memoryModelDeclarationsHandler);
	}
	...
	public static Expression getHeapAllocCounter(final ILocation loc,
			final RequiredMemoryModelFeatures requiredMemoryModelFeatures,
			final MemoryModelDeclarationsHandler memoryModelDeclarationsHandler) {
		return getMemoryModelFeatureExpression(loc, MemoryModelDeclarations.ULTIMATE_HEAP_ALLOCATIONS,
				requiredMemoryModelFeatures, memoryModelDeclarationsHandler);
	}
	...
	public static Expression getInitialAllocCounter(final ILocation loc,
			final RequiredMemoryModelFeatures requiredMemoryModelFeatures,
			final MemoryModelDeclarationsHandler memoryModelDeclarationsHandler) {
		return getMemoryModelFeatureExpression(loc, MemoryModelDeclarations.ULTIMATE_INITIAL_ALLOCATIONS,
				requiredMemoryModelFeatures, memoryModelDeclarationsHandler);
	}
