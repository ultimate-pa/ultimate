...
public class InterruptPriorityFunction extends InterruptManagementFunction {
	...
	public InterruptPriorityFunction(final Procedure proc, final InterruptReferenceAll irq, final Operation op) {
		super(proc, irq);
		mOp = op;
	}

	public InterruptPriorityFunction(final InterruptReferenceAll irq, final Operation op) {
		super(irq);
		mOp = op;
	}
