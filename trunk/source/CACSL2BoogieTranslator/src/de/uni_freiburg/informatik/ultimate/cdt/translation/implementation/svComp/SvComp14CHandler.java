...
public class SvComp14CHandler extends CHandler {
    ...
    public Result visit(Dispatcher main, IASTFunctionCallExpression node) {
        ...
        assert (node.getFunctionNameExpression() instanceof IASTIdExpression) :
        	"we assumed that getFunctionNameExpression is IASTIdExpression, this might be wrong for function pointers";
        IASTIdExpression astIdExpression = 
        		(IASTIdExpression) node.getFunctionNameExpression();
