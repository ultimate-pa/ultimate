...
public class MainDispatcher implements IDispatcher {
	...
	public Result dispatch(final ACSLNode n, final IASTNode cHook) {
		...
		case final InterruptServiceRoutine isr -> mAcslHandler.visit(this, isr);
		case final InterruptMasking masking -> mAcslHandler.visit(this, masking);
		case final InterruptPriorityGet prioGet -> mAcslHandler.visit(this, prioGet);
		case final InterruptPrioritySet prioSet -> mAcslHandler.visit(this, prioSet);
