...
public abstract class InterruptManagementFunction extends InterruptFunction {

	public InterruptManagementFunction(final Procedure proc, final InterruptRequest irq) {
		super(proc, irq);
	}
