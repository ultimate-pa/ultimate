...
/**
 * Main class of Plug-In IcfgBuilder
 *
 *
 * TODO: refine comments
 *
 */
public class IcfgBuilder implements IGenerator {

	private IcfgBuilderObserver mObserver;
	...
	public List<IObserver> getObservers() {
		mObserver = new IcfgBuilderObserver(mServices);
	...
	public IPreferenceInitializer getPreferences() {
		return new IcfgPreferenceInitializer();
	}
