...
public abstract class IcfgEdgeAnnotation extends AbstractAnnotations {

	private static final long serialVersionUID = 1L;

	protected IcfgEdge mBackingEdge;

	protected IcfgEdgeAnnotation(final IcfgEdge backingEdge) {
	...
	public boolean equals(final Object obj) {
		if (obj instanceof IcfgEdgeAnnotation) {
			return mBackingEdge.equals(((IcfgEdgeAnnotation) obj).mBackingEdge);
