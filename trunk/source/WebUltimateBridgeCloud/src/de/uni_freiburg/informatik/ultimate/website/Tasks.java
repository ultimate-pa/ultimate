...
public class Tasks {
	...
	private static final Class[] actTCs = {BoogieTraceAbstractionTC.class, CTraceAbstractionTC.class};
	/**
	...
	private static void initTaskNames() {
		...
		taskString.put(TaskNames.RunAutomataTestFile, "Run Automata Test File");
		taskString.put(TaskNames.RunSmt2Script, "Run Smt2Script");
