 ...
 * .epf files. There Strings are exactly those which occur in the
 * UltimatePreferenceInitializer file, but where the blank space is quoted with
 * backslash. In the current architecture we do not want that the web interface
 * depends on all plugins therefore we have to copy all these strings.
 * 
...
public class PrefStrings {
	...
	public static final String s_CACSL_LABEL_SignedIntegerOverflow = s_cacsl2boogietranslator + "/Check\\ absence\\ of\\ signed\\ integer\\ overflows";
	...
	public static final String s_TA_LABEL_Hoare = s_traceAbstraction + "/Compute\\ Hoare\\ Annotation\\ of\\ negated\\ interpolant\\ automaton,\\ abstraction\\ and\\ CFG";
