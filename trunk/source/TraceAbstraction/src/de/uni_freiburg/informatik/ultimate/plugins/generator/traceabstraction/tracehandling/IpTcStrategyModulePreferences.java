	...
	protected IInterpolatingTraceCheck<L> construct() {
		...
		case PathInvariants:
			...
			return new InterpolatingTraceCheckPathInvariantsWithFallback<>(mPrecondition, mPostcondition,
					pendingContexts, (NestedWord<L>) mCounterexample, mControlConfigurationSequence,
					mPrefs.getCfgSmtToolkit(), assertionOrder, mServices, mPrefs.computeCounterexample(),
					mPredicateFactory, mPredicateUnifier, invariantSynthesisSettings, simplificationTechnique,
					icfgContainer, mPrefs.collectInterpolantStatistics());
		case PDR:
