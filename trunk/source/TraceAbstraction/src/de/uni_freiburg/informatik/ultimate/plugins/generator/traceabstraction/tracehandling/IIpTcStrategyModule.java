 ...
 */
public interface IIpTcStrategyModule<T extends IInterpolatingTraceCheck<LETTER>, LETTER extends IAction>
		extends IIpgStrategyModule<T, LETTER>, ITraceCheckStrategyModule<T> {
