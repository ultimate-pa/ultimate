...
public class MyPrefs extends UltimatePreferenceInitializer {
	...
	protected UltimatePreferenceItem<?>[] initDefaultPreferences() {
		return new UltimatePreferenceItem<?>[] {
				new UltimatePreferenceItem<Boolean>(LABEL_INTERACTIVE_VERIFICATION, DEF_INTERACTIVE_VERIFICATION, PreferenceType.Boolean),
		};
	}
