...
import de.uni_freiburg.informatik.ultimate.lib.tracecheckutils.partialorder.BetterLockstepOrder;
...
import de.uni_freiburg.informatik.ultimate.lib.tracecheckutils.partialorder.SleepSetStateFactoryForRefinement;
import de.uni_freiburg.informatik.ultimate.lib.tracecheckutils.partialorder.SleepSetStateFactoryForRefinement.SleepPredicate;
...
public class PartialOrderCegarLoop<L extends IIcfgTransition<?>> extends BasicCegarLoop<L> {
	...
	public PartialOrderCegarLoop(final DebugIdentifier name, final IIcfg<IcfgLocation> rootNode,
			...
			final IInitialAbstractionProvider<L, ? extends INwaOutgoingLetterAndTransitionProvider<L, IPredicate>> abstractionProvider) {
		super(name, rootNode, csToolkit, predicateFactory, taPrefs, errorLocs, interpolation, false,
	...
	private IRun<L, IPredicate> getCounterexample(IDfsVisitor<L, IPredicate> visitor) {
		while (visitor instanceof WrapperVisitor<?, ?, ?>) {
