 ...
 */
public class FoxBitwuzlaInterpolationFirstRefinementStrategy<L extends IIcfgTransition<?>>
		extends BasicRefinementStrategy<L> {

	public FoxBitwuzlaInterpolationFirstRefinementStrategy(final StrategyFactory<L>.StrategyModuleFactory factory,
	...
	static <L extends IIcfgTransition<?>> IIpTcStrategyModule<?, L>[]
		...
		if (!hasFloats) {
			rtr.add(factory.createIpTcStrategyModuleBitwuzla(InterpolationTechnique.Craig_NestedInterpolation));
