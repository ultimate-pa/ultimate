...
public class LinearInequalityPatternProcessorFactory
		implements
		IInvariantPatternProcessorFactory<Collection<Collection<LinearInequality>>> {
	...
	public LinearInequalityInvariantPatternProcessor produce(
		...
		return new LinearInequalityInvariantPatternProcessor(services,
				predUnifier, smtManager,
				produceSmtSolver(), cfg, precondition, postcondition, strategy);
	}
