 ...
 */
public class BadgerRefinementStrategy<LETTER extends IIcfgTransition<?>>
		extends MultiTrackRefinementStrategy<LETTER> {

	public BadgerRefinementStrategy(final ILogger logger, final TaCheckAndRefinementPreferences<LETTER> prefs,
		...
		super(logger, prefs, services, cfgSmtToolkit, predicateFactory, predicateUnifier, assertionOrderModulation,
				counterexample, precondition, abstraction, taPrefsForInterpolantConsolidation, taskIdentifier,
				emptyStackFactory);
	}
