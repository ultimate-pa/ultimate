...
public class CamelOnlyBpRefinementStrategy<L extends IIcfgTransition<?>> extends BasicRefinementStrategy<L> {
	public CamelOnlyBpRefinementStrategy(final StrategyFactory<L>.StrategyModuleFactory factory,
	...
	public String getName() {
		return RefinementStrategy.CAMEL_BP_ONLY.toString();
	}
}
