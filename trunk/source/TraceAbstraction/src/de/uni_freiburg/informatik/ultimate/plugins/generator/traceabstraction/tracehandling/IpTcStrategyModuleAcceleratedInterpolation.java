 ...
 *
 */
public class IpTcStrategyModuleAcceleratedInterpolation<LETTER extends IIcfgTransition<?>>
	...
	public IpTcStrategyModuleAcceleratedInterpolation(final ILogger logger, final IIcfg<?> icfg,
	...
	protected IInterpolatingTraceCheck<LETTER> construct() {
		return new AcceleratedInterpolationMain<>(mLogger, mPrefs, mPredicateUnifier,
