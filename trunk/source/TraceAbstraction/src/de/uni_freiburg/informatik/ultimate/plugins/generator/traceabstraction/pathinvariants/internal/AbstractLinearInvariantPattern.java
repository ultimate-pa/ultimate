...
/**
 * Class represents an abstract linear invariant pattern, that consists of - a strict/non-strict linear inequality that
 * is defined for - a set of variables, and - each variable is associated with a coefficient.
 *
...
public abstract class AbstractLinearInvariantPattern {
	...
	public AbstractLinearInvariantPattern(final Script solver, final Set<IProgramVar> variables, final String prefix,
	 ...
	 *
	 * Generated variables are coefficients for {@link IProgramVar}s and the constant term.
	 *
