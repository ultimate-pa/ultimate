...
public class InvariantSynthesisStatisticsGenerator implements IStatisticsDataProvider {
	...
	public Object getValue(final String key) {
		...
		case ProgramSizeDisjuncts:
			return mProgramSizeDisjuncts;
		case ProgramLocs:
			return mNumOfPathProgramLocations;
		case ProgramLocsLbe:
			return mNumOfPathProgramLocationsAfterLbe;
		case ProgramVars:
			return mNumOfPathProgramVars;
		case SumOfTemplateInequalities:
			return mSumOfTemplateInequalities;
		case SizeOfLargestTemplate:
			return mSizeOfLargestTemplate;
		case SizeOfSmallestTemplate:
			return mSizeOfSmallestTemplate;
		case MaxNumOfInequalities:
			return mMaxNumOfInequalitiesPerRound;
		case MaxRound:
			return mMaxRound;
		case TreeSizeNormalConstr:
			return mTreeSizeSumOfNormalConstraints;
		case TreeSizeApproxConstr:
			return mTreeSizeSumOfApproxConstraints;
		case SumVarsPerLoc:
			return mSumOfVarsPerLoc;
		case SumNonLiveVarsPerLoc:
			return mNumOfNonLiveVariables;
		case SumNonUnsatCoreLocs:
			return mNumOfNonUnsatCoreLocs;
		case SumNonUnsatCoreVars:
			return mNumOfNonUnsatCoreVars;
		case MotzkinTransformationsNormalConstr:
			return mMotzkinTransformationsForNormalConstr;
		case MotzkinTransformationsApproxConstr:
			return mMotzkinTransformationsForApproxConstr;
		case MotzkinCoefficientsNormalConstr:
			return mMotzkinCoefficientsNormalConstr;
		case MotzkinCoefficientsApproxConstr:
			return mMotzkinCoefficientsApproxConstr;
		case ConstraintsSolvingTime:
			return mConstraintsSolvingTime;
		case ConstraintsConstructionTime:
			return mConstraintsConstructionTime;
		case SatStatus:
			return mSatStatus;
		default:
	...
	public void addStatisticsDataAfterCheckSat(final int numOfNonUnsatCoreLocs, final int numOfNonUnsatCoreVars,
		...
		mTreeSizeSumOfNormalConstraints += (Integer) linearInequalityStats
				.get(LinearInequalityPatternProcessorStatistics.TreesizeNormalConstraints);
		mTreeSizeSumOfApproxConstraints += (Integer) linearInequalityStats
				.get(LinearInequalityPatternProcessorStatistics.TreesizeApproxConstraints);

		mMotzkinTransformationsForNormalConstr += (Integer) linearInequalityStats
				.get(LinearInequalityPatternProcessorStatistics.MotzkinTransformationsNormalConstraints);
		mMotzkinTransformationsForApproxConstr += (Integer) linearInequalityStats
