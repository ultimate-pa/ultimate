...
public class ToothlessSifaTaipanRefinementStrategy<L extends IIcfgTransition<?>> extends BasicRefinementStrategy<L> {
	...
	public ToothlessSifaTaipanRefinementStrategy(final StrategyFactory<L>.StrategyModuleFactory factory,
	...
	public String getName() {
		return RefinementStrategy.TOOTHLESS_SIFA_TAIPAN.toString();
	}
