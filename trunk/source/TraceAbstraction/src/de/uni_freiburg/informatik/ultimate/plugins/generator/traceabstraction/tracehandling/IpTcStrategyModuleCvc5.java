...
/**
 * Creates external instance of CVC 5 using {@link TraceCheckSpWp}.
 *
...
public class IpTcStrategyModuleCvc5<LETTER extends IIcfgTransition<?>> extends IpTcStrategyModuleSpWp<LETTER> {
	...
	protected SolverSettings getSolverSettings() {
		...
		return mPrefs.constructSolverSettings(mTaskIdentifier).setUseExternalSolver(ExternalSolver.CVC5, timeout)
