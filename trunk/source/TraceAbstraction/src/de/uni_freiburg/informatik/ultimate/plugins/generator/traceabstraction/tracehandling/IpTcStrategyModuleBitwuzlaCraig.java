...
public class IpTcStrategyModuleBitwuzlaCraig<LETTER extends IIcfgTransition<?>>
	...
	public IpTcStrategyModuleBitwuzlaCraig(final TaskIdentifier taskIdentifier, final IUltimateServiceProvider services,
	...
	protected ManagedScript constructManagedScript() {
		final SolverSettings solverSettings = mPrefs.constructSolverSettings(mTaskIdentifier)
				.setUseExternalSolver(ExternalSolver.BITWUZLA_INTERPOLATION)
				.setSolverMode(SolverMode.External_BitwuzlaInterpolationMode);
