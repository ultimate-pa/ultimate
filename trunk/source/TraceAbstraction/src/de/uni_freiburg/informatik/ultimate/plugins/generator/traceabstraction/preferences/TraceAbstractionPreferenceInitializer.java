...
public class TraceAbstractionPreferenceInitializer extends UltimatePreferenceInitializer {
	...
	public static final String LABEL_POR_ORDER_THREADS = "Considered threads and their maximal amount of steps";
	private static final String DEF_POR_ORDER_THREADS = "X";
	private static final String DESC_POR_ORDER_THREADS =
			"(give as threadindex,steps threadIndex,steps ...), use X for all threads with single value MaxStep";
	...
	public static final String LABEL_POR_ORDER_HEURISTIC = "Enable heuristic with loops as step type";
	...
	public UltimatePreferenceItemContainer getPORSettings() {
		return new UltimatePreferenceItemContainer("Partial Order Reduction (GemCutter)",
				...
				new UltimatePreferenceItemGroup("Preference Order",
						...
						new UltimatePreferenceItem<>(LABEL_POR_ORDER_STEP_TYPE, DEF_POR_ORDER_STEP_TYPE,
								PreferenceType.Combo, StepType.values()),
						new UltimatePreferenceItem<>(LABEL_POR_ORDER_THREADS, DEF_POR_ORDER_THREADS,
								DESC_POR_ORDER_THREADS, PreferenceType.String),
						new UltimatePreferenceItem<>(LABEL_POR_ORDER_MAXSTEP, DEF_POR_ORDER_MAXSTEP,
								PreferenceType.Integer),
						new UltimatePreferenceItem<>(LABEL_POR_ORDER_HEURISTIC, DEF_POR_ORDER_HEURISTIC,
								PreferenceType.Boolean)),
