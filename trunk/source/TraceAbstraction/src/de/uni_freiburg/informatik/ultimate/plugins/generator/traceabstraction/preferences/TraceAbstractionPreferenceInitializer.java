		...
		return new BaseUltimatePreferenceItem[] {
				...
				new UltimatePreferenceItemGroup("Assert Order",
						...
						new UltimatePreferenceItem<>(LABEL_ASSERT_CODEBLOCKS_HEURISTIC_SCORING_METHOD,
								DEF_ASSERT_CODEBLOCKS_HEURISTIC_SCORING_METHOD,
								DESC_ASSERT_CODEBLOCKS_HEURISTIC_SCORING_METHOD, PreferenceType.Combo,
						...
						new UltimatePreferenceItem<>(LABEL_ASSERT_CODEBLOCKS_HEURISTIC_NUM_PARTITIONS,
								DEF_ASSERT_CODEBLOCKS_HEURISTIC_NUM_PARTITIONS,
								DESC_ASSERT_CODEBLOCKS_HEURISTIC_NUM_PARTITIONS, PreferenceType.Integer,
								new IUltimatePreferenceItemValidator.IntegerValidator(0, 1_0000_000)),
