...
//	}
	...
	public LBool isInductiveCall(IPredicate ps1, 
		...
		// OldVars not renamed.
		// All variables get index 0.
		Term ps1renamed = PredicateUtils.formulaWithIndexedVars(ps1,new HashSet<BoogieVar>(0),
				4, 0, Integer.MIN_VALUE,null,-5, 0, m_IndexedConstants, m_Script, m_Boogie2Smt);
		
		TransFormula tf = ta.getTransitionFormula();
		Set<BoogieVar> assignedVars = new HashSet<BoogieVar>();
		Term fTrans = PredicateUtils.formulaWithIndexedVars(tf, 0, 1, assignedVars, m_IndexedConstants, m_Script, m_Boogie2Smt.getVariableManager());

		// OldVars renamed to index 0
		// GlobalVars renamed to index 0
		// Other vars get index 1
		Term ps2renamed = PredicateUtils.formulaWithIndexedVars(ps2, new HashSet<BoogieVar>(0),
	...
	public LBool isInductiveReturn(IPredicate ps1, 
		...
		Term fReturn = PredicateUtils.formulaWithIndexedVars(tfReturn, 1, 2, assignedVarsOnReturn, m_IndexedConstants, m_Script, m_Boogie2Smt.getVariableManager());
//		fReturn = (new FormulaUnLet()).unlet(fReturn);
		...
		Term fCall = PredicateUtils.formulaWithIndexedVars(tfCall, 0, 1, assignedVarsOnCall, m_IndexedConstants, m_Script, m_Boogie2Smt.getVariableManager());
//		fCall = (new FormulaUnLet()).unlet(fCall);

		// oldVars not renamed
		// other variables get index 0
		Term pskrenamed = PredicateUtils.formulaWithIndexedVars(psk, new HashSet<BoogieVar>(0),
		...
		// other variables get index 0
		Term ps2renamed = PredicateUtils.formulaWithIndexedVars(ps2, assignedVarsOnReturn,
