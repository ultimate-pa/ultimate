...
/**
 * Constructs the canonical interpolant automaton.
 * Boolean flags determine if we also add selfloops in the initial and final 
 * state. I think this construction is unsound if the precondition if not 
 * the "true" predicate.
