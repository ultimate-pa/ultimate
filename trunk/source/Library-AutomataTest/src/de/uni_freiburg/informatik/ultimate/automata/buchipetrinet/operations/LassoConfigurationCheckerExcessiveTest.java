...
public class LassoConfigurationCheckerExcessiveTest {
	...
	@Test
	public final void testLassoConfigurationChecker()
		...
		LassoConfigurationCheckerExcessive<String, String> configurationChecker =
				new LassoConfigurationCheckerExcessive<>(mUnfolding);

		boolean test = configurationChecker.getLassoConfigurations().toArray().length == 1;

		assertThat("Right amount of lasso configurations", test);
	}
