 ...
 */
public class CompleteHorizontalTreeView extends Display {
	 ...
	 *            label
	 */
	public CompleteHorizontalTreeView(Graph graph, String label) {
		...
		ActionList orient = new ActionList(2000);// Activity.INFINITY);//2000);
