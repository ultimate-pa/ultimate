...
public class BoogieIcfgContainer extends ModernAnnotations implements IIcfg<BoogieIcfgLocation> {
	...
	public BoogieIcfgContainer(final IUltimateServiceProvider services, final BoogieDeclarations boogieDeclarations,
			final Boogie2SMT mBoogie2smt, final ConcurrencyInformation concurInfo, final ILogger logger) {
		...
		mCodeBlockFactory = new CodeBlockFactory(services, mgScript, mCfgSmtToolkit,
				mBoogie2SMT.getBoogie2SmtSymbolTable(), serialprovider, logger);
	...
	@Deprecated
	public RootNode constructRootNode(final String pluginId) {
		final RootNode rootNode = new RootNode(ILocation.getAnnotation(this), this, pluginId);
