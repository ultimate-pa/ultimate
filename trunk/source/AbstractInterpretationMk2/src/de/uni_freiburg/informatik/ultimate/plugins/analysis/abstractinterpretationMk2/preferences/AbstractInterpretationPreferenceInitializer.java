		...
		UltimatePreferenceInitializer
{
	...
	{
			OPTION_STOPAFTER_ANYERROR,
			OPTION_STOPAFTER_ALLERRORS,
	...
	protected UltimatePreferenceItem<?>[] initDefaultPreferences()
	{
		...
		preferenceItems.add(new UltimatePreferenceItem<String>("--- General preferences ---", null, PreferenceType.Label));
		...
		preferenceItems.add(new UltimatePreferenceItem<Integer>(LABEL_STATES_UNTIL_MERGE,
				DEF_STATES_UNTIL_MERGE,
				PreferenceType.Integer,
				new IUltimatePreferenceItemValidator.IntegerValidator(1, 10000)));

		preferenceItems.add(new UltimatePreferenceItem<String>(LABEL_WIDENING_FIXEDNUMBERS, DEF_WIDENING_FIXEDNUMBERS, PreferenceType.String));

		preferenceItems.add(new UltimatePreferenceItem<Boolean>(LABEL_WIDENING_AUTONUMBERS, DEF_WIDENING_AUTONUMBERS, PreferenceType.Boolean));

		preferenceItems.add(new UltimatePreferenceItem<Boolean>(LABEL_STATE_ANNOTATIONS, DEF_STATE_ANNOTATIONS, PreferenceType.Boolean));

		preferenceItems.add(new UltimatePreferenceItem<Boolean>(LABEL_LOGSTATES_CONSOLE, DEF_LOGSTATES_CONSOLE, PreferenceType.Boolean));

		preferenceItems.add(new UltimatePreferenceItem<Boolean>(LABEL_LOGSTATES_FILE, DEF_LOGSTATES_FILE, PreferenceType.Boolean));

		preferenceItems.add(new UltimatePreferenceItem<Boolean>(LABEL_LOGSTATES_USESOURCEPATH, DEF_LOGSTATES_USESOURCEPATH, PreferenceType.Boolean));

		preferenceItems.add(new UltimatePreferenceItem<String>(LABEL_LOGSTATES_PATH, DEF_LOGSTATES_PATH, PreferenceType.Directory));

		preferenceItems.add(new UltimatePreferenceItem<String>(LABEL_STOPAFTER, DEF_STOPAFTER, PreferenceType.Combo, OPTIONS_STOPAFTER));
		...
		preferenceItems.add(new UltimatePreferenceItem<String>(
				LABEL_DOMAIN,
				domainRegistry.getDefaultDomainID(),
		...
		preferenceItems.add(new UltimatePreferenceItem<String>(LABEL_INTFACTORY, domainRegistry.getDefaultFactoryIDForInt(),
				PreferenceType.Combo, validFactoryIDs));
		preferenceItems.add(new UltimatePreferenceItem<String>(LABEL_REALFACTORY, domainRegistry.getDefaultFactoryIDForReal(),
				PreferenceType.Combo, validFactoryIDs));
		preferenceItems.add(new UltimatePreferenceItem<String>(LABEL_BOOLFACTORY, domainRegistry.getDefaultFactoryIDForBool(),
				PreferenceType.Combo, validFactoryIDs));
		preferenceItems.add(new UltimatePreferenceItem<String>(LABEL_BITVECTORFACTORY, domainRegistry.getDefaultFactoryIDForBitVector(),
				PreferenceType.Combo, validFactoryIDs));
		preferenceItems.add(new UltimatePreferenceItem<String>(LABEL_STRINGFACTORY, domainRegistry.getDefaultFactoryIDForString(),
				PreferenceType.Combo, validFactoryIDs));
		...
		{
			preferenceItems.add(new UltimatePreferenceItem<Integer>(
					String.format("--- Preferences for the %s value factory ---", id),
					null, PreferenceType.Label));

			// widening operators
			Set<String> wideningOps = domainRegistry.getValueWideningOperators(id);
			if (wideningOps.size() > 0)
			{
				String[] validWideningOps = new String[wideningOps.size()];
				int i = 0;
