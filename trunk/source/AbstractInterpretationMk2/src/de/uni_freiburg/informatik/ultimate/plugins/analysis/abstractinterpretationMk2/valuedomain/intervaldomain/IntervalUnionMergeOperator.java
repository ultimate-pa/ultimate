 ...
 *
 */
public class IntervalUnionMergeOperator implements
		IValueMergeOperator<Interval> {

	private IntervalValueFactory m_factory;

	private Logger m_logger;

	public IntervalUnionMergeOperator(IntervalValueFactory factory,
			Logger logger) {
		m_factory = factory;
		m_logger = logger;
	}
	 ...
	 */
	@Override
	public IAbstractValue<Interval> apply(IAbstractValue<?> valueA,
