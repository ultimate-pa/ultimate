 ...
 *
 */
public class TopBottomMergeWideningOperator implements
		IValueWideningOperator<TopBottom>, IValueMergeOperator<TopBottom> {

	private TopBottomValueFactory m_factory;

	private Logger m_logger;

	public TopBottomMergeWideningOperator(TopBottomValueFactory factory,
			Logger logger) {
		m_factory = factory;
		m_logger = logger;
	}
	 ...
	 */
	@Override
	public TopBottomValue apply(IAbstractValue<?> oldValue,
		...
		if (bvA == bvB)
			return m_factory.makeValue(bvA);
