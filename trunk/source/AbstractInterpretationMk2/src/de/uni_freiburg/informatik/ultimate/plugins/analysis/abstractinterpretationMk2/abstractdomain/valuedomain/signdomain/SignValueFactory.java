...
import de.uni_freiburg.informatik.ultimate.plugins.analysis.abstractinterpretationMk2.abstractdomain.valuedomain.signdomain.SignValue.Sign;
...
public class SignValueFactory implements IAbstractValueFactory<Sign> {
	 ...
	 * @see de.uni_freiburg.informatik.ultimate.plugins.analysis.
	 * abstractinterpretationMk2
	 * .abstractdomain.IAbstractDomainFactory#makeIntegerValue(int)
	 */
	@Override
	public SignValue makeIntegerValue(String integer) {
		...
		try {
			...
			m_logger.warn(String.format(
					"Invalid number format: \"%s\" - Using Sign.PLUSMINUS",
					integer));
			return new SignValue(Sign.PLUSMINUS, this, m_logger);
		}
