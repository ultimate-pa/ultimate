 ...
 */
public class IntervalSetWideningOperator implements IValueWideningOperator<Interval> {
	...
	public IntervalSetWideningOperator(IntervalValueFactory factory, Set<String> numbersForWidening, Logger logger) {
		m_factory = factory;
		m_logger = logger;
	...
	public IntervalSetWideningOperator(IntervalValueFactory factory, List<Rational> numbersForWidening, Logger logger) {
		m_factory = factory;
		m_logger = logger;
