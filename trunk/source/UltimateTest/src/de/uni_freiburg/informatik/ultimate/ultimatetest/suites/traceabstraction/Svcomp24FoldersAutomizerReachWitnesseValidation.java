 ...
 *
 */
public class Svcomp24FoldersAutomizerReachWitnesseValidation extends AbstractTraceAbstractionTestSuite {
	...
	public Collection<UltimateTestCase> createTestCases() {
		for (final SvcompFolderSubset dfep : BENCHMARKS) {
			for (final String toolchain : TOOLCHAINS) {
				addTestCase(UltimateRunDefinitionGenerator.getRunDefinitionsFromSvcompYamlWithWitnesses(dfep, SETTINGS,
