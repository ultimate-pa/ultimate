...
//	private static final int FILES_PER_DIR_LIMIT = 3;
	...
	private static final DirectoryFileEndingsPair[] BENCHMARKS = {
		...
		new DirectoryFileEndingsPair("examples/svcomp/array-examples/", new String[]{ STANDARD_DOT_I_PATTERN_FALSE }, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/array-industry-pattern/", new String[]{ STANDARD_DOT_I_PATTERN_FALSE }, FILE_OFFSET,  FILES_PER_DIR_LIMIT),	
		new DirectoryFileEndingsPair("examples/svcomp/reducercommutativity/", new String[]{ STANDARD_DOT_I_PATTERN_FALSE }, FILE_OFFSET,  FILES_PER_DIR_LIMIT),	
		...
		new DirectoryFileEndingsPair("examples/svcomp/ssh-simplified/", new String[]{ STANDARD_DOT_C_PATTERN_FALSE }, FILE_OFFSET,  FILES_PER_DIR_LIMIT),
