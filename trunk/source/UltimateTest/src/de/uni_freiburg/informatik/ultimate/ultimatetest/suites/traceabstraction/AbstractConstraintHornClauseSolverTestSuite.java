...
import de.uni_freiburg.informatik.ultimate.lib.tracecheckutils.partialorder.petrinetlbe.PetriNetLargeBlockEncodingBenchmarks;
...
public abstract class AbstractConstraintHornClauseSolverTestSuite extends AbstractModelCheckerTestSuite {
	...
	protected ITestResultDecider constructITestResultDecider(final UltimateRunDefinition ultimateRunDefinition) {
		return new TreeAutomizerTestResultDecider(ultimateRunDefinition, true);
	}
