...
public class FindUndefinedBehaviourTestSuite extends AbstractTraceAbstractionTestSuite {
	...
	private static final DirectoryFileEndingsPair[] mDirectoryFileEndingsPairs_32bit = {
			...
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/reducercommutativity/", new String[]{ ".i" },
			// mFilesPerDirectoryLimit) ,
			//
			//
			...
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/bitvector-regression/", new String[]{ ".i" },
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/bitvector-loops/", new String[]{ ".i" },
			// mFilesPerDirectoryLimit) ,
			//
			//
			...
			// new DirectoryFileEndingsPair("examples/svcomp/loop-acceleration/", new String[]{".i" },
			// mFilesPerDirectoryLimit) ,
			...
			// ,
			// new DirectoryFileEndingsPair("examples/svcomp/recursive-simple/", new String[]{ ".c" },
			// mFilesPerDirectoryLimit) ,
			//
			...
			// new DirectoryFileEndingsPair("examples/svcomp/termination-memory-linkedlists/", new String[] { ".i" },
			// mFilesPerDirectoryLimit),
	...
	private static final DirectoryFileEndingsPair[] mDirectoryFileEndingsPairs_64bit = {
			...
			// new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-3.0/", new String[]{ ".i" },
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-3.4-simple/", new String[]{ ".c" },
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-3.7.3/", new String[]{ ".c" },
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/ldv-commit-tester/", new String[]{ ".c" },
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/ldv-consumption/", new String[]{ ".c" },
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-3.12-rc1/", new String[]{ ".c" },
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-3.16-rc1/", new String[]{ ".c" },
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/ldv-validator-v0.6/", new String[]{ ".c" },
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/ldv-validator-v0.8/", new String[]{ ".c" },
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-4.2-rc1/", new String[]{ ".c" },
			// mFilesPerDirectoryLimit) ,
			// new DirectoryFileEndingsPair("examples/svcomp/ldv-challenges/", new String[]{ ".c" },
			// mFilesPerDirectoryLimit) ,
			//
			// new DirectoryFileEndingsPair("examples/svcomp/busybox-1.22.0/", new String[]{ ".i" },
			// mFilesPerDirectoryLimit) ,

			new DirectoryFileEndingsPair("examples/LTL/svcomp17format/", new String[] { ".i" },
					mFilesPerDirectoryLimit), };
	...
	private static final String[] mCToolchains = { "AutomizerC.xml",
