...
/**
 * C-fronted counterpart of {@link SifaThreadModularRegressionSoundnessTest}. Runs thread-modular Sifa on
 * preprocessed C (.i) programs via the SifaCThreadModular toolchain. Only fails on unsoundness
 * (expected-unsafe reported as safe).
 */
public class SifaCThreadModularSmokeTest extends AbstractTraceAbstractionTestSuite {

	private static final String PROP_TIMEOUT_MS = "sifa.cregression.timeout.ms";
	private static final String PROP_MAX_FILES = "sifa.cregression.maxFiles";
	private static final String PROP_INCLUDE_REGEX = "sifa.cregression.includeRegex";
	private static final String PROP_EXCLUDE_REGEX = "sifa.cregression.excludeRegex";
	private static final String PROP_TOOLCHAIN = "sifa.cregression.toolchain";
	private static final String PROP_SETTINGS = "sifa.cregression.settings";
	private static final String PROP_INPUT_DIR = "sifa.cregression.inputDir";
	private static final String PROP_FILE_ENDING = "sifa.cregression.fileEnding";
	private static final String PROP_METHODS = "sifa.cregression.methods";
	private static final String PROP_LOCATION_TRACKING_MODE = "sifa.cregression.locationTrackingMode";
	private static final String PROP_USE_BUCKETS = "sifa.cregression.useBuckets";
	private static final String PROP_MAX_BUCKETS = "sifa.cregression.maxBuckets";
	private static final String PROP_MAX_DISJUNCTS_PER_BUCKET = "sifa.cregression.maxDisjunctsPerBucket";
	private static final String PROP_LOCKSET_AWARE = "sifa.cregression.locksetAware";
	private static final String PROP_PUBLISH_ON_ACQUIRE = "sifa.cregression.publishOnAcquire";
	private static final String PROP_PUBLISH_DEBUG = "sifa.cregression.publishDebug";
	private static final String PROP_JOIN_PRECISION = "sifa.cregression.joinPrecision";
	private static final String PROP_MAX_PARALLEL_EXPLICIT_VALUES = "sifa.cregression.maxParallelExplicitValues";
	private static final String PROP_ABSTRACT_DOMAIN = "sifa.cregression.abstractDomain";
	private static final String PROP_COMPOUND_DOMAINS = "sifa.cregression.compoundDomains";
	private static final String PROP_MAX_PARALLEL_INTERVALS = "sifa.cregression.maxParallelIntervals";
	private static final String PROP_MAX_PARALLEL_OCTAGON = "sifa.cregression.maxParallelOctagon";
	private static final String PROP_LOCATION_ABSTRACTION = "sifa.cregression.locationAbstraction";
	private static final String PROP_MAX_DISJUNCTIONS = "sifa.cregression.maxDisjunctions";
	private static final String PROP_INNER_WIDENING_THRESHOLD = "sifa.cregression.innerWideningThreshold";

	// icfgbuilder is required: rcfgbuilder cannot handle the replace-mutexes "if (m) abort();" form inside a
	// fork context (UnsupportedOperationException: Did not expect statement of type IfStatement).
	private static final String TOOLCHAIN = "SifaCThreadModular.xml";
	// Clean SVCOMP-Reach C frontend settings (cdt/cacsl) merged with the Sifa thread-modular prefs.
	private static final String SETTINGS = "examples/concurrent/c/regression/thread-modular-sifa-smoke/cSettings.epf";
	private static final String INPUT_DIR = "examples/concurrent/c/regression/thread-modular-sifa-smoke";
	private static final String FILE_ENDING = ".i";
	...
	public Collection<UltimateTestCase> createTestCases() {
		...
		for (final String method : getMethods()) {
			final UnaryOperator<IUltimateServiceProvider> callback = s -> {
				...
				putIntegerIfPresent(prefs, "Max. Parallel Intervals", PROP_MAX_PARALLEL_INTERVALS);
				...
				prefs.put("Use Buckets",
						Boolean.parseBoolean(System.getProperty(PROP_USE_BUCKETS, Boolean.toString(USE_BUCKETS))));
