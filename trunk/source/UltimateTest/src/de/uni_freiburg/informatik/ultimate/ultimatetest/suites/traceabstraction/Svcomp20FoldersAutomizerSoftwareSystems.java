 ...
 * 
 */
public class Svcomp20FoldersAutomizerSoftwareSystems extends AbstractTraceAbstractionTestSuite {
...
//	private static final int FILES_PER_DIR_LIMIT = Integer.MAX_VALUE;
	...
	private static final DirectoryFileEndingsPair[] BENCHMARKS_64BIT = {
		...
		new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-3.4-simple/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-3.7.3/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/ldv-commit-tester/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/ldv-consumption/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-3.12-rc1/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-3.16-rc1/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/ldv-validator-v0.6/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/ldv-validator-v0.8/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-4.2-rc1/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-3.14/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/ldv-challenges/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
		new DirectoryFileEndingsPair("examples/svcomp/ldv-linux-4.0-rc1-mav/", new String[]{ STANDARD_DOT_I_PATTERN }, FILE_OFFSET, FILES_PER_DIR_LIMIT),
	};
...
//		"default/automizer/svcomp-Reach-64bit-Automizer_Default_NoConstArrays.epf",
...
//		"automizer/DumpDifficultPathProgramsFromBoogie_svcomp-Reach-64bit-Automizer.epf"
	...
	private static final String[] SETTINGS_64BIT = {
		"default/automizer/svcomp-Reach-64bit-Automizer_Default.epf",
		"automizer/svcomp-Reach-64bit-Automizer_Default_NoConstArrays.epf",
//		"svcomp2017/automizer/svcomp-Reach-64bit-Automizer_Default-PENGUIN.epf",
