 ...
 *
 */
public class SvcompTerminationTestSuite extends AbstractSvcompTestSuite {
	...
	private List<SvcompTestDefinition> createTests(final String set, final long timeout, final int limit,
		...
		final String[] modes = new String[] { "Default" };
		for (final String mode : modes) {
			rtr.add(getTestDefinitionFromExamplesOrNull(set, "BuchiAutomizerCInline.xml",
