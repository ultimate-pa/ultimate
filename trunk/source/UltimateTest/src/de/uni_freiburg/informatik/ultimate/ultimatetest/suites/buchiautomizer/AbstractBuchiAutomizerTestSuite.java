...
public abstract class AbstractBuchiAutomizerTestSuite extends AbstractModelCheckerTestSuite {
	...
	protected ITestSummary[] constructTestSummaries() {
		...
		final ColumnDefinition[] columnDef = {
				new ColumnDefinition(CegarLoopStatisticsGenerator.OverallTime, "runtime",
				...
				new ColumnDefinition("Dead end removal time", "dead end time",
						ConversionContext.Divide(1000000000, 2, " s"), Aggregate.Ignore, Aggregate.Average),
				new ColumnDefinition(
						CegarLoopStatisticsGenerator.AutomataMinimizationStatistics + "_"
								+ AutomataMinimizationStatisticsGenerator.AutomataMinimizationTime,
						"mnmz time", ConversionContext.Divide(1000000000, 2, " s"), Aggregate.Ignore,
						Aggregate.Average),
				new ColumnDefinition(
						CegarLoopStatisticsGenerator.AutomataMinimizationStatistics + "_"
								+ AutomataMinimizationStatisticsGenerator.StatesRemovedByMinimization,
				...
				new ColumnDefinition("LassoNonterminationAnalysisSat", "gnta sat", ConversionContext.Divide(1, 0, ""),
						Aggregate.Ignore, Aggregate.Sum),
				...
				new ColumnDefinition("LassoNonterminationAnalysisUnknown", "gnta unknown",
						ConversionContext.Divide(1, 0, ""), Aggregate.Ignore, Aggregate.Sum),
				new ColumnDefinition(BuchiCegarLoopBenchmarkGenerator.MINIMIZATION_DET_AUTOMATA, "mnmz det",
						ConversionContext.Divide(1, 0, ""), Aggregate.Ignore, Aggregate.Sum),
				new ColumnDefinition(BuchiCegarLoopBenchmarkGenerator.MINIMIZATION_NONDET_AUTOMATA, "mnmz nondet",
						ConversionContext.Divide(1, 0, ""), Aggregate.Ignore, Aggregate.Sum), };
