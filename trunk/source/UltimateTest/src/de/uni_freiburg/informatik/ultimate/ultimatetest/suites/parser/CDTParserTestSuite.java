...
public class CDTParserTestSuite extends AbstractParserTestSuite {
	...
	private static final String[] ALL_C = { ".c" };
	 ...
	 */
	// @formatter:off
	private static final String[] INCLUDE_STD_DIR = {
	 ...
	 */
	// @formatter:off
	private static final String[] INCLUDE_EXD_DIRS = {
			"examples/CParser/include",
	...
	protected void addParserTestCase(final String inputFilename, final boolean recursive,
		...
		final UnaryOperator<IUltimateServiceProvider> customizeCdtParserSettings = services -> {
