...
public class UltimateTestFrameworkBug extends AbstractTraceAbstractionTestSuite {
	
	private static final String[] m_UltimateRepository = {
		"examples/programs/quantifier/regression/c/Aliasing02-Unsafe.c",
	};
	...
	private static final String[] m_Settings = {
		"automizer/BitvectorTranslation-allspec.epf",
	};
