...
public class SvcompBugs extends AbstractEvalTestSuite {
	...
	private static final Triple<String, String[], String>[] TOOLCHAINS = new Triple[] {
			//### C
			new Triple<>("AutomizerC.xml", C, "svcomp2017/automizer/svcomp-Reach-32bit-Automizer_Bitvector.epf"),
	};

	private static final String[] INPUT = new String[] {
			"examples/svcomp/ldv-linux-4.0-rc1-mav/linux-4.0-rc1---drivers--net--ethernet--atheros--atl1e--atl1e.ko_true-unreach-call.cil.c"
	...
	public Collection<UltimateTestCase> createTestCases() {
		final int timeout = (int) getTimeout();
		for (final Triple<String, String[], String> triple : TOOLCHAINS) {
			...
			for (int i = 0; i < INPUT.length; ++i) {
				pairs[i] = new DirectoryFileEndingsPair(INPUT[i], triple.getSecond(), timeout);
			}
