...
/**
 * This testsuite tests whether the Java2Boogie translates Java programs to
 * correct Boogie code. It parses the .java input and runs BoogiePrinter on the
 * result. Then, it compares the resulting Boogie file with a reference file.
 * 
 * <p>
 ...
 * 
 */
public class Java2BoogieRegressionTestSuite extends AbstractRegressionTestSuite {

	private static String sRootFolder = TestUtil.getPathFromTrunk("examples/JavaToBoogieTranslation");
	 ...
	 */
	public Java2BoogieRegressionTestSuite() {
		super();
		mTimeout = DEFAULT_TIMEOUT_MILLIS;
		mRootFolder = sRootFolder;
		mFiletypesToConsider = new String[] { ".java" };
	}
