 ...
 *
 */
public final class DefaultSymbolTableAdapter implements ISymbolTableAdapter {
	...
	public Map<String, Declaration> getLocalVariables(final String procedure) {
		return mSymbolTable.getLocalVariables(procedure);
	}
	...
	public BoogieVar getBoogieVar(final String varId, final DeclarationInformation declarationInformation,
		...
		return mBoogieVarTable.getBoogieVar(varId, declarationInformation, inOldContext);
	}
}