...
public class LiteralCollection {
	 ...
	 */
	public LiteralCollection(final Set<BigDecimal> realsSet) {
	 ...
	 */
	public BigDecimal getNextRealPositive(final BigDecimal value) {
	 ...
	 */
	public BigDecimal getNextRealNegative(final BigDecimal value) {
		return getNextNumberNegative(value);
	}

	private BigDecimal getNextNumberPositive(final BigDecimal value) {
	...
	private BigDecimal getNextNumberNegative(final BigDecimal value) {
