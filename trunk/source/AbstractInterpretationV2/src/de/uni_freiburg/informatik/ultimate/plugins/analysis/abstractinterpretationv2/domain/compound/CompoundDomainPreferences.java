...
public class CompoundDomainPreferences {
	...
	private static List<UltimatePreferenceItem<?>> addAbstractDomains() {
		List<UltimatePreferenceItem<?>> abstractDomains = new ArrayList<>();

		abstractDomains.add(new UltimatePreferenceItem<Boolean>(LABEL_USE_EMPTY_DOMAIN, DEF_USE_EMPTY_DOMAIN,
		        PreferenceType.Boolean));
		abstractDomains.add(new UltimatePreferenceItem<Boolean>(LABEL_USE_SIGN_DOMAIN, DEF_USE_SIGN_DOMAIN,
		        PreferenceType.Boolean));
		abstractDomains.add(new UltimatePreferenceItem<Boolean>(LABEL_USE_CONGRUENCE_DOMAIN, DEF_USE_CONGRUENCE_DOMAIN,
		        PreferenceType.Boolean));
		abstractDomains.add(new UltimatePreferenceItem<Boolean>(LABEL_USE_INTERVAL_DOMAIN, DEF_USE_INTERVAL_DOMAIN,
		        PreferenceType.Boolean));
		abstractDomains.add(new UltimatePreferenceItem<Boolean>(LABEL_USE_OCTAGON_DOMAIN, DEF_USE_OCTAGON_DOMAIN,
		        PreferenceType.Boolean));
