...
/**
 * Interface for values in any nonrelational abstract domain.
 * 
...
public interface INonrelationalValueFactory<V extends INonrelationalValue<V>> {
	...
	/**
	 * @return A new abstract value corresponding to &top;.
	 */
	V createTopValue();

	/**
	 * @return A new abstract value corresponding to &bot;.
	 */
	V createBottomValue();
}
