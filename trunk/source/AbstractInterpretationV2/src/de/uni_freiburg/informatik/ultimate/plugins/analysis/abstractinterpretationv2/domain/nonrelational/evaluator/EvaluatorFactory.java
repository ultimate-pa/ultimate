...
public class EvaluatorFactory<VALUE extends INonrelationalValue<VALUE>, STATE extends NonrelationalState<STATE, VALUE>>
	...
	public INAryEvaluator<VALUE, STATE, CodeBlock> createNAryExpressionEvaluator(final int arity,
		...
		switch (arity) {
		case ARITY_MIN:
			return new UnaryExpressionEvaluator<>(mLogger, mNonrelationalValueFactory);
		case ARITY_MAX:
			return new BinaryExpressionEvaluator<>(mLogger, type, mMaxParallelStates, mNonrelationalValueFactory);
		default:
	...
	@Override
	public IEvaluator<VALUE, STATE, CodeBlock> createFunctionEvaluator(String functionName, int inputParamCount) {
	...
	@Override
	public IEvaluator<VALUE, STATE, CodeBlock> createSingletonVariableExpressionEvaluator(
	...
	@Override
	public IEvaluator<VALUE, STATE, CodeBlock> createSingletonLogicalValueExpressionEvaluator(BooleanValue value) {
