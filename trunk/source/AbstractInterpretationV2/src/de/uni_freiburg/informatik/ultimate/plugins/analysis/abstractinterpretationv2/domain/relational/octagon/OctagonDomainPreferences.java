...
public class OctagonDomainPreferences {
	...
	public static List<BaseUltimatePreferenceItem> createPreferences() {
		...
		octagonContainer.addItem(new UltimatePreferenceItem<WideningOperator>(WIDENING_OPERATOR,
		        WIDENING_OPERATOR_DEFAULT, PreferenceType.Combo, WideningOperator.values()));
		octagonContainer.addItem(new UltimatePreferenceItem<String>(EXP_WIDENING_THRESHOLD,
		        EXP_WIDENING_THRESHOLD_DEFAULT_VALUE, EXP_WIDENING_THRESHOLD_TOOLTIP, PreferenceType.String));

		octagonContainer.addItem(new UltimatePreferenceItem<Boolean>(FALLBACK_ASSIGN_INTERVAL_PROJECTION,
