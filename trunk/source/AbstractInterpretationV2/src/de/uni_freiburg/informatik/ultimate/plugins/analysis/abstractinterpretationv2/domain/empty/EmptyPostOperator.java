...
public final class EmptyPostOperator<ACTION, VARDECL>
        implements IAbstractPostOperator<EmptyDomainState<ACTION>, ACTION, VARDECL> {

	@Override
	public List<EmptyDomainState<ACTION>> apply(EmptyDomainState<ACTION> oldstate, ACTION concrete) {
	...
	@Override
	public List<EmptyDomainState<ACTION>> apply(EmptyDomainState<ACTION> oldstate,
	        EmptyDomainState<ACTION> oldstateWithFreshVariables, ACTION transition) {
		final List<EmptyDomainState<ACTION>> returnList = new ArrayList<>();
