...
public class FutureRcfgVariableProvider<STATE extends IAbstractState<STATE, CodeBlock, IProgramVar>>
	...
	public FutureRcfgVariableProvider(final BoogieSymbolTable table, final Boogie2SmtSymbolTable boogieVarTable,
	...
	public STATE defineInitialVariables(final CodeBlock current, final STATE state) {
		...
		final TransFormula tf = current.getTransitionFormula();

		return null;
	}

	@Override
	public STATE defineVariablesAfter(final CodeBlock current, final STATE localPreState,
