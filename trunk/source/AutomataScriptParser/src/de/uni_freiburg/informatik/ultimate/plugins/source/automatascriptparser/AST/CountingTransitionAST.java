...
public class CountingTransitionAST extends AtsASTNode {
	...
	public CountingTransitionAST(final ILocation loc, final String predeccessorState, final String letter,
			final String guard, final UpdateListAST updateList, final String successorState) {
		super(loc);
		mPredecessorState = predeccessorState;
		mLetter = letter;
		mGuard = guard;
		mUpdateList = updateList;
		mSuccessorState = successorState;
	}
