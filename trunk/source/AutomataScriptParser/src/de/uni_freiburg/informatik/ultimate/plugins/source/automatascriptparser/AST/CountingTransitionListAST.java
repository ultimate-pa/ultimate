...
public class CountingTransitionListAST extends AtsASTNode{
	...
	public CountingTransitionListAST(ILocation loc) {
		super(loc);
		this.mTransitions = new ArrayList<CountingTransitionAST>();
	}
	
	public void addTransition(CountingTransitionAST transition) {
