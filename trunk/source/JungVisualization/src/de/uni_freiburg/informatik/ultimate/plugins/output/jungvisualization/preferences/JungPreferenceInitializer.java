...
public class JungPreferenceInitializer extends UltimatePreferenceInitializer {
	...
	protected UltimatePreferenceItem<?>[] initDefaultPreferences() {
		return new UltimatePreferenceItem<?>[] {
				new UltimatePreferenceItem<String>(JungPreferenceValues.LABEL_PATH, JungPreferenceValues.VALUE_PATH_DEFAULT,
						PreferenceType.Directory),
				new UltimatePreferenceItem<Boolean>(JungPreferenceValues.LABEL_ANNOTATED_EDGES,
						JungPreferenceValues.VALUE_ANNOTATED_EDGES_DEFAULT, PreferenceType.Boolean),
				...
				new UltimatePreferenceItem<String>(JungPreferenceValues.LABEL_COLOR_BACKGROUND,
						StringConverter.asString(JungPreferenceValues.VALUE_COLOR_BACKGROUND_DEFAULT), PreferenceType.Color),
