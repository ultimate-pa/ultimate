...
var server = "../service/if?callback=?";
...
function toggleEditor() {
    ...
    if (toggleEditorHeight) {
        ...
        e.style.height = '30%';
        document.getElementById('server_messages').style.height = '70%';
...
function getResult() {
    ...
    if (trimmedCode !== "" && trimmedCode !== INIT_CODE) {
        ...
        $('#srv_msg').html("<pre><img src=\"./img/wait.gif\"/>&nbsp;Ultimate started, please wait ...</pre>");
