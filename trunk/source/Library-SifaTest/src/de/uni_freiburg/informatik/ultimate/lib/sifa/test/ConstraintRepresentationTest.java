...
public class ConstraintRepresentationTest {
	...
	public void testGetMinimalForm() {
		...
		final var constraints1 = new ConstraintRepresentation(equalities1, congruences1);
		...
		final var constraints2 = new ConstraintRepresentation(equalities2, congruences2);
