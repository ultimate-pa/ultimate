...
/**
 * Location class for countertrace parser elements.
 */
public class CtLocation extends DefaultLocation {

	private static final long serialVersionUID = 1L;

	public CtLocation(final String filename, final int startLine, final int endLine, final int startColumn,
			final int endColumn) {
	...
	public String toString() {
		return ".ct File: " + getFileName() + ":" + getStartLine() + "/" + getStartColumn() + "-" + getEndLine() + "/"
				+ getEndColumn();
	}
}
