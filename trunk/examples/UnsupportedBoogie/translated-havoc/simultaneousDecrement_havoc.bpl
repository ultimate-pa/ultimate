...
procedure  simultaneousDecrement($i$1$3.30$simultaneousDecrement_.1:int, $j$2$3.37$simultaneousDecrement_.1:int) returns ($result.simultaneousDecrement$3.4$1$simultaneousDecrement:int)
...
var $i$1$3.30$simultaneousDecrement : int;
var $j$2$3.37$simultaneousDecrement : int;
var $result.assert$17.8$2$simultaneousDecrement : int;
var $x$3$7.5$simultaneousDecrement : int;
var $y$4$8.5$simultaneousDecrement : int;
var tempBoogie0:int;
var tempBoogie1:int;
var tempBoogie2:int;
var tempBoogie3:int;
...
$i$1$3.30$simultaneousDecrement := $i$1$3.30$simultaneousDecrement_.1;
$j$2$3.37$simultaneousDecrement := $j$2$3.37$simultaneousDecrement_.1;
goto label_3;


// c$$poirot\examples\account\simultaneousdecrement.c(19)
label_1:
return;
...
// c$$poirot\examples\account\simultaneousdecrement.c(7)
label_3:
goto label_4;
...
// c$$poirot\examples\account\simultaneousdecrement.c(7)
label_4:
$x$3$7.5$simultaneousDecrement := $i$1$3.30$simultaneousDecrement ;
goto label_5;


// c$$poirot\examples\account\simultaneousdecrement.c(8)
label_5:
goto label_6;
...
// c$$poirot\examples\account\simultaneousdecrement.c(8)
label_6:
$y$4$8.5$simultaneousDecrement := $j$2$3.37$simultaneousDecrement ;
goto label_7;


// c$$poirot\examples\account\simultaneousdecrement.c(10)
label_7:
...
label_7_true :
assume (INT_LT(0, $x$3$7.5$simultaneousDecrement));
goto label_9;
...
// c$$poirot\examples\account\simultaneousdecrement.c(16)
label_8:
goto label_8_true , label_8_false ;


label_8_true :
assume (INT_EQ($i$1$3.30$simultaneousDecrement, $j$2$3.37$simultaneousDecrement));
goto label_11;
...
// c$$poirot\examples\account\simultaneousdecrement.c(12)
label_9:
$x$3$7.5$simultaneousDecrement := MINUS_BOTH_PTR_OR_BOTH_INT( $x$3$7.5$simultaneousDecrement, 1, 1) ;
goto label_10;


// c$$poirot\examples\account\simultaneousdecrement.c(13)
label_10:
$y$4$8.5$simultaneousDecrement := MINUS_BOTH_PTR_OR_BOTH_INT( $y$4$8.5$simultaneousDecrement, 1, 1) ;
goto label_7_head;


// c$$poirot\examples\account\simultaneousdecrement.c(17)
label_11:
$assert.arg.1$3$ := LIFT(INT_EQ($y$4$8.5$simultaneousDecrement, 0)) ;
goto label_12;


// c$$poirot\examples\account\simultaneousdecrement.c(17)
label_12:
call $result.assert$17.8$2$simultaneousDecrement := assert ($assert.arg.1$3$);
goto label_1;
