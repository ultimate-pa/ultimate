 ...
 * modifications:
 * Verkleinert zu einem Beispiel ich noch immer das Problem habe, dass
 * Interpolanten keine induktive Invariante sondern von der folgenden
 * Form sind:
 * v__L_hs <= 0
 * v__L_hs <= 3
 * v__L_hs <= 6
 ...
 * v__L_hs <= 12
 *
 * Kommentiert man die zusätzliche Assertion
 *    assert L#s + 3 <= $_mul(P#n, 3) && $_mul(P#n, 3) <= $max.i4;
 * in Zeile 1245 ein, kann die Korrektheit gezeigt werden.
 */
