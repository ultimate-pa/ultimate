...
#include<stdio.h>
/*
 * implementation of __VERIFIER_nondet_int() in line 5729
 *  (it was line 5729 in the original file, now it is 5788)
 * Returns elements of the sequence [1, 0, 0, ...] in subsequent calls
 */
int ultimate_nondet_5729 = -1;
int Ultimate_nondet_5729() {
  ultimate_nondet_5729++;
  if (ultimate_nondet_5729 == 0) {
    return 1;
  } else {
    return 0;
  }
...
void Ultimate_checkPointer(void * p) {
  if (p != 0) {
    return;
  }
  printf("ERROR: null pointer deref\n");
  abort();
}
...
struct module __this_module ; // edit: removed extern
...
//void __might_sleep(char const   * c , int a , int b )  {}
...
{ 
  ...
  {
  tmp___0 = 1; //tmp___0 = __VERIFIER_nondet_int();
  if (tmp___0 != 0) {
    return ((void *)0);
  } else {
    tmp = calloc(1UL, size);
...
{ 
  ...
  ptr =  __VERIFIER_nondet_pointer(); //skb_put(skb, 1U);
...
{ 
  int result ;
  Ultimate_checkPointer(skb); Ultimate_checkPointer(skb->data); // (edit): inserted this line
  {
  switch ((int )*(skb->data)) {
  case 0: 
  //skb_pull(skb, 1U);
  result =  __VERIFIER_nondet_int();//lapb_data_request(dev, skb);
  if (result != 0) {
    ldv_skb_free(skb);
  } else {
  ...
  return (0);
  case 1: 
  result = __VERIFIER_nondet_int();// lapb_connect_request(dev);
  if (result != 0) {
    if (result == 3) {
      x25_connected(dev, 0);
    } else {
  ...
  goto ldv_42657;
  case 2: 
  result = __VERIFIER_nondet_int();// lapb_disconnect_request(dev);
  if (result != 0) {
    if (result == 4) {
...
{ 
  ...
  result = __VERIFIER_nondet_int();// lapb_register(dev, & cb);
  if (result != 0) {
    return (result);
  } else {
...
{ 
  ...
  tmp = __VERIFIER_nondet_int();// lapb_data_received(dev, skb);
  if (tmp == 0) {
    return (0);
  } else {
...
{ 
  ...
  return (0);
  case 8198U: 
  tmp___1 = __VERIFIER_nondet_int();// capable(12);
  if (tmp___1) {
    tmp___2 = 0;
  } else {
    tmp___2 = 1;
  ...
  result = __VERIFIER_nondet_int();// attach_hdlc_protocol(dev, & proto, 0UL);
  if (result != 0) {
    return (result);
  } else {
...
{ 
  ...
  ldv_42735: 
  tmp___0 = Ultimate_nondet_5729(); // tmp___0 = __VERIFIER_nondet_int();
  switch (tmp___0) {
  case 0: ;
  if (ldv_state_variable_1 != 0) {
    tmp___1 = 0; // tmp___1 = __VERIFIER_nondet_int();
    switch (tmp___1) {
    case 0: ;
  ...
  if (ldv_state_variable_0 != 0) {
    tmp___2 = 1; // tmp___2 = __VERIFIER_nondet_int();
    switch (tmp___2) {
    case 0: ;
