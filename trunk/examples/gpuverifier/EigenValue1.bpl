...
implementation {:source_name "calNumEigenValueInterval"} {:kernel} $calNumEigenValueInterval($width: bv32)
{
  ...
  $falsebb0:
    ...
    call {:sourceloc} {:sourceloc_num 17} _LOG_WRITE_$$numEigenIntervals(true, v0$1, BV32_SUB(FP32_TO_UI32(UI32_TO_FP32($count.i12.0$1)), FP32_TO_UI32(UI32_TO_FP32($count.i.0$1))), $$numEigenIntervals[v0$1]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 17} _CHECK_WRITE_$$numEigenIntervals(true, v0$2, BV32_SUB(FP32_TO_UI32(UI32_TO_FP32($count.i12.0$2)), FP32_TO_UI32(UI32_TO_FP32($count.i.0$2))));
