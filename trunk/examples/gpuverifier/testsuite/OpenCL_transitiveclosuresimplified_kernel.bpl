...
procedure {:source_name "transitive_closure_stage1_kernel"} ULTIMATE.start();
...
implementation {:source_name "transitive_closure_stage1_kernel"} ULTIMATE.start()
{
  var $k.0: bv32;
  var v0$1: bv32;
  var v0$2: bv32;
  ...
  __partitioned_block_$entry_0:
    v0$1 := BV32_ADD(32bv32, local_id_y$1);
    v0$2 := BV32_ADD(32bv32, local_id_y$2);
    v1$1 := BV32_ADD(32bv32, local_id_x$1);
    v1$2 := BV32_ADD(32bv32, local_id_x$2);
  ...
  __partitioned_block_$truebb_0:
    ...
    call _LOG_WRITE_$$primary_block_buffer(p5$1, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), BV32_ADD($k.0, 34bv32), $$primary_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    ...
    call _CHECK_WRITE_$$primary_block_buffer(p5$2, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2), BV32_ADD($k.0, 34bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$primary_block_buffer"} true;
    $$primary_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)] := (if p5$1 then BV32_ADD($k.0, 34bv32) else $$primary_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    $$primary_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)] := (if p5$2 then BV32_ADD($k.0, 34bv32) else $$primary_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)]);
