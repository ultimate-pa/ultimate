...
procedure {:source_name "bar"} $_Z3barPf($A: bv32) returns ($ret$1: bv32, $ret$2: bv32);
  requires $A == 0bv32;
...
implementation {:source_name "bar"} $_Z3barPf($A: bv32) returns ($ret$1: bv32, $ret$2: bv32)
{
  var $retval.0$1: bv32;
  var $retval.0$2: bv32;
  var v0$1: bool;
  ...
  $entry:
    ...
    call _LOG_WRITE_$$A(p1$1, BV32_ADD($A, 4bv32), 1104569958bv32, $$A[BV32_ADD($A, 4bv32)]);
    ...
    $$A[BV32_ADD($A, 4bv32)] := (if p1$1 then 1104569958bv32 else $$A[BV32_ADD($A, 4bv32)]);
    $$A[BV32_ADD($A, 4bv32)] := (if p1$2 then 1104569958bv32 else $$A[BV32_ADD($A, 4bv32)]);
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    call v0$1, v0$2 := $_Z3barPf(0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z3barPf"} true;
    return;
}
