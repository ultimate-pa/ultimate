...
implementation {:source_name "bar"} $bar($pAlias: bv32)
{
  ...
  $truebb:
    assume {:partition} v0;
    call _LOG_READ_$$p(true, BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$p[BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_READ_$$p(true, BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), $$p[BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v1$1 := $$p[BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))];
    v1$2 := $$p[BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))];
    call _LOG_WRITE_$$p(true, BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), FADD32(v1$1, 1065353216bv32), $$p[BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(true, BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_WRITE_$$p(true, BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), FADD32(v1$2, 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))] := FADD32(v1$1, 1065353216bv32);
    $$p[BV32_ADD($pAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))] := FADD32(v1$2, 1065353216bv32);
...
procedure {:source_name "baz"} $baz($qAlias: bv32);
  ...
  requires BV32_SLT(local_id_z$2, group_size_z);
  requires group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> local_id_x$1 != local_id_x$2 || local_id_y$1 != local_id_y$2 || local_id_z$1 != local_id_z$2;
  modifies _READ_HAS_OCCURRED_$$q, _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_READ_BENIGN_FLAG_$$q;
...
implementation {:source_name "baz"} $baz($qAlias: bv32)
{
  ...
  $truebb:
    assume {:partition} v0;
    call _LOG_READ_$$q(true, BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$q[BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 12} true;
    call _CHECK_READ_$$q(true, BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), $$q[BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$q"} true;
    v1$1 := $$q[BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))];
    v1$2 := $$q[BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))];
    call _LOG_WRITE_$$q(true, BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), FADD32(v1$1, 1065353216bv32), $$q[BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$q(true, BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 13} true;
    call _CHECK_WRITE_$$q(true, BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), FADD32(v1$2, 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$q"} true;
    $$q[BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))] := FADD32(v1$1, 1065353216bv32);
    $$q[BV32_ADD($qAlias, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))] := FADD32(v1$2, 1065353216bv32);
    $i.0 := BV32_ADD($i.0, 1bv32);
...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  requires BV32_SLT(local_id_z$2, group_size_z);
  requires group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> local_id_x$1 != local_id_x$2 || local_id_y$1 != local_id_y$2 || local_id_z$1 != local_id_z$2;
  modifies _READ_HAS_OCCURRED_$$p, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _READ_HAS_OCCURRED_$$q, _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_READ_BENIGN_FLAG_$$q;
