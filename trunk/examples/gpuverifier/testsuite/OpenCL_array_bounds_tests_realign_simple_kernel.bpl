...
var {:source_name "L"} {:group_shared} $$foo.L: [bv1][bv32]bv8;

axiom {:array_info "$$foo.L"} {:group_shared} {:elem_width 8} {:source_name "L"} {:source_elem_width 32} {:source_dimensions "64"} true;

var {:race_checking} {:group_shared} {:elem_width 8} {:source_elem_width 32} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$foo.L: bool;

var {:race_checking} {:group_shared} {:elem_width 8} {:source_elem_width 32} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$foo.L: bool;

var {:race_checking} {:group_shared} {:elem_width 8} {:source_elem_width 32} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$foo.L: bool;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    assert {:array_bounds} {:sourceloc_num 1} {:check_id "bounds_check_state_0"} {:array_name "$$foo.L"} BV32_SLT(_ARRAY_OFFSET_$$foo.L, 256bv32);
    call _LOG_WRITE_$$foo.L(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_MUL(group_size_x, num_groups_x)[8:0], $$foo.L[1bv1][BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    ...
    call _CHECK_WRITE_$$foo.L(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_MUL(group_size_x, num_groups_x)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.L"} true;
    $$foo.L[1bv1][BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := BV32_MUL(group_size_x, num_groups_x)[8:0];
    $$foo.L[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := BV32_MUL(group_size_x, num_groups_x)[8:0];
    return;
}
...
const _WATCHED_VALUE_$$foo.L: bv8;

procedure {:inline 1} _LOG_READ_$$foo.L(_P: bool, _offset: bv32, _value: bv8);
  modifies _READ_HAS_OCCURRED_$$foo.L;

implementation {:inline 1} _LOG_READ_$$foo.L(_P: bool, _offset: bv32, _value: bv8)
{
...
procedure _CHECK_READ_$$foo.L(_P: bool, _offset: bv32, _value: bv8);
...
procedure {:inline 1} _LOG_WRITE_$$foo.L(_P: bool, _offset: bv32, _value: bv8, _value_old: bv8);
  modifies _WRITE_HAS_OCCURRED_$$foo.L, _WRITE_READ_BENIGN_FLAG_$$foo.L;

implementation {:inline 1} _LOG_WRITE_$$foo.L(_P: bool, _offset: bv32, _value: bv8, _value_old: bv8)
{
...
procedure _CHECK_WRITE_$$foo.L(_P: bool, _offset: bv32, _value: bv8);
