...
var {:source_name "q"} {:global} $$q: [bv32]bv16;

axiom {:array_info "$$q"} {:global} {:elem_width 16} {:source_name "q"} {:source_elem_width 16} {:source_dimensions "*"} true;

var {:race_checking} {:global} {:elem_width 16} {:source_elem_width 16} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$q: bool;

var {:race_checking} {:global} {:elem_width 16} {:source_elem_width 16} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$q: bool;

var {:race_checking} {:global} {:elem_width 16} {:source_elem_width 16} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$q: bool;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    call _LOG_WRITE_$$q(true, 3bv32, local_id_x$1[16:0], $$q[3bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$q(true, 3bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$q(true, 3bv32, local_id_x$2[16:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$q"} true;
    $$q[3bv32] := local_id_x$1[16:0];
    $$q[3bv32] := local_id_x$2[16:0];
    return;
}
...
const _WATCHED_VALUE_$$q: bv16;

procedure {:inline 1} _LOG_READ_$$q(_P: bool, _offset: bv32, _value: bv16);
  modifies _READ_HAS_OCCURRED_$$q;

implementation {:inline 1} _LOG_READ_$$q(_P: bool, _offset: bv32, _value: bv16)
{
...
procedure _CHECK_READ_$$q(_P: bool, _offset: bv32, _value: bv16);
...
procedure {:inline 1} _LOG_WRITE_$$q(_P: bool, _offset: bv32, _value: bv16, _value_old: bv16);
  modifies _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q;

implementation {:inline 1} _LOG_WRITE_$$q(_P: bool, _offset: bv32, _value: bv16, _value_old: bv16)
{
...
procedure _CHECK_WRITE_$$q(_P: bool, _offset: bv32, _value: bv16);
