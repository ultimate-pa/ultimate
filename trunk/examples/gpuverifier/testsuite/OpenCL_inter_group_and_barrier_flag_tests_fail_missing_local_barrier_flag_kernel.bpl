...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$p, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _TRACKING;

implementation {:source_name "foo"} ULTIMATE.start()
{

  __partitioned_block_$entry_0:
    call _LOG_WRITE_$$p(true, local_id_x$1, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $$p[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(true, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$p(true, local_id_x$2, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][local_id_x$1] := BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2);
    goto __partitioned_block_$entry_1;

  __partitioned_block_$entry_1:
    call $bugle_barrier_duplicated_0(0bv1, 1bv1);
    call _LOG_WRITE_$$p(true, BV32_ADD(local_id_x$1, 1bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $$p[1bv1][BV32_ADD(local_id_x$1, 1bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(true, BV32_ADD(local_id_x$2, 1bv32));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_WRITE_$$p(true, BV32_ADD(local_id_x$2, 1bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][BV32_ADD(local_id_x$1, 1bv32)] := BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)] := BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2);
    return;
}
