...
procedure {:source_name "simple_kernel"} ULTIMATE.start();
  ...
  modifies $$p, _READ_HAS_OCCURRED_$$p, _TRACKING, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _TRACKING, _TRACKING, _TRACKING, _TRACKING;
...
implementation {:source_name "simple_kernel"} ULTIMATE.start()
{
  ...
  __partitioned_block_$falsebb_0:
    assume {:partition} !v0;
    call _LOG_READ_$$p(true, 0bv32, $$p[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 7} true;
    call _CHECK_READ_$$p(true, 0bv32, $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v1$1 := $$p[1bv1][0bv32];
    v1$2 := $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32];
    v2$1 := v1$1 == 22bv32;
    v2$2 := v1$2 == 22bv32;
  ...
  __partitioned_block_$falsebb_1:
    call $bugle_barrier_duplicated_0(1bv1, 1bv1, p0$1, p0$2);
    $i4.0$1 := (if p0$1 then 0bv32 else $i4.0$1);
    $i4.0$2 := (if p0$2 then 0bv32 else $i4.0$2);
    p1$1 := (if p0$1 then true else p1$1);
    p1$2 := (if p0$2 then true else p1$2);
    assume {:captureState "loop_entry_state_2_0"} true;
    goto __partitioned_block_$for.cond5_0;

  __partitioned_block_$for.cond5_0:
    assume {:captureState "loop_head_state_2"} true;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assume {:predicate "p1"} {:dominator_predicate "p0"} true;
    assert {:block_sourceloc} {:sourceloc_num 10} p1$1 ==> true;
    v3$1 := (if p1$1 then BV32_SLT($i4.0$1, 100bv32) else v3$1);
    v3$2 := (if p1$2 then BV32_SLT($i4.0$2, 100bv32) else v3$2);
    p2$1 := false;
    p2$2 := false;
    ...
    call _LOG_WRITE_$$p(p2$1, local_id_x$1, local_id_x$1, $$p[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(p2$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 12} true;
    call _CHECK_WRITE_$$p(p2$2, local_id_x$2, local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][local_id_x$1] := (if p2$1 then local_id_x$1 else $$p[1bv1][local_id_x$1]);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p2$2 then local_id_x$2 else $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    goto __partitioned_block_$for.cond5_1;

  __partitioned_block_$for.cond5_1:
    call $bugle_barrier_duplicated_3(1bv1, 1bv1, p2$1, p2$2);
    $i4.0$1 := (if p2$1 then BV32_ADD($i4.0$1, 1bv32) else $i4.0$1);
    $i4.0$2 := (if p2$2 then BV32_ADD($i4.0$2, 1bv32) else $i4.0$2);
  ...
  $for.cond5.tail:
    assume !p1$1 && !p1$2;
    $i14.0$1 := (if p0$1 then 0bv32 else $i14.0$1);
    $i14.0$2 := (if p0$2 then 0bv32 else $i14.0$2);
    p3$1 := (if p0$1 then true else p3$1);
    p3$2 := (if p0$2 then true else p3$2);
    assume {:captureState "loop_entry_state_1_0"} true;
    goto __partitioned_block_$for.cond15_0;

  __partitioned_block_$for.cond15_0:
    assume {:captureState "loop_head_state_1"} true;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assume {:predicate "p3"} {:dominator_predicate "p0"} true;
    assert {:block_sourceloc} {:sourceloc_num 16} p3$1 ==> true;
    v4$1 := (if p3$1 then BV32_SLT($i14.0$1, 100bv32) else v4$1);
    v4$2 := (if p3$2 then BV32_SLT($i14.0$2, 100bv32) else v4$2);
    p4$1 := false;
    p4$2 := false;
    p4$1 := (if p3$1 && v4$1 then v4$1 else p4$1);
    p4$2 := (if p3$2 && v4$2 then v4$2 else p4$2);
    p3$1 := (if p3$1 && !v4$1 then v4$1 else p3$1);
    p3$2 := (if p3$2 && !v4$2 then v4$2 else p3$2);
    call _LOG_WRITE_$$p(p4$1, local_id_x$1, local_id_x$1, $$p[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(p4$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 18} true;
    call _CHECK_WRITE_$$p(p4$2, local_id_x$2, local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][local_id_x$1] := (if p4$1 then local_id_x$1 else $$p[1bv1][local_id_x$1]);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p4$2 then local_id_x$2 else $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    goto __partitioned_block_$for.cond15_1;

  __partitioned_block_$for.cond15_1:
    call $bugle_barrier_duplicated_2(1bv1, 1bv1, p4$1, p4$2);
    $i14.0$1 := (if p4$1 then BV32_ADD($i14.0$1, 1bv32) else $i14.0$1);
    $i14.0$2 := (if p4$2 then BV32_ADD($i14.0$2, 1bv32) else $i14.0$2);
    p3$1 := (if p4$1 then true else p3$1);
    p3$2 := (if p4$2 then true else p3$2);
    goto $for.cond15.backedge, $for.cond15.tail;

  $for.cond15.tail:
    assume !p3$1 && !p3$2;
    $i24.0$1 := (if p0$1 then 0bv32 else $i24.0$1);
    $i24.0$2 := (if p0$2 then 0bv32 else $i24.0$2);
    p5$1 := (if p0$1 then true else p5$1);
    p5$2 := (if p0$2 then true else p5$2);
    assume {:captureState "loop_entry_state_0_0"} true;
    goto __partitioned_block_$for.cond25_0;

  __partitioned_block_$for.cond25_0:
    ...
    v5$1 := (if p5$1 then BV32_SLT($i24.0$1, 100bv32) else v5$1);
    v5$2 := (if p5$2 then BV32_SLT($i24.0$2, 100bv32) else v5$2);
    p6$1 := false;
    p6$2 := false;
    ...
    call _LOG_WRITE_$$p(p6$1, local_id_x$1, local_id_x$1, $$p[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(p6$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 24} true;
    call _CHECK_WRITE_$$p(p6$2, local_id_x$2, local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][local_id_x$1] := (if p6$1 then local_id_x$1 else $$p[1bv1][local_id_x$1]);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p6$2 then local_id_x$2 else $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    goto __partitioned_block_$for.cond25_1;

  __partitioned_block_$for.cond25_1:
    call $bugle_barrier_duplicated_1(1bv1, 1bv1, p6$1, p6$2);
    $i24.0$1 := (if p6$1 then BV32_ADD($i24.0$1, 1bv32) else $i24.0$1);
    $i24.0$2 := (if p6$2 then BV32_ADD($i24.0$2, 1bv32) else $i24.0$2);
    p5$1 := (if p6$1 then true else p5$1);
    p5$2 := (if p6$2 then true else p5$2);
    goto $for.cond25.backedge, $for.cond25.tail;
  ...
  __partitioned_block_$truebb_1:
    call $bugle_barrier_duplicated_4(1bv1, 1bv1);
