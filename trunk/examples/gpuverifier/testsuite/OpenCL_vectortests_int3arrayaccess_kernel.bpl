...
axiom {:array_info "$$i"} {:elem_width 32} {:source_name "i"} {:source_elem_width 32} {:source_dimensions "1"} true;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.vs"} true;
    v5$1 := $$foo.vs[1bv1][BV32_MUL(local_id_x$1, 4bv32)];
    v5$2 := $$foo.vs[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_MUL(local_id_x$2, 4bv32)];
    ...
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.vs"} true;
    v6$1 := $$foo.vs[1bv1][BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 1bv32)];
    v6$2 := $$foo.vs[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_x$2, 4bv32), 1bv32)];
    ...
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.vs"} true;
    v7$1 := $$foo.vs[1bv1][BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 2bv32)];
    v7$2 := $$foo.vs[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_x$2, 4bv32), 2bv32)];
    $$i$0bv32$1 := v5$1;
    $$i$0bv32$2 := v5$2;
    return;
}
