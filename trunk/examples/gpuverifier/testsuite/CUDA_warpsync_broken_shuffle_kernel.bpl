...
implementation {:source_name "shuffle"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call _LOG_READ_$$A(true, BV32_ADD(BV32_MUL(BV32_SDIV(local_id_x$1, 32bv32), 32bv32), BV32_SREM(BV32_ADD(local_id_x$1, 1bv32), 32bv32)), $$A[BV32_ADD(BV32_MUL(BV32_SDIV(local_id_x$1, 32bv32), 32bv32), BV32_SREM(BV32_ADD(local_id_x$1, 1bv32), 32bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_READ_$$A(true, BV32_ADD(BV32_MUL(BV32_SDIV(local_id_x$2, 32bv32), 32bv32), BV32_SREM(BV32_ADD(local_id_x$2, 1bv32), 32bv32)), $$A[BV32_ADD(BV32_MUL(BV32_SDIV(local_id_x$2, 32bv32), 32bv32), BV32_SREM(BV32_ADD(local_id_x$2, 1bv32), 32bv32))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    call _POST_WARP_SYNC_$$A_READ(true, true);
    v0$1 := $$A[BV32_ADD(BV32_MUL(BV32_SDIV(local_id_x$1, 32bv32), 32bv32), BV32_SREM(BV32_ADD(local_id_x$1, 1bv32), 32bv32))];
    v0$2 := $$A[BV32_ADD(BV32_MUL(BV32_SDIV(local_id_x$2, 32bv32), 32bv32), BV32_SREM(BV32_ADD(local_id_x$2, 1bv32), 32bv32))];
    call _PRE_WARP_SYNC_$$A_WRITE(true, true);
    call _LOG_WRITE_$$A(true, local_id_x$1, v0$1, $$A[local_id_x$1]);
    ...
    call _CHECK_WRITE_$$A(true, local_id_x$2, v0$2);
