...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies _WRITE_HAS_OCCURRED_$$A, _WRITE_READ_BENIGN_FLAG_$$A, _WRITE_READ_BENIGN_FLAG_$$A, $$A, _NOT_ACCESSED_$$A, _TRACKING, _READ_HAS_OCCURRED_$$A;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_0:
    call _LOG_WRITE_$$A(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 0bv32, $$A[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$A(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := 0bv32;
    $$A[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := 0bv32;
    assume _NOT_ACCESSED_$$A != BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) && _NOT_ACCESSED_$$A != BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2);
    assert {:barrier_invariant true} {:sourceloc_num 2} {:thread 1} true ==> (if $$A[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:barrier_invariant_access_check true} {:sourceloc_num 2} {:thread 1} true ==> true ==> _NOT_ACCESSED_$$A != BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1);
    goto __partitioned_block_$entry_1;

  __partitioned_block_$entry_1:
    call $bugle_barrier_duplicated_0(0bv1, 1bv1);
    assume true ==> BV32_SGE(local_id_x$1, 0bv32) && BV32_SLT(local_id_x$1, group_size_x) ==> (if $$A[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assume true ==> BV32_SGE(local_id_x$2, 0bv32) && BV32_SLT(local_id_x$2, group_size_x) ==> (if $$A[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    ...
    assume _NOT_ACCESSED_$$A != BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) && _NOT_ACCESSED_$$A != BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2);
    assert {:sourceloc_num 5} {:thread 1} (if v0$1 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 5} {:thread 2} (if v0$2 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    return;
}
...
procedure {:inline 1} {:safe_barrier} {:source_name "bugle_barrier"} {:barrier} $bugle_barrier_duplicated_0($0: bv1, $1: bv1);
  requires $0 == 0bv1;
  requires $1 == 1bv1;
  modifies $$A, _NOT_ACCESSED_$$A, _TRACKING;

var {:check_access} _NOT_ACCESSED_$$A: bv32;
