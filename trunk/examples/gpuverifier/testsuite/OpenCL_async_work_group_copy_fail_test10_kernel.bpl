...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$foo.mine, _READ_ASYNC_HANDLE_$$foo.mine, _WRITE_ASYNC_HANDLE_$$p, _WRITE_HAS_OCCURRED_$$foo.mine, _WRITE_READ_BENIGN_FLAG_$$foo.mine, _WRITE_READ_BENIGN_FLAG_$$foo.mine, $$p, _TRACKING, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_ASYNC_HANDLE_$$p, _READ_HAS_OCCURRED_$$foo.mine, _READ_ASYNC_HANDLE_$$foo.mine;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_0:
    call _LOG_WRITE_$$foo.mine(true, local_id_x$1, UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$foo.mine[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.mine(true, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$foo.mine(true, local_id_x$2, UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.mine"} true;
    $$foo.mine[1bv1][local_id_x$1] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    $$foo.mine[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    goto __partitioned_block_$entry_1;

  __partitioned_block_$entry_1:
    call $bugle_barrier_duplicated_0(1bv1, 0bv1);
    call v0$1, v0$2 := _ASYNC_WORK_GROUP_COPY_$$p_$$foo.mine(true, 0bv32, 0bv32, 64bv32, 0bv32, true, 0bv32, 0bv32, 64bv32, 0bv32);
    $$handle$0bv32$1 := v0$1;
    $$handle$0bv32$2 := v0$2;
    v1$1 := $$handle$0bv32$1;
    v1$2 := $$handle$0bv32$2;
    assert {:sourceloc_num 6} {:thread 1} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> true == true;
    assert {:sourceloc_num 6} {:thread 1} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> v1$1 == v1$2;
    assert {:sourceloc_num 6} {:thread 2} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> v1$2 == v1$1;
...
procedure {:inline 1} _LOG_WRITE_$$foo.mine(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$foo.mine, _WRITE_READ_BENIGN_FLAG_$$foo.mine;

implementation {:inline 1} _LOG_WRITE_$$foo.mine(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    ...
    assume $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$foo.mine;
