...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    assert {:do_not_predicate} {:sourceloc_num 1} {:thread 1} (if group_id_x$1 == group_id_x$2 ==> BV1_XOR((if BV32_AND(BV1_ZEXT32((if local_id_x$1 == 4bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if local_id_x$2 == 4bv32 then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1), 1bv1) == 1bv1 then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:sourceloc_num 1} {:thread 2} (if group_id_x$2 == group_id_x$1 ==> BV1_XOR((if BV32_AND(BV1_ZEXT32((if local_id_x$2 == 4bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if local_id_x$1 == 4bv32 then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1), 1bv1) == 1bv1 then 1bv1 else 0bv1) != 0bv1;
    return;
}
