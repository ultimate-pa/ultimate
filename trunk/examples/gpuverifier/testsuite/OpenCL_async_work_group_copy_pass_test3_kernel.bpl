...
axiom {:array_info "$$joint_handle"} {:elem_width 32} {:source_name "joint_handle"} {:source_elem_width 32} {:source_dimensions "1"} true;
...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies _READ_ASYNC_HANDLE_$$p, _READ_ASYNC_HANDLE_$$q, _WRITE_ASYNC_HANDLE_$$foo.my_p, _WRITE_ASYNC_HANDLE_$$foo.my_q, $$foo.my_p, $$foo.my_q, $$p, $$q, _TRACKING, _READ_HAS_OCCURRED_$$foo.my_p, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _READ_HAS_OCCURRED_$$foo.my_q, _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_HAS_OCCURRED_$$foo.my_p, _WRITE_READ_BENIGN_FLAG_$$foo.my_p, _WRITE_ASYNC_HANDLE_$$foo.my_p, _READ_HAS_OCCURRED_$$p, _READ_ASYNC_HANDLE_$$p, _WRITE_HAS_OCCURRED_$$foo.my_q, _WRITE_READ_BENIGN_FLAG_$$foo.my_q, _WRITE_ASYNC_HANDLE_$$foo.my_q, _READ_HAS_OCCURRED_$$q, _READ_ASYNC_HANDLE_$$q;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_0:
    ...
    $$joint_handle$0bv32$1 := v0$1;
    $$joint_handle$0bv32$2 := v0$2;
    v1$1 := $$joint_handle$0bv32$1;
    v1$2 := $$joint_handle$0bv32$2;
    call v2$1, v2$2 := _ASYNC_WORK_GROUP_COPY_$$foo.my_q_$$q(true, 0bv32, BV32_MUL(64bv32, group_id_x$1), 64bv32, v1$1, true, 0bv32, BV32_MUL(64bv32, group_id_x$2), 64bv32, v1$2);
    v3$1 := $$joint_handle$0bv32$1;
    v3$2 := $$joint_handle$0bv32$2;
    assert {:sourceloc_num 6} {:thread 1} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> true == true;
    assert {:sourceloc_num 6} {:thread 1} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> v3$1 == v3$2;
    assert {:sourceloc_num 6} {:thread 2} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> v3$2 == v3$1;
  ...
  __partitioned_block_$entry_1:
    ...
    call _LOG_WRITE_$$p(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), FMUL32(1073741824bv32, v4$1), $$p[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    ...
    call _CHECK_WRITE_$$p(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), FMUL32(1073741824bv32, v4$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := FMUL32(1073741824bv32, v4$1);
    $$p[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := FMUL32(1073741824bv32, v4$2);
    ...
    call _LOG_WRITE_$$q(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), FMUL32(1073741824bv32, v5$1), $$q[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    ...
    call _CHECK_WRITE_$$q(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), FMUL32(1073741824bv32, v5$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$q"} true;
    $$q[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := FMUL32(1073741824bv32, v5$1);
    $$q[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := FMUL32(1073741824bv32, v5$2);
    return;
}
...
procedure {:inline 1} {:safe_barrier} {:source_name "bugle_barrier"} {:barrier} $bugle_barrier_duplicated_0($0: bv1, $1: bv1);
  requires $0 == 1bv1;
  requires $1 == 1bv1;
  modifies $$foo.my_p, $$foo.my_q, $$p, $$q, _TRACKING;

var $$joint_handle$0bv32$1: bv32;

var $$joint_handle$0bv32$2: bv32;
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$foo.my_p;
  ...
  anon1:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$foo.my_q;
  ...
  anon6:
    assume _READ_ASYNC_HANDLE_$$q == _ASYNC_NO_HANDLE ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0bv1 ==> !_READ_HAS_OCCURRED_$$q;
