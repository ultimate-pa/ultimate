...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    assert {:sourceloc_num 1} {:thread 1} (if BV32_UGT(group_size_x, 0bv32) then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 2} {:thread 1} (if BV32_ULE(group_size_x, 1024bv32) then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 3} {:thread 1} (if BV32_UREM(BV32_MUL(group_size_x, num_groups_x), group_size_x) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    return;
}
...
axiom (if BV32_UGT(group_size_x, 0bv32) then 1bv1 else 0bv1) != 0bv1;

axiom (if BV32_ULE(group_size_x, 1024bv32) then 1bv1 else 0bv1) != 0bv1;

axiom (if BV32_UREM(1024bv32, group_size_x) == 0bv32 then 1bv1 else 0bv1) != 0bv1;

axiom (if num_groups_x == BV32_UDIV(1024bv32, group_size_x) then 1bv1 else 0bv1) != 0bv1;
