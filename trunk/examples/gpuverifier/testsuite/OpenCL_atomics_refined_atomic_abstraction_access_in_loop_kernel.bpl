...
var {:source_name "globalArray"} {:global} $$globalArray: [bv32]bv8;

axiom {:array_info "$$globalArray"} {:global} {:elem_width 8} {:source_name "globalArray"} {:source_elem_width 8} {:source_dimensions "*"} true;

var {:race_checking} {:global} {:elem_width 8} {:source_elem_width 8} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$globalArray: bool;

var {:race_checking} {:global} {:elem_width 8} {:source_elem_width 8} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$globalArray: bool;

var {:race_checking} {:global} {:elem_width 8} {:source_elem_width 8} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$globalArray: bool;

var {:source_name "localArray"} {:group_shared} $$localArray: [bv1][bv32]bv8;

axiom {:array_info "$$localArray"} {:group_shared} {:elem_width 8} {:source_name "localArray"} {:source_elem_width 8} {:source_dimensions "*"} true;

var {:race_checking} {:group_shared} {:elem_width 8} {:source_elem_width 8} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$localArray: bool;

var {:race_checking} {:group_shared} {:elem_width 8} {:source_elem_width 8} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$localArray: bool;

var {:race_checking} {:group_shared} {:elem_width 8} {:source_elem_width 8} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$localArray: bool;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $while.cond:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$localArray ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$localArray ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$localArray ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$localCounter ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$localCounter ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$localCounter ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:block_sourceloc} {:sourceloc_num 1} p0$1 ==> true;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 2} {:thread 1} (if _WRITE_HAS_OCCURRED_$$globalArray ==> _USED_$$globalCounter[0bv32][_WATCHED_OFFSET] then 1bv1 else 0bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$localArray ==> _USED_$$localCounter[0bv32][_WATCHED_OFFSET] then 1bv1 else 0bv1) != 0bv1;
    ...
    v0$1 := (if p0$1 then _HAVOC_bv32$1 else v0$1);
    v0$2 := (if p0$2 then _HAVOC_bv32$2 else v0$2);
    ...
    call _LOG_WRITE_$$globalArray(p0$1, v0$1, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)[8:0], $$globalArray[v0$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$globalArray(p0$2, v0$2);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 7} true;
    call _CHECK_WRITE_$$globalArray(p0$2, v0$2, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$globalArray"} true;
    $$globalArray[v0$1] := (if p0$1 then BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)[8:0] else $$globalArray[v0$1]);
    $$globalArray[v0$2] := (if p0$2 then BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)[8:0] else $$globalArray[v0$2]);
    call _LOG_WRITE_$$localArray(p0$1, v1$1, local_id_x$1[8:0], $$localArray[1bv1][v1$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$localArray(p0$2, v1$2);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 8} true;
    call _CHECK_WRITE_$$localArray(p0$2, v1$2, local_id_x$2[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$localArray"} true;
    $$localArray[1bv1][v1$1] := (if p0$1 then local_id_x$1[8:0] else $$localArray[1bv1][v1$1]);
    $$localArray[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v1$2] := (if p0$2 then local_id_x$2[8:0] else $$localArray[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v1$2]);
    v2$1 := (if p0$1 then BV32_UGT(v0$1, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)) else v2$1);
    v2$2 := (if p0$2 then BV32_UGT(v0$2, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)) else v2$2);
    p1$1 := false;
    p1$2 := false;
    p2$1 := false;
    p2$2 := false;
...
const _WATCHED_VALUE_$$globalArray: bv8;

procedure {:inline 1} _LOG_READ_$$globalArray(_P: bool, _offset: bv32, _value: bv8);
  modifies _READ_HAS_OCCURRED_$$globalArray;

implementation {:inline 1} _LOG_READ_$$globalArray(_P: bool, _offset: bv32, _value: bv8)
{
...
procedure _CHECK_READ_$$globalArray(_P: bool, _offset: bv32, _value: bv8);
...
procedure {:inline 1} _LOG_WRITE_$$globalArray(_P: bool, _offset: bv32, _value: bv8, _value_old: bv8);
  modifies _WRITE_HAS_OCCURRED_$$globalArray, _WRITE_READ_BENIGN_FLAG_$$globalArray;

implementation {:inline 1} _LOG_WRITE_$$globalArray(_P: bool, _offset: bv32, _value: bv8, _value_old: bv8)
{
...
procedure _CHECK_WRITE_$$globalArray(_P: bool, _offset: bv32, _value: bv8);
...
const _WATCHED_VALUE_$$localArray: bv8;

procedure {:inline 1} _LOG_READ_$$localArray(_P: bool, _offset: bv32, _value: bv8);
  modifies _READ_HAS_OCCURRED_$$localArray;

implementation {:inline 1} _LOG_READ_$$localArray(_P: bool, _offset: bv32, _value: bv8)
{
...
procedure _CHECK_READ_$$localArray(_P: bool, _offset: bv32, _value: bv8);
...
procedure {:inline 1} _LOG_WRITE_$$localArray(_P: bool, _offset: bv32, _value: bv8, _value_old: bv8);
  modifies _WRITE_HAS_OCCURRED_$$localArray, _WRITE_READ_BENIGN_FLAG_$$localArray;

implementation {:inline 1} _LOG_WRITE_$$localArray(_P: bool, _offset: bv32, _value: bv8, _value_old: bv8)
{
...
procedure _CHECK_WRITE_$$localArray(_P: bool, _offset: bv32, _value: bv8);
