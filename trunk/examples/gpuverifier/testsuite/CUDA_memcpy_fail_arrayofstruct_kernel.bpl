...
implementation {:source_name "k"} ULTIMATE.start()
{
  ...
  $entry:
    v0$1 := $$fresh$0bv32$1;
    v0$2 := $$fresh$0bv32$2;
    call _LOG_WRITE_$$pairs(true, 84bv32, v0$1, $$pairs[84bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$pairs(true, 84bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_WRITE_$$pairs(true, 84bv32, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$pairs"} true;
    $$pairs[84bv32] := v0$1;
    $$pairs[84bv32] := v0$2;
    v1$1 := $$fresh$1bv32$1;
    v1$2 := $$fresh$1bv32$2;
    call _LOG_WRITE_$$pairs(true, 85bv32, v1$1, $$pairs[85bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$pairs(true, 85bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_WRITE_$$pairs(true, 85bv32, v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$pairs"} true;
    $$pairs[85bv32] := v1$1;
    $$pairs[85bv32] := v1$2;
    return;
