...
axiom {:array_info "$$foo.L"} {:group_shared} {:elem_width 32} {:source_name "L"} {:source_elem_width 32} {:source_dimensions "25"} true;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    assert {:array_bounds} {:sourceloc_num 1} {:check_id "bounds_check_state_0"} {:array_name "$$foo.L"} BV32_SLT(_ARRAY_OFFSET_$$foo.L, 25bv32);
