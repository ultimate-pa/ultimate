...
axiom {:array_info "$$y"} {:elem_width 32} {:source_name "y"} {:source_elem_width 32} {:source_dimensions "1"} true;
...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$p, _READ_HAS_OCCURRED_$$p, _TRACKING, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_0:
    $$x$0bv32$1 := (if local_id_x$1 == 0bv32 then 1bv32 else 0bv32);
    $$x$0bv32$2 := (if local_id_x$2 == 0bv32 then 1bv32 else 0bv32);
    ...
    call _LOG_READ_$$p(p0$1, 0bv32, $$p[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_READ_$$p(p0$2, 0bv32, $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v1$1 := (if p0$1 then $$p[1bv1][0bv32] else v1$1);
    v1$2 := (if p0$2 then $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] else v1$2);
    $$y$0bv32$1 := (if p0$1 then v1$1 else $$y$0bv32$1);
    $$y$0bv32$2 := (if p0$2 then v1$2 else $$y$0bv32$2);
    v2$1 := $$x$0bv32$1;
    v2$2 := $$x$0bv32$2;
    v3$1 := $$x$0bv32$1;
    v3$2 := $$x$0bv32$2;
  ...
  __partitioned_block_$entry_1:
    call $bugle_barrier_duplicated_0((if BV32_AND(v2$1, 1bv32) != 0bv32 then 1bv1 else 0bv1), (if BV32_AND(v3$1, 2bv32) != 0bv32 then 1bv1 else 0bv1), (if BV32_AND(v2$2, 1bv32) != 0bv32 then 1bv1 else 0bv1), (if BV32_AND(v3$2, 2bv32) != 0bv32 then 1bv1 else 0bv1));
    v4$1 := local_id_x$1 == 1bv32;
    v4$2 := local_id_x$2 == 1bv32;
    p2$1 := (if v4$1 then v4$1 else p2$1);
    p2$2 := (if v4$2 then v4$2 else p2$2);
    call _LOG_WRITE_$$p(p2$1, 0bv32, 0bv32, $$p[1bv1][0bv32]);
    ...
    call _CHECK_WRITE_$$p(p2$2, 0bv32, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][0bv32] := (if p2$1 then 0bv32 else $$p[1bv1][0bv32]);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := (if p2$2 then 0bv32 else $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    return;
}
...
procedure {:inline 1} {:safe_barrier} {:source_name "bugle_barrier"} {:barrier} $bugle_barrier_duplicated_0($0$1: bv1, $1$1: bv1, $0$2: bv1, $1$2: bv1);
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0$1: bv1, $1$1: bv1, $0$2: bv1, $1$2: bv1)
{
  ...
  anon0:
    assume $0$1 != 0bv1 ==> !_READ_HAS_OCCURRED_$$p;
    assume $0$1 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$p;
    assume $0$1 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$p;
    goto anon1;
  ...
  anon5_Else:
    assume {:partition} !($0$1 != 0bv1 || $0$2 != 0bv1);
    goto anon3;
