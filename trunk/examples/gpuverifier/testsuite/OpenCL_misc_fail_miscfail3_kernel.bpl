...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$A, _WRITE_HAS_OCCURRED_$$A, _WRITE_READ_BENIGN_FLAG_$$A, _WRITE_READ_BENIGN_FLAG_$$A;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call _LOG_WRITE_$$A(p0$1, local_id_x$1, local_id_x$1, $$A[1bv1][local_id_x$1]);
    ...
    call _CHECK_WRITE_$$A(p0$2, local_id_x$2, local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][local_id_x$1] := (if p0$1 then local_id_x$1 else $$A[1bv1][local_id_x$1]);
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p0$2 then local_id_x$2 else $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    $i.0 := 0bv32;
  ...
  $truebb1:
    assume {:partition} v2;
    call _LOG_WRITE_$$A(true, 0bv32, local_id_x$1, $$A[1bv1][0bv32]);
    ...
    call _CHECK_WRITE_$$A(true, 0bv32, local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][0bv32] := local_id_x$1;
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := local_id_x$2;
    goto $if.end8;
}
