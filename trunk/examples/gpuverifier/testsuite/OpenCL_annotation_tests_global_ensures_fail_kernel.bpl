...
procedure {:source_name "bar"} $bar(_P$1: bool, $A$1: bv32, _P$2: bool, $A$2: bv32);
  requires _P$1 ==> BV1_XOR((if _READ_HAS_OCCURRED_$$A then 1bv1 else 0bv1), 1bv1) != 0bv1;
  requires _P$1 ==> $A$1 == 0bv32;
  requires _P$2 ==> $A$2 == 0bv32;
  requires _READ_HAS_OCCURRED_$$A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  requires _WRITE_HAS_OCCURRED_$$A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  requires _ATOMIC_HAS_OCCURRED_$$A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  ensures BV1_XOR((if _READ_HAS_OCCURRED_$$A then 1bv1 else 0bv1), 1bv1) != 0bv1;
  ensures _READ_HAS_OCCURRED_$$A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _WRITE_HAS_OCCURRED_$$A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _ATOMIC_HAS_OCCURRED_$$A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;

implementation {:source_name "bar"} $bar(_P$1: bool, $A$1: bv32, _P$2: bool, $A$2: bv32)
{
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call _LOG_READ_$$A(p0$1, BV32_ADD(local_id_x$1, 1bv32), $$A[1bv1][BV32_ADD(local_id_x$1, 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_READ_$$A(p0$2, BV32_ADD(local_id_x$2, 1bv32), $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v1$1 := (if p0$1 then $$A[1bv1][BV32_ADD(local_id_x$1, 1bv32)] else v1$1);
    v1$2 := (if p0$2 then $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)] else v1$2);
    call _LOG_WRITE_$$A(p0$1, local_id_x$1, v1$1, $$A[1bv1][local_id_x$1]);
    ...
    call _CHECK_WRITE_$$A(p0$2, local_id_x$2, v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][local_id_x$1] := (if p0$1 then v1$1 else $$A[1bv1][local_id_x$1]);
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p0$2 then v1$2 else $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    v2$1 := BV32_UREM(local_id_x$1, 2bv32) == 0bv32;
    v2$2 := BV32_UREM(local_id_x$2, 2bv32) == 0bv32;
    p2$1 := (if v2$1 then v2$1 else p2$1);
    p2$2 := (if v2$2 then v2$2 else p2$2);
    call $bar(p2$1, 0bv32, p2$2, 0bv32);
