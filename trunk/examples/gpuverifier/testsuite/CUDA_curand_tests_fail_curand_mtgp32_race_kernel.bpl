...
implementation {:source_name "curand_test"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    v1$1 := BV8_ZEXT32(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(group_size_z, group_size_y), local_id_z$1), BV32_MUL(group_size_x, local_id_y$1)), local_id_x$1)[8:0]);
    v1$2 := BV8_ZEXT32(BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(group_size_z, group_size_y), local_id_z$2), BV32_MUL(group_size_x, local_id_y$2)), local_id_x$2)[8:0]);
    call _LOG_READ_$$state(true, v1$1, $$state[v1$1]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_READ_$$state(true, v1$2, $$state[v1$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$state"} true;
    v2$1 := $$state[v1$1];
    v2$2 := $$state[v1$2];
    call _LOG_WRITE_$$state(true, v1$1, BV32_ADD(v2$1, v0$1), $$state[v1$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$state(true, v1$2);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_WRITE_$$state(true, v1$2, BV32_ADD(v2$2, v0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$state"} true;
    $$state[v1$1] := BV32_ADD(v2$1, v0$1);
    $$state[v1$2] := BV32_ADD(v2$2, v0$2);
    call v3$1, v3$2 := $_Z19__bugle_random_uintv();
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z19__bugle_random_uintv"} true;
    call _LOG_WRITE_$$A(true, local_id_x$1, UI32_TO_FP32(v3$1), $$A[local_id_x$1]);
    ...
    call _CHECK_WRITE_$$A(true, local_id_x$2, UI32_TO_FP32(v3$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[local_id_x$1] := UI32_TO_FP32(v3$1);
    $$A[local_id_x$2] := UI32_TO_FP32(v3$2);
    return;
}
