...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    assert {:sourceloc_num 1} {:thread 1} (if local_id_x$1 == 4bv32 ==> local_id_x$2 != 4bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 1} {:thread 2} (if local_id_x$2 == 4bv32 ==> local_id_x$1 != 4bv32 then 1bv1 else 0bv1) != 0bv1;
    return;
}
