...
axiom {:array_info "$$A"} {:elem_width 32} {:source_name "A"} {:source_elem_width 32} {:source_dimensions "1"} true;

var {:source_name "foo.A"} {:constant} $$foo.A$1: [bv32]bv32;

var {:source_name "foo.A"} {:constant} $$foo.A$2: [bv32]bv32;

axiom {:array_info "$$foo.A"} {:constant} {:elem_width 32} {:source_name "foo.A"} {:source_elem_width 32} {:source_dimensions "1"} true;
...
procedure {:source_name "foo"} ULTIMATE.start();
  requires $$foo.A$1[0bv32] == 1bv32;
  requires $$foo.A$2[0bv32] == 1bv32;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    v1$1 := $$A$0bv32$1;
    v1$2 := $$A$0bv32$2;
    call _LOG_WRITE_$$B(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), v1$1, $$B[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$B(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_WRITE_$$B(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$B"} true;
    $$B[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := v1$1;
    $$B[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := v1$2;
    return;
}
