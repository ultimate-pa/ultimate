...
const $functionId$$_Z12grabFunctioni: functionPtr;

axiom $functionId$$_Z12grabFunctioni == 3bv3;

const $functionId$$_Z3fooPfji: functionPtr;

axiom $functionId$$_Z3fooPfji == 4bv3;
...
procedure {:source_name "grabFunction"} $_Z12grabFunctioni($i: bv32) returns ($ret: functionPtr);
  ...
  requires BV32_SLT(local_id_z$2, group_size_z);
  requires group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> local_id_x$1 != local_id_x$2 || local_id_y$1 != local_id_y$2 || local_id_z$1 != local_id_z$2;
  ensures (if $ret == $functionId$$_Z11divideByTwoPfj then 1bv1 else 0bv1) != 0bv1;

implementation {:source_name "grabFunction"} $_Z12grabFunctioni($i: bv32) returns ($ret: functionPtr)
{
  var $retval.0: functionPtr;
  var v0: bool;
  ...
  $falsebb:
    assume {:partition} !v0;
    $retval.0 := $functionId$$_Z11divideByTwoPfj;
    goto $return;
  ...
  $truebb:
    assume {:partition} v0;
    $retval.0 := $functionId$$_Z13multiplyByTwoPfj;
    goto $return;
}

procedure {:source_name "foo"} ULTIMATE.start($size: bv32, $i: bv32);
  requires (if $i != 0bv32 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "foo"} ULTIMATE.start($size: bv32, $i: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1: functionPtr;
  ...
  $entry:
    ...
    call v1 := $_Z12grabFunctioni($i);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z12grabFunctioni"} true;
    ...
    p1$1 := (if p0$1 && v1 == $functionId$$_Z13multiplyByTwoPfj then v1 == $functionId$$_Z13multiplyByTwoPfj else p1$1);
    p1$2 := (if p0$2 && v1 == $functionId$$_Z13multiplyByTwoPfj then v1 == $functionId$$_Z13multiplyByTwoPfj else p1$2);
    p2$1 := (if p0$1 && v1 != $functionId$$_Z13multiplyByTwoPfj then v1 != $functionId$$_Z13multiplyByTwoPfj else p2$1);
    p2$2 := (if p0$2 && v1 != $functionId$$_Z13multiplyByTwoPfj then v1 != $functionId$$_Z13multiplyByTwoPfj else p2$2);
    ...
    p3$1 := (if p2$1 && v1 == $functionId$$_Z11divideByTwoPfj then v1 == $functionId$$_Z11divideByTwoPfj else p3$1);
    p3$2 := (if p2$2 && v1 == $functionId$$_Z11divideByTwoPfj then v1 == $functionId$$_Z11divideByTwoPfj else p3$2);
    p4$1 := (if p2$1 && v1 != $functionId$$_Z11divideByTwoPfj then v1 != $functionId$$_Z11divideByTwoPfj else p4$1);
    p4$2 := (if p2$2 && v1 != $functionId$$_Z11divideByTwoPfj then v1 != $functionId$$_Z11divideByTwoPfj else p4$2);
    ...
    assert {:bad_pointer_access} {:sourceloc_num 18} {:thread 1} p4$1 ==> false;
    assert {:bad_pointer_access} {:sourceloc_num 18} {:thread 2} p4$2 ==> false;
    return;
}
