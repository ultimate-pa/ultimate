...
implementation {:source_name "foo"} ULTIMATE.start($x: bv32)
{
  ...
  $truebb:
    assume {:partition} v0;
    call _LOG_WRITE_$$A(true, local_id_x$1, 3bv32, $$A[1bv1][local_id_x$1]);
    ...
    call _CHECK_WRITE_$$A(true, local_id_x$2, 3bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][local_id_x$1] := 3bv32;
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := 3bv32;
    goto $if.end;
}
