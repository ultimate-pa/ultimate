...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies _USED_$$localCounter, _ATOMIC_HAS_OCCURRED_$$localCounter, _WRITE_HAS_OCCURRED_$$globalArray, _WRITE_READ_BENIGN_FLAG_$$globalArray, _WRITE_READ_BENIGN_FLAG_$$globalArray;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    havoc v0$1, v0$2;
    assume !_USED_$$localCounter[0bv32][v0$1];
    _USED_$$localCounter[0bv32][v0$1] := true;
    assume !_USED_$$localCounter[0bv32][v0$2];
    _USED_$$localCounter[0bv32][v0$2] := true;
    call _LOG_WRITE_$$globalArray(true, v0$1, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $$globalArray[v0$1]);
    ...
    call _CHECK_WRITE_$$globalArray(true, v0$2, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$globalArray"} true;
    $$globalArray[v0$1] := BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1);
    $$globalArray[v0$2] := BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2);
    return;
}
