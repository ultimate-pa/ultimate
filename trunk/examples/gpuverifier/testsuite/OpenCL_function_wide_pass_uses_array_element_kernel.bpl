...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $for.cond:
    ...
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 0} {:thread 1} (if $$A[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] == 1bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:procedure_wide_invariant} {:do_not_predicate} {:sourceloc_num 0} {:thread 2} (if $$A[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] == 1bv32 then 1bv1 else 0bv1) != 0bv1;
  ...
  $falsebb:
    ...
    assert {:sourceloc_num 9} {:thread 1} (if v1$1 == 1bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 9} {:thread 2} (if v1$2 == 1bv32 then 1bv1 else 0bv1) != 0bv1;
    call _LOG_READ_$$A(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $$A[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
