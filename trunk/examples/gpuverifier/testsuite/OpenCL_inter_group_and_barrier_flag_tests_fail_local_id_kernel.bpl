...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    call _LOG_WRITE_$$p(true, local_id_x$1, group_id_x$1, $$p[local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(true, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$p(true, local_id_x$2, group_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[local_id_x$1] := group_id_x$1;
    $$p[local_id_x$2] := group_id_x$2;
    return;
}
