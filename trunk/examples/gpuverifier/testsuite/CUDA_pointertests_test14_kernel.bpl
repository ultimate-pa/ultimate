...
axiom {:array_info "$$_ZZ3fooPiE1x"} {:group_shared} {:elem_width 32} {:source_name "x"} {:source_elem_width 32} {:source_dimensions "32"} true;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$_ZZ3fooPiE1x: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$_ZZ3fooPiE1x: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$_ZZ3fooPiE1x: bool;
...
const _WATCHED_VALUE_$$_ZZ3fooPiE1x: bv32;

procedure {:inline 1} _LOG_READ_$$_ZZ3fooPiE1x(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$_ZZ3fooPiE1x;

implementation {:inline 1} _LOG_READ_$$_ZZ3fooPiE1x(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$_ZZ3fooPiE1x(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ3fooPiE1x(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$_ZZ3fooPiE1x, _WRITE_READ_BENIGN_FLAG_$$_ZZ3fooPiE1x;

implementation {:inline 1} _LOG_WRITE_$$_ZZ3fooPiE1x(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$_ZZ3fooPiE1x(_P: bool, _offset: bv32, _value: bv32);
