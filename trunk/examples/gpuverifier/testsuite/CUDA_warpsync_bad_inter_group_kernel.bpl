...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call _LOG_READ_$$A(true, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1), $$A[BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_READ_$$A(true, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$2, 1bv32), group_size_x), local_id_x$2), $$A[BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$2, 1bv32), group_size_x), local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    call _POST_WARP_SYNC_$$A_READ(true, true);
    v0$1 := $$A[BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1)];
    v0$2 := $$A[BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$2, 1bv32), group_size_x), local_id_x$2)];
    ...
    call _LOG_WRITE_$$A(true, v1$1, BV32_ADD(v2$1, v0$1), $$A[v1$1]);
    ...
    $$A[v1$1] := BV32_ADD(v2$1, v0$1);
    $$A[v1$2] := BV32_ADD(v2$2, v0$2);
    return;
}
