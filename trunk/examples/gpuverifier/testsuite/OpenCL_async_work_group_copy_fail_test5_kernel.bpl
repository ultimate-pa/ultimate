...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies _READ_ASYNC_HANDLE_$$p, _READ_ASYNC_HANDLE_$$q, _READ_ASYNC_HANDLE_$$foo.my_p, _READ_ASYNC_HANDLE_$$foo.my_q, _WRITE_ASYNC_HANDLE_$$foo.my_p, _WRITE_ASYNC_HANDLE_$$foo.my_q, _WRITE_ASYNC_HANDLE_$$p, _READ_ASYNC_HANDLE_$$p, _READ_ASYNC_HANDLE_$$q, _READ_ASYNC_HANDLE_$$foo.my_p, _READ_ASYNC_HANDLE_$$foo.my_q, _WRITE_ASYNC_HANDLE_$$foo.my_p, _WRITE_ASYNC_HANDLE_$$foo.my_q, _WRITE_ASYNC_HANDLE_$$p, $$foo.my_p, $$foo.my_q, _READ_HAS_OCCURRED_$$foo.my_p, _READ_ASYNC_HANDLE_$$foo.my_p, _WRITE_HAS_OCCURRED_$$foo.my_p, _WRITE_READ_BENIGN_FLAG_$$foo.my_p, _WRITE_ASYNC_HANDLE_$$foo.my_p, _WRITE_READ_BENIGN_FLAG_$$foo.my_p, _READ_HAS_OCCURRED_$$foo.my_q, _READ_ASYNC_HANDLE_$$foo.my_q, _WRITE_HAS_OCCURRED_$$foo.my_q, _WRITE_READ_BENIGN_FLAG_$$foo.my_q, _WRITE_ASYNC_HANDLE_$$foo.my_q, _WRITE_READ_BENIGN_FLAG_$$foo.my_q, $$p, _TRACKING, _READ_HAS_OCCURRED_$$p, _READ_ASYNC_HANDLE_$$p, _READ_HAS_OCCURRED_$$q, _READ_ASYNC_HANDLE_$$q, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_ASYNC_HANDLE_$$p;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_1:
    ...
    call v7$1, v7$2 := _ASYNC_WORK_GROUP_COPY_$$p_$$foo.my_q(true, BV32_MUL(64bv32, group_id_x$1), 0bv32, 64bv32, 0bv32, true, BV32_MUL(64bv32, group_id_x$2), 0bv32, 64bv32, 0bv32);
    return;
}
...
procedure {:inline 1} {:safe_barrier} {:source_name "bugle_barrier"} {:barrier} $bugle_barrier_duplicated_0($0: bv1, $1: bv1);
  requires $0 == 1bv1;
  requires $1 == 0bv1;
  modifies $$foo.my_p, $$foo.my_q, $$p, _TRACKING;
...
procedure {:inline 1} _ASYNC_WORK_GROUP_COPY_$$p_$$foo.my_q(_P$1: bool, DstOffset$1: bv32, SrcOffset$1: bv32, Size$1: bv32, Handle$1: bv32, _P$2: bool, DstOffset$2: bv32, SrcOffset$2: bv32, Size$2: bv32, Handle$2: bv32) returns (ResultHandle$1: bv32, ResultHandle$2: bv32);
  requires _P$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 == _P$2;
  requires _P$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$2 == _P$1;
  requires _P$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> DstOffset$1 == DstOffset$2;
  requires _P$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> DstOffset$2 == DstOffset$1;
  ...
  requires _P$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> Handle$1 == Handle$2;
  requires _P$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> Handle$2 == Handle$1;
  modifies _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_ASYNC_HANDLE_$$p, _READ_HAS_OCCURRED_$$foo.my_q, _READ_ASYNC_HANDLE_$$foo.my_q;

implementation {:inline 1} _ASYNC_WORK_GROUP_COPY_$$p_$$foo.my_q(_P$1: bool, DstOffset$1: bv32, SrcOffset$1: bv32, Size$1: bv32, Handle$1: bv32, _P$2: bool, DstOffset$2: bv32, SrcOffset$2: bv32, Size$2: bv32, Handle$2: bv32) returns (ResultHandle$1: bv32, ResultHandle$2: bv32)
{
  var Index$1: bv32;
  var Index$2: bv32;
  var IdX$1: bv32;
  ...
  entry:
    ...
    assume (p0$1 ==> BV32_UGE(Index$1, 0bv32)) && (p0$2 ==> BV32_UGE(Index$2, 0bv32));
    assume (p0$1 ==> BV32_ULT(Index$1, Size$1)) && (p0$2 ==> BV32_ULT(Index$2, Size$2));
    call _LOG_WRITE_$$p(p0$1, BV32_ADD(DstOffset$1, Index$1), $$foo.my_q[1bv1][BV32_ADD(SrcOffset$1, Index$1)], $$p[BV32_ADD(DstOffset$1, Index$1)], ResultHandle$1);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 15} true;
    call _CHECK_WRITE_$$p(p0$2, BV32_ADD(DstOffset$2, Index$2), $$foo.my_q[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(SrcOffset$2, Index$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    assume _READ_ASYNC_HANDLE_$$foo.my_p == _ASYNC_NO_HANDLE ==> $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$foo.my_p;
    assume _WRITE_ASYNC_HANDLE_$$foo.my_p == _ASYNC_NO_HANDLE ==> $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$foo.my_p;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$foo.my_p;
    goto anon1;

  anon1:
    assume _READ_ASYNC_HANDLE_$$foo.my_q == _ASYNC_NO_HANDLE ==> $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$foo.my_q;
    assume _WRITE_ASYNC_HANDLE_$$foo.my_q == _ASYNC_NO_HANDLE ==> $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$foo.my_q;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$foo.my_q;
    goto anon2;
