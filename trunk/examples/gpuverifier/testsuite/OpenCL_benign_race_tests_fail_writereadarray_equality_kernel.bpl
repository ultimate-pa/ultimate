...
procedure {:source_name "example"} ULTIMATE.start();
  ...
  modifies $$A, _WRITE_HAS_OCCURRED_$$A, _WRITE_READ_BENIGN_FLAG_$$A, _WRITE_READ_BENIGN_FLAG_$$A, _READ_HAS_OCCURRED_$$A;
...
implementation {:source_name "example"} ULTIMATE.start()
{
  ...
  $entry:
    call _LOG_WRITE_$$A(true, local_id_x$1, 0bv32, $$A[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$A(true, local_id_x$2, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][local_id_x$1] := 0bv32;
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := 0bv32;
    call _LOG_READ_$$A(true, BV32_ADD(local_id_x$1, 1bv32), $$A[1bv1][BV32_ADD(local_id_x$1, 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_READ_$$A(true, BV32_ADD(local_id_x$2, 1bv32), $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v0$1 := $$A[1bv1][BV32_ADD(local_id_x$1, 1bv32)];
    v0$2 := $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)];
    call $foo(v0$1, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$foo"} true;
    return;
}

procedure {:source_name "foo"} $foo($0$1: bv32, $0$2: bv32);
