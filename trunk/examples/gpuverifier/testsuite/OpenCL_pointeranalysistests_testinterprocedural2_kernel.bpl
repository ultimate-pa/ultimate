...
procedure {:source_name "bar"} $bar($pAlias: bv32);
  requires $pAlias == 0bv32;
  requires _READ_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  requires _WRITE_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  requires _ATOMIC_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  requires _READ_HAS_OCCURRED_$$q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  requires _WRITE_HAS_OCCURRED_$$q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  requires _ATOMIC_HAS_OCCURRED_$$q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  modifies $$p, _READ_HAS_OCCURRED_$$p, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p;
  ensures _READ_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _WRITE_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _ATOMIC_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _READ_HAS_OCCURRED_$$q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _WRITE_HAS_OCCURRED_$$q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _ATOMIC_HAS_OCCURRED_$$q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;

implementation {:source_name "bar"} $bar($pAlias: bv32)
{
  var $i.0: bv32;
  var v0: bool;
  var v1$1: bv32;
  ...
  $for.cond:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:originated_from_invariant} {:sourceloc_num 2} {:thread 1} (if _READ_HAS_OCCURRED_$$p ==> BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 3} {:thread 1} (if _WRITE_HAS_OCCURRED_$$p ==> BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
  ...
  $truebb:
    assume {:partition} v0;
    call _LOG_READ_$$p(true, BV32_ADD($pAlias, local_id_x$1), $$p[1bv1][BV32_ADD($pAlias, local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_READ_$$p(true, BV32_ADD($pAlias, local_id_x$2), $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD($pAlias, local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v1$1 := $$p[1bv1][BV32_ADD($pAlias, local_id_x$1)];
    v1$2 := $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD($pAlias, local_id_x$2)];
    call _LOG_WRITE_$$p(true, BV32_ADD($pAlias, local_id_x$1), FADD32(v1$1, 1065353216bv32), $$p[1bv1][BV32_ADD($pAlias, local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(true, BV32_ADD($pAlias, local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 6} true;
    call _CHECK_WRITE_$$p(true, BV32_ADD($pAlias, local_id_x$2), FADD32(v1$2, 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][BV32_ADD($pAlias, local_id_x$1)] := FADD32(v1$1, 1065353216bv32);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD($pAlias, local_id_x$2)] := FADD32(v1$2, 1065353216bv32);
    $i.0 := BV32_ADD($i.0, 1bv32);
    assume {:captureState "loop_back_edge_state_0_0"} true;
    goto $for.cond;
}

procedure {:source_name "baz"} $baz($qAlias: bv32);
  requires $qAlias == 0bv32;
  requires _READ_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  requires _WRITE_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  requires _ATOMIC_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  requires _READ_HAS_OCCURRED_$$q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  requires BV32_SLT(local_id_z$2, group_size_z);
  requires group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> local_id_x$1 != local_id_x$2 || local_id_y$1 != local_id_y$2 || local_id_z$1 != local_id_z$2;
  modifies $$q, _READ_HAS_OCCURRED_$$q, _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_READ_BENIGN_FLAG_$$q;
  ensures _READ_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _WRITE_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _ATOMIC_HAS_OCCURRED_$$p ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _READ_HAS_OCCURRED_$$q ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
...
implementation {:source_name "baz"} $baz($qAlias: bv32)
{
  var $i.0: bv32;
  var v0: bool;
  var v1$1: bv32;
  ...
  $for.cond:
    ...
    assert {:originated_from_invariant} {:sourceloc_num 13} {:thread 1} (if _READ_HAS_OCCURRED_$$q ==> BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 14} {:thread 1} (if _WRITE_HAS_OCCURRED_$$q ==> BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    v0 := BV32_SLT($i.0, 100bv32);
    goto $truebb, $falsebb;
  ...
  $truebb:
    assume {:partition} v0;
    call _LOG_READ_$$q(true, BV32_ADD($qAlias, local_id_x$1), $$q[1bv1][BV32_ADD($qAlias, local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 16} true;
    call _CHECK_READ_$$q(true, BV32_ADD($qAlias, local_id_x$2), $$q[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD($qAlias, local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$q"} true;
    v1$1 := $$q[1bv1][BV32_ADD($qAlias, local_id_x$1)];
    v1$2 := $$q[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD($qAlias, local_id_x$2)];
    call _LOG_WRITE_$$q(true, BV32_ADD($qAlias, local_id_x$1), FADD32(v1$1, 1065353216bv32), $$q[1bv1][BV32_ADD($qAlias, local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$q(true, BV32_ADD($qAlias, local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 17} true;
    call _CHECK_WRITE_$$q(true, BV32_ADD($qAlias, local_id_x$2), FADD32(v1$2, 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$q"} true;
    $$q[1bv1][BV32_ADD($qAlias, local_id_x$1)] := FADD32(v1$1, 1065353216bv32);
    $$q[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD($qAlias, local_id_x$2)] := FADD32(v1$2, 1065353216bv32);
    $i.0 := BV32_ADD($i.0, 1bv32);
...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  requires BV32_SLT(local_id_z$2, group_size_z);
  requires group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> local_id_x$1 != local_id_x$2 || local_id_y$1 != local_id_y$2 || local_id_z$1 != local_id_z$2;
  modifies $$p, $$q, _READ_HAS_OCCURRED_$$p, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _TRACKING, _READ_HAS_OCCURRED_$$q, _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_READ_BENIGN_FLAG_$$q;
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon1:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$q;
    assume $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$q;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$q;
    goto anon2;
