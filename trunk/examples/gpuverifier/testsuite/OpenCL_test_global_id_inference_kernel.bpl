...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $truebb:
    ...
    call _CHECK_WRITE_$$A(true, v0$2, BV32_ADD(v2$2, 2bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[v0$1] := BV32_ADD(v2$1, 2bv32);
    $$A[v0$2] := BV32_ADD(v2$2, 2bv32);
    call _LOG_READ_$$B(true, v0$1, $$B[v0$1]);
    ...
    v3$1 := $$B[v0$1];
    v3$2 := $$B[v0$2];
    call _LOG_WRITE_$$B(true, v0$1, BV32_ADD(v3$1, 1bv32), $$B[v0$1]);
    ...
    call _CHECK_WRITE_$$B(true, v0$2, BV32_ADD(v3$2, 1bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$B"} true;
    $$B[v0$1] := BV32_ADD(v3$1, 1bv32);
    $$B[v0$2] := BV32_ADD(v3$2, 1bv32);
