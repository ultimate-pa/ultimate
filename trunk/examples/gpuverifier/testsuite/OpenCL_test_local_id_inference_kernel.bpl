...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    v0$1 := local_id_x$1;
    v0$2 := local_id_x$2;
    call _LOG_WRITE_$$A(true, v0$1, 0bv32, $$A[1bv1][v0$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, v0$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$A(true, v0$2, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][v0$1] := 0bv32;
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v0$2] := 0bv32;
    $i.0 := 0bv32;
  ...
  $truebb:
    ...
    v2$1 := $$A[1bv1][v0$1];
    v2$2 := $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v0$2];
    call _LOG_WRITE_$$A(true, v0$1, BV32_ADD(v2$1, 1bv32), $$A[1bv1][v0$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, v0$2);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_WRITE_$$A(true, v0$2, BV32_ADD(v2$2, 1bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][v0$1] := BV32_ADD(v2$1, 1bv32);
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v0$2] := BV32_ADD(v2$2, 1bv32);
