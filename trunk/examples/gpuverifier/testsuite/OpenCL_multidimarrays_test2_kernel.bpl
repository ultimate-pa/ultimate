...
axiom {:array_info "$$foo.A"} {:group_shared} {:elem_width 32} {:source_name "A"} {:source_elem_width 32} {:source_dimensions "32,32"} true;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,32"} _READ_HAS_OCCURRED_$$foo.A: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,32"} _WRITE_HAS_OCCURRED_$$foo.A: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,32"} _ATOMIC_HAS_OCCURRED_$$foo.A: bool;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    call _LOG_WRITE_$$foo.A(true, BV32_ADD(BV32_MUL(local_id_y$1, 32bv32), local_id_x$1), 2bv32, $$foo.A[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 32bv32), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.A(true, BV32_ADD(BV32_MUL(local_id_y$2, 32bv32), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$foo.A(true, BV32_ADD(BV32_MUL(local_id_y$2, 32bv32), local_id_x$2), 2bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.A"} true;
    $$foo.A[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 32bv32), local_id_x$1)] := 2bv32;
    $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 32bv32), local_id_x$2)] := 2bv32;
    return;
}
