...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    $cond$1 := (if p0$1 then 1bv32 else $cond$1);
    $cond$2 := (if p0$2 then 1bv32 else $cond$2);
    $cond$1 := (if p1$1 then BV32_MUL(2bv32, local_id_x$1) else $cond$1);
    $cond$2 := (if p1$2 then BV32_MUL(2bv32, local_id_x$2) else $cond$2);
