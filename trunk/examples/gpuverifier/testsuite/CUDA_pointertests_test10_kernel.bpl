...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    call _LOG_WRITE_$$_ZZ3foovE1A(true, BV32_ADD(1bv32, local_id_x$1), 0bv32, $$_ZZ3foovE1A[1bv1][BV32_ADD(1bv32, local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ3foovE1A(true, BV32_ADD(1bv32, local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$_ZZ3foovE1A(true, BV32_ADD(1bv32, local_id_x$2), 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ3foovE1A"} true;
    $$_ZZ3foovE1A[1bv1][BV32_ADD(1bv32, local_id_x$1)] := 0bv32;
    $$_ZZ3foovE1A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(1bv32, local_id_x$2)] := 0bv32;
    return;
}
