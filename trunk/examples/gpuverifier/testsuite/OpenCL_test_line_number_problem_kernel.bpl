...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$A, _READ_HAS_OCCURRED_$$A, _TRACKING, _WRITE_HAS_OCCURRED_$$A, _WRITE_READ_BENIGN_FLAG_$$A, _WRITE_READ_BENIGN_FLAG_$$A;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$truebb_0:
    assume {:partition} v1;
    v2$1 := BV32_ULT($i.0, local_id_x$1);
    v2$2 := BV32_ULT($i.0, local_id_x$2);
    p1$1 := (if v2$1 then v2$1 else p1$1);
    p1$2 := (if v2$2 then v2$2 else p1$2);
    p0$1 := (if !v2$1 then !v2$1 else p0$1);
    p0$2 := (if !v2$2 then !v2$2 else p0$2);
    $temp.1$1 := (if p0$1 then $temp.0$1 else $temp.1$1);
    $temp.1$2 := (if p0$2 then $temp.0$2 else $temp.1$2);
    call _LOG_READ_$$A(p1$1, BV32_SUB(local_id_x$1, $i.0), $$A[1bv1][BV32_SUB(local_id_x$1, $i.0)]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_READ_$$A(p1$2, BV32_SUB(local_id_x$2, $i.0), $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_SUB(local_id_x$2, $i.0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v3$1 := (if p1$1 then $$A[1bv1][BV32_SUB(local_id_x$1, $i.0)] else v3$1);
    v3$2 := (if p1$2 then $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_SUB(local_id_x$2, $i.0)] else v3$2);
    $temp.1$1 := (if p1$1 then v3$1 else $temp.1$1);
    $temp.1$2 := (if p1$2 then v3$2 else $temp.1$2);
    goto __partitioned_block_$truebb_1;

  __partitioned_block_$truebb_1:
    call $bugle_barrier_duplicated_0(1bv1, 0bv1);
    v4$1 := BV32_ULT($i.0, local_id_x$1);
    v4$2 := BV32_ULT($i.0, local_id_x$2);
    p3$1 := (if v4$1 then v4$1 else p3$1);
    p3$2 := (if v4$2 then v4$2 else p3$2);
    call _LOG_READ_$$A(p3$1, local_id_x$1, $$A[1bv1][local_id_x$1]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 8} true;
    call _CHECK_READ_$$A(p3$2, local_id_x$2, $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v5$1 := (if p3$1 then $$A[1bv1][local_id_x$1] else v5$1);
    v5$2 := (if p3$2 then $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] else v5$2);
    call _LOG_WRITE_$$A(p3$1, local_id_x$1, BV32_ADD(v5$1, $temp.1$1), $$A[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(p3$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 9} true;
    call _CHECK_WRITE_$$A(p3$2, local_id_x$2, BV32_ADD(v5$2, $temp.1$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][local_id_x$1] := (if p3$1 then BV32_ADD(v5$1, $temp.1$1) else $$A[1bv1][local_id_x$1]);
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p3$2 then BV32_ADD(v5$2, $temp.1$2) else $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    $temp.0$1, $i.0 := $temp.1$1, BV32_MUL($i.0, 2bv32);
    $temp.0$2 := $temp.1$2;
