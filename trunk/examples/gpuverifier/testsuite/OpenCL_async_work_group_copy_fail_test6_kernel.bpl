...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    assert {:sourceloc_num 1} {:thread 1} (if local_id_x$1 != 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 1} {:thread 2} (if local_id_x$2 != 0bv32 then 1bv1 else 0bv1) != 0bv1;
    call v0$1, v0$2 := _ASYNC_WORK_GROUP_COPY_$$foo.my_p_$$p(true, 0bv32, BV32_MUL(64bv32, local_id_x$1), 64bv32, 0bv32, true, 0bv32, BV32_MUL(64bv32, local_id_x$2), 64bv32, 0bv32);
