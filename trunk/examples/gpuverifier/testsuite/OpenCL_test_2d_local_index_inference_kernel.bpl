...
axiom {:array_info "$$foo.B"} {:group_shared} {:elem_width 32} {:source_name "B"} {:source_elem_width 32} {:source_dimensions "1024"} true;
...
axiom {:array_info "$$foo.A"} {:group_shared} {:elem_width 32} {:source_name "A"} {:source_elem_width 32} {:source_dimensions "1024"} true;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    v1$1 := local_id_y$1;
    v1$2 := local_id_y$2;
    v2$1 := BV32_ADD(BV32_MUL(v1$1, group_size_x), local_id_x$1);
    v2$2 := BV32_ADD(BV32_MUL(v1$2, group_size_x), local_id_x$2);
    $i.0 := 0bv32;
  ...
  $truebb:
    assume {:partition} v3;
    call _LOG_READ_$$foo.B(true, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), v0$1), $$foo.B[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), v0$1)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_READ_$$foo.B(true, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), v0$2), $$foo.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), v0$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.B"} true;
    v4$1 := $$foo.B[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), v0$1)];
    v4$2 := $$foo.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), v0$2)];
    call _LOG_WRITE_$$foo.A(true, BV32_ADD(BV32_MUL(v1$1, group_size_x), v0$1), BV32_ADD(v4$1, 2bv32), $$foo.A[1bv1][BV32_ADD(BV32_MUL(v1$1, group_size_x), v0$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.A(true, BV32_ADD(BV32_MUL(v1$2, group_size_x), v0$2));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 6} true;
    call _CHECK_WRITE_$$foo.A(true, BV32_ADD(BV32_MUL(v1$2, group_size_x), v0$2), BV32_ADD(v4$2, 2bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.A"} true;
    $$foo.A[1bv1][BV32_ADD(BV32_MUL(v1$1, group_size_x), v0$1)] := BV32_ADD(v4$1, 2bv32);
    $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v1$2, group_size_x), v0$2)] := BV32_ADD(v4$2, 2bv32);
    call _LOG_READ_$$foo.B(true, v2$1, $$foo.B[1bv1][v2$1]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 7} true;
    call _CHECK_READ_$$foo.B(true, v2$2, $$foo.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v2$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.B"} true;
    v5$1 := $$foo.B[1bv1][v2$1];
    v5$2 := $$foo.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v2$2];
    call _LOG_WRITE_$$foo.B(true, v2$1, BV32_ADD(v5$1, 1bv32), $$foo.B[1bv1][v2$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.B(true, v2$2);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 8} true;
    call _CHECK_WRITE_$$foo.B(true, v2$2, BV32_ADD(v5$2, 1bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.B"} true;
    $$foo.B[1bv1][v2$1] := BV32_ADD(v5$1, 1bv32);
    $$foo.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v2$2] := BV32_ADD(v5$2, 1bv32);
