...
procedure {:source_name "inline_test"} ULTIMATE.start($offset: bv32);
  ...
  requires (if BV32_SLT($offset, 1024bv32) then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "inline_test"} ULTIMATE.start($offset: bv32)
{
  ...
  $entry:
    call _LOG_READ_$$A(true, BV32_ADD(local_id_x$1, $offset), $$A[BV32_ADD(local_id_x$1, $offset)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_READ_$$A(true, BV32_ADD(local_id_x$2, $offset), $$A[BV32_ADD(local_id_x$2, $offset)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v0$1 := $$A[BV32_ADD(local_id_x$1, $offset)];
    v0$2 := $$A[BV32_ADD(local_id_x$2, $offset)];
    ...
    v1$1 := $$A[local_id_x$1];
    v1$2 := $$A[local_id_x$2];
    call _LOG_WRITE_$$A(true, local_id_x$1, BV32_ADD(v1$1, v0$1), $$A[local_id_x$1]);
    ...
    call _CHECK_WRITE_$$A(true, local_id_x$2, BV32_ADD(v1$2, v0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[local_id_x$1] := BV32_ADD(v1$1, v0$1);
    $$A[local_id_x$2] := BV32_ADD(v1$2, v0$2);
    return;
}
