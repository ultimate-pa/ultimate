...
procedure {:source_name "bar"} $bar($p: bv32) returns ($ret: bv32);
  requires $p == 0bv32;
...
implementation {:source_name "bar"} $bar($p: bv32) returns ($ret: bv32)
{
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call _LOG_WRITE_$$A(true, BV32_ADD(v0, local_id_x$1), local_id_x$1, $$A[1bv1][BV32_ADD(v0, local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, BV32_ADD(v0, local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_WRITE_$$A(true, BV32_ADD(v0, local_id_x$2), local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][BV32_ADD(v0, local_id_x$1)] := local_id_x$1;
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v0, local_id_x$2)] := local_id_x$2;
    return;
}
