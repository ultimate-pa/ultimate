...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$foo.A, _WRITE_HAS_OCCURRED_$$foo.A, _WRITE_READ_BENIGN_FLAG_$$foo.A, _WRITE_READ_BENIGN_FLAG_$$foo.A, _NOT_ACCESSED_$$foo.A, _TRACKING;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_0:
    ...
    assert {:barrier_invariant true} {:sourceloc_num 2} {:thread 1} true ==> (if $$foo.A[1bv1][local_id_x$1] == BV32_ADD(local_id_x$1, 1bv32) then 1bv1 else 0bv1) != 0bv1;
  ...
  __partitioned_block_$entry_1:
    ...
    assume true ==> BV32_SGE(0bv32, 0bv32) && BV32_SLT(0bv32, group_size_x) ==> (if $$foo.A[1bv1][0bv32] == BV32_ADD(0bv32, 1bv32) then 1bv1 else 0bv1) != 0bv1;
    assume true ==> BV32_SGE(0bv32, 0bv32) && BV32_SLT(0bv32, group_size_x) ==> (if $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] == BV32_ADD(0bv32, 1bv32) then 1bv1 else 0bv1) != 0bv1;
    return;
}
