...
axiom {:array_info "$$A"} {:global} {:elem_width 32} {:source_name "A"} {:source_elem_width 64} {:source_dimensions "*"} true;

var {:race_checking} {:global} {:elem_width 32} {:source_elem_width 64} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$A: bool;

var {:race_checking} {:global} {:elem_width 32} {:source_elem_width 64} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$A: bool;

var {:race_checking} {:global} {:elem_width 32} {:source_elem_width 64} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$A: bool;
...
procedure {:source_name "align_test"} ULTIMATE.start();
...
implementation {:source_name "align_test"} ULTIMATE.start()
{
  var v0$1: bv32;
  var v0$2: bv32;
  ...
  $entry:
    ...
    call _LOG_WRITE_$$A(true, BV32_MUL(v0$1, 2bv32), local_id_x$1, $$A[BV32_MUL(v0$1, 2bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, BV32_MUL(v0$2, 2bv32));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$A(true, BV32_MUL(v0$2, 2bv32), local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV32_MUL(v0$1, 2bv32)] := local_id_x$1;
    $$A[BV32_MUL(v0$2, 2bv32)] := local_id_x$2;
    call _LOG_WRITE_$$A(true, BV32_ADD(BV32_MUL(v0$1, 2bv32), 1bv32), group_id_x$1, $$A[BV32_ADD(BV32_MUL(v0$1, 2bv32), 1bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, BV32_ADD(BV32_MUL(v0$2, 2bv32), 1bv32));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_WRITE_$$A(true, BV32_ADD(BV32_MUL(v0$2, 2bv32), 1bv32), group_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV32_ADD(BV32_MUL(v0$1, 2bv32), 1bv32)] := group_id_x$1;
    $$A[BV32_ADD(BV32_MUL(v0$2, 2bv32), 1bv32)] := group_id_x$2;
    return;
}
