...
const $functionId$$_Z4foogPfPFfS_jES1_j: functionPtr;

axiom $functionId$$_Z4foogPfPFfS_jES1_j == 3bv3;
...
function FUNCPTR_LT(functionPtr, functionPtr) : bool;
...
procedure {:source_name "foog"} ULTIMATE.start($f: functionPtr, $g: functionPtr, $size: bv32);
  requires (if $f == $functionId$$_Z11divideByTwoPfj then 1bv1 else 0bv1) != 0bv1;
  requires (if $g == $functionId$$_Z13multiplyByTwoPfj then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "foog"} ULTIMATE.start($f: functionPtr, $g: functionPtr, $size: bv32)
{
  var $h.0: functionPtr;
  var v0$1: bv32;
  var v0$2: bv32;
  ...
  $entry:
    ...
    v1 := (if $g == $f then true else FUNCPTR_LT($g, $f));
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
  ...
  $if.end:
    ...
    p1$1 := (if p0$1 && $h.0 == $functionId$$_Z13multiplyByTwoPfj then $h.0 == $functionId$$_Z13multiplyByTwoPfj else p1$1);
    p1$2 := (if p0$2 && $h.0 == $functionId$$_Z13multiplyByTwoPfj then $h.0 == $functionId$$_Z13multiplyByTwoPfj else p1$2);
    p2$1 := (if p0$1 && $h.0 != $functionId$$_Z13multiplyByTwoPfj then $h.0 != $functionId$$_Z13multiplyByTwoPfj else p2$1);
    p2$2 := (if p0$2 && $h.0 != $functionId$$_Z13multiplyByTwoPfj then $h.0 != $functionId$$_Z13multiplyByTwoPfj else p2$2);
    ...
    p3$1 := (if p2$1 && $h.0 == $functionId$$_Z11divideByTwoPfj then $h.0 == $functionId$$_Z11divideByTwoPfj else p3$1);
    p3$2 := (if p2$2 && $h.0 == $functionId$$_Z11divideByTwoPfj then $h.0 == $functionId$$_Z11divideByTwoPfj else p3$2);
    p4$1 := (if p2$1 && $h.0 != $functionId$$_Z11divideByTwoPfj then $h.0 != $functionId$$_Z11divideByTwoPfj else p4$1);
    p4$2 := (if p2$2 && $h.0 != $functionId$$_Z11divideByTwoPfj then $h.0 != $functionId$$_Z11divideByTwoPfj else p4$2);
