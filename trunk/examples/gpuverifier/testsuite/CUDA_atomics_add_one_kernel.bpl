...
procedure {:source_name "race_test"} ULTIMATE.start();
  ...
  modifies _USED_$$i, _ATOMIC_HAS_OCCURRED_$$i, _WRITE_HAS_OCCURRED_$$A, _WRITE_READ_BENIGN_FLAG_$$A, _WRITE_READ_BENIGN_FLAG_$$A;
...
implementation {:source_name "race_test"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    havoc v0$1, v0$2;
    assume !_USED_$$i[0bv32][v0$1];
    _USED_$$i[0bv32][v0$1] := true;
    assume !_USED_$$i[0bv32][v0$2];
    _USED_$$i[0bv32][v0$2] := true;
...
var {:atomic_usedmap} _USED_$$i: [bv32][bv32]bool;
