...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p, $$p, _TRACKING;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_0:
    call _LOG_WRITE_$$p(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $$p[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$p(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1);
    $$p[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2);
    goto __partitioned_block_$entry_1;

  __partitioned_block_$entry_1:
    call $bugle_barrier_duplicated_0(0bv1, 1bv1);
    v0$1 := BV32_ULT(local_id_x$1, BV32_SUB(group_size_x, 1bv32));
    v0$2 := BV32_ULT(local_id_x$2, BV32_SUB(group_size_x, 1bv32));
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
    ...
    call _LOG_WRITE_$$p(p0$1, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $$p[BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(p0$2, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_WRITE_$$p(p0$2, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32)] := (if p0$1 then BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1) else $$p[BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32)]);
    $$p[BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)] := (if p0$2 then BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2) else $$p[BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)]);
    return;
}
