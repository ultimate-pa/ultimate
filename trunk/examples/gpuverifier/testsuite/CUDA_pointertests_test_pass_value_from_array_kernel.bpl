...
procedure {:source_name "bar"} $_Z3barf($x$1: bv32, $x$2: bv32);
...
implementation {:source_name "bar"} $_Z3barf($x$1: bv32, $x$2: bv32)
{
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    havoc v0$1, v0$2;
    call $_Z3barf(SI32_TO_FP32(v0$1), SI32_TO_FP32(v0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z3barf"} true;
    return;
}
