...
axiom {:array_info "$$example.L"} {:group_shared} {:elem_width 32} {:source_name "L"} {:source_elem_width 32} {:source_dimensions "64,64"} true;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,64"} _READ_HAS_OCCURRED_$$example.L: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,64"} _WRITE_HAS_OCCURRED_$$example.L: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,64"} _ATOMIC_HAS_OCCURRED_$$example.L: bool;
...
procedure {:source_name "example"} ULTIMATE.start();
  ...
  modifies $$example.L, _READ_HAS_OCCURRED_$$G, _WRITE_HAS_OCCURRED_$$example.L, _WRITE_READ_BENIGN_FLAG_$$example.L, _WRITE_READ_BENIGN_FLAG_$$example.L, _READ_HAS_OCCURRED_$$example.L, _WRITE_HAS_OCCURRED_$$G, _WRITE_READ_BENIGN_FLAG_$$G, _WRITE_READ_BENIGN_FLAG_$$G;
...
implementation {:source_name "example"} ULTIMATE.start()
{
  ...
  $entry:
    call _LOG_READ_$$G(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$G[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_READ_$$G(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), $$G[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$G"} true;
    v0$1 := $$G[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))];
    v0$2 := $$G[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))];
    call _LOG_WRITE_$$example.L(true, BV32_ADD(BV32_MUL(local_id_y$1, 64bv32), local_id_x$1), v0$1, $$example.L[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 64bv32), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$example.L(true, BV32_ADD(BV32_MUL(local_id_y$2, 64bv32), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_WRITE_$$example.L(true, BV32_ADD(BV32_MUL(local_id_y$2, 64bv32), local_id_x$2), v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$example.L"} true;
    $$example.L[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 64bv32), local_id_x$1)] := v0$1;
    $$example.L[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 64bv32), local_id_x$2)] := v0$2;
    v1$1 := BV32_ADD(local_id_y$1, 1bv32);
    v1$2 := BV32_ADD(local_id_y$2, 1bv32);
    v2$1 := local_id_x$1;
    v2$2 := local_id_x$2;
    call _LOG_READ_$$example.L(true, BV32_ADD(BV32_MUL(v1$1, 64bv32), v2$1), $$example.L[1bv1][BV32_ADD(BV32_MUL(v1$1, 64bv32), v2$1)]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_READ_$$example.L(true, BV32_ADD(BV32_MUL(v1$2, 64bv32), v2$2), $$example.L[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v1$2, 64bv32), v2$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$example.L"} true;
    v3$1 := $$example.L[1bv1][BV32_ADD(BV32_MUL(v1$1, 64bv32), v2$1)];
    v3$2 := $$example.L[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v1$2, 64bv32), v2$2)];
    call _LOG_WRITE_$$example.L(true, BV32_ADD(BV32_MUL(v1$1, 64bv32), v2$1), BV32_ADD(v3$1, 1bv32), $$example.L[1bv1][BV32_ADD(BV32_MUL(v1$1, 64bv32), v2$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$example.L(true, BV32_ADD(BV32_MUL(v1$2, 64bv32), v2$2));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_WRITE_$$example.L(true, BV32_ADD(BV32_MUL(v1$2, 64bv32), v2$2), BV32_ADD(v3$2, 1bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$example.L"} true;
    $$example.L[1bv1][BV32_ADD(BV32_MUL(v1$1, 64bv32), v2$1)] := BV32_ADD(v3$1, 1bv32);
    $$example.L[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v1$2, 64bv32), v2$2)] := BV32_ADD(v3$2, 1bv32);
    call _LOG_READ_$$example.L(true, BV32_ADD(BV32_MUL(local_id_y$1, 64bv32), local_id_x$1), $$example.L[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 64bv32), local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_READ_$$example.L(true, BV32_ADD(BV32_MUL(local_id_y$2, 64bv32), local_id_x$2), $$example.L[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 64bv32), local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$example.L"} true;
    v4$1 := $$example.L[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 64bv32), local_id_x$1)];
    v4$2 := $$example.L[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 64bv32), local_id_x$2)];
    call _LOG_WRITE_$$G(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), v4$1, $$G[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$G(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 6} true;
    call _CHECK_WRITE_$$G(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), v4$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$G"} true;
    $$G[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))] := v4$1;
    $$G[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), BV32_MUL(group_size_y, num_groups_y)), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))] := v4$2;
    return;
}
