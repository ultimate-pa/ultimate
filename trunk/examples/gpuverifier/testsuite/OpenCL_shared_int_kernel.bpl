...
axiom {:array_info "$$foo.a"} {:group_shared} {:elem_width 32} {:source_name "a"} {:source_elem_width 32} {:source_dimensions "1"} true;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    call _LOG_WRITE_$$foo.a(true, 0bv32, local_id_x$1, $$foo.a[1bv1][0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.a(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$foo.a(true, 0bv32, local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.a"} true;
    $$foo.a[1bv1][0bv32] := local_id_x$1;
    $$foo.a[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := local_id_x$2;
    return;
}
