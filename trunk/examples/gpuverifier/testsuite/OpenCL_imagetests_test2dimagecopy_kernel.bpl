...
implementation {:source_name "k"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    havoc v9$1, v9$2;
    havoc v10$1, v10$2;
    call _LOG_WRITE_$$dest(true, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), v7$1, $$dest[BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$dest(true, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 18} true;
    call _CHECK_WRITE_$$dest(true, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32), v7$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dest"} true;
    $$dest[BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32)] := v7$1;
    $$dest[BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32)] := v7$2;
    call _LOG_WRITE_$$dest(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 1bv32), v8$1, $$dest[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 1bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$dest(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32), 1bv32));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 19} true;
    call _CHECK_WRITE_$$dest(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32), 1bv32), v8$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dest"} true;
    $$dest[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 1bv32)] := v8$1;
    $$dest[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32), 1bv32)] := v8$2;
    call _LOG_WRITE_$$dest(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 2bv32), v9$1, $$dest[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 2bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$dest(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32), 2bv32));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 20} true;
    call _CHECK_WRITE_$$dest(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32), 2bv32), v9$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dest"} true;
    $$dest[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 2bv32)] := v9$1;
    $$dest[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32), 2bv32)] := v9$2;
    call _LOG_WRITE_$$dest(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 3bv32), v10$1, $$dest[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 3bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$dest(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32), 3bv32));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 21} true;
    call _CHECK_WRITE_$$dest(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32), 3bv32), v10$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dest"} true;
    $$dest[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 4bv32), 3bv32)] := v10$1;
    $$dest[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 8192bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 4bv32), 3bv32)] := v10$2;
    return;
}
