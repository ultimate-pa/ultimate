...
axiom {:array_info "$$foo.L"} {:group_shared} {:elem_width 32} {:source_name "L"} {:source_elem_width 32} {:source_dimensions "10,10,10"} true;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,10,10"} _READ_HAS_OCCURRED_$$foo.L: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,10,10"} _WRITE_HAS_OCCURRED_$$foo.L: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,10,10"} _ATOMIC_HAS_OCCURRED_$$foo.L: bool;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    _ARRAY_OFFSET_$$foo.L := BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 100bv32), BV32_MUL(local_id_y$1, 10bv32)), local_id_z$1);
    _ARRAY_OFFSET_$$foo.L := BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 100bv32), BV32_MUL(local_id_y$2, 10bv32)), local_id_z$2);
    ...
    assert {:array_bounds} {:sourceloc_num 1} {:check_id "bounds_check_state_0"} {:array_name "$$foo.L"} BV32_SLT(_ARRAY_OFFSET_$$foo.L, 1000bv32);
    call _LOG_WRITE_$$foo.L(true, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 100bv32), BV32_MUL(local_id_y$1, 10bv32)), local_id_z$1), group_id_x$1, $$foo.L[1bv1][BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 100bv32), BV32_MUL(local_id_y$1, 10bv32)), local_id_z$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.L(true, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 100bv32), BV32_MUL(local_id_y$2, 10bv32)), local_id_z$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$foo.L(true, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 100bv32), BV32_MUL(local_id_y$2, 10bv32)), local_id_z$2), group_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.L"} true;
    $$foo.L[1bv1][BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 100bv32), BV32_MUL(local_id_y$1, 10bv32)), local_id_z$1)] := group_id_x$1;
    $$foo.L[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 100bv32), BV32_MUL(local_id_y$2, 10bv32)), local_id_z$2)] := group_id_x$2;
    return;
}
...
axiom (if group_size_z == 10bv32 then 1bv1 else 0bv1) != 0bv1;
