...
procedure {:source_name "foo"} ULTIMATE.start($j: bv32);
  requires (if $j == 0bv32 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "foo"} ULTIMATE.start($j: bv32)
{
  var $i.0: bv32;
  var v0: bool;
  var v1$1: bv32;
  ...
  $truebb:
    ...
    call _LOG_WRITE_$$A(true, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $j), v1$1, $$A[BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $j)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $j));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_WRITE_$$A(true, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $j), v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), $j)] := v1$1;
    $$A[BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), $j)] := v1$2;
