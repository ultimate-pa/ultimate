...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_0:
    call _LOG_WRITE_$$foo.A(true, local_id_x$1, 42bv32, $$foo.A[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.A(true, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$foo.A(true, local_id_x$2, 42bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.A"} true;
    $$foo.A[1bv1][local_id_x$1] := 42bv32;
    $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := 42bv32;
  ...
  $for.cond:
    ...
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 4} {:thread 1} BV1_XOR((if _READ_HAS_OCCURRED_$$foo.A then 1bv1 else 0bv1), 1bv1) != 0bv1;
    assert {:do_not_predicate} {:originated_from_invariant} {:sourceloc_num 5} {:thread 1} BV1_XOR((if _WRITE_HAS_OCCURRED_$$foo.A then 1bv1 else 0bv1), 1bv1) != 0bv1;
    ...
    $k.0$1 := (if p1$1 then 0bv32 else $k.0$1);
    $k.0$2 := (if p1$2 then 0bv32 else $k.0$2);
  ...
  $for.cond5:
    ...
    v1$1 := (if p2$1 then BV32_ULT($k.0$1, group_id_x$1) else v1$1);
    v1$2 := (if p2$2 then BV32_ULT($k.0$2, group_id_x$2) else v1$2);
    p3$1 := false;
    p3$2 := false;
    p4$1 := false;
    p4$2 := false;
    ...
    v2$1 := (if p3$1 then BV32_UGT($j.0$1, local_id_x$1) else v2$1);
    v2$2 := (if p3$2 then BV32_UGT($j.0$2, local_id_x$2) else v2$2);
    p5$1 := (if p3$1 && v2$1 then v2$1 else p5$1);
    p5$2 := (if p3$2 && v2$2 then v2$2 else p5$2);
    $i.0$1 := (if p5$1 then 0bv32 else $i.0$1);
    $i.0$2 := (if p5$2 then 0bv32 else $i.0$2);
  ...
  $for.cond11:
    ...
    v3$1 := (if p6$1 then BV32_ULT($i.0$1, group_id_x$1) else v3$1);
    v3$2 := (if p6$2 then BV32_ULT($i.0$2, group_id_x$2) else v3$2);
    p7$1 := false;
    p7$2 := false;
    p7$1 := (if p6$1 && v3$1 then v3$1 else p7$1);
    p7$2 := (if p6$2 && v3$2 then v3$2 else p7$2);
    p6$1 := (if p6$1 && !v3$1 then v3$1 else p6$1);
    p6$2 := (if p6$2 && !v3$2 then v3$2 else p6$2);
    v4$1 := (if p7$1 then local_id_x$1 else v4$1);
    v4$2 := (if p7$2 then local_id_x$2 else v4$2);
    call _LOG_READ_$$foo.A(p7$1, v4$1, $$foo.A[1bv1][v4$1]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 12} true;
    call _CHECK_READ_$$foo.A(p7$2, v4$2, $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v4$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.A"} true;
    v5$1 := (if p7$1 then $$foo.A[1bv1][v4$1] else v5$1);
    v5$2 := (if p7$2 then $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v4$2] else v5$2);
    call _LOG_WRITE_$$foo.A(p7$1, v4$1, BV32_ADD(v5$1, 42bv32), $$foo.A[1bv1][v4$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.A(p7$2, v4$2);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 13} true;
    call _CHECK_WRITE_$$foo.A(p7$2, v4$2, BV32_ADD(v5$2, 42bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.A"} true;
    $$foo.A[1bv1][v4$1] := (if p7$1 then BV32_ADD(v5$1, 42bv32) else $$foo.A[1bv1][v4$1]);
    $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v4$2] := (if p7$2 then BV32_ADD(v5$2, 42bv32) else $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v4$2]);
    $i.0$1 := (if p7$1 then BV32_ADD($i.0$1, 1bv32) else $i.0$1);
    $i.0$2 := (if p7$2 then BV32_ADD($i.0$2, 1bv32) else $i.0$2);
    p6$1 := (if p7$1 then true else p6$1);
    p6$2 := (if p7$2 then true else p6$2);
    goto $for.cond11.backedge, __partitioned_block_$for.cond11.tail_0;

  __partitioned_block_$for.cond11.tail_0:
    assume !p6$1 && !p6$2;
    goto __partitioned_block_$for.cond11.tail_1;

  __partitioned_block_$for.cond11.tail_1:
    call $bugle_barrier_duplicated_1(1bv1, 0bv1, p3$1, p3$2);
  ...
  $for.cond.tail:
    assume !p0$1 && !p0$2;
    call _LOG_WRITE_$$foo.A(true, BV32_UREM(BV32_ADD(local_id_x$1, 1bv32), 32bv32), 1bv32, $$foo.A[1bv1][BV32_UREM(BV32_ADD(local_id_x$1, 1bv32), 32bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.A(true, BV32_UREM(BV32_ADD(local_id_x$2, 1bv32), 32bv32));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 22} true;
    call _CHECK_WRITE_$$foo.A(true, BV32_UREM(BV32_ADD(local_id_x$2, 1bv32), 32bv32), 1bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.A"} true;
    $$foo.A[1bv1][BV32_UREM(BV32_ADD(local_id_x$1, 1bv32), 32bv32)] := 1bv32;
    $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_UREM(BV32_ADD(local_id_x$2, 1bv32), 32bv32)] := 1bv32;
    return;
