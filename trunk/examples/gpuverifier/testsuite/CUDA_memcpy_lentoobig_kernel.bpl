...
implementation {:source_name "k"} ULTIMATE.start()
{
  ...
  $entry:
    havoc v0$1, v0$2;
    call _LOG_WRITE_$$out(true, BV32_MUL(local_id_x$1, 4bv32), v0$1, $$out[BV32_MUL(local_id_x$1, 4bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$out(true, BV32_MUL(local_id_x$2, 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_WRITE_$$out(true, BV32_MUL(local_id_x$2, 4bv32), v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_MUL(local_id_x$1, 4bv32)] := v0$1;
    $$out[BV32_MUL(local_id_x$2, 4bv32)] := v0$2;
    havoc v1$1, v1$2;
    call _LOG_WRITE_$$out(true, BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 1bv32), v1$1, $$out[BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 1bv32)]);
    ...
    call _CHECK_WRITE_$$out(true, BV32_ADD(BV32_MUL(local_id_x$2, 4bv32), 1bv32), v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 1bv32)] := v1$1;
    $$out[BV32_ADD(BV32_MUL(local_id_x$2, 4bv32), 1bv32)] := v1$2;
    havoc v2$1, v2$2;
    call _LOG_WRITE_$$out(true, BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 2bv32), v2$1, $$out[BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 2bv32)]);
    ...
    call _CHECK_WRITE_$$out(true, BV32_ADD(BV32_MUL(local_id_x$2, 4bv32), 2bv32), v2$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 2bv32)] := v2$1;
    $$out[BV32_ADD(BV32_MUL(local_id_x$2, 4bv32), 2bv32)] := v2$2;
    havoc v3$1, v3$2;
    call _LOG_WRITE_$$out(true, BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 3bv32), v3$1, $$out[BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 3bv32)]);
    ...
    call _CHECK_WRITE_$$out(true, BV32_ADD(BV32_MUL(local_id_x$2, 4bv32), 3bv32), v3$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 3bv32)] := v3$1;
    $$out[BV32_ADD(BV32_MUL(local_id_x$2, 4bv32), 3bv32)] := v3$2;
    havoc v4$1, v4$2;
    call _LOG_WRITE_$$out(true, BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 4bv32), v4$1, $$out[BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 4bv32)]);
    ...
    call _CHECK_WRITE_$$out(true, BV32_ADD(BV32_MUL(local_id_x$2, 4bv32), 4bv32), v4$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 4bv32)] := v4$1;
    $$out[BV32_ADD(BV32_MUL(local_id_x$2, 4bv32), 4bv32)] := v4$2;
    return;
}
