...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $for.cond:
    ...
    assert {:sourceloc_num 2} {:thread 1} (if $k.0 == $k.0 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 3} {:thread 1} (if BV1_ZEXT32((if true then 1bv1 else 0bv1)) == BV1_ZEXT32((if true then 1bv1 else 0bv1)) then 1bv1 else 0bv1) != 0bv1;
