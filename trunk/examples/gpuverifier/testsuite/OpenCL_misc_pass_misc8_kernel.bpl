...
procedure {:source_name "baz"} $baz(_P$1: bool, $p$1: bv32, _P$2: bool, $p$2: bv32) returns ($ret$1: bv32, $ret$2: bv32);
  requires _P$1 ==> $p$1 == 1073741824bv32;
  requires _P$2 ==> $p$2 == 1073741824bv32;
...
implementation {:source_name "baz"} $baz(_P$1: bool, $p$1: bv32, _P$2: bool, $p$2: bv32) returns ($ret$1: bv32, $ret$2: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;

  $entry:
    call v0$1, v0$2 := $__half_powr_float(1073741824bv32, _P$1, $p$1, _P$2, $p$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$__half_powr_float"} true;
    $ret$1 := (if _P$1 then v0$1 else $ret$1);
    $ret$2 := (if _P$2 then v0$2 else $ret$2);
    return;
}
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    v1$1 := FLT32(0bv32, v0$1) || FLT32(v0$1, 0bv32) || FUNO32(v0$1, 0bv32);
    v1$2 := FLT32(0bv32, v0$2) || FLT32(v0$2, 0bv32) || FUNO32(v0$2, 0bv32);
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
    ...
    call v2$1, v2$2 := $baz(p0$1, 1073741824bv32, p0$2, 1073741824bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "$baz"} true;
    return;
}

procedure {:source_name "__half_powr_float"} $__half_powr_float($0: bv32, _P$1: bool, $1$1: bv32, _P$2: bool, $1$2: bv32) returns ($ret$1: bv32, $ret$2: bv32);
  requires _P$1 ==> $0 == 1073741824bv32;
  requires _P$2 ==> $0 == 1073741824bv32;
