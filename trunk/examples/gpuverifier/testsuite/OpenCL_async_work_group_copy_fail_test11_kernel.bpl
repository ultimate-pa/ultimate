...
axiom $arrayId$$joint_handle_p == 3bv3;
...
axiom $arrayId$$joint_handle_q == 4bv3;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    v3$1 := (if p2$1 then $$joint_handle_p$1[BV32_MUL(offset#MKPTR($joint_handle_ptr.0$1), 4bv32)] else v3$1);
    v3$2 := (if p2$2 then $$joint_handle_p$2[BV32_MUL(offset#MKPTR($joint_handle_ptr.0$2), 4bv32)] else v3$2);
    ...
    v3$1 := (if p4$1 then $$joint_handle_q$1[BV32_MUL(offset#MKPTR($joint_handle_ptr.0$1), 4bv32)] else v3$1);
    v3$2 := (if p4$2 then $$joint_handle_q$2[BV32_MUL(offset#MKPTR($joint_handle_ptr.0$2), 4bv32)] else v3$2);
    ...
    assert {:sourceloc_num 10} {:thread 1} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> true == true;
    assert {:sourceloc_num 10} {:thread 1} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> v3$1 == v3$2;
    assert {:sourceloc_num 10} {:thread 2} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> v3$2 == v3$1;
