...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $for.cond6:
    ...
    assert {:tag "user"} {:originated_from_invariant} {:sourceloc_num 11} {:thread 1} _c0 ==> (if $$A[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:tag "user"} {:originated_from_invariant} {:sourceloc_num 11} {:thread 2} _c0 ==> (if $$A[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
