...
procedure {:source_name "baz"} ULTIMATE.start();
...
implementation {:source_name "baz"} ULTIMATE.start()
{
  var v0$1: bv32;
  var v0$2: bv32;
  ...
  $entry:
    ...
    v0$1 := $$p[1bv1][local_id_x$1];
    v0$2 := $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2];
    call _LOG_WRITE_$$p(true, BV32_ADD(local_id_x$1, 1bv32), local_id_x$1, $$p[1bv1][BV32_ADD(local_id_x$1, 1bv32)]);
    ...
    call _CHECK_WRITE_$$p(true, BV32_ADD(local_id_x$2, 1bv32), local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][BV32_ADD(local_id_x$1, 1bv32)] := local_id_x$1;
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)] := local_id_x$2;
    return;
}
