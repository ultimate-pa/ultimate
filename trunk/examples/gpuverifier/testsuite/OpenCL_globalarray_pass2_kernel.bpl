...
axiom {:array_info "$$A"} {:constant} {:elem_width 32} {:source_name "A"} {:source_elem_width 32} {:source_dimensions "8"} true;
...
procedure {:source_name "globalarray"} ULTIMATE.start();
  ...
  requires $$A$1[1bv32] == 1bv32;
  requires $$A$2[1bv32] == 1bv32;
  requires $$A$1[2bv32] == 2bv32;
  requires $$A$2[2bv32] == 2bv32;
  requires $$A$1[3bv32] == 3bv32;
  requires $$A$2[3bv32] == 3bv32;
  requires $$A$1[4bv32] == 4bv32;
  requires $$A$2[4bv32] == 4bv32;
  requires $$A$1[5bv32] == 5bv32;
  requires $$A$2[5bv32] == 5bv32;
  requires $$A$1[6bv32] == 6bv32;
  requires $$A$2[6bv32] == 6bv32;
  requires $$A$1[7bv32] == 7bv32;
  requires $$A$2[7bv32] == 7bv32;
...
implementation {:source_name "globalarray"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    v1$1 := v0$1 != BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1);
    v1$2 := v0$2 != BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2);
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
    ...
    assert {:sourceloc_num 4} {:thread 1} p0$1 ==> false;
    assert {:sourceloc_num 4} {:thread 2} p0$2 ==> false;
    return;
}
