...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $cond.end:
    ...
    assert {:sourceloc_num 5} {:thread 1} p0$1 ==> false;
    assert {:sourceloc_num 5} {:thread 2} p0$2 ==> false;
    assert {:sourceloc_num 7} {:thread 1} p1$1 ==> false;
    assert {:sourceloc_num 7} {:thread 2} p1$2 ==> false;
    return;
