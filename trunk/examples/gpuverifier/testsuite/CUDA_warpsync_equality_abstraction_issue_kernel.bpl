...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call _LOG_WRITE_$$A(true, 0bv32, 1bv32, $$A[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$A(true, 0bv32, 1bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    call _POST_WARP_SYNC_$$A_WRITE(true, true);
    $$A[0bv32] := 1bv32;
    call _PRE_WARP_SYNC_$$A_WRITE(true, true);
    call _LOG_WRITE_$$A(true, 1bv32, 1bv32, $$A[1bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, 1bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_WRITE_$$A(true, 1bv32, 1bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    call _POST_WARP_SYNC_$$A_WRITE(true, true);
    $$A[1bv32] := 1bv32;
    call _PRE_WARP_SYNC_$$A_WRITE(true, true);
    call _LOG_WRITE_$$A(true, 2bv32, 1bv32, $$A[2bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, 2bv32);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_WRITE_$$A(true, 2bv32, 1bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    call _POST_WARP_SYNC_$$A_WRITE(true, true);
    $$A[2bv32] := 1bv32;
    call _PRE_WARP_SYNC_$$A_WRITE(true, true);
    call _LOG_WRITE_$$A(true, local_id_x$1, 0bv32, $$A[local_id_x$1]);
    ...
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    call _POST_WARP_SYNC_$$A_WRITE(true, true);
    $$A[local_id_x$1] := 0bv32;
    $$A[local_id_x$2] := 0bv32;
    ...
    v0$2 := $$A[0bv32];
    call _PRE_WARP_SYNC_$$A_READ(true, true);
    call _LOG_READ_$$A(true, 1bv32, $$A[1bv32]);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 6} true;
    call _CHECK_READ_$$A(true, 1bv32, $$A[1bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    call _POST_WARP_SYNC_$$A_READ(true, true);
    v1$1 := $$A[1bv32];
    v1$2 := $$A[1bv32];
    call _PRE_WARP_SYNC_$$A_READ(true, true);
    call _LOG_READ_$$A(true, 2bv32, $$A[2bv32]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 7} true;
    call _CHECK_READ_$$A(true, 2bv32, $$A[2bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    call _POST_WARP_SYNC_$$A_READ(true, true);
    v2$1 := $$A[2bv32];
    v2$2 := $$A[2bv32];
    assert {:sourceloc_num 8} {:thread 1} (if BV32_OR(BV32_OR(BV1_ZEXT32((if v0$1 == 1bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if v1$1 == 1bv32 then 1bv1 else 0bv1))), BV1_ZEXT32((if v2$1 == 1bv32 then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 8} {:thread 2} (if BV32_OR(BV32_OR(BV1_ZEXT32((if v0$2 == 1bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if v1$2 == 1bv32 then 1bv1 else 0bv1))), BV1_ZEXT32((if v2$2 == 1bv32 then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
    return;
}
