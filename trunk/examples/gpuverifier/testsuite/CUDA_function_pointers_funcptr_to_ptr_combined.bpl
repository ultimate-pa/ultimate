...
axiom (forall y : ptr :: {FUNCPTR_TO_PTR(PTR_TO_FUNCPTR(y))} FUNCPTR_TO_PTR(PTR_TO_FUNCPTR(y)) == y);
...
const $functionId$$_Z3fooPfPFfS_jEji: functionPtr;

axiom $functionId$$_Z3fooPfPFfS_jEji == 3bv3;
...
function FUNCPTR_TO_PTR(functionPtr) : ptr;

function PTR_TO_FUNCPTR(ptr) : functionPtr;
...
procedure {:source_name "foo"} ULTIMATE.start($f: functionPtr, $size: bv32, $i: bv32);
  requires (if $i != 0bv32 then 1bv1 else 0bv1) != 0bv1;
  requires (if $f == $functionId$$_Z11divideByTwoPfj then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "foo"} ULTIMATE.start($f: functionPtr, $size: bv32, $i: bv32)
{
  var $x.0: ptr;
  var v0$1: bv32;
  var v0$2: bv32;
  ...
  $falsebb:
    assume {:partition} !v1;
    $x.0 := FUNCPTR_TO_PTR($f);
    goto $if.end;

  $if.end:
    v2$1 := BV32_ULT(v0$1, $size);
    v2$2 := BV32_ULT(v0$2, $size);
    p0$1 := (if v2$1 then v2$1 else p0$1);
    p0$2 := (if v2$2 then v2$2 else p0$2);
    p1$1 := (if p0$1 && PTR_TO_FUNCPTR($x.0) == $functionId$$_Z13multiplyByTwoPfj then PTR_TO_FUNCPTR($x.0) == $functionId$$_Z13multiplyByTwoPfj else p1$1);
    p1$2 := (if p0$2 && PTR_TO_FUNCPTR($x.0) == $functionId$$_Z13multiplyByTwoPfj then PTR_TO_FUNCPTR($x.0) == $functionId$$_Z13multiplyByTwoPfj else p1$2);
    p2$1 := (if p0$1 && PTR_TO_FUNCPTR($x.0) != $functionId$$_Z13multiplyByTwoPfj then PTR_TO_FUNCPTR($x.0) != $functionId$$_Z13multiplyByTwoPfj else p2$1);
    p2$2 := (if p0$2 && PTR_TO_FUNCPTR($x.0) != $functionId$$_Z13multiplyByTwoPfj then PTR_TO_FUNCPTR($x.0) != $functionId$$_Z13multiplyByTwoPfj else p2$2);
    call v3$1, v3$2 := $_Z13multiplyByTwoPfj(p1$1, 0bv32, v0$1, p1$2, 0bv32, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z13multiplyByTwoPfj"} true;
    p3$1 := (if p2$1 && PTR_TO_FUNCPTR($x.0) == $functionId$$_Z11divideByTwoPfj then PTR_TO_FUNCPTR($x.0) == $functionId$$_Z11divideByTwoPfj else p3$1);
    p3$2 := (if p2$2 && PTR_TO_FUNCPTR($x.0) == $functionId$$_Z11divideByTwoPfj then PTR_TO_FUNCPTR($x.0) == $functionId$$_Z11divideByTwoPfj else p3$2);
    p4$1 := (if p2$1 && PTR_TO_FUNCPTR($x.0) != $functionId$$_Z11divideByTwoPfj then PTR_TO_FUNCPTR($x.0) != $functionId$$_Z11divideByTwoPfj else p4$1);
    p4$2 := (if p2$2 && PTR_TO_FUNCPTR($x.0) != $functionId$$_Z11divideByTwoPfj then PTR_TO_FUNCPTR($x.0) != $functionId$$_Z11divideByTwoPfj else p4$2);
    call v3$1, v3$2 := $_Z11divideByTwoPfj(p3$1, 0bv32, v0$1, p3$2, 0bv32, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z11divideByTwoPfj"} true;
    assert {:bad_pointer_access} {:sourceloc_num 12} {:thread 1} p4$1 ==> false;
    assert {:bad_pointer_access} {:sourceloc_num 12} {:thread 2} p4$2 ==> false;
    return;

  $truebb:
    assume {:partition} v1;
    $x.0 := MKPTR($arrayId$$null$, 0bv32);
    goto $if.end;
}
