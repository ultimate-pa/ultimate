...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    v0$1 := group_id_x$1 != 16bv32;
    v0$2 := group_id_x$2 != 16bv32;
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
    ...
    p4$1 := false;
    p4$2 := false;
    p3$1 := (if v0$1 then v0$1 else p3$1);
    p3$2 := (if v0$2 then v0$2 else p3$2);
    ...
    v1$1 := (if p1$1 then group_id_y$1 != 16bv32 else v1$1);
    v1$2 := (if p1$2 then group_id_y$2 != 16bv32 else v1$2);
    ...
    call _LOG_WRITE_$$A(p3$1, 0bv32, local_id_x$1, $$A[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(p3$2, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_WRITE_$$A(p3$2, 0bv32, local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[0bv32] := (if p3$1 then local_id_x$1 else $$A[0bv32]);
    $$A[0bv32] := (if p3$2 then local_id_x$2 else $$A[0bv32]);
    return;
}
...
axiom (if group_id_x$1 == 16bv32 then 1bv1 else 0bv1) != 0bv1;

axiom (if group_id_y$1 == 16bv32 then 1bv1 else 0bv1) != 0bv1;
