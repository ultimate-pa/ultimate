...
implementation {:source_name "curand_test"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call _LOG_READ_$$state(true, 0bv32, $$state[0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_READ_$$state(true, 0bv32, $$state[0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$state"} true;
    v1$1 := $$state[0bv32];
    v1$2 := $$state[0bv32];
    call _LOG_WRITE_$$state(true, 0bv32, BV32_ADD(v1$1, v0$1), $$state[0bv32]);
    ...
    call _CHECK_WRITE_$$state(true, 0bv32, BV32_ADD(v1$2, v0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$state"} true;
    $$state[0bv32] := BV32_ADD(v1$1, v0$1);
    $$state[0bv32] := BV32_ADD(v1$2, v0$2);
    call v2$1, v2$2 := $_Z19__bugle_random_uintv();
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z19__bugle_random_uintv"} true;
    call v3$1, v3$2 := $_Z20__bugle_random_floatv();
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z20__bugle_random_floatv"} true;
    call _LOG_WRITE_$$A(true, local_id_x$1, v3$1, $$A[local_id_x$1]);
    ...
    call _CHECK_WRITE_$$A(true, local_id_x$2, v3$2);
...
procedure {:source_name "_Z20__bugle_random_floatv"} $_Z20__bugle_random_floatv() returns ($ret$1: bv32, $ret$2: bv32);
