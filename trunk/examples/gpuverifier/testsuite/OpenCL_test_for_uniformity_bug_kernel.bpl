...
implementation {:source_name "k"} ULTIMATE.start()
{
  ...
  $for.cond:
    ...
    assert {:originated_from_invariant} {:sourceloc_num 2} {:thread 1} (if $i.0 == $i.0 then 1bv1 else 0bv1) != 0bv1;
    v0 := BV32_SLT($i.0, 4bv32);
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
  ...
  __partitioned_block_$truebb_0:
    assume {:partition} v0;
    v1$1 := BV32_ULT(local_id_x$1, 4bv32);
    v1$2 := BV32_ULT(local_id_x$2, 4bv32);
    p1$1 := (if v1$1 then v1$1 else p1$1);
    p1$2 := (if v1$2 then v1$2 else p1$2);
    v2$1 := (if p1$1 then $i.0 == 0bv32 else v2$1);
    v2$2 := (if p1$2 then $i.0 == 0bv32 else v2$2);
    v3$1 := (if p1$1 then $i.0 == 1bv32 else v3$1);
    v3$2 := (if p1$2 then $i.0 == 1bv32 else v3$2);
    v4$1 := (if p1$1 then $i.0 == 2bv32 else v4$1);
    v4$2 := (if p1$2 then $i.0 == 2bv32 else v4$2);
    v5$1 := (if p1$1 then $i.0 == 3bv32 else v5$1);
    v5$2 := (if p1$2 then $i.0 == 3bv32 else v5$2);
