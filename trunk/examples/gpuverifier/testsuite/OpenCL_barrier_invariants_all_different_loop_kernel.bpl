...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $for.cond:
    ...
    assert {:originated_from_invariant} {:sourceloc_num 3} {:thread 1} (if BV32_AND(BV32_AND(BV1_ZEXT32((if group_id_x$1 == group_id_x$2 then 1bv1 else 0bv1)), BV1_ZEXT32((if group_id_y$1 == group_id_y$2 then 1bv1 else 0bv1))), BV1_ZEXT32((if group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1))) != 0bv32 ==> $$foo.A[1bv1][local_id_x$1] != $$foo.A[1bv1][local_id_x$2] then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 3} {:thread 2} (if BV32_AND(BV32_AND(BV1_ZEXT32((if group_id_x$2 == group_id_x$1 then 1bv1 else 0bv1)), BV1_ZEXT32((if group_id_y$2 == group_id_y$1 then 1bv1 else 0bv1))), BV1_ZEXT32((if group_id_z$2 == group_id_z$1 then 1bv1 else 0bv1))) != 0bv32 ==> $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] != $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$1] then 1bv1 else 0bv1) != 0bv1;
    v0 := BV32_SLT($i.0, 100000bv32);
    goto __partitioned_block_$truebb_0, __partitioned_block_$falsebb_0;

  __partitioned_block_$falsebb_0:
    assume {:partition} !v0;
    assert {:barrier_invariant true} {:sourceloc_num 11} {:thread 1} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> true ==> (if $$foo.A[1bv1][local_id_x$1] != $$foo.A[1bv1][local_id_x$2] then 1bv1 else 0bv1) != 0bv1;
  ...
  __partitioned_block_$falsebb_1:
    ...
    v4$1 := $$foo.A[1bv1][local_id_x$2];
    v4$2 := $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$1];
    assert {:sourceloc_num 15} {:thread 1} (if BV32_AND(BV32_AND(BV1_ZEXT32((if group_id_x$1 == group_id_x$2 then 1bv1 else 0bv1)), BV1_ZEXT32((if group_id_y$1 == group_id_y$2 then 1bv1 else 0bv1))), BV1_ZEXT32((if group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1))) != 0bv32 ==> v3$1 != v4$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 15} {:thread 2} (if BV32_AND(BV32_AND(BV1_ZEXT32((if group_id_x$2 == group_id_x$1 then 1bv1 else 0bv1)), BV1_ZEXT32((if group_id_y$2 == group_id_y$1 then 1bv1 else 0bv1))), BV1_ZEXT32((if group_id_z$2 == group_id_z$1 then 1bv1 else 0bv1))) != 0bv32 ==> v3$2 != v4$2 then 1bv1 else 0bv1) != 0bv1;
    return;

  __partitioned_block_$truebb_0:
    assume {:partition} v0;
    assert {:barrier_invariant true} {:sourceloc_num 5} {:thread 1} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> true ==> (if $$foo.A[1bv1][local_id_x$1] != $$foo.A[1bv1][local_id_x$2] then 1bv1 else 0bv1) != 0bv1;
