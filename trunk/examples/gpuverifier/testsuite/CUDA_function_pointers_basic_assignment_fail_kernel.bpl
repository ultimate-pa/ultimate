...
const $functionId$$_Z4foorPfjj: functionPtr;

axiom $functionId$$_Z4foorPfjj == 3bv3;
...
procedure {:source_name "foor"} ULTIMATE.start($size: bv32, $i: bv32);
...
implementation {:source_name "foor"} ULTIMATE.start($size: bv32, $i: bv32)
{
  var $f.1: functionPtr;
  var $f.0: functionPtr;
  var v0$1: bv32;
  ...
  $if.end4:
    v3$1 := BV32_ULT(v0$1, $size);
    v3$2 := BV32_ULT(v0$2, $size);
    p0$1 := (if v3$1 then v3$1 else p0$1);
    p0$2 := (if v3$2 then v3$2 else p0$2);
    p1$1 := (if p0$1 && $f.1 == $functionId$$_Z13multiplyByTwoPfj then $f.1 == $functionId$$_Z13multiplyByTwoPfj else p1$1);
    p1$2 := (if p0$2 && $f.1 == $functionId$$_Z13multiplyByTwoPfj then $f.1 == $functionId$$_Z13multiplyByTwoPfj else p1$2);
    p2$1 := (if p0$1 && $f.1 != $functionId$$_Z13multiplyByTwoPfj then $f.1 != $functionId$$_Z13multiplyByTwoPfj else p2$1);
    p2$2 := (if p0$2 && $f.1 != $functionId$$_Z13multiplyByTwoPfj then $f.1 != $functionId$$_Z13multiplyByTwoPfj else p2$2);
    call v4$1, v4$2 := $_Z13multiplyByTwoPfj(p1$1, 0bv32, v0$1, p1$2, 0bv32, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z13multiplyByTwoPfj"} true;
    p3$1 := (if p2$1 && $f.1 == $functionId$$_Z11divideByTwoPfj then $f.1 == $functionId$$_Z11divideByTwoPfj else p3$1);
    p3$2 := (if p2$2 && $f.1 == $functionId$$_Z11divideByTwoPfj then $f.1 == $functionId$$_Z11divideByTwoPfj else p3$2);
    p4$1 := (if p2$1 && $f.1 != $functionId$$_Z11divideByTwoPfj then $f.1 != $functionId$$_Z11divideByTwoPfj else p4$1);
    p4$2 := (if p2$2 && $f.1 != $functionId$$_Z11divideByTwoPfj then $f.1 != $functionId$$_Z11divideByTwoPfj else p4$2);
    call v4$1, v4$2 := $_Z11divideByTwoPfj(p3$1, 0bv32, v0$1, p3$2, 0bv32, v0$2);
    ...
    call v5$1, v5$2 := $_Z13multiplyByTwoPfj(p0$1, 0bv32, v0$1, p0$2, 0bv32, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z13multiplyByTwoPfj"} true;
    return;
