...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$a, _TRACKING, _WRITE_HAS_OCCURRED_$$a, _WRITE_READ_BENIGN_FLAG_$$a, _WRITE_READ_BENIGN_FLAG_$$a;
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1, _P$1: bool, _P$2: bool)
{
  ...
  anon0:
    assume _P$1 && $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$a;
    assume _P$1 && $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$a;
    assume _P$1 && $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$a;
    goto anon1;
