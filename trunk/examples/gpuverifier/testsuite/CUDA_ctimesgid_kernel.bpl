...
implementation {:source_name "k"} ULTIMATE.start()
{
  ...
  $truebb:
    assume {:partition} v1;
    call _LOG_WRITE_$$A(true, BV32_ADD($i.0, BV32_MUL(v0$1, 256bv32)), v0$1, $$A[BV32_ADD($i.0, BV32_MUL(v0$1, 256bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, BV32_ADD($i.0, BV32_MUL(v0$2, 256bv32)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_WRITE_$$A(true, BV32_ADD($i.0, BV32_MUL(v0$2, 256bv32)), v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV32_ADD($i.0, BV32_MUL(v0$1, 256bv32))] := v0$1;
    $$A[BV32_ADD($i.0, BV32_MUL(v0$2, 256bv32))] := v0$2;
