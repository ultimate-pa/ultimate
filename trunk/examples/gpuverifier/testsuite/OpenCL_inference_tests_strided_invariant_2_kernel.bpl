...
implementation {:source_name "example"} ULTIMATE.start()
{
  ...
  $truebb:
    assume {:partition} v0;
    assert {:sourceloc_num 3} {:thread 1} (if BV32_UREM($i.0, 128bv32) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    $j.0 := 0bv32;
  ...
  $for.cond2:
    ...
    v1 := BV32_ULT($j.0, 65536bv32);
    goto $truebb0, $falsebb0;

  $falsebb0:
    assume {:partition} !v1;
    $i.0 := BV32_ADD($i.0, 128bv32);
    assume {:captureState "loop_back_edge_state_0_0"} true;
    goto $for.cond;

  $truebb0:
    assume {:partition} v1;
    assert {:sourceloc_num 6} {:thread 1} (if BV32_UREM($j.0, 16bv32) == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    $k.0 := 3bv32;
  ...
  $truebb1:
    assume {:partition} v2;
    assert {:sourceloc_num 9} {:thread 1} (if BV32_UREM($k.0, 32bv32) == 3bv32 then 1bv1 else 0bv1) != 0bv1;
    $k.0 := BV32_ADD($k.0, 32bv32);
