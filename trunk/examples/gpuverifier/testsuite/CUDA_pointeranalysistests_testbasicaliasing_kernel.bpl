...
axiom {:array_info "$$b"} {:elem_width 32} {:source_name "b"} {:source_elem_width 32} {:source_dimensions "1"} true;

const $arrayId$$b: arrayId;

axiom $arrayId$$b == 4bv3;

var {:source_name "c"} $$c$1: [bv32]bv32;

var {:source_name "c"} $$c$2: [bv32]bv32;

axiom {:array_info "$$c"} {:elem_width 32} {:source_name "c"} {:source_elem_width 32} {:source_dimensions "1"} true;

const $arrayId$$c: arrayId;

axiom $arrayId$$c == 5bv3;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $falsebb:
    ...
    $d.0, $p.addr.0 := MKPTR($arrayId$$b, 0bv32), MKPTR($arrayId$$q, 0bv32);
    goto $if.end;
  ...
  anon10_Else:
    assume {:partition} base#MKPTR($p.addr.0) != $arrayId$$q;
    goto anon11_Then, anon11_Else;

  anon11_Else:
    assume {:partition} base#MKPTR($p.addr.0) != $arrayId$$p;
  ...
  anon11_Then:
    assume {:partition} base#MKPTR($p.addr.0) == $arrayId$$p;
    call _LOG_WRITE_$$p(true, BV32_ADD(offset#MKPTR($p.addr.0), 100bv32), BV32_ADD(v0$1, 1bv32), $$p[BV32_ADD(offset#MKPTR($p.addr.0), 100bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(true, BV32_ADD(offset#MKPTR($p.addr.0), 100bv32));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 8} true;
    call _CHECK_WRITE_$$p(true, BV32_ADD(offset#MKPTR($p.addr.0), 100bv32), BV32_ADD(v0$2, 1bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[BV32_ADD(offset#MKPTR($p.addr.0), 100bv32)] := BV32_ADD(v0$1, 1bv32);
    $$p[BV32_ADD(offset#MKPTR($p.addr.0), 100bv32)] := BV32_ADD(v0$2, 1bv32);
    goto anon7;

  anon10_Then:
    assume {:partition} base#MKPTR($p.addr.0) == $arrayId$$q;
    call _LOG_WRITE_$$q(true, BV32_ADD(offset#MKPTR($p.addr.0), 100bv32), BV32_ADD(v0$1, 1bv32), $$q[BV32_ADD(offset#MKPTR($p.addr.0), 100bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$q(true, BV32_ADD(offset#MKPTR($p.addr.0), 100bv32));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 7} true;
    call _CHECK_WRITE_$$q(true, BV32_ADD(offset#MKPTR($p.addr.0), 100bv32), BV32_ADD(v0$2, 1bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$q"} true;
    $$q[BV32_ADD(offset#MKPTR($p.addr.0), 100bv32)] := BV32_ADD(v0$1, 1bv32);
    $$q[BV32_ADD(offset#MKPTR($p.addr.0), 100bv32)] := BV32_ADD(v0$2, 1bv32);
    goto anon7;

  anon9_Then:
    assume {:partition} base#MKPTR($d.0) == $arrayId$$c;
    $$c$1[BV32_ADD(offset#MKPTR($d.0), 1bv32)] := 200bv32;
    $$c$2[BV32_ADD(offset#MKPTR($d.0), 1bv32)] := 200bv32;
    goto anon3;

  anon8_Then:
    assume {:partition} base#MKPTR($d.0) == $arrayId$$b;
    $$b$1[BV32_ADD(offset#MKPTR($d.0), 1bv32)] := 200bv32;
    $$b$2[BV32_ADD(offset#MKPTR($d.0), 1bv32)] := 200bv32;
    goto anon3;

  $truebb:
    assume {:partition} false;
    $d.0, $p.addr.0 := MKPTR($arrayId$$c, 0bv32), MKPTR($arrayId$$p, 0bv32);
    goto $if.end;
}
