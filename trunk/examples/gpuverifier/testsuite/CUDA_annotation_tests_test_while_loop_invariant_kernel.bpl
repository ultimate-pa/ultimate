...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $while.cond:
    ...
    assert {:originated_from_invariant} {:sourceloc_num 2} {:thread 1} (if true ==> BV32_OR(BV32_OR(BV32_OR(BV32_OR(BV32_OR(BV32_OR(BV1_ZEXT32((if $d.0 == 1bv32 then 1bv1 else 0bv1)), BV1_ZEXT32((if $d.0 == 2bv32 then 1bv1 else 0bv1))), BV1_ZEXT32((if $d.0 == 4bv32 then 1bv1 else 0bv1))), BV1_ZEXT32((if $d.0 == 8bv32 then 1bv1 else 0bv1))), BV1_ZEXT32((if $d.0 == 16bv32 then 1bv1 else 0bv1))), BV1_ZEXT32((if $d.0 == 32bv32 then 1bv1 else 0bv1))), BV1_ZEXT32((if $d.0 == 64bv32 then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 3} {:thread 1} (if BV32_SGT($d.0, 0bv32) then 1bv1 else 0bv1) != 0bv1;
