...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call _LOG_WRITE_$$a(p0$1, 7bv32, 0bv32, $$a[1bv1][7bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$a(p0$2, 7bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_WRITE_$$a(p0$2, 7bv32, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$a"} true;
    $$a[1bv1][7bv32] := (if p0$1 then 0bv32 else $$a[1bv1][7bv32]);
    $$a[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][7bv32] := (if p0$2 then 0bv32 else $$a[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][7bv32]);
    return;
}
