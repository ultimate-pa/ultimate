...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    v0$1 := group_id_x$1 == 0bv32;
    v0$2 := group_id_x$2 == 0bv32;
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
    ...
    call _LOG_WRITE_$$A(p0$1, local_id_x$1, 1109917696bv32, $$A[local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(p0$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_WRITE_$$A(p0$2, local_id_x$2, 1109917696bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[local_id_x$1] := (if p0$1 then 1109917696bv32 else $$A[local_id_x$1]);
    $$A[local_id_x$2] := (if p0$2 then 1109917696bv32 else $$A[local_id_x$2]);
    return;
}
