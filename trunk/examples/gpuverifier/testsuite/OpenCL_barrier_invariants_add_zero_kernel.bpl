...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$foo.A, _WRITE_HAS_OCCURRED_$$foo.A, _WRITE_READ_BENIGN_FLAG_$$foo.A, _WRITE_READ_BENIGN_FLAG_$$foo.A, _NOT_ACCESSED_$$foo.A, _TRACKING, _READ_HAS_OCCURRED_$$foo.A, _TRACKING;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_0:
    call _LOG_WRITE_$$foo.A(true, local_id_x$1, 0bv32, $$foo.A[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.A(true, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$foo.A(true, local_id_x$2, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.A"} true;
    $$foo.A[1bv1][local_id_x$1] := 0bv32;
    $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := 0bv32;
    assume _NOT_ACCESSED_$$foo.A != local_id_x$1 && _NOT_ACCESSED_$$foo.A != local_id_x$2;
    assert {:barrier_invariant true} {:sourceloc_num 2} {:thread 1} true ==> (if $$foo.A[1bv1][local_id_x$1] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
  ...
  __partitioned_block_$entry_1:
    ...
    assume true ==> BV32_SGE(local_id_x$1, 0bv32) && BV32_SLT(local_id_x$1, group_size_x) ==> (if $$foo.A[1bv1][local_id_x$1] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assume true ==> BV32_SGE(local_id_x$2, 0bv32) && BV32_SLT(local_id_x$2, group_size_x) ==> (if $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assume true ==> BV32_SGE(BV32_ADD(local_id_x$1, 1bv32), 0bv32) && BV32_SLT(BV32_ADD(local_id_x$1, 1bv32), group_size_x) ==> (if $$foo.A[1bv1][BV32_ADD(local_id_x$1, 1bv32)] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assume true ==> BV32_SGE(BV32_ADD(local_id_x$2, 1bv32), 0bv32) && BV32_SLT(BV32_ADD(local_id_x$2, 1bv32), group_size_x) ==> (if $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    ...
    call _LOG_READ_$$foo.A(p0$1, local_id_x$1, $$foo.A[1bv1][local_id_x$1]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_READ_$$foo.A(p0$2, local_id_x$2, $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.A"} true;
    v1$1 := (if p0$1 then $$foo.A[1bv1][local_id_x$1] else v1$1);
    v1$2 := (if p0$2 then $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] else v1$2);
    assume (p0$1 ==> _NOT_ACCESSED_$$foo.A != local_id_x$1) && (p0$2 ==> _NOT_ACCESSED_$$foo.A != local_id_x$2);
    call _LOG_READ_$$foo.A(p0$1, BV32_ADD(local_id_x$1, 1bv32), $$foo.A[1bv1][BV32_ADD(local_id_x$1, 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 6} true;
    call _CHECK_READ_$$foo.A(p0$2, BV32_ADD(local_id_x$2, 1bv32), $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.A"} true;
    v2$1 := (if p0$1 then $$foo.A[1bv1][BV32_ADD(local_id_x$1, 1bv32)] else v2$1);
    v2$2 := (if p0$2 then $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)] else v2$2);
    assume (p0$1 ==> _NOT_ACCESSED_$$foo.A != BV32_ADD(local_id_x$1, 1bv32)) && (p0$2 ==> _NOT_ACCESSED_$$foo.A != BV32_ADD(local_id_x$2, 1bv32));
    call _LOG_WRITE_$$foo.A(p0$1, local_id_x$1, BV32_ADD(v1$1, v2$1), $$foo.A[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.A(p0$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 7} true;
    call _CHECK_WRITE_$$foo.A(p0$2, local_id_x$2, BV32_ADD(v1$2, v2$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.A"} true;
    $$foo.A[1bv1][local_id_x$1] := (if p0$1 then BV32_ADD(v1$1, v2$1) else $$foo.A[1bv1][local_id_x$1]);
    $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p0$2 then BV32_ADD(v1$2, v2$2) else $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    assume (p0$1 ==> _NOT_ACCESSED_$$foo.A != local_id_x$1) && (p0$2 ==> _NOT_ACCESSED_$$foo.A != local_id_x$2);
    call _LOG_READ_$$foo.A(true, local_id_x$1, $$foo.A[1bv1][local_id_x$1]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 9} true;
    call _CHECK_READ_$$foo.A(true, local_id_x$2, $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.A"} true;
    v3$1 := $$foo.A[1bv1][local_id_x$1];
    v3$2 := $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2];
    assume _NOT_ACCESSED_$$foo.A != local_id_x$1 && _NOT_ACCESSED_$$foo.A != local_id_x$2;
    $$__read_permission_temp$0bv32$1 := v3$1;
    $$__read_permission_temp$0bv32$2 := v3$2;
    assert {:barrier_invariant true} {:sourceloc_num 11} {:thread 1} true ==> (if $$foo.A[1bv1][local_id_x$1] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:barrier_invariant_access_check true} {:sourceloc_num 11} {:thread 1} true ==> true ==> _NOT_ACCESSED_$$foo.A != local_id_x$1;
  ...
  __partitioned_block_$entry_2:
    ...
    assume _NOT_ACCESSED_$$foo.A != local_id_x$1 && _NOT_ACCESSED_$$foo.A != local_id_x$2;
    assert {:sourceloc_num 14} {:thread 1} (if v4$1 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 14} {:thread 2} (if v4$2 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    return;
}
