...
procedure {:source_name "add_neighbour"} ULTIMATE.start($offset: bv32);
  requires (if BV32_AND(BV32_AND(BV1_ZEXT32((if BV32_SGE($offset, 0bv32) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV32_UGT($offset, group_size_x) then 1bv1 else 0bv1))), BV1_ZEXT32((if BV32_SLT($offset, 1000000bv32) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "add_neighbour"} ULTIMATE.start($offset: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $entry:
    assume BV1_ZEXT32((if BV32_ULT(local_id_x$1, 10bv32) then 1bv1 else 0bv1)) != 0bv32 && BV1_ZEXT32((if BV32_ULT(local_id_x$2, 10bv32) then 1bv1 else 0bv1)) != 0bv32;
    call _LOG_READ_$$A(true, local_id_x$1, $$A[1bv1][local_id_x$1]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_READ_$$A(true, local_id_x$2, $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    ...
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v1$1 := $$A[1bv1][BV32_ADD(local_id_x$1, $offset)];
    v1$2 := $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, $offset)];
    call _LOG_WRITE_$$A(true, local_id_x$1, BV32_ADD(v0$1, v1$1), $$A[1bv1][local_id_x$1]);
    ...
    call _CHECK_WRITE_$$A(true, local_id_x$2, BV32_ADD(v0$2, v1$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][local_id_x$1] := BV32_ADD(v0$1, v1$1);
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := BV32_ADD(v0$2, v1$2);
    return;
}
