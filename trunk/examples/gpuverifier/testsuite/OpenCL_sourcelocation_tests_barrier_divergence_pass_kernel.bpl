...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$a, $$b, _WRITE_HAS_OCCURRED_$$a, _WRITE_READ_BENIGN_FLAG_$$a, _WRITE_READ_BENIGN_FLAG_$$a, _TRACKING, _WRITE_HAS_OCCURRED_$$b, _WRITE_READ_BENIGN_FLAG_$$b, _WRITE_READ_BENIGN_FLAG_$$b;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_1:
    ...
    call _LOG_WRITE_$$b(true, local_id_x$1, local_id_x$1, $$b[1bv1][local_id_x$1]);
    ...
    call _CHECK_WRITE_$$b(true, local_id_x$2, local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$b"} true;
    $$b[1bv1][local_id_x$1] := local_id_x$1;
    $$b[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := local_id_x$2;
    return;
}
