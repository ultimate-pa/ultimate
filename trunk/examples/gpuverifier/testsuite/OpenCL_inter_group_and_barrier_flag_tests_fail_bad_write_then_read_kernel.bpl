...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_0:
    $$x$0bv32$1 := (if local_id_x$1 == 0bv32 then 0bv32 else 1bv32);
    $$x$0bv32$2 := (if local_id_x$2 == 0bv32 then 0bv32 else 1bv32);
    ...
    call _LOG_WRITE_$$p(p0$1, 0bv32, local_id_x$1, $$p[1bv1][0bv32]);
    ...
    call _CHECK_WRITE_$$p(p0$2, 0bv32, local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][0bv32] := (if p0$1 then local_id_x$1 else $$p[1bv1][0bv32]);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := (if p0$2 then local_id_x$2 else $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    v1$1 := $$x$0bv32$1;
    v1$2 := $$x$0bv32$2;
    v2$1 := $$x$0bv32$1;
    v2$2 := $$x$0bv32$2;
  ...
  __partitioned_block_$entry_1:
    call $bugle_barrier_duplicated_0((if BV32_AND(v1$1, 1bv32) != 0bv32 then 1bv1 else 0bv1), (if BV32_AND(v2$1, 2bv32) != 0bv32 then 1bv1 else 0bv1), (if BV32_AND(v1$2, 1bv32) != 0bv32 then 1bv1 else 0bv1), (if BV32_AND(v2$2, 2bv32) != 0bv32 then 1bv1 else 0bv1));
    v3$1 := local_id_x$1 == 1bv32;
    v3$2 := local_id_x$2 == 1bv32;
    p2$1 := (if v3$1 then v3$1 else p2$1);
    p2$2 := (if v3$2 then v3$2 else p2$2);
    call _LOG_READ_$$p(p2$1, 0bv32, $$p[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 9} true;
    call _CHECK_READ_$$p(p2$2, 0bv32, $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v4$1 := (if p2$1 then $$p[1bv1][0bv32] else v4$1);
    v4$2 := (if p2$2 then $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] else v4$2);
    $$y$0bv32$1 := (if p2$1 then v4$1 else $$y$0bv32$1);
    $$y$0bv32$2 := (if p2$2 then v4$2 else $$y$0bv32$2);
    return;
}
