...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    assert {:sourceloc_num 1} {:thread 1} (if BV32_AND(BV1_ZEXT32((if BV32_ULT(local_id_x$1, group_size_x) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV32_ULT(local_id_x$2, group_size_x) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 1} {:thread 2} (if BV32_AND(BV1_ZEXT32((if BV32_ULT(local_id_x$2, group_size_x) then 1bv1 else 0bv1)), BV1_ZEXT32((if BV32_ULT(local_id_x$1, group_size_x) then 1bv1 else 0bv1))) != 0bv32 then 1bv1 else 0bv1) != 0bv1;
    return;
}
