...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$q, $$p, _TRACKING, _READ_HAS_OCCURRED_$$q, _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _READ_HAS_OCCURRED_$$p, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $for.cond.i19:
    ...
    assert {:originated_from_invariant} {:sourceloc_num 10} {:thread 1} (if _READ_HAS_OCCURRED_$$q ==> BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 11} {:thread 1} (if _WRITE_HAS_OCCURRED_$$q ==> BV32_UDIV(BV32_MUL(4bv32, _WATCHED_OFFSET), 4bv32) == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    v2 := BV32_SLT($i.i5.0, 100bv32);
  ...
  $truebb0:
    ...
    v3$1 := $$q[1bv1][local_id_x$1];
    v3$2 := $$q[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2];
    call _LOG_WRITE_$$q(true, local_id_x$1, FADD32(v3$1, 1065353216bv32), $$q[1bv1][local_id_x$1]);
    ...
    call _CHECK_WRITE_$$q(true, local_id_x$2, FADD32(v3$2, 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$q"} true;
    $$q[1bv1][local_id_x$1] := FADD32(v3$1, 1065353216bv32);
    $$q[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := FADD32(v3$2, 1065353216bv32);
    $i.i5.0 := BV32_ADD($i.i5.0, 1bv32);
    assume {:captureState "loop_back_edge_state_0_0"} true;
    goto $for.cond.i19;

  $truebb:
    assume {:partition} v0;
    call _LOG_READ_$$p(true, local_id_x$1, $$p[1bv1][local_id_x$1]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_READ_$$p(true, local_id_x$2, $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v1$1 := $$p[1bv1][local_id_x$1];
    v1$2 := $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2];
    call _LOG_WRITE_$$p(true, local_id_x$1, FADD32(v1$1, 1065353216bv32), $$p[1bv1][local_id_x$1]);
    ...
    call _CHECK_WRITE_$$p(true, local_id_x$2, FADD32(v1$2, 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][local_id_x$1] := FADD32(v1$1, 1065353216bv32);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := FADD32(v1$2, 1065353216bv32);
