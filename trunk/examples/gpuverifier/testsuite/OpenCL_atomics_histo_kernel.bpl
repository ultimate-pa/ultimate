...
procedure {:source_name "atomic"} ULTIMATE.start();
  ...
  modifies _USED_$$B, _ATOMIC_HAS_OCCURRED_$$B;
...
implementation {:source_name "atomic"} ULTIMATE.start()
{
  ...
  $entry:
    havoc v0$1, v0$2;
    call _LOG_ATOMIC_$$B(true, BV32_SDIV(BV32_MUL(v0$1, 4bv32), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_ATOMIC_$$B(true, BV32_SDIV(BV32_MUL(v0$2, 4bv32), 4bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_ATOMIC_$$B"} true;
    havoc v1$1, v1$2;
    assume !_USED_$$B[BV32_SDIV(BV32_MUL(v0$1, 4bv32), 4bv32)][v1$1];
    _USED_$$B[BV32_SDIV(BV32_MUL(v0$1, 4bv32), 4bv32)][v1$1] := true;
    assume !_USED_$$B[BV32_SDIV(BV32_MUL(v0$2, 4bv32), 4bv32)][v1$2];
    _USED_$$B[BV32_SDIV(BV32_MUL(v0$2, 4bv32), 4bv32)][v1$2] := true;
    return;
}
