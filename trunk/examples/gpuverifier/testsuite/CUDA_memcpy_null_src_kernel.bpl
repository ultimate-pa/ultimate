...
axiom {:array_info "$$in"} {:global} {:elem_width 16} {:source_name "in"} {:source_elem_width 32} {:source_dimensions "*"} true;

var {:race_checking} {:global} {:elem_width 16} {:source_elem_width 32} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$in: bool;

var {:race_checking} {:global} {:elem_width 16} {:source_elem_width 32} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$in: bool;

var {:race_checking} {:global} {:elem_width 16} {:source_elem_width 32} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$in: bool;

axiom {:array_info "$$out"} {:global} {:elem_width 16} {:source_name "out"} {:source_elem_width 32} {:source_dimensions "*"} true;

var {:race_checking} {:global} {:elem_width 16} {:source_elem_width 32} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$out: bool;

var {:race_checking} {:global} {:elem_width 16} {:source_elem_width 32} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$out: bool;

var {:race_checking} {:global} {:elem_width 16} {:source_elem_width 32} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$out: bool;
...
const _WATCHED_VALUE_$$in: bv16;

procedure {:inline 1} _LOG_READ_$$in(_P: bool, _offset: bv32, _value: bv16);
  modifies _READ_HAS_OCCURRED_$$in;

implementation {:inline 1} _LOG_READ_$$in(_P: bool, _offset: bv32, _value: bv16)
{
...
procedure _CHECK_READ_$$in(_P: bool, _offset: bv32, _value: bv16);
...
procedure {:inline 1} _LOG_WRITE_$$in(_P: bool, _offset: bv32, _value: bv16, _value_old: bv16);
  modifies _WRITE_HAS_OCCURRED_$$in, _WRITE_READ_BENIGN_FLAG_$$in;

implementation {:inline 1} _LOG_WRITE_$$in(_P: bool, _offset: bv32, _value: bv16, _value_old: bv16)
{
...
procedure _CHECK_WRITE_$$in(_P: bool, _offset: bv32, _value: bv16);
...
const _WATCHED_VALUE_$$out: bv16;

procedure {:inline 1} _LOG_READ_$$out(_P: bool, _offset: bv32, _value: bv16);
  modifies _READ_HAS_OCCURRED_$$out;

implementation {:inline 1} _LOG_READ_$$out(_P: bool, _offset: bv32, _value: bv16)
{
...
procedure _CHECK_READ_$$out(_P: bool, _offset: bv32, _value: bv16);
...
procedure {:inline 1} _LOG_WRITE_$$out(_P: bool, _offset: bv32, _value: bv16, _value_old: bv16);
  modifies _WRITE_HAS_OCCURRED_$$out, _WRITE_READ_BENIGN_FLAG_$$out;

implementation {:inline 1} _LOG_WRITE_$$out(_P: bool, _offset: bv32, _value: bv16, _value_old: bv16)
{
...
procedure _CHECK_WRITE_$$out(_P: bool, _offset: bv32, _value: bv16);
