...
procedure {:source_name "atomic"} ULTIMATE.start();
  ...
  modifies _USED_$$A, _READ_HAS_OCCURRED_$$A, _ATOMIC_HAS_OCCURRED_$$A;

implementation {:source_name "atomic"} ULTIMATE.start()
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $entry:
    ...
    call _LOG_READ_$$A(true, local_id_x$1, _abstracted_call_arg_0$1);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    havoc _abstracted_call_arg_1$1, _abstracted_call_arg_1$2;
    call _CHECK_READ_$$A(true, local_id_x$2, _abstracted_call_arg_1$2);
    ...
    havoc v1$1, v1$2;
    assume !_USED_$$A[0bv32][v1$1];
    _USED_$$A[0bv32][v1$1] := true;
    assume !_USED_$$A[0bv32][v1$2];
    _USED_$$A[0bv32][v1$2] := true;
    return;
}
