...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    $cond$1 := (if p0$1 then BV32_MUL(2bv32, local_id_x$1) else $cond$1);
    $cond$2 := (if p0$2 then BV32_MUL(2bv32, local_id_x$2) else $cond$2);
    $cond$1 := (if p1$1 then 1bv32 else $cond$1);
    $cond$2 := (if p1$2 then 1bv32 else $cond$2);
    call _LOG_WRITE_$$A(true, $cond$1, 1075419546bv32, $$A[1bv1][$cond$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, $cond$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_WRITE_$$A(true, $cond$2, 1075419546bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][$cond$1] := 1075419546bv32;
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][$cond$2] := 1075419546bv32;
    return;
}
