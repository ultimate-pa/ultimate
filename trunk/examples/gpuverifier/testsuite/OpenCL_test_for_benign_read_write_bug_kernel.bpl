...
var {:source_name "p"} {:group_shared} $$p: [bv1][bv32]bv16;

axiom {:array_info "$$p"} {:group_shared} {:elem_width 16} {:source_name "p"} {:source_elem_width 16} {:source_dimensions "*"} true;

var {:race_checking} {:group_shared} {:elem_width 16} {:source_elem_width 16} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$p: bool;

var {:race_checking} {:group_shared} {:elem_width 16} {:source_elem_width 16} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$p: bool;

var {:race_checking} {:group_shared} {:elem_width 16} {:source_elem_width 16} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$p: bool;
...
function {:builtin "bvadd"} BV16_ADD(bv16, bv16) : bv16;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    v0$1 := $$p[1bv1][0bv32];
    v0$2 := $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32];
    call _LOG_WRITE_$$p(true, 0bv32, BV16_ADD(v0$1, 1bv16), $$p[1bv1][0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_WRITE_$$p(true, 0bv32, BV16_ADD(v0$2, 1bv16));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][0bv32] := BV16_ADD(v0$1, 1bv16);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := BV16_ADD(v0$2, 1bv16);
    return;
}
...
const _WATCHED_VALUE_$$p: bv16;

procedure {:inline 1} _LOG_READ_$$p(_P: bool, _offset: bv32, _value: bv16);
  modifies _READ_HAS_OCCURRED_$$p;

implementation {:inline 1} _LOG_READ_$$p(_P: bool, _offset: bv32, _value: bv16)
{
...
procedure _CHECK_READ_$$p(_P: bool, _offset: bv32, _value: bv16);
...
procedure {:inline 1} _LOG_WRITE_$$p(_P: bool, _offset: bv32, _value: bv16, _value_old: bv16);
  modifies _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p;

implementation {:inline 1} _LOG_WRITE_$$p(_P: bool, _offset: bv32, _value: bv16, _value_old: bv16)
{
...
procedure _CHECK_WRITE_$$p(_P: bool, _offset: bv32, _value: bv16);
