...
procedure {:source_name "inline_test"} ULTIMATE.start($offset: bv32);
  requires (if BV32_SGE($offset, 0bv32) then 1bv1 else 0bv1) != 0bv1;
  requires (if BV32_SLT($offset, 8388608bv32) then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "inline_test"} ULTIMATE.start($offset: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $entry:
    call _LOG_READ_$$A(true, BV32_ADD(local_id_x$1, $offset), $$A[1bv1][BV32_ADD(local_id_x$1, $offset)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_READ_$$A(true, BV32_ADD(local_id_x$2, $offset), $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, $offset)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v0$1 := $$A[1bv1][BV32_ADD(local_id_x$1, $offset)];
    v0$2 := $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, $offset)];
    v1$1 := local_id_x$1;
    v1$2 := local_id_x$2;
    call _LOG_READ_$$A(true, v1$1, $$A[1bv1][v1$1]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_READ_$$A(true, v1$2, $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v1$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v2$1 := $$A[1bv1][v1$1];
    v2$2 := $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v1$2];
    call _LOG_WRITE_$$A(true, v1$1, BV32_ADD(v2$1, v0$1), $$A[1bv1][v1$1]);
    ...
    call _CHECK_WRITE_$$A(true, v1$2, BV32_ADD(v2$2, v0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[1bv1][v1$1] := BV32_ADD(v2$1, v0$1);
    $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v1$2] := BV32_ADD(v2$2, v0$2);
    return;
}
