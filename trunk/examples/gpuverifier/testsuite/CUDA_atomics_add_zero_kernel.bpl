...
axiom {:array_info "$$i"} {:global} {:elem_width 32} {:source_name "i"} {:source_elem_width 32} {:source_dimensions "*"} true;

var {:race_checking} {:global} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$i: bool;

var {:race_checking} {:global} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$i: bool;

var {:race_checking} {:global} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$i: bool;
...
procedure {:source_name "race_test"} ULTIMATE.start();
  ...
  modifies _ATOMIC_HAS_OCCURRED_$$i, _WRITE_HAS_OCCURRED_$$A, _WRITE_READ_BENIGN_FLAG_$$A, _WRITE_READ_BENIGN_FLAG_$$A;

implementation {:source_name "race_test"} ULTIMATE.start()
{
  var v0$1: bv32;
  var v0$2: bv32;
  ...
  $entry:
    ...
    havoc v0$1, v0$2;
    call _LOG_WRITE_$$A(true, v0$1, local_id_x$1, $$A[v0$1]);
    ...
    call _CHECK_WRITE_$$A(true, v0$2, local_id_x$2);
...
const _WATCHED_VALUE_$$i: bv32;

procedure {:inline 1} _LOG_READ_$$i(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$i;

implementation {:inline 1} _LOG_READ_$$i(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$i(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$i(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$i, _WRITE_READ_BENIGN_FLAG_$$i;

implementation {:inline 1} _LOG_WRITE_$$i(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$i(_P: bool, _offset: bv32, _value: bv32);
