...
procedure {:source_name "multiplyByTwo"} $_Z13multiplyByTwoPf7wrapped($v: ptr, $tw: ptr) returns ($ret: bv32);
...
implementation {:source_name "multiplyByTwo"} $_Z13multiplyByTwoPf7wrapped($v: ptr, $tw: ptr) returns ($ret: bv32)
{
...
procedure {:source_name "divideByTwo"} $_Z11divideByTwoPf7wrapped($v: ptr, $tw: ptr) returns ($ret: bv32);
  requires BV32_SGT(group_size_x, 0bv32);
  requires BV32_SGT(num_groups_x, 0bv32);
  requires BV32_SGE(group_id_x$1, 0bv32);
  requires BV32_SGE(group_id_x$2, 0bv32);
...
implementation {:source_name "divideByTwo"} $_Z11divideByTwoPf7wrapped($v: ptr, $tw: ptr) returns ($ret: bv32)
{
