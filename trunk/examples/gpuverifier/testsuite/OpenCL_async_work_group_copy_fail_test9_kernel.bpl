...
procedure {:wait_group_events} _WAIT_GROUP_EVENTS(_P$1: bool, handle$1: bv32, _P$2: bool, handle$2: bv32);
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    v3$1 := BV32_UGT(local_id_x$1, 13bv32);
    v3$2 := BV32_UGT(local_id_x$2, 13bv32);
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
    ...
    v4$1 := (if p0$1 then $$joint_handle$0bv32$1 else v4$1);
    v4$2 := (if p0$2 then $$joint_handle$0bv32$2 else v4$2);
    assert {:sourceloc_num 7} {:thread 1} p0$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p0$1 == p0$2;
    assert {:sourceloc_num 7} {:thread 2} p0$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p0$2 == p0$1;
    assert {:sourceloc_num 7} {:thread 1} p0$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> v4$1 == v4$2;
    assert {:sourceloc_num 7} {:thread 2} p0$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> v4$2 == v4$1;
    _READ_ASYNC_HANDLE_$$p := (if p0$1 then (if v4$1 == _READ_ASYNC_HANDLE_$$p then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$p) else _READ_ASYNC_HANDLE_$$p);
    _READ_ASYNC_HANDLE_$$p := (if p0$2 then (if v4$2 == _READ_ASYNC_HANDLE_$$p then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$p) else _READ_ASYNC_HANDLE_$$p);
    _READ_ASYNC_HANDLE_$$q := (if p0$1 then (if v4$1 == _READ_ASYNC_HANDLE_$$q then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$q) else _READ_ASYNC_HANDLE_$$q);
    _READ_ASYNC_HANDLE_$$q := (if p0$2 then (if v4$2 == _READ_ASYNC_HANDLE_$$q then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$q) else _READ_ASYNC_HANDLE_$$q);
    _WRITE_ASYNC_HANDLE_$$foo.my_p := (if p0$1 then (if v4$1 == _WRITE_ASYNC_HANDLE_$$foo.my_p then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$foo.my_p) else _WRITE_ASYNC_HANDLE_$$foo.my_p);
    _WRITE_ASYNC_HANDLE_$$foo.my_p := (if p0$2 then (if v4$2 == _WRITE_ASYNC_HANDLE_$$foo.my_p then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$foo.my_p) else _WRITE_ASYNC_HANDLE_$$foo.my_p);
    _WRITE_ASYNC_HANDLE_$$foo.my_q := (if p0$1 then (if v4$1 == _WRITE_ASYNC_HANDLE_$$foo.my_q then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$foo.my_q) else _WRITE_ASYNC_HANDLE_$$foo.my_q);
    _WRITE_ASYNC_HANDLE_$$foo.my_q := (if p0$2 then (if v4$2 == _WRITE_ASYNC_HANDLE_$$foo.my_q then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$foo.my_q) else _WRITE_ASYNC_HANDLE_$$foo.my_q);
    return;
}
