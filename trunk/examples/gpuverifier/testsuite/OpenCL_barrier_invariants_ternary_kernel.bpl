...
procedure {:source_name "wrap_around"} ULTIMATE.start();
  ...
  modifies $$wrap_around.A, $$wrap_around.B, _WRITE_HAS_OCCURRED_$$wrap_around.A, _WRITE_READ_BENIGN_FLAG_$$wrap_around.A, _WRITE_READ_BENIGN_FLAG_$$wrap_around.A, _NOT_ACCESSED_$$wrap_around.A, _NOT_ACCESSED_$$wrap_around.B, _TRACKING, _READ_HAS_OCCURRED_$$wrap_around.A, _WRITE_HAS_OCCURRED_$$wrap_around.B, _WRITE_READ_BENIGN_FLAG_$$wrap_around.B, _WRITE_READ_BENIGN_FLAG_$$wrap_around.B, _TRACKING, _READ_HAS_OCCURRED_$$wrap_around.B;
...
implementation {:source_name "wrap_around"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_0:
    ...
    $cond$1 := (if p0$1 then BV32_UREM(BV32_ADD(local_id_x$1, 2bv32), 8bv32) else $cond$1);
    $cond$2 := (if p0$2 then BV32_UREM(BV32_ADD(local_id_x$2, 2bv32), 8bv32) else $cond$2);
    $cond$1 := (if p1$1 then local_id_x$1 else $cond$1);
    $cond$2 := (if p1$2 then local_id_x$2 else $cond$2);
    call _LOG_WRITE_$$wrap_around.A(true, local_id_x$1, $cond$1, $$wrap_around.A[1bv1][local_id_x$1]);
    ...
    call _CHECK_WRITE_$$wrap_around.A(true, local_id_x$2, $cond$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$wrap_around.A"} true;
    $$wrap_around.A[1bv1][local_id_x$1] := $cond$1;
    $$wrap_around.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := $cond$2;
    assume _NOT_ACCESSED_$$wrap_around.A != local_id_x$1 && _NOT_ACCESSED_$$wrap_around.A != local_id_x$2;
    assert {:barrier_invariant true} {:sourceloc_num 5} {:thread 1} true ==> (if $$wrap_around.A[1bv1][local_id_x$1] == (if BV32_UREM(local_id_x$1, 2bv32) == 0bv32 then BV32_UREM(BV32_ADD(local_id_x$1, 2bv32), 8bv32) else local_id_x$1) then 1bv1 else 0bv1) != 0bv1;
    assert {:barrier_invariant_access_check true} {:sourceloc_num 5} {:thread 1} true ==> true ==> _NOT_ACCESSED_$$wrap_around.A != local_id_x$1;
    goto __partitioned_block_$entry_1;

  __partitioned_block_$entry_1:
    call $bugle_barrier_duplicated_0(1bv1, 0bv1);
    assume true ==> BV32_SGE(local_id_x$1, 0bv32) && BV32_SLT(local_id_x$1, group_size_x) ==> (if $$wrap_around.A[1bv1][local_id_x$1] == (if BV32_UREM(local_id_x$1, 2bv32) == 0bv32 then BV32_UREM(BV32_ADD(local_id_x$1, 2bv32), 8bv32) else local_id_x$1) then 1bv1 else 0bv1) != 0bv1;
    assume true ==> BV32_SGE(local_id_x$2, 0bv32) && BV32_SLT(local_id_x$2, group_size_x) ==> (if $$wrap_around.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] == (if BV32_UREM(local_id_x$2, 2bv32) == 0bv32 then BV32_UREM(BV32_ADD(local_id_x$2, 2bv32), 8bv32) else local_id_x$2) then 1bv1 else 0bv1) != 0bv1;
    assume true ==> BV32_SGE(BV32_UREM(BV32_ADD(local_id_x$1, 1bv32), 8bv32), 0bv32) && BV32_SLT(BV32_UREM(BV32_ADD(local_id_x$1, 1bv32), 8bv32), group_size_x) ==> (if $$wrap_around.A[1bv1][BV32_UREM(BV32_ADD(local_id_x$1, 1bv32), 8bv32)] == (if BV32_UREM(BV32_UREM(BV32_ADD(local_id_x$1, 1bv32), 8bv32), 2bv32) == 0bv32 then BV32_UREM(BV32_ADD(BV32_UREM(BV32_ADD(local_id_x$1, 1bv32), 8bv32), 2bv32), 8bv32) else BV32_UREM(BV32_ADD(local_id_x$1, 1bv32), 8bv32)) then 1bv1 else 0bv1) != 0bv1;
    assume true ==> BV32_SGE(BV32_UREM(BV32_ADD(local_id_x$2, 1bv32), 8bv32), 0bv32) && BV32_SLT(BV32_UREM(BV32_ADD(local_id_x$2, 1bv32), 8bv32), group_size_x) ==> (if $$wrap_around.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_UREM(BV32_ADD(local_id_x$2, 1bv32), 8bv32)] == (if BV32_UREM(BV32_UREM(BV32_ADD(local_id_x$2, 1bv32), 8bv32), 2bv32) == 0bv32 then BV32_UREM(BV32_ADD(BV32_UREM(BV32_ADD(local_id_x$2, 1bv32), 8bv32), 2bv32), 8bv32) else BV32_UREM(BV32_ADD(local_id_x$2, 1bv32), 8bv32)) then 1bv1 else 0bv1) != 0bv1;
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 7} true;
    v1$1 := $$wrap_around.A[1bv1][BV32_UREM(BV32_ADD(local_id_x$1, 1bv32), 8bv32)];
    v1$2 := $$wrap_around.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_UREM(BV32_ADD(local_id_x$2, 1bv32), 8bv32)];
    ...
    call _LOG_WRITE_$$wrap_around.B(true, v1$1, local_id_x$1, $$wrap_around.B[1bv1][v1$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$wrap_around.B(true, v1$2);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 8} true;
    call _CHECK_WRITE_$$wrap_around.B(true, v1$2, local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$wrap_around.B"} true;
    $$wrap_around.B[1bv1][v1$1] := local_id_x$1;
    $$wrap_around.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v1$2] := local_id_x$2;
    assume _NOT_ACCESSED_$$wrap_around.B != v1$1 && _NOT_ACCESSED_$$wrap_around.B != v1$2;
    assert {:barrier_invariant true} {:sourceloc_num 9} {:thread 1} true ==> (if $$wrap_around.B[1bv1][BV32_UREM(BV32_ADD(local_id_x$1, (if BV32_UREM(local_id_x$1, 2bv32) == 0bv32 then 1bv32 else 3bv32)), 8bv32)] == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:barrier_invariant_access_check true} {:sourceloc_num 9} {:thread 1} true ==> true ==> _NOT_ACCESSED_$$wrap_around.B != BV32_UREM(BV32_ADD(local_id_x$1, (if BV32_UREM(local_id_x$1, 2bv32) == 0bv32 then 1bv32 else 3bv32)), 8bv32);
    goto __partitioned_block_$entry_2;

  __partitioned_block_$entry_2:
    call $bugle_barrier_duplicated_1(1bv1, 0bv1);
    assume true ==> BV32_SGE(local_id_x$1, 0bv32) && BV32_SLT(local_id_x$1, group_size_x) ==> (if $$wrap_around.B[1bv1][BV32_UREM(BV32_ADD(local_id_x$1, (if BV32_UREM(local_id_x$1, 2bv32) == 0bv32 then 1bv32 else 3bv32)), 8bv32)] == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    assume true ==> BV32_SGE(local_id_x$2, 0bv32) && BV32_SLT(local_id_x$2, group_size_x) ==> (if $$wrap_around.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_UREM(BV32_ADD(local_id_x$2, (if BV32_UREM(local_id_x$2, 2bv32) == 0bv32 then 1bv32 else 3bv32)), 8bv32)] == local_id_x$2 then 1bv1 else 0bv1) != 0bv1;
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 11} true;
    v2$1 := $$wrap_around.B[1bv1][BV32_UREM(BV32_ADD(local_id_x$1, (if BV32_UREM(local_id_x$1, 2bv32) == 0bv32 then 1bv32 else 3bv32)), 8bv32)];
    v2$2 := $$wrap_around.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_UREM(BV32_ADD(local_id_x$2, (if BV32_UREM(local_id_x$2, 2bv32) == 0bv32 then 1bv32 else 3bv32)), 8bv32)];
    assume _NOT_ACCESSED_$$wrap_around.B != BV32_UREM(BV32_ADD(local_id_x$1, (if BV32_UREM(local_id_x$1, 2bv32) == 0bv32 then 1bv32 else 3bv32)), 8bv32) && _NOT_ACCESSED_$$wrap_around.B != BV32_UREM(BV32_ADD(local_id_x$2, (if BV32_UREM(local_id_x$2, 2bv32) == 0bv32 then 1bv32 else 3bv32)), 8bv32);
    assert {:sourceloc_num 12} {:thread 1} (if v2$1 == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 12} {:thread 2} (if v2$2 == local_id_x$2 then 1bv1 else 0bv1) != 0bv1;
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 13} true;
    v3$1 := $$wrap_around.B[1bv1][BV32_UREM(BV32_ADD(local_id_x$1, 1bv32), 8bv32)];
    v3$2 := $$wrap_around.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_UREM(BV32_ADD(local_id_x$2, 1bv32), 8bv32)];
    ...
    assert {:sourceloc_num 14} {:thread 1} (if BV32_UREM(local_id_x$1, 2bv32) == 0bv32 ==> v3$1 == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 14} {:thread 2} (if BV32_UREM(local_id_x$2, 2bv32) == 0bv32 ==> v3$2 == local_id_x$2 then 1bv1 else 0bv1) != 0bv1;
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 15} true;
    v4$1 := $$wrap_around.B[1bv1][BV32_UREM(BV32_ADD(local_id_x$1, 3bv32), 8bv32)];
    v4$2 := $$wrap_around.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_UREM(BV32_ADD(local_id_x$2, 3bv32), 8bv32)];
    assume _NOT_ACCESSED_$$wrap_around.B != BV32_UREM(BV32_ADD(local_id_x$1, 3bv32), 8bv32) && _NOT_ACCESSED_$$wrap_around.B != BV32_UREM(BV32_ADD(local_id_x$2, 3bv32), 8bv32);
    assert {:sourceloc_num 16} {:thread 1} (if BV1_XOR((if BV32_UREM(local_id_x$1, 2bv32) == 0bv32 then 1bv1 else 0bv1), 1bv1) == 1bv1 ==> v4$1 == local_id_x$1 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 16} {:thread 2} (if BV1_XOR((if BV32_UREM(local_id_x$2, 2bv32) == 0bv32 then 1bv1 else 0bv1), 1bv1) == 1bv1 ==> v4$2 == local_id_x$2 then 1bv1 else 0bv1) != 0bv1;
    return;
}
