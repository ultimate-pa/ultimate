...
implementation {:source_name "bar"} $bar() returns ($ret$1: bv32, $ret$2: bv32)
{
  ...
  $entry:
    $ret$1 := BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1);
    $ret$2 := BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2);
    return;
}
...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  requires BV32_SLT(local_id_z$2, group_size_z);
  requires group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> local_id_x$1 != local_id_x$2 || local_id_y$1 != local_id_y$2 || local_id_z$1 != local_id_z$2;
  modifies _READ_HAS_OCCURRED_$$B, _WRITE_HAS_OCCURRED_$$A, _WRITE_READ_BENIGN_FLAG_$$A, _WRITE_READ_BENIGN_FLAG_$$A, _WRITE_HAS_OCCURRED_$$B, _WRITE_READ_BENIGN_FLAG_$$B, _WRITE_READ_BENIGN_FLAG_$$B;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    v2$1 := BV32_ADD(BV32_MUL(v1$1, BV32_MUL(group_size_x, num_groups_x)), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    v2$2 := BV32_ADD(BV32_MUL(v1$2, BV32_MUL(group_size_x, num_groups_x)), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    $i.0 := 0bv32;
  ...
  $truebb:
    assume {:partition} v3;
    call _LOG_READ_$$B(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), BV32_MUL(group_size_x, num_groups_x)), v0$1), $$B[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), BV32_MUL(group_size_x, num_groups_x)), v0$1)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_READ_$$B(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), BV32_MUL(group_size_x, num_groups_x)), v0$2), $$B[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), BV32_MUL(group_size_x, num_groups_x)), v0$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$B"} true;
    v4$1 := $$B[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), BV32_MUL(group_size_x, num_groups_x)), v0$1)];
    v4$2 := $$B[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), BV32_MUL(group_size_x, num_groups_x)), v0$2)];
    call _LOG_WRITE_$$A(true, BV32_ADD(BV32_MUL(v1$1, BV32_MUL(group_size_x, num_groups_x)), v0$1), BV32_ADD(v4$1, 2bv32), $$A[BV32_ADD(BV32_MUL(v1$1, BV32_MUL(group_size_x, num_groups_x)), v0$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, BV32_ADD(BV32_MUL(v1$2, BV32_MUL(group_size_x, num_groups_x)), v0$2));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 6} true;
    call _CHECK_WRITE_$$A(true, BV32_ADD(BV32_MUL(v1$2, BV32_MUL(group_size_x, num_groups_x)), v0$2), BV32_ADD(v4$2, 2bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV32_ADD(BV32_MUL(v1$1, BV32_MUL(group_size_x, num_groups_x)), v0$1)] := BV32_ADD(v4$1, 2bv32);
    $$A[BV32_ADD(BV32_MUL(v1$2, BV32_MUL(group_size_x, num_groups_x)), v0$2)] := BV32_ADD(v4$2, 2bv32);
    call _LOG_READ_$$B(true, v2$1, $$B[v2$1]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 7} true;
    call _CHECK_READ_$$B(true, v2$2, $$B[v2$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$B"} true;
    v5$1 := $$B[v2$1];
    v5$2 := $$B[v2$2];
    call _LOG_WRITE_$$B(true, v2$1, BV32_ADD(v5$1, 1bv32), $$B[v2$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$B(true, v2$2);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 8} true;
    call _CHECK_WRITE_$$B(true, v2$2, BV32_ADD(v5$2, 1bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$B"} true;
    $$B[v2$1] := BV32_ADD(v5$1, 1bv32);
    $$B[v2$2] := BV32_ADD(v5$2, 1bv32);
