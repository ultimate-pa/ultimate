...
implementation {:source_name "test"} ULTIMATE.start()
{
  ...
  $entry:
    call _LOG_WRITE_$$A(true, 0bv32, FCOS32(UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))), $$A[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$A(true, 0bv32, FCOS32(UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[0bv32] := FCOS32(UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)));
    $$A[0bv32] := FCOS32(UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    return;
}
