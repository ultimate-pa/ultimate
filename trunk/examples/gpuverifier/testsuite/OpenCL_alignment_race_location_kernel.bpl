...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call _LOG_WRITE_$$n(true, 800bv32, v0$1, $$n[800bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$n(true, 800bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$n(true, 800bv32, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$n"} true;
    $$n[800bv32] := v0$1;
    $$n[800bv32] := v0$2;
    call _LOG_WRITE_$$n(true, 801bv32, v0$1, $$n[801bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$n(true, 801bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_WRITE_$$n(true, 801bv32, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$n"} true;
    $$n[801bv32] := v0$1;
    $$n[801bv32] := v0$2;
    call _LOG_WRITE_$$n(true, 802bv32, v0$1, $$n[802bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$n(true, 802bv32);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_WRITE_$$n(true, 802bv32, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$n"} true;
    $$n[802bv32] := v0$1;
    $$n[802bv32] := v0$2;
    call _LOG_WRITE_$$n(true, 803bv32, 0bv32, $$n[803bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$n(true, 803bv32);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_WRITE_$$n(true, 803bv32, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$n"} true;
    $$n[803bv32] := 0bv32;
    return;
}
