...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$p, $$r, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_HAS_OCCURRED_$$r, _WRITE_READ_BENIGN_FLAG_$$r, _WRITE_READ_BENIGN_FLAG_$$r;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    havoc v1$1, v1$2;
    call _LOG_WRITE_$$r(true, local_id_x$1, v1$1, $$r[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$r(true, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_WRITE_$$r(true, local_id_x$2, v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$r"} true;
    $$r[1bv1][local_id_x$1] := v1$1;
    $$r[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := v1$2;
    return;
}
