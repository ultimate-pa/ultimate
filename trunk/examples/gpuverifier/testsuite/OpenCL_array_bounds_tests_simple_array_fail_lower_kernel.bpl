...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    _ARRAY_OFFSET_$$foo.L := BV32_SUB(0bv32, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    _ARRAY_OFFSET_$$foo.L := BV32_SUB(0bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    ...
    call _LOG_WRITE_$$foo.L(true, BV32_SUB(0bv32, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), BV32_MUL(group_size_x, num_groups_x), $$foo.L[1bv1][BV32_SUB(0bv32, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.L(true, BV32_SUB(0bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$foo.L(true, BV32_SUB(0bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), BV32_MUL(group_size_x, num_groups_x));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.L"} true;
    $$foo.L[1bv1][BV32_SUB(0bv32, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))] := BV32_MUL(group_size_x, num_groups_x);
    $$foo.L[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_SUB(0bv32, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2))] := BV32_MUL(group_size_x, num_groups_x);
    return;
}
