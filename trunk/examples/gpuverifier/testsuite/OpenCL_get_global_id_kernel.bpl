...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call _LOG_WRITE_$$A(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), FADD32(v0$1, 1065353216bv32), $$A[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    ...
    call _CHECK_WRITE_$$A(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), FADD32(v0$2, 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := FADD32(v0$1, 1065353216bv32);
    $$A[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := FADD32(v0$2, 1065353216bv32);
    return;
}
