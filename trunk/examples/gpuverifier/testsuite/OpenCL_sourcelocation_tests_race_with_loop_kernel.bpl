...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$p, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _READ_HAS_OCCURRED_$$p;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $falsebb:
    assume {:partition} !v0;
    call _LOG_WRITE_$$p(true, local_id_x$1, $x.0$1, $$p[1bv1][local_id_x$1]);
    ...
    call _CHECK_WRITE_$$p(true, local_id_x$2, $x.0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][local_id_x$1] := $x.0$1;
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := $x.0$2;
    return;

  $truebb:
    assume {:partition} v0;
    call _LOG_READ_$$p(true, $i.0, $$p[1bv1][$i.0]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_READ_$$p(true, $i.0, $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][$i.0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v1$1 := $$p[1bv1][$i.0];
    v1$2 := $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][$i.0];
    call _LOG_READ_$$p(true, BV32_ADD($i.0, 1bv32), $$p[1bv1][BV32_ADD($i.0, 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_READ_$$p(true, BV32_ADD($i.0, 1bv32), $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD($i.0, 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v2$1 := $$p[1bv1][BV32_ADD($i.0, 1bv32)];
    v2$2 := $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD($i.0, 1bv32)];
    $x.0$1, $i.0 := BV32_ADD(BV32_ADD($x.0$1, v1$1), v2$1), BV32_ADD($i.0, 1bv32);
    $x.0$2 := BV32_ADD(BV32_ADD($x.0$2, v1$2), v2$2);
