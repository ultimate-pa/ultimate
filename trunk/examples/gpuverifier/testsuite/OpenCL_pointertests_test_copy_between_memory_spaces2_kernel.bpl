...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$B, _READ_HAS_OCCURRED_$$B, _TRACKING, _WRITE_HAS_OCCURRED_$$B, _WRITE_READ_BENIGN_FLAG_$$B, _WRITE_READ_BENIGN_FLAG_$$B;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_0:
    ...
    v0$1 := $$B[1bv1][0bv32];
    v0$2 := $$B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32];
    v1$1 := $$A[0bv32];
    v1$2 := $$A[0bv32];
    v2$1 := FLT32(v0$1, v1$1);
    v2$2 := FLT32(v0$2, v1$2);
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
  ...
  __partitioned_block_$entry_1:
    ...
    v3$1 := $$A[0bv32];
    v3$2 := $$A[0bv32];
    v4$1 := FLT32(0bv32, v3$1);
    v4$2 := FLT32(0bv32, v3$2);
    p2$1 := (if v4$1 then v4$1 else p2$1);
    p2$2 := (if v4$2 then v4$2 else p2$2);
    v5$1 := (if p2$1 then $$A[0bv32] else v5$1);
    v5$2 := (if p2$2 then $$A[0bv32] else v5$2);
    call _LOG_WRITE_$$B(p2$1, 0bv32, v5$1, $$B[1bv1][0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$B(p2$2, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 9} true;
    call _CHECK_WRITE_$$B(p2$2, 0bv32, v5$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$B"} true;
    $$B[1bv1][0bv32] := (if p2$1 then v5$1 else $$B[1bv1][0bv32]);
    $$B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := (if p2$2 then v5$2 else $$B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    return;
}
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$B;
    assume $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$B;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$B;
    goto anon1;
