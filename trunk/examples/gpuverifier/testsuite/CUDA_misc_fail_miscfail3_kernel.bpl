...
implementation {:source_name "inline_test"} ULTIMATE.start($offset: bv32)
{
  ...
  $entry:
    call $_Z7inlinedPii(0bv32, $offset);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z7inlinedPii"} true;
    return;
}

procedure {:source_name "inlined"} $_Z7inlinedPii($A: bv32, $offset: bv32);
  requires $A == 0bv32;
  requires BV32_SGT(group_size_x, 0bv32);
  requires BV32_SGT(num_groups_x, 0bv32);
  requires BV32_SGE(group_id_x$1, 0bv32);
...
implementation {:source_name "inlined"} $_Z7inlinedPii($A: bv32, $offset: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $entry:
    call _LOG_READ_$$A(true, BV32_ADD($A, BV32_ADD(local_id_x$1, $offset)), $$A[BV32_ADD($A, BV32_ADD(local_id_x$1, $offset))]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_READ_$$A(true, BV32_ADD($A, BV32_ADD(local_id_x$2, $offset)), $$A[BV32_ADD($A, BV32_ADD(local_id_x$2, $offset))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v0$1 := $$A[BV32_ADD($A, BV32_ADD(local_id_x$1, $offset))];
    v0$2 := $$A[BV32_ADD($A, BV32_ADD(local_id_x$2, $offset))];
    call _LOG_READ_$$A(true, BV32_ADD($A, local_id_x$1), $$A[BV32_ADD($A, local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_READ_$$A(true, BV32_ADD($A, local_id_x$2), $$A[BV32_ADD($A, local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$A"} true;
    v1$1 := $$A[BV32_ADD($A, local_id_x$1)];
    v1$2 := $$A[BV32_ADD($A, local_id_x$2)];
    call _LOG_WRITE_$$A(true, BV32_ADD($A, local_id_x$1), BV32_ADD(v1$1, v0$1), $$A[BV32_ADD($A, local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, BV32_ADD($A, local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_WRITE_$$A(true, BV32_ADD($A, local_id_x$2), BV32_ADD(v1$2, v0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[BV32_ADD($A, local_id_x$1)] := BV32_ADD(v1$1, v0$1);
    $$A[BV32_ADD($A, local_id_x$2)] := BV32_ADD(v1$2, v0$2);
    return;
}
