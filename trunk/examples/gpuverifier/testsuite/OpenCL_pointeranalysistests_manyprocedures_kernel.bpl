...
procedure {:source_name "bar"} $bar($a: ptr, $b: ptr, $c: ptr);
  ...
  modifies _WRITE_HAS_OCCURRED_$$s, _WRITE_READ_BENIGN_FLAG_$$s, _WRITE_READ_BENIGN_FLAG_$$s, _WRITE_HAS_OCCURRED_$$t, _WRITE_READ_BENIGN_FLAG_$$t, _WRITE_READ_BENIGN_FLAG_$$t, _WRITE_HAS_OCCURRED_$$u, _WRITE_READ_BENIGN_FLAG_$$u, _WRITE_READ_BENIGN_FLAG_$$u, _WRITE_HAS_OCCURRED_$$r, _WRITE_READ_BENIGN_FLAG_$$r, _WRITE_READ_BENIGN_FLAG_$$r;

implementation {:source_name "bar"} $bar($a: ptr, $b: ptr, $c: ptr)
{
  ...
  anon12_Else:
    assume {:partition} base#MKPTR($a) != $arrayId$$r;
    goto anon13_Then, anon13_Else;

  anon13_Else:
    assume {:partition} base#MKPTR($a) != $arrayId$$t;
  ...
  anon14_Else:
    assume {:partition} base#MKPTR($b) != $arrayId$$s;
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} base#MKPTR($b) != $arrayId$$u;
  ...
  anon16_Else:
    assume {:partition} base#MKPTR($c) != $arrayId$$t;
    goto anon17_Then, anon17_Else;

  anon17_Else:
    assume {:partition} base#MKPTR($c) != $arrayId$$s;
  ...
  anon17_Then:
    assume {:partition} base#MKPTR($c) == $arrayId$$s;
    call _LOG_WRITE_$$s(true, BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$s[BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$s(true, BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 8} true;
    call _CHECK_WRITE_$$s(true, BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$s"} true;
    $$s[BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    $$s[BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    goto anon11;

  anon16_Then:
    assume {:partition} base#MKPTR($c) == $arrayId$$t;
    call _LOG_WRITE_$$t(true, BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$t[BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$t(true, BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 7} true;
    call _CHECK_WRITE_$$t(true, BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$t"} true;
    $$t[BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    $$t[BV32_ADD(offset#MKPTR($c), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    goto anon11;

  anon15_Then:
    assume {:partition} base#MKPTR($b) == $arrayId$$u;
    call _LOG_WRITE_$$u(true, BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$u[BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$u(true, BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_WRITE_$$u(true, BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$u"} true;
    $$u[BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    $$u[BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    goto anon7;

  anon14_Then:
    assume {:partition} base#MKPTR($b) == $arrayId$$s;
    call _LOG_WRITE_$$s(true, BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$s[BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$s(true, BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_WRITE_$$s(true, BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$s"} true;
    $$s[BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    $$s[BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    goto anon7;

  anon13_Then:
    assume {:partition} base#MKPTR($a) == $arrayId$$t;
    call _LOG_WRITE_$$t(true, BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$t[BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$t(true, BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)));
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_WRITE_$$t(true, BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$t"} true;
    $$t[BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    $$t[BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    goto anon3;

  anon12_Then:
    assume {:partition} base#MKPTR($a) == $arrayId$$r;
    call _LOG_WRITE_$$r(true, BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$r[BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$r(true, BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)));
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$r(true, BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$r"} true;
    $$r[BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    $$r[BV32_ADD(offset#MKPTR($a), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    goto anon3;
}

procedure {:source_name "baz"} $baz($a: ptr, $b: ptr, $c: bv32);
  requires $c == 0bv32;
  requires BV32_SGT(group_size_x, 0bv32);
  requires BV32_SGT(num_groups_x, 0bv32);
  requires BV32_SGE(group_id_x$1, 0bv32);
  ...
  requires BV32_SLT(local_id_z$2, group_size_z);
  requires group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> local_id_x$1 != local_id_x$2 || local_id_y$1 != local_id_y$2 || local_id_z$1 != local_id_z$2;
  modifies _WRITE_HAS_OCCURRED_$$t, _WRITE_READ_BENIGN_FLAG_$$t, _WRITE_READ_BENIGN_FLAG_$$t, _WRITE_HAS_OCCURRED_$$s, _WRITE_READ_BENIGN_FLAG_$$s, _WRITE_READ_BENIGN_FLAG_$$s, _WRITE_HAS_OCCURRED_$$r, _WRITE_READ_BENIGN_FLAG_$$r, _WRITE_READ_BENIGN_FLAG_$$r;

implementation {:source_name "baz"} $baz($a: ptr, $b: ptr, $c: bv32)
{
  ...
  anon9_Else:
    assume {:partition} base#MKPTR($a) != $arrayId$$t;
    assert {:bad_pointer_access} {:sourceloc_num 13} {:thread 1} false;
    goto anon3;
  ...
  anon10_Else:
    assume {:partition} base#MKPTR($b) != $arrayId$$r;
    goto anon11_Then, anon11_Else;

  anon11_Else:
    assume {:partition} base#MKPTR($b) != $arrayId$$s;
    assert {:bad_pointer_access} {:sourceloc_num 16} {:thread 1} false;
    goto anon7;

  anon7:
    call _LOG_WRITE_$$t(true, BV32_ADD($c, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$t[BV32_ADD($c, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$t(true, BV32_ADD($c, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)));
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 17} true;
    call _CHECK_WRITE_$$t(true, BV32_ADD($c, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$t"} true;
    $$t[BV32_ADD($c, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    $$t[BV32_ADD($c, BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    return;
  ...
  anon10_Then:
    assume {:partition} base#MKPTR($b) == $arrayId$$r;
    call _LOG_WRITE_$$r(true, BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$r[BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$r(true, BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)));
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 14} true;
    call _CHECK_WRITE_$$r(true, BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32)), UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$r"} true;
    $$r[BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    $$r[BV32_ADD(offset#MKPTR($b), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 1bv32))] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    goto anon7;
...
procedure {:source_name "foo"} ULTIMATE.start($x: bv32);
  ...
  requires BV32_SLT(local_id_z$2, group_size_z);
  requires group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> local_id_x$1 != local_id_x$2 || local_id_y$1 != local_id_y$2 || local_id_z$1 != local_id_z$2;
  modifies _WRITE_HAS_OCCURRED_$$s, _WRITE_READ_BENIGN_FLAG_$$s, _WRITE_READ_BENIGN_FLAG_$$s, _WRITE_HAS_OCCURRED_$$t, _WRITE_READ_BENIGN_FLAG_$$t, _WRITE_READ_BENIGN_FLAG_$$t, _WRITE_HAS_OCCURRED_$$u, _WRITE_READ_BENIGN_FLAG_$$u, _WRITE_READ_BENIGN_FLAG_$$u, _WRITE_HAS_OCCURRED_$$r, _WRITE_READ_BENIGN_FLAG_$$r, _WRITE_READ_BENIGN_FLAG_$$r, _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p;
...
implementation {:source_name "foo"} ULTIMATE.start($x: bv32)
{
  ...
  anon5_Else:
    ...
    assert {:bad_pointer_access} {:sourceloc_num 23} {:thread 1} false;
    goto anon3;

  anon3:
    call $bar(MKPTR($arrayId$$r, 0bv32), MKPTR($arrayId$$s, 0bv32), MKPTR($arrayId$$t, 0bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$bar"} true;
    call $bar(MKPTR($arrayId$$t, 0bv32), MKPTR($arrayId$$u, 0bv32), MKPTR($arrayId$$s, 0bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$bar"} true;
    call $baz(MKPTR($arrayId$$r, 0bv32), MKPTR($arrayId$$r, 0bv32), 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "$baz"} true;
    call $baz(MKPTR($arrayId$$t, 0bv32), MKPTR($arrayId$$s, 0bv32), 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "$baz"} true;
    return;
  ...
  anon4_Then:
    ...
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 21} true;
