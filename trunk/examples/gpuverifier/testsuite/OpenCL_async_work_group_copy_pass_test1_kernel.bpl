...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies _READ_ASYNC_HANDLE_$$p, _WRITE_ASYNC_HANDLE_$$foo.mine, $$foo.mine, $$p, _TRACKING, _READ_HAS_OCCURRED_$$foo.mine, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_HAS_OCCURRED_$$foo.mine, _WRITE_READ_BENIGN_FLAG_$$foo.mine, _WRITE_ASYNC_HANDLE_$$foo.mine, _READ_HAS_OCCURRED_$$p, _READ_ASYNC_HANDLE_$$p;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  __partitioned_block_$entry_1:
    ...
    v2$1 := $$foo.mine[1bv1][local_id_x$1];
    v2$2 := $$foo.mine[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2];
    call _LOG_WRITE_$$p(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), FMUL32(1073741824bv32, v2$1), $$p[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    ...
    call _CHECK_WRITE_$$p(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), FMUL32(1073741824bv32, v2$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := FMUL32(1073741824bv32, v2$1);
    $$p[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := FMUL32(1073741824bv32, v2$2);
    return;
}
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$foo.mine;
