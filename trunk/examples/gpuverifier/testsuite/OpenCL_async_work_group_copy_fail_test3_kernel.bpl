...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call v2$1, v2$2 := _ASYNC_WORK_GROUP_COPY_$$foo.my_q_$$q(true, 0bv32, BV32_MUL(64bv32, group_id_x$1), 64bv32, BV32_ADD(v1$1, 1bv32), true, 0bv32, BV32_MUL(64bv32, group_id_x$2), 64bv32, BV32_ADD(v1$2, 1bv32));
