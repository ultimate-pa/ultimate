...
var {:source_name "global_constant"} {:constant} $$global_constant$1: [bv32]bv32;

var {:source_name "global_constant"} {:constant} $$global_constant$2: [bv32]bv32;

axiom {:array_info "$$global_constant"} {:constant} {:elem_width 32} {:source_name "global_constant"} {:source_elem_width 32} {:source_dimensions "4"} true;
...
procedure {:source_name "constant"} ULTIMATE.start();
...
implementation {:source_name "constant"} ULTIMATE.start()
{
  var v0$1: bv32;
  var v0$2: bv32;
  ...
  $entry:
    havoc v0$1, v0$2;
    $$global_constant$1[local_id_x$1] := v0$1;
    $$global_constant$2[local_id_x$2] := v0$2;
    assert {:sourceloc_num 2} {:constant_write} {:thread 1} false;
    return;
}
