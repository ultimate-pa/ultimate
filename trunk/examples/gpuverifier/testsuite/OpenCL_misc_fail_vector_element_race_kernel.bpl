...
procedure {:source_name "example"} ULTIMATE.start();
  ...
  modifies _READ_HAS_OCCURRED_$$G, _WRITE_HAS_OCCURRED_$$G, _WRITE_READ_BENIGN_FLAG_$$G, _WRITE_READ_BENIGN_FLAG_$$G;
...
implementation {:source_name "example"} ULTIMATE.start()
{
  ...
  $entry:
    call _LOG_READ_$$G(true, 12bv32, $$G[12bv32]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_READ_$$G(true, 12bv32, $$G[12bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$G"} true;
    v0$1 := $$G[12bv32];
    v0$2 := $$G[12bv32];
    call _LOG_READ_$$G(true, 13bv32, $$G[13bv32]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_READ_$$G(true, 13bv32, $$G[13bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$G"} true;
    v1$1 := $$G[13bv32];
    v1$2 := $$G[13bv32];
    call _LOG_READ_$$G(true, 14bv32, $$G[14bv32]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_READ_$$G(true, 14bv32, $$G[14bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$G"} true;
    v2$1 := $$G[14bv32];
    v2$2 := $$G[14bv32];
    call _LOG_READ_$$G(true, 15bv32, $$G[15bv32]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_READ_$$G(true, 15bv32, $$G[15bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$G"} true;
    v3$1 := $$G[15bv32];
    v3$2 := $$G[15bv32];
    call _LOG_WRITE_$$G(true, 12bv32, v0$1, $$G[12bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$G(true, 12bv32);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_WRITE_$$G(true, 12bv32, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$G"} true;
    $$G[12bv32] := v0$1;
    $$G[12bv32] := v0$2;
    call _LOG_WRITE_$$G(true, 13bv32, UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), $$G[13bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$G(true, 13bv32);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 6} true;
    call _CHECK_WRITE_$$G(true, 13bv32, UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$G"} true;
    $$G[13bv32] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    $$G[13bv32] := UI32_TO_FP32(BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    call _LOG_WRITE_$$G(true, 14bv32, v2$1, $$G[14bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$G(true, 14bv32);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 7} true;
    call _CHECK_WRITE_$$G(true, 14bv32, v2$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$G"} true;
    $$G[14bv32] := v2$1;
    $$G[14bv32] := v2$2;
    call _LOG_WRITE_$$G(true, 15bv32, v3$1, $$G[15bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$G(true, 15bv32);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 8} true;
    call _CHECK_WRITE_$$G(true, 15bv32, v3$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$G"} true;
    $$G[15bv32] := v3$1;
    $$G[15bv32] := v3$2;
    return;
