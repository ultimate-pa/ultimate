...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$foo.A, $$foo.B, _WRITE_HAS_OCCURRED_$$foo.A, _WRITE_READ_BENIGN_FLAG_$$foo.A, _WRITE_READ_BENIGN_FLAG_$$foo.A, _WRITE_HAS_OCCURRED_$$foo.B, _WRITE_READ_BENIGN_FLAG_$$foo.B, _WRITE_READ_BENIGN_FLAG_$$foo.B, _READ_HAS_OCCURRED_$$foo.A, _READ_HAS_OCCURRED_$$foo.B;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    call _LOG_WRITE_$$foo.B(true, local_id_x$1, 0bv32, $$foo.B[1bv1][local_id_x$1]);
    ...
    call _CHECK_WRITE_$$foo.B(true, local_id_x$2, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.B"} true;
    $$foo.B[1bv1][local_id_x$1] := 0bv32;
    $$foo.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := 0bv32;
    $i.0 := 0bv32;
  ...
  $for.cond:
    ...
    assert {:originated_from_invariant} {:sourceloc_num 4} {:thread 1} (if $$foo.A[1bv1][local_id_x$1] == $$foo.B[1bv1][local_id_x$1] then 1bv1 else 0bv1) != 0bv1;
    assert {:originated_from_invariant} {:sourceloc_num 4} {:thread 2} (if $$foo.A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] == $$foo.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] then 1bv1 else 0bv1) != 0bv1;
  ...
  $truebb:
    ...
    v3$1 := local_id_x$1;
    v3$2 := local_id_x$2;
    call _LOG_READ_$$foo.B(true, v3$1, $$foo.B[1bv1][v3$1]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 8} true;
    call _CHECK_READ_$$foo.B(true, v3$2, $$foo.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v3$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.B"} true;
    v4$1 := $$foo.B[1bv1][v3$1];
    v4$2 := $$foo.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v3$2];
    call _LOG_WRITE_$$foo.B(true, v3$1, BV32_ADD(v4$1, 1bv32), $$foo.B[1bv1][v3$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.B(true, v3$2);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 9} true;
    call _CHECK_WRITE_$$foo.B(true, v3$2, BV32_ADD(v4$2, 1bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.B"} true;
    $$foo.B[1bv1][v3$1] := BV32_ADD(v4$1, 1bv32);
    $$foo.B[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v3$2] := BV32_ADD(v4$2, 1bv32);
