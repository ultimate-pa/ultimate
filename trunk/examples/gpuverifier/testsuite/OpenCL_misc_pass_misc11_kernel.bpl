...
procedure {:source_name "foo"} ULTIMATE.start();
  requires (if $$A[1bv1][local_id_x$1] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
  requires (if $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] == 0bv32 then 1bv1 else 0bv1) != 0bv1;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    v0$1 := $$A[1bv1][local_id_x$1];
    v0$2 := $$A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2];
    assert {:sourceloc_num 4} {:thread 1} (if v0$1 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    assert {:sourceloc_num 4} {:thread 2} (if v0$2 == 0bv32 then 1bv1 else 0bv1) != 0bv1;
    return;
}
