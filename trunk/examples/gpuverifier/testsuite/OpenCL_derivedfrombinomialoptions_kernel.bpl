...
procedure {:source_name "binomial_options_kernel"} ULTIMATE.start();
  ...
  modifies _WRITE_HAS_OCCURRED_$$call_value, _WRITE_READ_BENIGN_FLAG_$$call_value, _WRITE_READ_BENIGN_FLAG_$$call_value, _WRITE_HAS_OCCURRED_$$call_buffer, _WRITE_READ_BENIGN_FLAG_$$call_buffer, _WRITE_READ_BENIGN_FLAG_$$call_buffer;
...
implementation {:source_name "binomial_options_kernel"} ULTIMATE.start()
{
  ...
  $entry:
    havoc v0$1, v0$2;
    call _LOG_WRITE_$$call_value(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), v0$1, $$call_value[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$call_value(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 2} true;
    call _CHECK_WRITE_$$call_value(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$call_value"} true;
    $$call_value[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := v0$1;
    $$call_value[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := v0$2;
    havoc v1$1, v1$2;
    call _LOG_WRITE_$$call_buffer(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), v1$1, $$call_buffer[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$call_buffer(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_WRITE_$$call_buffer(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), v1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$call_buffer"} true;
    $$call_buffer[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := v1$1;
    $$call_buffer[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := v1$2;
    return;
}
