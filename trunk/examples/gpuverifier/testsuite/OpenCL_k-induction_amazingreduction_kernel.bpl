...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies $$p, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _TRACKING, _READ_HAS_OCCURRED_$$p;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    $d.0 := BV32_UDIV(group_size_x, 2bv32);
  ...
  $falsebb:
    ...
    call _LOG_WRITE_$$p(p2$1, 0bv32, local_id_x$1, $$p[1bv1][0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(p2$2, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 12} true;
    call _CHECK_WRITE_$$p(p2$2, 0bv32, local_id_x$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][0bv32] := (if p2$1 then local_id_x$1 else $$p[1bv1][0bv32]);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] := (if p2$2 then local_id_x$2 else $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    return;
  ...
  __partitioned_block_$truebb_1:
    ...
    v1$1 := BV32_ULT(local_id_x$1, $d.0);
    v1$2 := BV32_ULT(local_id_x$2, $d.0);
    p1$1 := (if v1$1 then v1$1 else p1$1);
    p1$2 := (if v1$2 then v1$2 else p1$2);
    call _LOG_READ_$$p(p1$1, BV32_ADD(local_id_x$1, $d.0), $$p[1bv1][BV32_ADD(local_id_x$1, $d.0)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 5} true;
    call _CHECK_READ_$$p(p1$2, BV32_ADD(local_id_x$2, $d.0), $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, $d.0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v2$1 := (if p1$1 then $$p[1bv1][BV32_ADD(local_id_x$1, $d.0)] else v2$1);
    v2$2 := (if p1$2 then $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, $d.0)] else v2$2);
    v3$1 := (if p1$1 then local_id_x$1 else v3$1);
    v3$2 := (if p1$2 then local_id_x$2 else v3$2);
    call _LOG_READ_$$p(p1$1, v3$1, $$p[1bv1][v3$1]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 6} true;
    call _CHECK_READ_$$p(p1$2, v3$2, $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v3$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v4$1 := (if p1$1 then $$p[1bv1][v3$1] else v4$1);
    v4$2 := (if p1$2 then $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v3$2] else v4$2);
    call _LOG_WRITE_$$p(p1$1, v3$1, BV32_ADD(v4$1, v2$1), $$p[1bv1][v3$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(p1$2, v3$2);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 7} true;
    call _CHECK_WRITE_$$p(p1$2, v3$2, BV32_ADD(v4$2, v2$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][v3$1] := (if p1$1 then BV32_ADD(v4$1, v2$1) else $$p[1bv1][v3$1]);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v3$2] := (if p1$2 then BV32_ADD(v4$2, v2$2) else $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v3$2]);
    $d.0 := BV32_ASHR($d.0, 1bv32);
