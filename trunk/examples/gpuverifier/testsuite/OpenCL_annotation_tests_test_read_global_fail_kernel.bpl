...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies _READ_HAS_OCCURRED_$$q, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_READ_BENIGN_FLAG_$$q;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    v0$1 := $$q[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)];
    v0$2 := $$q[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)];
    call _LOG_WRITE_$$p(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), v0$1, $$p[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    ...
    call _CHECK_WRITE_$$p(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := v0$1;
    $$p[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := v0$2;
    assert {:sourceloc_num 3} {:thread 1} BV1_XOR((if _READ_HAS_OCCURRED_$$q then 1bv1 else 0bv1), 1bv1) != 0bv1;
    call _LOG_WRITE_$$q(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), 42bv32, $$q[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    ...
    call _CHECK_WRITE_$$q(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), 42bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$q"} true;
    $$q[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := 42bv32;
    $$q[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := 42bv32;
    return;
}
