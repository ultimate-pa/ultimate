...
procedure {:source_name "mul24_test"} ULTIMATE.start();
  ...
  modifies _WRITE_HAS_OCCURRED_$$A, _WRITE_READ_BENIGN_FLAG_$$A, _WRITE_READ_BENIGN_FLAG_$$A, _WRITE_HAS_OCCURRED_$$B, _WRITE_READ_BENIGN_FLAG_$$B, _WRITE_READ_BENIGN_FLAG_$$B;

implementation {:source_name "mul24_test"} ULTIMATE.start()
{
  var v0$1: bv32;
  var v0$2: bv32;
  ...
  $entry:
    ...
    call _LOG_WRITE_$$A(true, v0$1, v0$1, $$A[v0$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$A(true, v0$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$A(true, v0$2, v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$A"} true;
    $$A[v0$1] := v0$1;
    $$A[v0$2] := v0$2;
    call _LOG_WRITE_$$B(true, BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), v0$1, $$B[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)]);
    ...
    call _CHECK_WRITE_$$B(true, BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2), v0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$B"} true;
    $$B[BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)] := v0$1;
    $$B[BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)] := v0$2;
    return;
}
