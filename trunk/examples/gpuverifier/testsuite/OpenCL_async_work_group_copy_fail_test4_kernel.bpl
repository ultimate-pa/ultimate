...
procedure {:source_name "foo"} ULTIMATE.start();
  ...
  modifies _READ_ASYNC_HANDLE_$$p, _READ_ASYNC_HANDLE_$$q, _READ_ASYNC_HANDLE_$$foo.my_p, _READ_ASYNC_HANDLE_$$foo.my_q, _WRITE_ASYNC_HANDLE_$$foo.my_p, _WRITE_ASYNC_HANDLE_$$foo.my_q, _WRITE_ASYNC_HANDLE_$$p, _WRITE_ASYNC_HANDLE_$$q, _READ_ASYNC_HANDLE_$$p, _READ_ASYNC_HANDLE_$$q, _READ_ASYNC_HANDLE_$$foo.my_p, _READ_ASYNC_HANDLE_$$foo.my_q, _WRITE_ASYNC_HANDLE_$$foo.my_p, _WRITE_ASYNC_HANDLE_$$foo.my_q, _WRITE_ASYNC_HANDLE_$$p, _WRITE_ASYNC_HANDLE_$$q, $$foo.my_p, $$foo.my_q, _READ_HAS_OCCURRED_$$foo.my_p, _READ_ASYNC_HANDLE_$$foo.my_p, _WRITE_HAS_OCCURRED_$$foo.my_p, _WRITE_READ_BENIGN_FLAG_$$foo.my_p, _WRITE_ASYNC_HANDLE_$$foo.my_p, _WRITE_READ_BENIGN_FLAG_$$foo.my_p, _READ_HAS_OCCURRED_$$foo.my_q, _READ_ASYNC_HANDLE_$$foo.my_q, _WRITE_HAS_OCCURRED_$$foo.my_q, _WRITE_READ_BENIGN_FLAG_$$foo.my_q, _WRITE_ASYNC_HANDLE_$$foo.my_q, _WRITE_READ_BENIGN_FLAG_$$foo.my_q, _READ_HAS_OCCURRED_$$p, _READ_ASYNC_HANDLE_$$p, _READ_HAS_OCCURRED_$$q, _READ_ASYNC_HANDLE_$$q, _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_ASYNC_HANDLE_$$p, _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_ASYNC_HANDLE_$$q;
...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $entry:
    ...
    _READ_ASYNC_HANDLE_$$foo.my_p := (if v2$1 == _READ_ASYNC_HANDLE_$$foo.my_p then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$foo.my_p);
    _READ_ASYNC_HANDLE_$$foo.my_p := (if v2$2 == _READ_ASYNC_HANDLE_$$foo.my_p then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$foo.my_p);
    _READ_ASYNC_HANDLE_$$foo.my_q := (if v2$1 == _READ_ASYNC_HANDLE_$$foo.my_q then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$foo.my_q);
    _READ_ASYNC_HANDLE_$$foo.my_q := (if v2$2 == _READ_ASYNC_HANDLE_$$foo.my_q then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$foo.my_q);
    ...
    _WRITE_ASYNC_HANDLE_$$p := (if v2$1 == _WRITE_ASYNC_HANDLE_$$p then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$p);
    _WRITE_ASYNC_HANDLE_$$p := (if v2$2 == _WRITE_ASYNC_HANDLE_$$p then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$p);
    _WRITE_ASYNC_HANDLE_$$q := (if v2$1 == _WRITE_ASYNC_HANDLE_$$q then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$q);
    _WRITE_ASYNC_HANDLE_$$q := (if v2$2 == _WRITE_ASYNC_HANDLE_$$q then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$q);
    v3$1 := $$handles$1bv32$1;
    v3$2 := $$handles$1bv32$2;
    assert {:sourceloc_num 8} {:thread 1} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> true == true;
    assert {:sourceloc_num 8} {:thread 1} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> v3$1 == v3$2;
    assert {:sourceloc_num 8} {:thread 2} group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> v3$2 == v3$1;
    ...
    _READ_ASYNC_HANDLE_$$q := (if v3$1 == _READ_ASYNC_HANDLE_$$q then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$q);
    _READ_ASYNC_HANDLE_$$q := (if v3$2 == _READ_ASYNC_HANDLE_$$q then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$q);
    _READ_ASYNC_HANDLE_$$foo.my_p := (if v3$1 == _READ_ASYNC_HANDLE_$$foo.my_p then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$foo.my_p);
    _READ_ASYNC_HANDLE_$$foo.my_p := (if v3$2 == _READ_ASYNC_HANDLE_$$foo.my_p then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$foo.my_p);
    _READ_ASYNC_HANDLE_$$foo.my_q := (if v3$1 == _READ_ASYNC_HANDLE_$$foo.my_q then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$foo.my_q);
    _READ_ASYNC_HANDLE_$$foo.my_q := (if v3$2 == _READ_ASYNC_HANDLE_$$foo.my_q then _ASYNC_NO_HANDLE else _READ_ASYNC_HANDLE_$$foo.my_q);
    _WRITE_ASYNC_HANDLE_$$foo.my_p := (if v3$1 == _WRITE_ASYNC_HANDLE_$$foo.my_p then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$foo.my_p);
    _WRITE_ASYNC_HANDLE_$$foo.my_p := (if v3$2 == _WRITE_ASYNC_HANDLE_$$foo.my_p then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$foo.my_p);
    _WRITE_ASYNC_HANDLE_$$foo.my_q := (if v3$1 == _WRITE_ASYNC_HANDLE_$$foo.my_q then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$foo.my_q);
    _WRITE_ASYNC_HANDLE_$$foo.my_q := (if v3$2 == _WRITE_ASYNC_HANDLE_$$foo.my_q then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$foo.my_q);
    ...
    _WRITE_ASYNC_HANDLE_$$q := (if v3$1 == _WRITE_ASYNC_HANDLE_$$q then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$q);
    _WRITE_ASYNC_HANDLE_$$q := (if v3$2 == _WRITE_ASYNC_HANDLE_$$q then _ASYNC_NO_HANDLE else _WRITE_ASYNC_HANDLE_$$q);
    call _LOG_READ_$$foo.my_p(true, local_id_x$1, $$foo.my_p[1bv1][local_id_x$1], _ASYNC_NO_HANDLE);
    ...
    v4$1 := $$foo.my_p[1bv1][local_id_x$1];
    v4$2 := $$foo.my_p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2];
    call _LOG_WRITE_$$foo.my_p(true, local_id_x$1, FMUL32(1073741824bv32, v4$1), $$foo.my_p[1bv1][local_id_x$1], _ASYNC_NO_HANDLE);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.my_p(true, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 10} true;
    call _CHECK_WRITE_$$foo.my_p(true, local_id_x$2, FMUL32(1073741824bv32, v4$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.my_p"} true;
    $$foo.my_p[1bv1][local_id_x$1] := FMUL32(1073741824bv32, v4$1);
    $$foo.my_p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := FMUL32(1073741824bv32, v4$2);
    call _LOG_READ_$$foo.my_q(true, local_id_x$1, $$foo.my_q[1bv1][local_id_x$1], _ASYNC_NO_HANDLE);
    ...
    v5$1 := $$foo.my_q[1bv1][local_id_x$1];
    v5$2 := $$foo.my_q[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2];
    call _LOG_WRITE_$$foo.my_q(true, local_id_x$1, FMUL32(1073741824bv32, v5$1), $$foo.my_q[1bv1][local_id_x$1], _ASYNC_NO_HANDLE);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$foo.my_q(true, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 12} true;
    call _CHECK_WRITE_$$foo.my_q(true, local_id_x$2, FMUL32(1073741824bv32, v5$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$foo.my_q"} true;
    $$foo.my_q[1bv1][local_id_x$1] := FMUL32(1073741824bv32, v5$1);
    $$foo.my_q[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := FMUL32(1073741824bv32, v5$2);
    call v6$1, v6$2 := _ASYNC_WORK_GROUP_COPY_$$p_$$foo.my_p(true, BV32_MUL(64bv32, group_id_x$1), 0bv32, 64bv32, 0bv32, true, BV32_MUL(64bv32, group_id_x$2), 0bv32, 64bv32, 0bv32);
    call v7$1, v7$2 := _ASYNC_WORK_GROUP_COPY_$$q_$$foo.my_q(true, BV32_MUL(64bv32, group_id_x$1), 0bv32, 64bv32, 0bv32, true, BV32_MUL(64bv32, group_id_x$2), 0bv32, 64bv32, 0bv32);
    return;
}
...
procedure {:inline 1} _ASYNC_WORK_GROUP_COPY_$$p_$$foo.my_p(_P$1: bool, DstOffset$1: bv32, SrcOffset$1: bv32, Size$1: bv32, Handle$1: bv32, _P$2: bool, DstOffset$2: bv32, SrcOffset$2: bv32, Size$2: bv32, Handle$2: bv32) returns (ResultHandle$1: bv32, ResultHandle$2: bv32);
  requires _P$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 == _P$2;
  requires _P$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$2 == _P$1;
  requires _P$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> DstOffset$1 == DstOffset$2;
  requires _P$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> DstOffset$2 == DstOffset$1;
  ...
  requires _P$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> Handle$1 == Handle$2;
  requires _P$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> Handle$2 == Handle$1;
  modifies _WRITE_HAS_OCCURRED_$$p, _WRITE_READ_BENIGN_FLAG_$$p, _WRITE_ASYNC_HANDLE_$$p, _READ_HAS_OCCURRED_$$foo.my_p, _READ_ASYNC_HANDLE_$$foo.my_p;

implementation {:inline 1} _ASYNC_WORK_GROUP_COPY_$$p_$$foo.my_p(_P$1: bool, DstOffset$1: bv32, SrcOffset$1: bv32, Size$1: bv32, Handle$1: bv32, _P$2: bool, DstOffset$2: bv32, SrcOffset$2: bv32, Size$2: bv32, Handle$2: bv32) returns (ResultHandle$1: bv32, ResultHandle$2: bv32)
{
  var Index$1: bv32;
  var Index$2: bv32;
  var IdX$1: bv32;
  ...
  entry:
    ...
    assume (p0$1 ==> BV32_UGE(Index$1, 0bv32)) && (p0$2 ==> BV32_UGE(Index$2, 0bv32));
    assume (p0$1 ==> BV32_ULT(Index$1, Size$1)) && (p0$2 ==> BV32_ULT(Index$2, Size$2));
    call _LOG_WRITE_$$p(p0$1, BV32_ADD(DstOffset$1, Index$1), $$foo.my_p[1bv1][BV32_ADD(SrcOffset$1, Index$1)], $$p[BV32_ADD(DstOffset$1, Index$1)], ResultHandle$1);
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 13} true;
    call _CHECK_WRITE_$$p(p0$2, BV32_ADD(DstOffset$2, Index$2), $$foo.my_p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(SrcOffset$2, Index$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    call _LOG_READ_$$foo.my_p(p0$1, BV32_ADD(SrcOffset$1, Index$1), $$foo.my_p[1bv1][BV32_ADD(SrcOffset$1, Index$1)], ResultHandle$1);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 13} true;
    call _CHECK_READ_$$foo.my_p(p0$2, BV32_ADD(SrcOffset$2, Index$2), $$foo.my_p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(SrcOffset$2, Index$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.my_p"} true;
    return;
}

procedure {:inline 1} _ASYNC_WORK_GROUP_COPY_$$q_$$foo.my_q(_P$1: bool, DstOffset$1: bv32, SrcOffset$1: bv32, Size$1: bv32, Handle$1: bv32, _P$2: bool, DstOffset$2: bv32, SrcOffset$2: bv32, Size$2: bv32, Handle$2: bv32) returns (ResultHandle$1: bv32, ResultHandle$2: bv32);
  requires _P$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 == _P$2;
  requires _P$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$2 == _P$1;
  requires _P$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> DstOffset$1 == DstOffset$2;
  requires _P$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> DstOffset$2 == DstOffset$1;
  ...
  requires _P$1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> Handle$1 == Handle$2;
  requires _P$2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> Handle$2 == Handle$1;
  modifies _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_ASYNC_HANDLE_$$q, _READ_HAS_OCCURRED_$$foo.my_q, _READ_ASYNC_HANDLE_$$foo.my_q;

implementation {:inline 1} _ASYNC_WORK_GROUP_COPY_$$q_$$foo.my_q(_P$1: bool, DstOffset$1: bv32, SrcOffset$1: bv32, Size$1: bv32, Handle$1: bv32, _P$2: bool, DstOffset$2: bv32, SrcOffset$2: bv32, Size$2: bv32, Handle$2: bv32) returns (ResultHandle$1: bv32, ResultHandle$2: bv32)
{
  var Index$1: bv32;
  var Index$2: bv32;
  var IdX$1: bv32;
  ...
  entry:
    ...
    assume (p0$1 ==> BV32_UGE(Index$1, 0bv32)) && (p0$2 ==> BV32_UGE(Index$2, 0bv32));
    assume (p0$1 ==> BV32_ULT(Index$1, Size$1)) && (p0$2 ==> BV32_ULT(Index$2, Size$2));
    call _LOG_WRITE_$$q(p0$1, BV32_ADD(DstOffset$1, Index$1), $$foo.my_q[1bv1][BV32_ADD(SrcOffset$1, Index$1)], $$q[BV32_ADD(DstOffset$1, Index$1)], ResultHandle$1);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 14} true;
    call _CHECK_WRITE_$$q(p0$2, BV32_ADD(DstOffset$2, Index$2), $$foo.my_q[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(SrcOffset$2, Index$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$q"} true;
    call _LOG_READ_$$foo.my_q(p0$1, BV32_ADD(SrcOffset$1, Index$1), $$foo.my_q[1bv1][BV32_ADD(SrcOffset$1, Index$1)], ResultHandle$1);
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 14} true;
    call _CHECK_READ_$$foo.my_q(p0$2, BV32_ADD(SrcOffset$2, Index$2), $$foo.my_q[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(SrcOffset$2, Index$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$foo.my_q"} true;
    return;
}
...
var _WRITE_ASYNC_HANDLE_$$q: bv32;

procedure {:inline 1} _LOG_WRITE_$$q(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32, _async_handle: bv32);
  modifies _WRITE_HAS_OCCURRED_$$q, _WRITE_READ_BENIGN_FLAG_$$q, _WRITE_ASYNC_HANDLE_$$q;

implementation {:inline 1} _LOG_WRITE_$$q(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32, _async_handle: bv32)
{
  ...
  log_access_entry:
    ...
    _WRITE_ASYNC_HANDLE_$$q := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$q == _value then _async_handle else _WRITE_ASYNC_HANDLE_$$q);
    return;
}
...
var _READ_ASYNC_HANDLE_$$foo.my_p: bv32;

procedure {:inline 1} _LOG_READ_$$foo.my_p(_P: bool, _offset: bv32, _value: bv32, _async_handle: bv32);
  modifies _READ_HAS_OCCURRED_$$foo.my_p, _READ_ASYNC_HANDLE_$$foo.my_p;

implementation {:inline 1} _LOG_READ_$$foo.my_p(_P: bool, _offset: bv32, _value: bv32, _async_handle: bv32)
{
  ...
  log_access_entry:
    ...
    _READ_ASYNC_HANDLE_$$foo.my_p := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$foo.my_p == _value then _async_handle else _READ_ASYNC_HANDLE_$$foo.my_p);
    return;
}
...
var _READ_ASYNC_HANDLE_$$foo.my_q: bv32;

procedure {:inline 1} _LOG_READ_$$foo.my_q(_P: bool, _offset: bv32, _value: bv32, _async_handle: bv32);
  modifies _READ_HAS_OCCURRED_$$foo.my_q, _READ_ASYNC_HANDLE_$$foo.my_q;

implementation {:inline 1} _LOG_READ_$$foo.my_q(_P: bool, _offset: bv32, _value: bv32, _async_handle: bv32)
{
  ...
  log_access_entry:
    ...
    _READ_ASYNC_HANDLE_$$foo.my_q := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$foo.my_q == _value then _async_handle else _READ_ASYNC_HANDLE_$$foo.my_q);
    return;
}
