...
procedure {:source_name "foo"} ULTIMATE.start($i: bv32, $j: bv32);
  ...
  modifies $$A, _WRITE_HAS_OCCURRED_$$A;

implementation {:source_name "foo"} ULTIMATE.start($i: bv32, $j: bv32)
{

  $entry:
    call _LOG_WRITE_$$A(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_WRITE_$$A(true, 0bv32);
...
procedure {:inline 1} _LOG_READ_$$A(_P: bool, _offset: bv32);
  modifies _READ_HAS_OCCURRED_$$A;

implementation {:inline 1} _LOG_READ_$$A(_P: bool, _offset: bv32)
{

  log_access_entry:
    _READ_HAS_OCCURRED_$$A := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset then true else _READ_HAS_OCCURRED_$$A);
    return;
}

procedure _CHECK_READ_$$A(_P: bool, _offset: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$A(_P: bool, _offset: bv32);
  modifies _WRITE_HAS_OCCURRED_$$A;

implementation {:inline 1} _LOG_WRITE_$$A(_P: bool, _offset: bv32)
{

  log_access_entry:
    _WRITE_HAS_OCCURRED_$$A := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset then true else _WRITE_HAS_OCCURRED_$$A);
    return;
}

procedure _CHECK_WRITE_$$A(_P: bool, _offset: bv32);
  requires !(_P && _WRITE_HAS_OCCURRED_$$A && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
...
procedure {:inline 1} _LOG_READ_$$B(_P: bool, _offset: bv32);
  modifies _READ_HAS_OCCURRED_$$B;

implementation {:inline 1} _LOG_READ_$$B(_P: bool, _offset: bv32)
{

  log_access_entry:
    _READ_HAS_OCCURRED_$$B := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset then true else _READ_HAS_OCCURRED_$$B);
    return;
}

procedure _CHECK_READ_$$B(_P: bool, _offset: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$B(_P: bool, _offset: bv32);
  modifies _WRITE_HAS_OCCURRED_$$B;

implementation {:inline 1} _LOG_WRITE_$$B(_P: bool, _offset: bv32)
{

  log_access_entry:
    _WRITE_HAS_OCCURRED_$$B := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset then true else _WRITE_HAS_OCCURRED_$$B);
    return;
}

procedure _CHECK_WRITE_$$B(_P: bool, _offset: bv32);
  requires !(_P && _WRITE_HAS_OCCURRED_$$B && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
