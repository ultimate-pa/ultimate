...
procedure {:source_name "foo"} $foo($A: bv32) returns ($ret$1: bv32, $ret$2: bv32);
  requires $A == 0bv32;
...
implementation {:source_name "foo"} $foo($A: bv32) returns ($ret$1: bv32, $ret$2: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;

  $entry:
    call _LOG_READ_$$p(true, BV32_ADD($A, local_id_x$1), $$p[1bv1][BV32_ADD($A, local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call _CHECK_READ_$$p(true, BV32_ADD($A, local_id_x$2), $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD($A, local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v0$1 := $$p[1bv1][BV32_ADD($A, local_id_x$1)];
    v0$2 := $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD($A, local_id_x$2)];
    $ret$1 := v0$1;
    $ret$2 := v0$2;
    return;
}

procedure {:source_name "bar"} ULTIMATE.start();
...
implementation {:source_name "bar"} ULTIMATE.start()
{
  var $i.0: bv32;
  var v0: bool;
  var v1$1: bv32;
