...
implementation {:source_name "foo"} ULTIMATE.start()
{
  ...
  $truebb:
    assume {:partition} v0;
    call _LOG_READ_$$p(true, BV32_ADD(10bv32, local_id_x$1), $$p[1bv1][BV32_ADD(10bv32, local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 3} true;
    call _CHECK_READ_$$p(true, BV32_ADD(10bv32, local_id_x$2), $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(10bv32, local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$p"} true;
    v1$1 := $$p[1bv1][BV32_ADD(10bv32, local_id_x$1)];
    v1$2 := $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(10bv32, local_id_x$2)];
    call _LOG_WRITE_$$p(true, BV32_ADD(10bv32, local_id_x$1), FADD32(v1$1, 1065353216bv32), $$p[1bv1][BV32_ADD(10bv32, local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$p(true, BV32_ADD(10bv32, local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 4} true;
    call _CHECK_WRITE_$$p(true, BV32_ADD(10bv32, local_id_x$2), FADD32(v1$2, 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$p"} true;
    $$p[1bv1][BV32_ADD(10bv32, local_id_x$1)] := FADD32(v1$1, 1065353216bv32);
    $$p[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(10bv32, local_id_x$2)] := FADD32(v1$2, 1065353216bv32);
...
axiom (if group_size_x == 8192bv32 then 1bv1 else 0bv1) != 0bv1;
