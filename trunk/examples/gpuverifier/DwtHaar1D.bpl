...
implementation {:source_name "dwtHaar1D"} {:kernel} $dwtHaar1D($tLevels: bv32, $signalLength: bv32, $levelsDone: bv32, $mLevels: bv32)
{
  ...
  $falsebb1:
    ...
    call {:sourceloc} {:sourceloc_num 38} _LOG_READ_$$sharedArray(p4$1, 0bv32, $$sharedArray[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 38} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 38} _CHECK_READ_$$sharedArray(p4$2, 0bv32, $$sharedArray[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
  ...
  __partitioned_block_$truebb1_0:
    ...
    call {:sourceloc} {:sourceloc_num 26} _LOG_READ_$$sharedArray(p1$1, BV32_MUL(2bv32, v0$1), $$sharedArray[1bv1][BV32_MUL(2bv32, v0$1)]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 26} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 26} _CHECK_READ_$$sharedArray(p1$2, BV32_MUL(2bv32, v0$2), $$sharedArray[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_MUL(2bv32, v0$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$sharedArray"} true;
    ...
    call {:sourceloc} {:sourceloc_num 27} _LOG_READ_$$sharedArray(p1$1, BV32_ADD(BV32_MUL(2bv32, v0$1), 1bv32), $$sharedArray[1bv1][BV32_ADD(BV32_MUL(2bv32, v0$1), 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 27} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 27} _CHECK_READ_$$sharedArray(p1$2, BV32_ADD(BV32_MUL(2bv32, v0$2), 1bv32), $$sharedArray[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(2bv32, v0$2), 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$sharedArray"} true;
  ...
  __partitioned_block_$truebb1_1:
    call {:sourceloc_num 29} $bugle_barrier_duplicated_1(1bv1, 0bv1);
  ...
  __partitioned_block_$truebb1_2:
    call {:sourceloc_num 34} $bugle_barrier_duplicated_2(1bv1, 0bv1);
