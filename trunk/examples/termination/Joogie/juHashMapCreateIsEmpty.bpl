...
procedure java.lang.Class$java.lang.Class$getComponentType$467(__this : ref) returns (__ret : ref);
	 ...
	 //  @line: 4
// <javaUtilEx.juHashMapCreateIsEmpty: void main(java.lang.String[])>
procedure void$javaUtilEx.juHashMapCreateIsEmpty$main$2778($param_0 : [int]ref)
...
Block1167:
	...
	java.lang.String$lp$$rp$$javaUtilEx.Random$args321 := r01130;
	 ...
	 //  @line: 7
	 call r11133 := javaUtilEx.HashMap$javaUtilEx.juHashMapCreateIsEmpty$createMap$2779(($i01131));
	 assert ($neref((r11133), ($null))==1);
	 //  @line: 8
	 call $freshlocal0 := boolean$javaUtilEx.HashMap$isEmpty$2615((r11133));
	 return;
}
...
Block1176:
	r01146 := __this;
	 assert ($neref((r01146), ($null))==1);
	 //  @line: 3
	 call void$java.lang.Object$$la$init$ra$$28((r01146));
	 return;
}
...
Block512:
	 ...
	 //  @line: 2
// <javaUtilEx.juHashMapCreateIsEmpty: void <init>()>
procedure void$javaUtilEx.juHashMapCreateIsEmpty$$la$init$ra$$2777(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01129 : ref;
Block1166:
	r01129 := __this;
...
Block1096:
	...
	__ret := $i01066;
	 ...
	 //  @line: 11
// <javaUtilEx.juHashMapCreateIsEmpty: javaUtilEx.HashMap createMap(int)>
procedure javaUtilEx.HashMap$javaUtilEx.juHashMapCreateIsEmpty$createMap$2779($param_0 : int) returns (__ret : ref) {
var i21145 : int;
var $r41138 : ref;
var r01136 : ref;
var r21143 : ref;
...
Block1168:
	i21145 := $param_0;
	 //  @line: 12
	$r31135 := $newvariable((1169));
	 assume ($neref(($newvariable((1169))), ($null))==1);
	 assert ($neref(($r31135), ($null))==1);
	 //  @line: 12
	 call void$javaUtilEx.HashMap$$la$init$ra$$2609(($r31135));
	 //  @line: 12
	r01136 := $r31135;
	 goto Block1170;
	 //  @line: 13
...
Block1173:
	 //  @line: 13
	 assume ($negInt(($leint((i21145), (0))))==1);
	 //  @line: 14
	$r41138 := $newvariable((1174));
	 assume ($neref(($newvariable((1174))), ($null))==1);
	 //  @line: 14
	 call $i01139 := int$javaUtilEx.Random$random$2781();
	 assert ($neref(($r41138), ($null))==1);
	 //  @line: 14
	 call void$javaUtilEx.Content$$la$init$ra$$2604(($r41138), ($i01139));
	 //  @line: 14
	r11140 := $r41138;
	 //  @line: 15
	$r51141 := $newvariable((1175));
	 assume ($neref(($newvariable((1175))), ($null))==1);
	 //  @line: 15
	 call $i11142 := int$javaUtilEx.Random$random$2781();
	 assert ($neref(($r51141), ($null))==1);
	 //  @line: 15
	 call void$javaUtilEx.Content$$la$init$ra$$2604(($r51141), ($i11142));
	 //  @line: 15
	r21143 := $r51141;
	 assert ($neref((r01136), ($null))==1);
	 //  @line: 16
	 call $freshlocal0 := java.lang.Object$javaUtilEx.HashMap$put$2620((r01136), (r11140), (r21143));
	 //  @line: 17
	i21145 := $addint((i21145), (-1));
	 goto Block1170;
	 //  @line: 13
Block1171:
	 assume ($leint((i21145), (0))==1);
	 goto Block1172;
	 //  @line: 19
Block1172:
	 //  @line: 19
...
Block1177:
	 //  @line: 8
	$r11148 := java.lang.String$lp$$rp$$javaUtilEx.Random$args321;
	 //  @line: 8
	$i01147 := int$javaUtilEx.Random$index0;
	 assert ($geint(($i01147), (0))==1);
	 assert ($ltint(($i01147), ($refArrSize[$r11148[$arrSizeIdx]]))==1);
	 //  @line: 8
	r01149 := $r11148[$i01147];
	 //  @line: 9
	$i11150 := int$javaUtilEx.Random$index0;
	 //  @line: 9
	$i21151 := $addint(($i11150), (1));
	 //  @line: 9
	int$javaUtilEx.Random$index0 := $i21151;
	$i31152 := $stringSize[r01149];
	 //  @line: 10
	__ret := $i31152;
	 return;
}
