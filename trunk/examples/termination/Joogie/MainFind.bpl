...
function {:inline true} $modreal($param00 : realVar, $param11 : realVar) returns (__ret : realVar);
	 ...
	 //  @line: 6
// <DoublyLinkedList.MainFind: void <init>()>
procedure void$DoublyLinkedList.MainFind$$la$init$ra$$2238(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r071 : ref;
Block100:
	r071 := __this;
...
procedure int$DoublyLinkedList.Random$random$2241() returns (__ret : int)
  modifies int$DoublyLinkedList.Random$index0, $stringSize;
 {
var $r178 : [int]ref;
var r083 : ref;
var $i586 : int;
...
Block103:
	 //  @line: 7
	$r178 := java.lang.String$lp$$rp$$DoublyLinkedList.Random$args256;
	 //  @line: 7
	$i180 := $refArrSize[$r178[$arrSizeIdx]];
	 //  @line: 7
	$i079 := int$DoublyLinkedList.Random$index0;
	 goto Block104;
	 //  @line: 7
Block104:
...
Block107:
	 //  @line: 7
	 assume ($negInt(($gtint(($i180), ($i079))))==1);
	 //  @line: 8
	__ret := 0;
	 return;
	 //  @line: 7
Block105:
	 assume ($gtint(($i180), ($i079))==1);
	 goto Block106;
	 //  @line: 10
Block106:
	 //  @line: 10
	$r282 := java.lang.String$lp$$rp$$DoublyLinkedList.Random$args256;
	 goto Block108;
	 //  @line: 10
Block108:
	 //  @line: 10
	$i281 := int$DoublyLinkedList.Random$index0;
	 assert ($geint(($i281), (0))==1);
	 assert ($ltint(($i281), ($refArrSize[$r282[$arrSizeIdx]]))==1);
	 //  @line: 10
	r083 := $r282[$i281];
	 //  @line: 11
	$i384 := int$DoublyLinkedList.Random$index0;
	 //  @line: 11
	$i485 := $addint(($i384), (1));
	 //  @line: 11
	int$DoublyLinkedList.Random$index0 := $i485;
	 goto Block109;
	 //  @line: 12
Block109:
...
Block102:
	r077 := __this;
	 assert ($neref((r077), ($null))==1);
	 //  @line: 2
	 call void$java.lang.Object$$la$init$ra$$28((r077));
	 return;
}
...
if (x != y) then 1 else 0
	 ...
	 //  @line: 8
// <DoublyLinkedList.MainFind: void main(java.lang.String[])>
procedure void$DoublyLinkedList.MainFind$main$2239($param_0 : [int]ref)
...
Block101:
	...
	java.lang.String$lp$$rp$$DoublyLinkedList.Random$args256 := r072;
	 ...
	 //  @line: 11
	 call $freshlocal0 := DoublyLinkedList.DoublyLinkedList$DoublyLinkedList.DoublyLinkedList$find$2232((r174), ($i075));
	 return;
}
