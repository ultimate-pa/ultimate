...
if (x >= y) then 1 else 0
	 ...
	 //  @line: 8
// <PastaA4: void main(java.lang.String[])>
procedure void$PastaA4$main$2229($param_0 : [int]ref)
...
function {:inline true} $shrref($param00 : ref, $param11 : ref) returns (__ret : int);
	 ...
	 //  @line: 6
// <PastaA4: void <init>()>
procedure void$PastaA4$$la$init$ra$$2228(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01 : ref;
Block16:
	r01 := __this;
