...
// <Round3: void <init>()>
procedure void$Round3$$la$init$ra$$2453(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r08 : ref;
Block19:
	r08 := __this;
...
Block17:
	...
	__ret := $i37;
	 ...
	 //  @line: 2
// <Round3: void main(java.lang.String[])>
procedure void$Round3$main$2454($param_0 : [int]ref)
...
Block20:
	...
	java.lang.String$lp$$rp$$Random$args254 := r09;
	 //  @line: 4
	 call i113 := int$Random$random$2229();
	 goto Block21;
	 //  @line: 6
Block21:
	 //  @line: 6
...
Block22:
	 ...
	 //  @line: 6
Block23:
	 assume ($eqint(($i012), (0))==1);
	 goto Block24;
	 //  @line: 6
Block25:
	 //  @line: 6
	 assume ($negInt(($eqint(($i012), (0))))==1);
	 //  @line: 7
	i113 := $addint((i113), (1));
	 goto Block21;
	 //  @line: 9
