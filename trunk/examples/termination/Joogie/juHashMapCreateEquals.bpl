...
Block1177:
	 //  @line: 8
	$r11151 := java.lang.String$lp$$rp$$javaUtilEx.Random$args321;
	 //  @line: 8
	$i01150 := int$javaUtilEx.Random$index0;
	 assert ($geint(($i01150), (0))==1);
	 assert ($ltint(($i01150), ($refArrSize[$r11151[$arrSizeIdx]]))==1);
	 //  @line: 8
	r01152 := $r11151[$i01150];
	 //  @line: 9
	$i11153 := int$javaUtilEx.Random$index0;
	 //  @line: 9
	$i21154 := $addint(($i11153), (1));
	 //  @line: 9
	int$javaUtilEx.Random$index0 := $i21154;
	$i31155 := $stringSize[r01152];
	 //  @line: 10
	__ret := $i31155;
	 return;
}
...
Block891:
	...
	__ret := $r1843;
	 ...
	 //  @line: 12
// <javaUtilEx.juHashMapCreateEquals: javaUtilEx.HashMap createMap(int)>
procedure javaUtilEx.HashMap$javaUtilEx.juHashMapCreateEquals$createMap$2779($param_0 : int) returns (__ret : ref) {
var r11143 : ref;
var $i01142 : int;
var $r51144 : ref;
var r21146 : ref;
...
Block1168:
	i21148 := $param_0;
	 //  @line: 13
	$r31138 := $newvariable((1169));
	 assume ($neref(($newvariable((1169))), ($null))==1);
	 assert ($neref(($r31138), ($null))==1);
	 //  @line: 13
	 call void$javaUtilEx.HashMap$$la$init$ra$$2609(($r31138));
	 //  @line: 13
	r01139 := $r31138;
	 goto Block1170;
	 //  @line: 14
Block1170:
	 ...
	 //  @line: 14
Block1171:
	 assume ($leint((i21148), (0))==1);
	 goto Block1172;
	 //  @line: 14
Block1173:
	 //  @line: 14
	 assume ($negInt(($leint((i21148), (0))))==1);
	 //  @line: 15
	$r41141 := $newvariable((1174));
	 assume ($neref(($newvariable((1174))), ($null))==1);
	 //  @line: 15
	 call $i01142 := int$javaUtilEx.Random$random$2781();
	 assert ($neref(($r41141), ($null))==1);
	 //  @line: 15
	 call void$javaUtilEx.Content$$la$init$ra$$2604(($r41141), ($i01142));
	 //  @line: 15
	r11143 := $r41141;
	 //  @line: 16
	$r51144 := $newvariable((1175));
	 assume ($neref(($newvariable((1175))), ($null))==1);
	 //  @line: 16
	 call $i11145 := int$javaUtilEx.Random$random$2781();
	 assert ($neref(($r51144), ($null))==1);
	 //  @line: 16
	 call void$javaUtilEx.Content$$la$init$ra$$2604(($r51144), ($i11145));
	 //  @line: 16
	r21146 := $r51144;
	 assert ($neref((r01139), ($null))==1);
	 //  @line: 17
	 call $freshlocal0 := java.lang.Object$javaUtilEx.HashMap$put$2620((r01139), (r11143), (r21146));
	 //  @line: 18
	i21148 := $addint((i21148), (-1));
	 goto Block1170;
	 //  @line: 20
Block1172:
	 //  @line: 20
...
Block1176:
	r01149 := __this;
	 assert ($neref((r01149), ($null))==1);
	 //  @line: 3
	 call void$java.lang.Object$$la$init$ra$$28((r01149));
	 return;
}
...
procedure void$javaUtilEx.HashMap$$la$init$ra$$2607(__this : ref, $param_0 : int, $param_1 : realVar) returns ($Exep0 : ref)
  modifies $HeapVar, $stringSize, $refArrSize;
  requires ($neref((__this), ($null))==1);
 {
var $r7534 : ref;
var i3540 : int;
...
Block133:
	...
	$stringSize[$fresh6] := 2;
	 ...
	 //  @line: 2
// <javaUtilEx.juHashMapCreateEquals: void <init>()>
procedure void$javaUtilEx.juHashMapCreateEquals$$la$init$ra$$2777(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01129 : ref;
Block1166:
	r01129 := __this;
...
procedure javaUtilEx.Iterator$javaUtilEx.Collection$iterator$2244(__this : ref) returns (__ret : ref);
	 ...
	 //  @line: 4
// <javaUtilEx.juHashMapCreateEquals: void main(java.lang.String[])>
procedure void$javaUtilEx.juHashMapCreateEquals$main$2778($param_0 : [int]ref)
...
Block1167:
	...
	java.lang.String$lp$$rp$$javaUtilEx.Random$args321 := r01130;
	 ...
	 //  @line: 7
	 call r11133 := javaUtilEx.HashMap$javaUtilEx.juHashMapCreateEquals$createMap$2779(($i01131));
	 //  @line: 8
	 call $i11134 := int$javaUtilEx.Random$random$2781();
	 //  @line: 8
	 call r21136 := javaUtilEx.HashMap$javaUtilEx.juHashMapCreateEquals$createMap$2779(($i11134));
	 assert ($neref((r11133), ($null))==1);
	 //  @line: 9
	 call $freshlocal0 := boolean$javaUtilEx.AbstractMap$equals$2512((r11133), (r21136));
	 return;
}
