...
function {:inline true} $newvariable($param00 : int) returns (__ret : ref);
	 ...
	 //  @line: 2
// <LogIterative: int log(int,int)>
procedure int$LogIterative$log$2229($param_0 : int, $param_1 : int) returns (__ret : int) {
var i15 : int;
var i26 : int;
var i04 : int;
Block17:
...
// <LogIterative: void <init>()>
procedure void$LogIterative$$la$init$ra$$2228(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01 : ref;
Block16:
	r01 := __this;
...
function {:inline true} $geref($param00 : ref, $param11 : ref) returns (__ret : int);
	 ...
	 //  @line: 11
// <LogIterative: void main(java.lang.String[])>
procedure void$LogIterative$main$2230($param_0 : [int]ref)
...
Block25:
	...
	java.lang.String$lp$$rp$$Random$args254 := r07;
	 ...
	 //  @line: 15
	 call $freshlocal0 := int$LogIterative$log$2229((i09), (i111));
	 return;
}
