...
if (x < y) then 1 else if (x == y) then 0 else -1
	 ...
	 //  @line: 4
// <Terms.TermsCreateMatch: void main(java.lang.String[])>
procedure void$Terms.TermsCreateMatch$main$2482($param_0 : [int]ref)
...
Block147:
	...
	java.lang.String$lp$$rp$$Terms.Random$args261 := r0148;
	 ...
	 //  @line: 7
	 call $i1152 := int$Terms.Random$random$2257();
	 //  @line: 7
	 call r2154 := Terms.Term$Terms.Term$create$2235(($i1152));
	 assert ($neref((r1151), ($null))==1);
	 //  @line: 8
	 call $freshlocal0 := boolean$Terms.Term$matches$2236((r1151), (r2154));
	 return;
}
...
procedure int$Terms.Random$random$2257() returns (__ret : int)
  modifies int$Terms.Random$index0, $stringSize;
 {
var r0143 : ref;
var $i3146 : int;
var $i0141 : int;
...
if (x == 0) then 1 else 0
	 ...
	 //  @line: 2
// <Terms.TermsCreateMatch: void <init>()>
procedure void$Terms.TermsCreateMatch$$la$init$ra$$2481(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r0147 : ref;
Block146:
	r0147 := __this;
