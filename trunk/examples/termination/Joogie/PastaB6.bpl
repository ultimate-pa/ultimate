...
if (x != y) then 1 else 0
	 ...
	 //  @line: 8
// <PastaB6: void main(java.lang.String[])>
procedure void$PastaB6$main$2229($param_0 : [int]ref)
...
if (x < y) then 1 else if (x == y) then 0 else -1
	 ...
	 //  @line: 6
// <PastaB6: void <init>()>
procedure void$PastaB6$$la$init$ra$$2228(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01 : ref;
Block16:
	r01 := __this;
