...
var SharingPair$SharingPair$next296 : Field ref;
...
procedure int$java.lang.String$length$59(__this : ref) returns (__ret : int);
	 ...
	 //  @line: 4
// <SharingPair: void main(java.lang.String[])>
procedure void$SharingPair$main$2454($param_0 : [int]ref)
...
Block20:
	...
	$r310 := $newvariable((21));
	 ...
	 //  @line: 6
	 call void$SharingPair$$la$init$ra$$2453(($r310));
	 //  @line: 6
	r111 := $r310;
	 //  @line: 7
	$r412 := $newvariable((22));
	 ...
	 //  @line: 7
	 call void$SharingPair$$la$init$ra$$2453(($r412));
	 //  @line: 7
	r213 := $r412;
	 //  @line: 9
	 call i015 := int$Random$random$2229();
	 goto Block23;
	 //  @line: 10
Block23:
...
Block26:
	 ...
	 //  @line: 11
	$HeapVar[r111, SharingPair$SharingPair$next296] := r213;
	 //  @line: 12
	r719 := r111;
	 goto Block27;
	 //  @line: 14
Block25:
	 ...
	 //  @line: 14
	$HeapVar[r213, SharingPair$SharingPair$next296] := r111;
	 goto Block28;
	 //  @line: 19
Block27:
...
Block31:
	...
	$r618 := $newvariable((32));
	 ...
	 //  @line: 20
	 call void$SharingPair$$la$init$ra$$2453(($r618));
	 assert ($neref((r111), ($null))==1);
	 //  @line: 20
	$HeapVar[r111, SharingPair$SharingPair$next296] := $r618;
	 assert ($neref((r719), ($null))==1);
	 //  @line: 21
	r719 := $HeapVar[r719, SharingPair$SharingPair$next296];
	 goto Block27;
	 //  @line: 19
Block29:
	 assume ($neint((i015), (0))==1);
...
Block34:
	 ...
	 //  @line: 23
	 call void$SharingPair$$la$init$ra$$2453(($r517));
	 assert ($neref((r213), ($null))==1);
	 //  @line: 23
	$HeapVar[r213, SharingPair$SharingPair$next296] := $r517;
	 assert ($neref((r719), ($null))==1);
	 //  @line: 24
	r719 := $HeapVar[r719, SharingPair$SharingPair$next296];
	 goto Block27;
...
// <SharingPair: void <init>()>
procedure void$SharingPair$$la$init$ra$$2453(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r08 : ref;
Block19:
	r08 := __this;
