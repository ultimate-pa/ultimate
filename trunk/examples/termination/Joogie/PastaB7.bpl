...
function {:inline true} $orint($param00 : int, $param11 : int) returns (__ret : int);
	 ...
	 //  @line: 6
// <PastaB7: void <init>()>
procedure void$PastaB7$$la$init$ra$$2228(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01 : ref;
Block16:
	r01 := __this;
...
if ($ltref((x), (y)) == 1) then 1 else if ($eqref((x), (y)) == 1) then 0 else -1
	 ...
	 //  @line: 8
// <PastaB7: void main(java.lang.String[])>
procedure void$PastaB7$main$2229($param_0 : [int]ref)
