...
Block28:
	...
	$i128 := int$Random$index0;
	 //  @line: 6
	$r126 := java.lang.String$lp$$rp$$Random$args254;
	 //  @line: 6
	$i027 := $refArrSize[$r126[$arrSizeIdx]];
	 goto Block29;
	 //  @line: 6
Block29:
	 ...
	 //  @line: 6
Block30:
	 assume ($ltint(($i128), ($i027))==1);
	 goto Block31;
	 //  @line: 6
Block32:
	 //  @line: 6
	 assume ($negInt(($ltint(($i128), ($i027))))==1);
	 //  @line: 7
	__ret := 0;
	 return;
	 //  @line: 9
Block31:
	 //  @line: 9
	$r230 := java.lang.String$lp$$rp$$Random$args254;
	 goto Block33;
	 //  @line: 9
Block33:
	 //  @line: 9
	$i229 := int$Random$index0;
	 assert ($geint(($i229), (0))==1);
	 assert ($ltint(($i229), ($refArrSize[$r230[$arrSizeIdx]]))==1);
	 //  @line: 9
	r031 := $r230[$i229];
	 //  @line: 10
	$i332 := int$Random$index0;
	 //  @line: 10
	$i433 := $addint(($i332), (1));
	 //  @line: 10
	int$Random$index0 := $i433;
	$i534 := $stringSize[r031];
	 //  @line: 11
	__ret := $i534;
	 return;
}
...
Block17:
	...
	java.lang.String$lp$$rp$$Random$args254 := r02;
	 //  @line: 4
	 call i1122 := int$Random$random$2231();
	 //  @line: 5
	 call i1223 := int$Random$random$2231();
	 //  @line: 6
	 call i1324 := int$Random$random$2231();
	 goto Block18;
	 //  @line: 7
Block18:
	 ...
	 //  @line: 7
Block19:
	 assume ($ltint((i1324), (0))==1);
	 goto Block20;
	 //  @line: 7
Block21:
	 //  @line: 7
	 assume ($negInt(($ltint((i1324), (0))))==1);
	 //  @line: 8
	...
	$i213 := $mulint((2), (i1122));
	 //  @line: 10
	$i718 := $subint(($i314), ($i213));
	 //  @line: 10
	$i516 := $mulint((3), (i112));
	 //  @line: 10
	$i415 := $mulint((2), (i010));
	 //  @line: 10
	$i617 := $subint(($i516), ($i415));
	 goto Block22;
	 //  @line: 15
Block20:
	 return;
...
Block22:
	 ...
	 //  @line: 10
Block23:
	 assume ($ltint(($i718), ($i617))==1);
	 goto Block24;
	 //  @line: 10
Block25:
	 //  @line: 10
	 assume ($negInt(($ltint(($i718), ($i617))))==1);
	 goto Block20;
	 //  @line: 11
Block24:
	 //  @line: 11
...
Block26:
	...
	$i819 := $mulint((2), (i1122));
	 //  @line: 13
	$i1021 := $subint(($i920), ($i819));
	 //  @line: 13
	i1324 := $subint((i1324), ($i1021));
	 goto Block18;
}
