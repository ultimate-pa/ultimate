...
// <Overflow: void <init>()>
procedure void$Overflow$$la$init$ra$$2228(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01 : ref;
Block16:
	r01 := __this;
...
Block24:
	 //  @line: 6
	$r18 := java.lang.String$lp$$rp$$Random$args254;
	 //  @line: 6
	$i07 := int$Random$index0;
	 assert ($geint(($i07), (0))==1);
	 assert ($ltint(($i07), ($refArrSize[$r18[$arrSizeIdx]]))==1);
	 //  @line: 6
	r09 := $r18[$i07];
	 //  @line: 7
	$i110 := int$Random$index0;
	 //  @line: 7
	$i211 := $addint(($i110), (1));
	 //  @line: 7
	int$Random$index0 := $i211;
	$i312 := $stringSize[r09];
	 //  @line: 8
	__ret := $i312;
	 return;
...
function {:inline true} $eqintarray($param00 : [int]int, $param11 : [int]int) returns (__ret : int);
	 ...
	 //  @line: 10
// <Overflow: void main(java.lang.String[])>
procedure void$Overflow$main$2230($param_0 : [int]ref)
...
Block22:
	...
	java.lang.String$lp$$rp$$Random$args254 := r04;
	 //  @line: 12
	 call $i05 := int$Random$random$2232();
	 //  @line: 12
	 call void$Overflow$overflow$2229(($i05));
	 return;
}
...
function {:inline true} $gereal($param00 : realVar, $param11 : realVar) returns (__ret : int);
	 ...
	 //  @line: 4
// <Overflow: void overflow(int)>
procedure void$Overflow$overflow$2229($param_0 : int) {
var i03 : int;
Block17:
	i03 := $param_0;
	 goto Block18;
...
Block21:
	 //  @line: 5
	 assume ($negInt(($gtint((i03), (2147483647))))==1);
	 //  @line: 6
	i03 := $addint((i03), (1));
	 goto Block18;
	 //  @line: 5
Block19:
	 assume ($gtint((i03), (2147483647))==1);
	 goto Block20;
	 //  @line: 8
Block20:
	 return;
