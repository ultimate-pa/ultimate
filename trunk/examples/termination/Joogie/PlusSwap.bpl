...
function {:inline true} $ushrint($param00 : int, $param11 : int) returns (__ret : int);
	 ...
	 //  @line: 2
// <PlusSwap: void main(java.lang.String[])>
procedure void$PlusSwap$main$2229($param_0 : [int]ref)
...
// <PlusSwap: void <init>()>
procedure void$PlusSwap$$la$init$ra$$2228(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01 : ref;
Block16:
	r01 := __this;
