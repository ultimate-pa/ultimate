...
function {:inline true} $ushrint($param00 : int, $param11 : int) returns (__ret : int);
	 ...
	 //  @line: 6
// <PastaB10: void <init>()>
procedure void$PastaB10$$la$init$ra$$2228(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01 : ref;
Block16:
	r01 := __this;
...
if (x == y) then 1 else 0
	 ...
	 //  @line: 8
// <PastaB10: void main(java.lang.String[])>
procedure void$PastaB10$main$2229($param_0 : [int]ref)
