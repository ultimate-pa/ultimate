...
function {:inline true} $geref($param00 : ref, $param11 : ref) returns (__ret : int);
	 ...
	 //  @line: 8
// <PastaB2: void main(java.lang.String[])>
procedure void$PastaB2$main$2229($param_0 : [int]ref)
...
function {:inline true} $andreal($param00 : realVar, $param11 : realVar) returns (__ret : int);
	 ...
	 //  @line: 6
// <PastaB2: void <init>()>
procedure void$PastaB2$$la$init$ra$$2228(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01 : ref;
Block16:
	r01 := __this;
