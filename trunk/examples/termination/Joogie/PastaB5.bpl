...
function {:inline true} $negReal($param00 : realVar) returns (__ret : int);
	 ...
	 //  @line: 8
// <PastaB5: void main(java.lang.String[])>
procedure void$PastaB5$main$2229($param_0 : [int]ref)
...
function {:inline true} $gereal($param00 : realVar, $param11 : realVar) returns (__ret : int);
	 ...
	 //  @line: 6
// <PastaB5: void <init>()>
procedure void$PastaB5$$la$init$ra$$2228(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01 : ref;
Block16:
	r01 := __this;
