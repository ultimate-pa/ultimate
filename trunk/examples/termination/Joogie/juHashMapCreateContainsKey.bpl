...
Block1177:
	r01148 := __this;
	 assert ($neref((r01148), ($null))==1);
	 //  @line: 3
	 call void$java.lang.Object$$la$init$ra$$28((r01148));
	 return;
}
...
Block448:
	...
	__ret := r2425;
	 ...
	 //  @line: 2
// <javaUtilEx.juHashMapCreateContainsKey: void <init>()>
procedure void$javaUtilEx.juHashMapCreateContainsKey$$la$init$ra$$2777(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01129 : ref;
Block1166:
	r01129 := __this;
...
Block912:
	...
	$HeapVar[r0854, javaUtilEx.Collection$javaUtilEx.AbstractMap$values299] := r3858;
	 ...
	 //  @line: 4
// <javaUtilEx.juHashMapCreateContainsKey: void main(java.lang.String[])>
procedure void$javaUtilEx.juHashMapCreateContainsKey$main$2778($param_0 : [int]ref)
...
Block1167:
	...
	java.lang.String$lp$$rp$$javaUtilEx.Random$args321 := r01130;
	 ...
	 //  @line: 7
	 call r11133 := javaUtilEx.HashMap$javaUtilEx.juHashMapCreateContainsKey$createMap$2779(($i01131));
	 //  @line: 8
	$r21134 := $newvariable((1168));
	 ...
	 //  @line: 8
	 call $freshlocal0 := boolean$javaUtilEx.HashMap$containsKey$2618((r11133), ($r21134));
	 return;
}
...
Block1178:
	 //  @line: 8
	$r11150 := java.lang.String$lp$$rp$$javaUtilEx.Random$args321;
	 //  @line: 8
	$i01149 := int$javaUtilEx.Random$index0;
	 assert ($geint(($i01149), (0))==1);
	 assert ($ltint(($i01149), ($refArrSize[$r11150[$arrSizeIdx]]))==1);
	 //  @line: 8
	r01151 := $r11150[$i01149];
	 //  @line: 9
	$i11152 := int$javaUtilEx.Random$index0;
	 //  @line: 9
	$i21153 := $addint(($i11152), (1));
	 //  @line: 9
	int$javaUtilEx.Random$index0 := $i21153;
	$i31154 := $stringSize[r01151];
	 //  @line: 10
	__ret := $i31154;
	 return;
}
...
procedure java.lang.Object$javaUtilEx.Iterator$next$2255(__this : ref) returns (__ret : ref);
	 ...
	 //  @line: 11
// <javaUtilEx.juHashMapCreateContainsKey: javaUtilEx.HashMap createMap(int)>
procedure javaUtilEx.HashMap$javaUtilEx.juHashMapCreateContainsKey$createMap$2779($param_0 : int) returns (__ret : ref) {
var $r41140 : ref;
var $i01141 : int;
var r21145 : ref;
var $i11144 : int;
...
Block1169:
	i21147 := $param_0;
	 //  @line: 12
	$r31137 := $newvariable((1170));
	 assume ($neref(($newvariable((1170))), ($null))==1);
	 assert ($neref(($r31137), ($null))==1);
	 //  @line: 12
	 call void$javaUtilEx.HashMap$$la$init$ra$$2609(($r31137));
	 //  @line: 12
	r01138 := $r31137;
	 goto Block1171;
	 //  @line: 13
...
Block1174:
	 //  @line: 13
	 assume ($negInt(($leint((i21147), (0))))==1);
	 //  @line: 14
	$r41140 := $newvariable((1175));
	 assume ($neref(($newvariable((1175))), ($null))==1);
	 //  @line: 14
	 call $i01141 := int$javaUtilEx.Random$random$2781();
	 assert ($neref(($r41140), ($null))==1);
	 //  @line: 14
	 call void$javaUtilEx.Content$$la$init$ra$$2604(($r41140), ($i01141));
	 //  @line: 14
	r11142 := $r41140;
	 //  @line: 15
	$r51143 := $newvariable((1176));
	 assume ($neref(($newvariable((1176))), ($null))==1);
	 //  @line: 15
	 call $i11144 := int$javaUtilEx.Random$random$2781();
	 assert ($neref(($r51143), ($null))==1);
	 //  @line: 15
	 call void$javaUtilEx.Content$$la$init$ra$$2604(($r51143), ($i11144));
	 //  @line: 15
	r21145 := $r51143;
	 assert ($neref((r01138), ($null))==1);
	 //  @line: 16
	 call $freshlocal0 := java.lang.Object$javaUtilEx.HashMap$put$2620((r01138), (r11142), (r21145));
	 //  @line: 17
	i21147 := $addint((i21147), (-1));
	 goto Block1171;
	 //  @line: 13
Block1172:
	 assume ($leint((i21147), (0))==1);
	 goto Block1173;
	 //  @line: 19
Block1173:
	 //  @line: 19
