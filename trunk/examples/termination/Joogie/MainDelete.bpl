...
if (x != y) then 1 else 0
	 ...
	 //  @line: 6
// <DoublyLinkedList.MainDelete: void <init>()>
procedure void$DoublyLinkedList.MainDelete$$la$init$ra$$2238(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r071 : ref;
Block100:
	r071 := __this;
	 ...
	 //  @line: 8
// <DoublyLinkedList.MainDelete: void main(java.lang.String[])>
procedure void$DoublyLinkedList.MainDelete$main$2239($param_0 : [int]ref)
...
Block101:
	...
	java.lang.String$lp$$rp$$DoublyLinkedList.Random$args256 := r072;
	 ...
	 //  @line: 11
	 call void$DoublyLinkedList.DoublyLinkedList$delete$2234((r174), ($i075));
	 return;
}
...
Block103:
	 //  @line: 7
	$r177 := java.lang.String$lp$$rp$$DoublyLinkedList.Random$args256;
	 //  @line: 7
	$i179 := $refArrSize[$r177[$arrSizeIdx]];
	 //  @line: 7
	$i078 := int$DoublyLinkedList.Random$index0;
	 goto Block104;
	 //  @line: 7
Block104:
	 ...
	 //  @line: 7
Block105:
	 assume ($gtint(($i179), ($i078))==1);
	 goto Block106;
	 //  @line: 7
Block107:
	 //  @line: 7
	 assume ($negInt(($gtint(($i179), ($i078))))==1);
	 //  @line: 8
	__ret := 0;
	 return;
	 //  @line: 10
Block106:
	 //  @line: 10
	$r281 := java.lang.String$lp$$rp$$DoublyLinkedList.Random$args256;
	 goto Block108;
	 //  @line: 10
Block108:
	 //  @line: 10
	$i280 := int$DoublyLinkedList.Random$index0;
	 assert ($geint(($i280), (0))==1);
	 assert ($ltint(($i280), ($refArrSize[$r281[$arrSizeIdx]]))==1);
	 //  @line: 10
	r082 := $r281[$i280];
	 //  @line: 11
	$i383 := int$DoublyLinkedList.Random$index0;
	 //  @line: 11
	$i484 := $addint(($i383), (1));
	 //  @line: 11
	int$DoublyLinkedList.Random$index0 := $i484;
	 goto Block109;
	 //  @line: 12
Block109:
...
Block112:
	 //  @line: 12
	 assume ($negInt(($neref((r082), ($null))))==1);
	 //  @line: 13
	__ret := 0;
	 return;
	 //  @line: 12
Block110:
	 assume ($neref((r082), ($null))==1);
	 goto Block111;
	 //  @line: 15
Block111:
	$i585 := $stringSize[r082];
	 goto Block113;
	 //  @line: 15
Block113:
	 //  @line: 15
