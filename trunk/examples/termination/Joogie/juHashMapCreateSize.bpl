...
procedure void$java.lang.RuntimeException$$la$init$ra$$762(__this : ref, $param_0 : ref, $param_1 : ref);
	 ...
	 //  @line: 11
// <javaUtilEx.juHashMapCreateSize: javaUtilEx.HashMap createMap(int)>
procedure javaUtilEx.HashMap$javaUtilEx.juHashMapCreateSize$createMap$2779($param_0 : int) returns (__ret : ref) {
var r01137 : ref;
var r21144 : ref;
var i21146 : int;
var $i01140 : int;
...
Block1168:
	...
	$r31136 := $newvariable((1169));
	 ...
	 //  @line: 12
	 call void$javaUtilEx.HashMap$$la$init$ra$$2609(($r31136));
	 //  @line: 12
	r01137 := $r31136;
	 goto Block1170;
	 //  @line: 13
Block1170:
	 goto Block1173, Block1171;
	 //  @line: 13
Block1173:
	 //  @line: 13
	 assume ($negInt(($leint((i21146), (0))))==1);
	 //  @line: 14
	$r41139 := $newvariable((1174));
	 assume ($neref(($newvariable((1174))), ($null))==1);
	 //  @line: 14
	 call $i01140 := int$javaUtilEx.Random$random$2781();
	 assert ($neref(($r41139), ($null))==1);
	 //  @line: 14
	 call void$javaUtilEx.Content$$la$init$ra$$2604(($r41139), ($i01140));
	 //  @line: 14
	r11141 := $r41139;
	 //  @line: 15
	$r51142 := $newvariable((1175));
	 assume ($neref(($newvariable((1175))), ($null))==1);
	 //  @line: 15
	 call $i11143 := int$javaUtilEx.Random$random$2781();
	 assert ($neref(($r51142), ($null))==1);
	 //  @line: 15
	 call void$javaUtilEx.Content$$la$init$ra$$2604(($r51142), ($i11143));
	 //  @line: 15
	r21144 := $r51142;
	 assert ($neref((r01137), ($null))==1);
	 //  @line: 16
	 call $freshlocal0 := java.lang.Object$javaUtilEx.HashMap$put$2620((r01137), (r11141), (r21144));
	 //  @line: 17
	i21146 := $addint((i21146), (-1));
	 goto Block1170;
	 //  @line: 13
Block1171:
	 assume ($leint((i21146), (0))==1);
	 goto Block1172;
	 //  @line: 19
Block1172:
	 //  @line: 19
...
Block1177:
	 //  @line: 8
	$r11149 := java.lang.String$lp$$rp$$javaUtilEx.Random$args321;
	 //  @line: 8
	$i01148 := int$javaUtilEx.Random$index0;
	 assert ($geint(($i01148), (0))==1);
	 assert ($ltint(($i01148), ($refArrSize[$r11149[$arrSizeIdx]]))==1);
	 //  @line: 8
	r01150 := $r11149[$i01148];
	 //  @line: 9
	$i11151 := int$javaUtilEx.Random$index0;
	 //  @line: 9
	$i21152 := $addint(($i11151), (1));
	 //  @line: 9
	int$javaUtilEx.Random$index0 := $i21152;
	$i31153 := $stringSize[r01150];
	 //  @line: 10
	__ret := $i31153;
	 return;
}
...
Block1045:
	...
	__ret := $i01000;
	 ...
	 //  @line: 2
// <javaUtilEx.juHashMapCreateSize: void <init>()>
procedure void$javaUtilEx.juHashMapCreateSize$$la$init$ra$$2777(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01129 : ref;
Block1166:
	r01129 := __this;
...
Block1097:
	...
	__ret := $z01070;
	 ...
	 //  @line: 4
// <javaUtilEx.juHashMapCreateSize: void main(java.lang.String[])>
procedure void$javaUtilEx.juHashMapCreateSize$main$2778($param_0 : [int]ref)
...
Block1167:
	...
	java.lang.String$lp$$rp$$javaUtilEx.Random$args321 := r01130;
	 //  @line: 7
	 call $i11131 := int$javaUtilEx.Random$random$2781();
	 //  @line: 7
	 call r11133 := javaUtilEx.HashMap$javaUtilEx.juHashMapCreateSize$createMap$2779(($i11131));
	 assert ($neref((r11133), ($null))==1);
	 //  @line: 8
	 call $freshlocal0 := int$javaUtilEx.HashMap$size$2614((r11133));
	 return;
}
...
Block1176:
	r01147 := __this;
	 assert ($neref((r01147), ($null))==1);
	 //  @line: 3
	 call void$java.lang.Object$$la$init$ra$$28((r01147));
	 return;
}
