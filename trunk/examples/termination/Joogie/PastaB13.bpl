...
Block32:
	r011 := __this;
	 ...
	 //  @line: 6
// <PastaB13: void <init>()>
procedure void$PastaB13$$la$init$ra$$2228(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01 : ref;
Block16:
	r01 := __this;
	 ...
	 //  @line: 8
// <PastaB13: void main(java.lang.String[])>
procedure void$PastaB13$main$2229($param_0 : [int]ref)
...
Block21:
	 //  @line: 14
	 assume ($negInt(($gtint((i19), (i08))))==1);
	 goto Block22;
	 //  @line: 14
Block19:
	 assume ($gtint((i19), (i08))==1);
	 goto Block20;
	 //  @line: 14
Block22:
