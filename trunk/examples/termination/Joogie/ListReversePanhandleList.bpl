...
function {:inline true} $orref($param00 : ref, $param11 : ref) returns (__ret : int);
	 ...
	 //  @line: 2
// <ListReversePanhandleList: void main(java.lang.String[])>
procedure void$ListReversePanhandleList$main$2234($param_0 : [int]ref)
  modifies $stringSize;
 {
var $r225 : ref;
var $i026 : int;
...
Block33:
	...
	$i026 := $stringSize[$r225];
	 assert ($geint((1), (0))==1);
	 assert ($ltint((1), ($refArrSize[r024[$arrSizeIdx]]))==1);
	 //  @line: 3
	$r327 := r024[1];
	$i128 := $stringSize[$r327];
	 //  @line: 3
	 call r130 := List$List$createPanhandleList$2232(($i026), ($i128));
	 //  @line: 4
	 call void$List$reverse$2229((r130));
	 return;
}
...
// <ListReversePanhandleList: void <init>()>
procedure void$ListReversePanhandleList$$la$init$ra$$2233(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r023 : ref;
Block32:
	r023 := __this;
