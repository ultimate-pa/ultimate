...
// <DivWithoutMinus: void <init>()>
procedure void$DivWithoutMinus$$la$init$ra$$2228(__this : ref)  requires ($neref((__this), ($null))==1);
 {
var r01 : ref;
Block16:
	r01 := __this;
...
if (x != y) then 1 else 0
	 ...
	 //  @line: 3
// <DivWithoutMinus: void main(java.lang.String[])>
procedure void$DivWithoutMinus$main$2229($param_0 : [int]ref)
...
Block26:
	 ...
	 //  @line: 13
Block32:
	 assume ($neint((i210), (0))==1);
	 goto Block33;
	 //  @line: 13
Block34:
	 //  @line: 13
	 assume ($negInt(($neint((i210), (0))))==1);
	 //  @line: 15
	i210 := i07;
	 goto Block18;
	 //  @line: 11
