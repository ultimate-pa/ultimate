...
modifies #memory_$Pointer$.base, #valid, #memory_int, #NULL.offset, #length, #NULL.base, #memory_$Pointer$.offset;
{
  ...
  loc2_1:
    assume !(0 == main_~item~0.offset) || !(0 == main_~item~0.base);
    main_~itr~0.base, main_~itr~0.offset := main_~item~0.base, main_~item~0.offset;
    read~$Pointer$_#ptr.base, read~$Pointer$_#sizeOfReadType, read~$Pointer$_#ptr.offset := main_~item~0.base, 4, main_~item~0.offset;
    assume !(1 == #valid[read~$Pointer$_#ptr.base]);
    goto loc3;
  loc3:
    assert false;
