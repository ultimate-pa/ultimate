...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2_1:
    ...
    goto loc1;
  loc3:
    assume main_~j~0 < main_~length~0 * main_~fac~0;
    assume ((!(0 == main_~i~0 % main_~length~0) && (((!(0 == main_~i~0 % main_~length~0) && main_~i~0 < 0) || !(main_~i~0 < 0)) || 0 == main_~i~0 % main_~length~0)) && main_~i~0 < 0) || ((!(main_~i~0 < 0) || 0 == main_~i~0 % main_~length~0) && (((!(0 == main_~i~0 % main_~length~0) && main_~i~0 < 0) || !(main_~i~0 < 0)) || 0 == main_~i~0 % main_~length~0));
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := main_~arr~0.base, 4 * (if main_~i~0 < 0 && !(main_~i~0 % main_~length~0 == 0) then (if main_~length~0 < 0 then main_~i~0 % main_~length~0 + main_~length~0 else main_~i~0 % main_~length~0 + -1 * main_~length~0) else main_~i~0 % main_~length~0) + main_~arr~0.offset, 4;
    ...
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 4, main_~arr2~0.base, main_#t~mem9, main_~arr2~0.offset + 4 * main_~j~0;
    assume 1 == #valid[write~int_#ptr.base];
    goto loc4;
  loc4:
    goto loc4_0, loc4_1;
  ...
  loc4_1:
    ...
    havoc main_#t~mem9;
    main_#t~post8 := main_~j~0;
    main_~j~0 := main_#t~post8 + 1;
    havoc main_#t~post8;
    goto loc3;
  loc5:
    assert false;
