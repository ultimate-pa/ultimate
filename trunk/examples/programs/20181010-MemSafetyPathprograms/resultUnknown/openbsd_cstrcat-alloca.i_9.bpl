...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
    ...
    var cstrcat_#t~pre2.base : int;
    var cstrcat_#in~append.offset : int;
    var cstrcat_~s.base : int;
  ...
  loc0:
    ...
    cstrcat_#in~s.base, cstrcat_#in~s.offset, cstrcat_#in~append.offset, cstrcat_#in~append.base := main_~nondetString2~0.base, main_~nondetString2~0.offset, main_~nondetString1~0.offset, main_~nondetString1~0.base;
    havoc cstrcat_#res.offset, cstrcat_#res.base;
    havoc cstrcat_~append.offset, cstrcat_#t~post4.offset, cstrcat_#t~pre2.offset, cstrcat_#t~post5.base, cstrcat_~save~0.base, cstrcat_~save~0.offset, cstrcat_#t~post5.offset, cstrcat_~append.base, cstrcat_~s.offset, cstrcat_#t~post4.base, cstrcat_#t~pre2.base, cstrcat_#t~mem3, cstrcat_~s.base, cstrcat_#t~mem6;
    cstrcat_~s.offset, cstrcat_~s.base := cstrcat_#in~s.offset, cstrcat_#in~s.base;
    cstrcat_~append.offset, cstrcat_~append.base := cstrcat_#in~append.offset, cstrcat_#in~append.base;
    cstrcat_~save~0.base, cstrcat_~save~0.offset := cstrcat_~s.base, cstrcat_~s.offset;
    goto loc1;
  loc1:
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := cstrcat_~s.base, cstrcat_~s.offset, 1;
  ...
  loc2_1:
    ...
    cstrcat_#t~mem3 := read~int_#value;
    assume !(0 == cstrcat_#t~mem3);
    havoc cstrcat_#t~mem3;
    cstrcat_#t~pre2.base, cstrcat_#t~pre2.offset := cstrcat_~s.base, cstrcat_~s.offset + 1;
    cstrcat_~s.offset, cstrcat_~s.base := cstrcat_~s.offset + 1, cstrcat_~s.base;
    havoc cstrcat_#t~pre2.base, cstrcat_#t~pre2.offset;
    goto loc1;
  loc3:
    assert false;
}
