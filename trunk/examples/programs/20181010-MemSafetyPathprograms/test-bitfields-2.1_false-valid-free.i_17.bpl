...
modifies ~#d~0.offset, ~#d~0.base, #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc0:
    ...
    assume write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base := write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base][write~unchecked~int_#ptr.offset := write~unchecked~int_#value]] == #memory_int;
    write~unchecked~int_old_#memory_int := #memory_int;
    write~unchecked~int_#sizeOfWrittenType, write~unchecked~int_#ptr.offset, write~unchecked~int_#value, write~unchecked~int_#ptr.base := 4, ~#d~0.offset + 5, 0, ~#d~0.base;
    havoc #memory_int;
    assume write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base := write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base][write~unchecked~int_#ptr.offset := write~unchecked~int_#value]] == #memory_int;
    write~unchecked~int_old_#memory_int := #memory_int;
    ...
    assume write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base := write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base][write~unchecked~int_#ptr.offset := write~unchecked~int_#value]] == #memory_int;
    write~unchecked~int_old_#memory_int := #memory_int;
    write~unchecked~int_#sizeOfWrittenType, write~unchecked~int_#ptr.offset, write~unchecked~int_#value, write~unchecked~int_#ptr.base := 1, ~#d~0.offset + 10, 0, ~#d~0.base;
    havoc #memory_int;
    assume write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base := write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base][write~unchecked~int_#ptr.offset := write~unchecked~int_#value]] == #memory_int;
    write~unchecked~int_old_#memory_int := #memory_int;
    write~unchecked~int_#sizeOfWrittenType, write~unchecked~int_#ptr.offset, write~unchecked~int_#value, write~unchecked~int_#ptr.base := 1, ~#d~0.offset + 11, 0, ~#d~0.base;
    havoc #memory_int;
    assume write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base := write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base][write~unchecked~int_#ptr.offset := write~unchecked~int_#value]] == #memory_int;
    write~unchecked~int_old_#memory_int := #memory_int;
    write~unchecked~int_#sizeOfWrittenType, write~unchecked~int_#ptr.offset, write~unchecked~int_#value, write~unchecked~int_#ptr.base := 1, ~#d~0.offset + 12, 0, ~#d~0.base;
    havoc #memory_int;
    assume write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base := write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base][write~unchecked~int_#ptr.offset := write~unchecked~int_#value]] == #memory_int;
    ...
    assume write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]] == #memory_int;
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 4, ~#d~0.base, 4, ~#d~0.offset + 5;
    assume 1 == #valid[write~int_#ptr.base];
    assume write~int_#sizeOfWrittenType + write~int_#ptr.offset <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    assume #valid[write~int_#ptr.base] == 1;
    assume 0 <= write~int_#ptr.offset && write~int_#sizeOfWrittenType + write~int_#ptr.offset <= #length[write~int_#ptr.base];
    ...
    assume write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]] == #memory_int;
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 1, ~#d~0.base, 5, ~#d~0.offset + 9;
    assume #valid[write~int_#ptr.base] == 1;
