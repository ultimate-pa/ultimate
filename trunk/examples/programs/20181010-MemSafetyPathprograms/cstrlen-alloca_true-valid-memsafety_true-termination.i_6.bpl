...
{
    var cstrlen_#t~post3.offset : int;
    var cstrlen_~s.base : int;
    var read~int_#value : int;
    var main_#t~nondet4 : int;
    var #Ultimate.alloc_old_#valid : [int]int;
    var write~int_#ptr.offset : int;
    var cstrlen_#in~s.offset : int;
    var cstrlen_~p~0.base : int;
    var write~int_#ptr.base : int;
    var main_~nondetString1~0.base : int;
    var cstrlen_#t~post3.base : int;
    var #Ultimate.alloc_#res.base : int;
    var #Ultimate.alloc_#res.offset : int;
    var cstrlen_~p~0.offset : int;
    ...
    var cstrlen_#in~s.base : int;
    var #Ultimate.alloc_old_#length : [int]int;
    var cstrlen_~s.offset : int;
  ...
  loc0:
    ...
    cstrlen_#in~s.offset, cstrlen_#in~s.base := main_~nondetString1~0.offset, main_~nondetString1~0.base;
    havoc cstrlen_#res;
    havoc cstrlen_#t~post3.offset, cstrlen_~p~0.offset, cstrlen_~s.base, cstrlen_~p~0.base, cstrlen_#t~post3.base, cstrlen_#t~mem2, cstrlen_~s.offset;
    cstrlen_~s.base, cstrlen_~s.offset := cstrlen_#in~s.base, cstrlen_#in~s.offset;
    cstrlen_~p~0.offset, cstrlen_~p~0.base := cstrlen_~s.offset, cstrlen_~s.base;
    goto loc1;
  loc1:
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := cstrlen_~p~0.base, cstrlen_~p~0.offset, 1;
  ...
  loc2_1:
    ...
    cstrlen_#t~mem2 := read~int_#value;
    assume !(0 == cstrlen_#t~mem2);
    havoc cstrlen_#t~mem2;
    cstrlen_#t~post3.offset, cstrlen_#t~post3.base := cstrlen_~p~0.offset, cstrlen_~p~0.base;
    cstrlen_~p~0.offset, cstrlen_~p~0.base := cstrlen_#t~post3.offset + 1, cstrlen_#t~post3.base;
    havoc cstrlen_#t~post3.offset, cstrlen_#t~post3.base;
    goto loc1;
  loc3:
    assert false;
}
