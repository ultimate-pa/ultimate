...
modifies ~b~0.base, ~a~0.base, #valid, ~b~0.offset, #memory_int, #NULL.offset, ~a~0.offset, #length, ~n~0, #NULL.base;
{
  ...
  loc0:
    ...
    havoc main_#res;
    havoc main_#t~malloc4.offset, main_#t~post6.base, main_#t~mem7, main_#t~nondet2, main_#t~post3, main_#t~malloc4.base, main_#t~malloc5.base, main_#t~post6.offset, main_#t~malloc5.offset;
    ~n~0 := 1;
    ...
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 4, main_#t~post6.base, 0, main_#t~post6.offset;
  ...
  loc2_0:
    assume !(foo_~i~0 < ~n~0);
    foo_~i~0 := 0;
    assume !(foo_~i~0 + 1 < ~n~0);
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := ~b~0.base, ~b~0.offset + -4, 4;
    ...
    assume !(main_#t~mem7 == 0);
    havoc main_#t~mem7;
    assume 0 == ~a~0.offset;
    assume 0 == ~a~0.base || #valid[~a~0.base] == 1;
    ULTIMATE.dealloc_old_#valid := #valid;
    ULTIMATE.dealloc_~addr.base, ULTIMATE.dealloc_~addr.offset := ~a~0.base, ~a~0.offset;
    havoc #valid;
