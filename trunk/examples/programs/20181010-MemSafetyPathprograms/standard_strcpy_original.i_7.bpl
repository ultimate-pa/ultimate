...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc0:
    ...
    havoc main_#res;
    havoc main_~#src~0.offset, main_~#dst~0.offset, main_~#src~0.base, main_#t~mem2, main_#t~mem1, main_#t~mem0, main_~i~0, main_~#dst~0.base, main_#t~mem4, main_#t~mem3;
