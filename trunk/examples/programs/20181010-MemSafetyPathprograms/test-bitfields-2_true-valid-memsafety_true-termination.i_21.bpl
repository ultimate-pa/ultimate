...
modifies ~#d~0.offset, ~#d~0.base, #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc1_1:
    ...
    assume !(3 == main_#t~mem4 % 256);
    havoc main_#t~mem4;
    assume main_~p~0.offset == 0;
    assume #valid[main_~p~0.base] == 1 || main_~p~0.base == 0;
    ...
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := main_~p~0.base, main_~p~0.offset + 3, 1;
    assume !(1 == #valid[read~int_#ptr.base]);
    goto loc2;
  loc2:
    assert false;
