...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
    ...
    var Sum_#t~post3 : int;
    var write~int_#ptr.base : int;
    var Sum_~count~0 : int;
    var Sum_#t~union6.b : int;
    var Sum_#t~union6.a : int;
    var Sum_#t~union6.d : int;
    var Sum_#t~union6.c : int;
    var Sum_#t~union6.f : int;
    var #Ultimate.alloc_#res.base : int;
    var Sum_#t~union6.e : int;
    var #Ultimate.alloc_#res.offset : int;
    var Sum_~instrs.offset : int;
    var #Ultimate.alloc_~size : int;
    var main_#t~memset12.base : int;
    var Sum_~instrs.base : int;
    var main_~p~0.base : int;
    var write~int_old_#memory_int : [int][int]int;
    var Sum_#in~instrs.base : int;
  ...
  loc1_1:
    ...
    havoc #memory_int;
    assume #memory_int == write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]];
    Sum_#in~instrs.base, Sum_#in~instrs.offset := main_~p~0.base, main_~p~0.offset;
    havoc Sum_#res;
    havoc Sum_~instrs.offset, Sum_#t~mem4, Sum_~instrs.base, Sum_~i~0, Sum_#t~mem5, Sum_#t~post3, Sum_~count~0, Sum_#t~union6.b, Sum_#t~union6.a, Sum_#t~union6.d, Sum_#t~union6.c, Sum_#t~union6.f, Sum_#t~union6.e;
    Sum_~instrs.offset, Sum_~instrs.base := Sum_#in~instrs.offset, Sum_#in~instrs.base;
    Sum_~count~0 := 0;
    havoc Sum_~i~0;
    Sum_~i~0 := 0;
    goto loc2;
  loc2:
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := Sum_~instrs.base, Sum_~instrs.offset, 4;
    ...
    Sum_#t~mem4 := read~int_#value;
    assume Sum_~i~0 < Sum_#t~mem4;
    havoc Sum_#t~mem4;
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := Sum_~instrs.base, Sum_~instrs.offset + 30 * Sum_~i~0 + 10, 8;
    assume #valid[read~int_#ptr.base] == 1;
    goto loc3;
  loc3:
    goto loc3_0, loc3_1;
  ...
  loc3_1:
    ...
    havoc read~int_#value;
    assume read~int_#value == #memory_int[read~int_#ptr.base][read~int_#ptr.offset];
    Sum_#t~mem5 := read~int_#value;
    Sum_~count~0 := Sum_#t~mem5 + Sum_~count~0;
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 2, Sum_~instrs.base, Sum_#t~union6.a, Sum_~instrs.offset + 30 * Sum_~i~0 + 4;
    assume 1 == #valid[write~int_#ptr.base];
    assume write~int_#ptr.offset + write~int_#sizeOfWrittenType <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    assume #valid[write~int_#ptr.base] == 1;
    assume write~int_#ptr.offset + write~int_#sizeOfWrittenType <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    ...
    assume write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]] == #memory_int;
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 2, Sum_~instrs.base, Sum_#t~union6.b, 30 * Sum_~i~0 + Sum_~instrs.offset + 6;
    assume 1 == #valid[write~int_#ptr.base];
    assume write~int_#sizeOfWrittenType + write~int_#ptr.offset <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    assume 1 == #valid[write~int_#ptr.base];
    assume write~int_#sizeOfWrittenType + write~int_#ptr.offset <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    ...
    assume write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]] == #memory_int;
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 2, Sum_~instrs.base, Sum_#t~union6.c, 30 * Sum_~i~0 + Sum_~instrs.offset + 8;
    assume #valid[write~int_#ptr.base] == 1;
    assume 0 <= write~int_#ptr.offset && write~int_#ptr.offset + write~int_#sizeOfWrittenType <= #length[write~int_#ptr.base];
    assume 1 == #valid[write~int_#ptr.base];
    assume write~int_#ptr.offset + write~int_#sizeOfWrittenType <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    ...
    assume write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]] == #memory_int;
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 8, Sum_~instrs.base, Sum_#t~union6.d, 30 * Sum_~i~0 + Sum_~instrs.offset + 10;
    assume 1 == #valid[write~int_#ptr.base];
    assume write~int_#sizeOfWrittenType + write~int_#ptr.offset <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    assume #valid[write~int_#ptr.base] == 1;
    assume 0 <= write~int_#ptr.offset && write~int_#sizeOfWrittenType + write~int_#ptr.offset <= #length[write~int_#ptr.base];
    ...
    assume write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]] == #memory_int;
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 8, Sum_~instrs.base, Sum_#t~union6.e, 30 * Sum_~i~0 + Sum_~instrs.offset + 18;
    assume #valid[write~int_#ptr.base] == 1;
    assume write~int_#ptr.offset + write~int_#sizeOfWrittenType <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    assume 1 == #valid[write~int_#ptr.base];
    assume write~int_#ptr.offset + write~int_#sizeOfWrittenType <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    ...
    assume write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]] == #memory_int;
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 8, Sum_~instrs.base, Sum_#t~union6.f, 30 * Sum_~i~0 + Sum_~instrs.offset + 26;
    assume 1 == #valid[write~int_#ptr.base];
    assume write~int_#ptr.offset + write~int_#sizeOfWrittenType <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    assume 1 == #valid[write~int_#ptr.base];
    assume write~int_#ptr.offset + write~int_#sizeOfWrittenType <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    havoc #memory_int;
    assume write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]] == #memory_int;
    havoc Sum_#t~union6.b, Sum_#t~union6.a, Sum_#t~union6.d, Sum_#t~union6.c, Sum_#t~union6.f, Sum_#t~union6.e;
    havoc Sum_#t~mem5;
    Sum_#t~post3 := Sum_~i~0;
    Sum_~i~0 := Sum_#t~post3 + 1;
    havoc Sum_#t~post3;
    goto loc2;
  loc4:
    assert false;
