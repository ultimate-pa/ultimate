...
{
    var Sum2_~instrs.offset : int;
    var read~int_#value : int;
    var main_#t~malloc11.offset : int;
    var Sum_~i~0 : int;
    var Sum2_#t~union10.a : int;
    var Sum_#t~mem5 : int;
    var main_#t~malloc11.base : int;
    var Sum2_#t~mem8 : int;
    var Sum2_~instrs.base : int;
    var Sum2_#t~union10.e : int;
    var Sum2_#t~union10.c : int;
    var write~int_#ptr.base : int;
    var Sum_~count~0 : int;
    var Sum2_#in~instrs.base : int;
    var Sum2_#res : int;
  ...
  loc1_1:
    ...
    havoc Sum_#t~mem4;
    Sum_#res := Sum_~count~0;
    main_#t~ret13 := Sum_#res;
    assume !(main_#t~ret13 % 18446744073709551616 == 4311811859);
    havoc main_#t~ret13;
    Sum2_#in~instrs.offset, Sum2_#in~instrs.base := main_~p~0.offset, main_~p~0.base;
    havoc Sum2_#res;
    havoc Sum2_~instrs.offset, Sum2_~i~1, Sum2_#t~mem9, Sum2_#t~union10.a, Sum2_~count~1, Sum2_#t~mem8, Sum2_~instrs.base, Sum2_#t~union10.e, Sum2_#t~union10.d, Sum2_#t~union10.c, Sum2_#t~union10.b, Sum2_#t~union10.f, Sum2_#t~post7;
    Sum2_~instrs.offset, Sum2_~instrs.base := Sum2_#in~instrs.offset, Sum2_#in~instrs.base;
    Sum2_~count~1 := 0;
    havoc Sum2_~i~1;
    Sum2_~i~1 := 0;
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := Sum2_~instrs.base, Sum2_~instrs.offset, 4;
    assume #valid[read~int_#ptr.base] == 1;
    ...
    havoc read~int_#value;
    assume read~int_#value == #memory_int[read~int_#ptr.base][read~int_#ptr.offset];
    Sum2_#t~mem8 := read~int_#value;
    assume !(Sum2_~i~1 < Sum2_#t~mem8);
    havoc Sum2_#t~mem8;
    Sum2_#res := Sum2_~count~1;
    main_#t~ret14 := Sum2_#res;
    assume main_#t~ret14 <= 9223372036854775807 && 0 <= main_#t~ret14 + 9223372036854775808;
    assume !(main_#t~ret14 == 4311811859);
    havoc main_#t~ret14;
    main_~p~0.base, main_~p~0.offset := 0, 0;
    main_#res := 0;
