...
modifies ~#d~0.offset, ~#d~0.base, #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
    ...
    var #Ultimate.C_memcpy_#t~loopctr7 : int;
  ...
  loc0:
    ...
    havoc main_#res;
    havoc main_#t~memcpy1.base, main_#t~malloc0.base, main_#t~memcpy1.offset, main_#t~mem2, main_~p~0.base, main_#t~malloc0.offset, main_#t~mem5, main_#t~mem4, main_~p~0.offset, main_#t~mem3;
    ...
    havoc #memory_int;
    assume write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]] == #memory_int;
    #Ultimate.C_memcpy_src.base, #Ultimate.C_memcpy_src.offset, #Ultimate.C_memcpy_dest.base, #Ultimate.C_memcpy_dest.offset, #Ultimate.C_memcpy_size := ~#d~0.base, ~#d~0.offset, main_~p~0.base, main_~p~0.offset, 3;
    ...
    havoc #Ultimate.C_memcpy_#t~loopctr7;
    #Ultimate.C_memcpy_#t~loopctr7 := 0;
    goto loc1;
  loc1:
    goto loc1_0, loc1_1;
  loc1_0:
    assume #Ultimate.C_memcpy_#t~loopctr7 < #Ultimate.C_memcpy_size;
    #memory_int := #memory_int[#Ultimate.C_memcpy_dest.base := #memory_int[#Ultimate.C_memcpy_dest.base][#Ultimate.C_memcpy_dest.offset + #Ultimate.C_memcpy_#t~loopctr7 := #memory_int[#Ultimate.C_memcpy_src.base][#Ultimate.C_memcpy_src.offset + #Ultimate.C_memcpy_#t~loopctr7]]];
    #Ultimate.C_memcpy_#t~loopctr7 := #Ultimate.C_memcpy_#t~loopctr7 + 1;
    goto loc1;
  loc1_1:
    assume !(#Ultimate.C_memcpy_#t~loopctr7 < #Ultimate.C_memcpy_size);
