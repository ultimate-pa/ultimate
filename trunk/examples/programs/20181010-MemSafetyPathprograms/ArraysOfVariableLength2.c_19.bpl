...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2_0:
    ...
    main_~i~2 := 0;
    assume main_~i~2 < 100;
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := main_~#b~0.base, main_~#b~0.offset + 4 * main_~i~2, 4;
  ...
  loc5_1:
    ...
    havoc foo_#t~mem3;
    foo_#t~post2 := foo_~i~1;
    foo_~i~1 := foo_#t~post2 + 1;
    havoc foo_#t~post2;
    goto loc4;
  loc6:
    goto loc7;
  ...
  loc7_1:
    assume bar_~i~0 < bar_~size;
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := bar_~b.base, 4 * bar_~i~0 + bar_~b.offset, 4;
    assume #valid[read~int_#ptr.base] == 1;
    assume read~int_#ptr.offset + read~int_#sizeOfReadType <= #length[read~int_#ptr.base] && 0 <= read~int_#ptr.offset;
    assume #valid[read~int_#ptr.base] == 1;
    assume read~int_#ptr.offset + read~int_#sizeOfReadType <= #length[read~int_#ptr.base] && 0 <= read~int_#ptr.offset;
    havoc read~int_#value;
    assume #memory_int[read~int_#ptr.base][read~int_#ptr.offset] == read~int_#value;
    bar_#t~mem1 := read~int_#value;
    bar_~res~0 := bar_#t~mem1 + bar_~res~0;
    havoc bar_#t~mem1;
    bar_#t~post0 := bar_~i~0;
    bar_~i~0 := bar_#t~post0 + 1;
    havoc bar_#t~post0;
    goto loc6;
}
