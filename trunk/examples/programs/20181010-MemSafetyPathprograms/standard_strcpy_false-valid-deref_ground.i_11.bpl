...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2_0:
    ...
    havoc main_~x~0;
    main_~x~0 := 0;
    assume main_~x~0 < main_~i~0;
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := main_~#dst~0.base, main_~#dst~0.offset + 4 * main_~x~0, 4;
    assume #valid[read~int_#ptr.base] == 1;
    ...
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := main_~#src~0.base, main_~#src~0.offset + 4 * main_~x~0, 4;
    assume #valid[read~int_#ptr.base] == 1;
    assume !(0 <= read~int_#ptr.offset) || !(read~int_#sizeOfReadType + read~int_#ptr.offset <= #length[read~int_#ptr.base]);
    goto loc3;
  loc2_1:
