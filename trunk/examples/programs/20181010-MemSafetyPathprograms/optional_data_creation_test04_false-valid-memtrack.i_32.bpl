...
modifies #memory_$Pointer$.base, #valid, #memory_int, #NULL.offset, #length, #NULL.base, #memory_$Pointer$.offset;
{
  ...
  loc2_0:
    ...
    assume 0 <= create_data_#t~nondet9 + 2147483648 && create_data_#t~nondet9 <= 2147483647;
    ...
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 4, create_data_~data~0.base, create_data_#t~nondet9, create_data_~data~0.offset;
