...
modifies #memory_$Pointer$.base, #valid, #memory_int, #NULL.offset, ~#a~0.base, #length, ~#a~0.offset, #NULL.base, #memory_$Pointer$.offset;
{
  ...
  loc2_1:
    assume !(#Ultimate.C_memcpy_#t~loopctr5 < #Ultimate.C_memcpy_size);
    assume #Ultimate.C_memcpy_dest.base == #Ultimate.C_memcpy_#res.base && #Ultimate.C_memcpy_dest.offset == #Ultimate.C_memcpy_#res.offset;
    main_#t~memcpy2.base, main_#t~memcpy2.offset := #Ultimate.C_memcpy_#res.base, #Ultimate.C_memcpy_#res.offset;
    havoc main_#t~memcpy2.base, main_#t~memcpy2.offset;
    read~$Pointer$_#ptr.base, read~$Pointer$_#sizeOfReadType, read~$Pointer$_#ptr.offset := main_~#p~1.base, 4, main_~#p~1.offset;
