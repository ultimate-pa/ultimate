...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc0:
    ...
    cstrncpy_~us~0.base, cstrncpy_~us~0.offset := cstrncpy_~dst~0.base, cstrncpy_~dst~0.offset;
    cstrncpy_~n2~0 := cstrncpy_~n;
    goto loc1;
  loc1:
    cstrncpy_#t~post6 := cstrncpy_~n2~0;
    cstrncpy_~n2~0 := cstrncpy_#t~post6 + -1;
    assume !(0 == cstrncpy_#t~post6);
    havoc cstrncpy_#t~post6;
    cstrncpy_#t~post7.offset, cstrncpy_#t~post7.base := cstrncpy_~us~0.offset, cstrncpy_~us~0.base;
    cstrncpy_~us~0.base, cstrncpy_~us~0.offset := cstrncpy_#t~post7.base, cstrncpy_#t~post7.offset + 1;
    write~int_old_#memory_int := #memory_int;
  ...
  loc2_1:
    ...
    havoc #memory_int;
    assume write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]] == #memory_int;
    havoc cstrncpy_#t~post7.offset, cstrncpy_#t~post7.base;
    goto loc1;
  loc3:
    assert false;
}
