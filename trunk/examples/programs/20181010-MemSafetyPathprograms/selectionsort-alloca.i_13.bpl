...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2_0:
    ...
    havoc read~int_#value;
    assume read~int_#value == #memory_int[read~int_#ptr.base][read~int_#ptr.offset];
    SelectionSort_#t~mem7 := read~int_#value;
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 4, SelectionSort_~a.base, SelectionSort_#t~mem7, 4 * SelectionSort_~i~0 + SelectionSort_~a.offset;
    ...
    havoc SelectionSort_#t~mem7;
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 4, SelectionSort_~a.base, SelectionSort_~temp~0, SelectionSort_~a.offset + 4 * SelectionSort_~min~0;
    assume 1 == #valid[write~int_#ptr.base];
