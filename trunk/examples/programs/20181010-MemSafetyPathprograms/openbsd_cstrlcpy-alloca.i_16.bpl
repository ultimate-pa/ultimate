...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc0:
    ...
    assume 0 == cstrlcpy_#t~pre2 % 4294967296;
    havoc cstrlcpy_#t~pre2;
    assume cstrlcpy_~n~0 % 4294967296 == 0;
    assume !(cstrlcpy_~siz % 4294967296 == 0);
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 1, cstrlcpy_~d~0.base, 0, cstrlcpy_~d~0.offset;
    assume #valid[write~int_#ptr.base] == 1;
    assume write~int_#sizeOfWrittenType + write~int_#ptr.offset <= #length[write~int_#ptr.base] && 0 <= write~int_#ptr.offset;
    assume 1 == #valid[write~int_#ptr.base];
    assume 0 <= write~int_#ptr.offset && write~int_#sizeOfWrittenType + write~int_#ptr.offset <= #length[write~int_#ptr.base];
    ...
    goto loc1;
  loc1:
    cstrlcpy_#t~post6.base, cstrlcpy_#t~post6.offset := cstrlcpy_~s~0.base, cstrlcpy_~s~0.offset;
    cstrlcpy_~s~0.offset, cstrlcpy_~s~0.base := cstrlcpy_#t~post6.offset + 1, cstrlcpy_#t~post6.base;
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := cstrlcpy_#t~post6.base, cstrlcpy_#t~post6.offset, 1;
  ...
  loc2_1:
    ...
    cstrlcpy_#t~mem7 := read~int_#value;
    assume !(0 == cstrlcpy_#t~mem7);
    havoc cstrlcpy_#t~post6.base, cstrlcpy_#t~post6.offset;
    havoc cstrlcpy_#t~mem7;
    goto loc1;
  loc3:
    assert false;
}
