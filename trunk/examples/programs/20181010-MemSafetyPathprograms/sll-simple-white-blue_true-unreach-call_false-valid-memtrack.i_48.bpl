...
modifies #memory_$Pointer$.base, #valid, #memory_int, #NULL.offset, #length, #NULL.base, #memory_$Pointer$.offset;
{
  ...
  loc0:
    ...
    main_~x~0.offset, main_~x~0.base := main_#t~mem13.offset, main_#t~mem13.base;
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume 0 == main_~x~0.offset && main_~x~0.base == 0;
    main_~x~0.offset, main_~x~0.base := main_~head~0.offset, main_~head~0.base;
    goto loc3;
  loc2_1:
    assume !(main_~x~0.base == 0) || !(0 == main_~x~0.offset);
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := main_~x~0.base, main_~x~0.offset + 4, 4;
    assume #valid[read~int_#ptr.base] == 1;
    ...
    main_~x~0.offset, main_~x~0.base := main_#t~mem15.offset, main_#t~mem15.base;
  ...
  loc4_1:
    ...
    main_~x~0.offset, main_~x~0.base := main_#t~mem16.offset, main_#t~mem16.base;
    havoc main_#t~mem16.base, main_#t~mem16.offset;
    assume 0 == main_~head~0.offset;
    assume 0 == main_~head~0.base || 1 == #valid[main_~head~0.base];
    ULTIMATE.dealloc_old_#valid := #valid;
    ULTIMATE.dealloc_~addr.base, ULTIMATE.dealloc_~addr.offset := main_~head~0.base, main_~head~0.offset;
    havoc #valid;
