...
modifies ~#d~0.offset, ~#d~0.base, #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
    ...
    var #Ultimate.C_memcpy_#t~loopctr13 : int;
  ...
  loc0:
    ...
    write~unchecked~int_old_#memory_int := #memory_int;
    write~unchecked~int_#sizeOfWrittenType, write~unchecked~int_#ptr.offset, write~unchecked~int_#value, write~unchecked~int_#ptr.base := 1, ~#d~0.offset + 1, 3, ~#d~0.base;
    havoc #memory_int;
    assume #memory_int == write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base := write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base][write~unchecked~int_#ptr.offset := write~unchecked~int_#value]];
    write~unchecked~int_old_#memory_int := #memory_int;
    ...
    assume write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base := write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base][write~unchecked~int_#ptr.offset := write~unchecked~int_#value]] == #memory_int;
    write~unchecked~int_old_#memory_int := #memory_int;
    write~unchecked~int_#sizeOfWrittenType, write~unchecked~int_#ptr.offset, write~unchecked~int_#value, write~unchecked~int_#ptr.base := 4, ~#d~0.offset + 6, 0, ~#d~0.base;
    havoc #memory_int;
    assume write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base := write~unchecked~int_old_#memory_int[write~unchecked~int_#ptr.base][write~unchecked~int_#ptr.offset := write~unchecked~int_#value]] == #memory_int;
    main_old_#valid := #valid;
    havoc main_#res;
    havoc main_#t~memcpy1.base, main_#t~mem10, main_#t~mem11, main_#t~memcpy1.offset, main_~p~0.base, main_#t~malloc0.offset, main_~p~0.offset, main_#t~malloc0.base, main_#t~mem9, main_#t~mem8, main_#t~mem7, main_#t~mem2, main_#t~mem6, main_#t~mem5, main_#t~mem4, main_#t~mem3;
    ...
    havoc #Ultimate.C_memcpy_#t~loopctr13;
    #Ultimate.C_memcpy_#t~loopctr13 := 0;
    goto loc1;
  loc1:
    goto loc1_0, loc1_1;
  loc1_0:
    assume #Ultimate.C_memcpy_#t~loopctr13 < #Ultimate.C_memcpy_size;
    #memory_int := #memory_int[#Ultimate.C_memcpy_dest.base := #memory_int[#Ultimate.C_memcpy_dest.base][#Ultimate.C_memcpy_dest.offset + #Ultimate.C_memcpy_#t~loopctr13 := #memory_int[#Ultimate.C_memcpy_src.base][#Ultimate.C_memcpy_src.offset + #Ultimate.C_memcpy_#t~loopctr13]]];
    #Ultimate.C_memcpy_#t~loopctr13 := #Ultimate.C_memcpy_#t~loopctr13 + 1;
    goto loc1;
  loc1_1:
    assume !(#Ultimate.C_memcpy_#t~loopctr13 < #Ultimate.C_memcpy_size);
