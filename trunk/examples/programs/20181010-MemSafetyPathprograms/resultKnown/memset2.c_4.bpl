...
modifies #valid, #NULL.offset, #length, #NULL.base;
{
  ...
  loc0:
    ...
    #Ultimate.C_memset_#ptr.offset, #Ultimate.C_memset_#value, #Ultimate.C_memset_#amount, #Ultimate.C_memset_#ptr.base := main_~#cstats~0.offset, 0, 40, main_~#cstats~0.base;
