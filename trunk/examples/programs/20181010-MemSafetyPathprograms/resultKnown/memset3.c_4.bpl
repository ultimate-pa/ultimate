...
modifies #valid, #NULL.offset, #length, #NULL.base;
{
  ...
  loc0:
    ...
    havoc main_#res;
    havoc main_#t~memset3.offset, main_~point~0.base, main_#t~memset3.base, main_~#cstats~0.base, main_~point~0.offset, main_~#cstats~0.offset;
    ...
    havoc main_~point~0.base, main_~point~0.offset;
    main_~point~0.base, main_~point~0.offset := main_~#cstats~0.base, main_~#cstats~0.offset;
    #Ultimate.C_memset_#ptr.offset, #Ultimate.C_memset_#value, #Ultimate.C_memset_#amount, #Ultimate.C_memset_#ptr.base := main_~point~0.offset, 0, 80, main_~point~0.base;
