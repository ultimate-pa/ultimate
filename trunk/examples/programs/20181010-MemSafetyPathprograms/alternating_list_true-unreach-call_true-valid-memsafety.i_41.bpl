...
modifies #memory_$Pointer$.base, #valid, #memory_int, #NULL.offset, #length, #NULL.base, #memory_$Pointer$.offset;
{
  ...
  loc4_1:
    ...
    main_~p~0.base, main_~p~0.offset := main_#t~mem7.base, main_#t~mem7.offset;
  ...
  loc6_0:
    ...
    assume main_~p~0.base == 0 || 1 == #valid[main_~p~0.base];
  ...
  loc6_1:
    assume !(main_#t~mem8 == 3);
    havoc main_#t~mem8;
    main_~tmp~0.base, main_~tmp~0.offset := main_~p~0.base, main_~p~0.offset;
    read~$Pointer$_#ptr.base, read~$Pointer$_#sizeOfReadType, read~$Pointer$_#ptr.offset := main_~p~0.base, 4, main_~p~0.offset + 4;
    assume 1 == #valid[read~$Pointer$_#ptr.base];
    assume 0 <= read~$Pointer$_#ptr.offset && read~$Pointer$_#ptr.offset + read~$Pointer$_#sizeOfReadType <= #length[read~$Pointer$_#ptr.base];
    assume 1 == #valid[read~$Pointer$_#ptr.base];
    ...
    main_~p~0.base, main_~p~0.offset := main_#t~mem9.base, main_#t~mem9.offset;
    havoc main_#t~mem9.offset, main_#t~mem9.base;
    assume 0 == main_~tmp~0.offset;
    assume 1 == #valid[main_~tmp~0.base] || main_~tmp~0.base == 0;
    ULTIMATE.dealloc_old_#valid := #valid;
    ULTIMATE.dealloc_~addr.base, ULTIMATE.dealloc_~addr.offset := main_~tmp~0.base, main_~tmp~0.offset;
    havoc #valid;
    assume #valid == ULTIMATE.dealloc_old_#valid[ULTIMATE.dealloc_~addr.base := 0];
    goto loc5;
  loc7:
