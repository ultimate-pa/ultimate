...
implementation ULTIMATE.start() returns (){
    ...
    var main_~c1~165 : int;
    var main_~i2~165 : int;
    var init_#res : int;
    var init_~tmp~74 : int;
    ...
    var node5_~m5~52 : ~msg_t;
    var node6_#t~ite10 : int;
    var node6_#t~ite11 : int;
    var node6_~m6~63 : ~msg_t;
    var check_#res : int;
    var check_~tmp~158 : int;
  ...
  loc8_1:
    ...
    goto loc9;
  loc9:
    havoc node5_#t~ite8, node5_#t~ite9, node5_~m5~52;
    havoc node5_~m5~52;
    node5_~m5~52 := ~nomsg;
    goto loc10;
  loc10:
  ...
  loc10_1:
    ...
    node5_~m5~52 := ~p4_old;
    ~p4_old := ~nomsg;
    assume !(node5_~m5~52 != ~nomsg);
    ~mode5 := 0;
    goto loc11;
  loc11:
    havoc node6_#t~ite10, node6_#t~ite11, node6_~m6~63;
    havoc node6_~m6~63;
    node6_~m6~63 := ~nomsg;
    goto loc12;
  loc12:
  ...
  loc14_1:
    ...
    goto loc15;
  loc15:
    check_#res := check_~tmp~158;
    main_#t~ret44 := check_#res;
    assume -2147483648 <= main_#t~ret44 && main_#t~ret44 <= 2147483647;
    main_~c1~165 := main_#t~ret44;
    havoc main_#t~ret44;
    assert_#in~arg := (if main_~c1~165 == 0 then 0 else 1);
    havoc assert_~arg;
  ...
  loc16_1:
    assume !(assert_~arg % 256 == 0);
    main_#t~post45 := main_~i2~165;
    main_~i2~165 := main_#t~post45 + 1;
