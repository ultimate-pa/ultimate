...
implementation ULTIMATE.start() returns (){
    ...
    var main_#t~post44 : int;
    var main_~c1~163 : int;
    var main_~i2~163 : int;
    var init_#res : int;
    var init_~tmp~72 : int;
    var node1_#t~ite0 : int;
    var node1_~m1~7 : ~msg_t;
    var node2_#t~ite1 : int;
    var node2_#t~ite2 : int;
    var node2_~m2~17 : ~msg_t;
    var node3_#t~ite3 : int;
    var node3_#t~ite4 : int;
    var node3_~m3~28 : ~msg_t;
    var node4_#t~ite5 : int;
    var node4_#t~ite6 : int;
    var node4_~m4~39 : ~msg_t;
    var node5_#t~ite7 : int;
    var node5_#t~ite8 : int;
    var node5_~m5~50 : ~msg_t;
    var node6_#t~ite9 : int;
    var node6_#t~ite10 : int;
    var node6_~m6~61 : ~msg_t;
    var check_#res : int;
    var check_~tmp~156 : int;
  ...
  loc0:
    ...
    ~send6 := 0;
    havoc main_#res;
    havoc main_#t~nondet11, main_#t~nondet12, main_#t~nondet13, main_#t~nondet14, main_#t~nondet15, main_#t~nondet16, main_#t~nondet17, main_#t~nondet18, main_#t~nondet19, main_#t~nondet20, main_#t~nondet21, main_#t~nondet22, main_#t~nondet23, main_#t~nondet24, main_#t~nondet25, main_#t~nondet26, main_#t~nondet27, main_#t~nondet28, main_#t~nondet29, main_#t~nondet30, main_#t~nondet31, main_#t~nondet32, main_#t~nondet33, main_#t~nondet34, main_#t~nondet35, main_#t~nondet36, main_#t~nondet37, main_#t~nondet38, main_#t~nondet39, main_#t~nondet40, main_#t~nondet41, main_#t~ret42, main_#t~ret43, main_#t~post44, main_~c1~163, main_~i2~163;
    havoc main_~c1~163;
    havoc main_~i2~163;
    main_~c1~163 := 0;
    ...
    assume ~id5 != ~id6;
    init_~tmp~72 := 1;
    init_#res := init_~tmp~72;
    main_#t~ret42 := init_#res;
    assume -2147483648 <= main_#t~ret42 && main_#t~ret42 <= 2147483647;
    main_~i2~163 := main_#t~ret42;
    havoc main_#t~ret42;
    assume main_~i2~163 != 0;
    ~p1_old := ~nomsg;
    ~p1_new := ~nomsg;
    ~p2_old := ~nomsg;
    ~p2_new := ~nomsg;
  ...
  loc2_1:
    ...
    goto loc3;
  loc3:
    havoc node2_#t~ite1, node2_#t~ite2, node2_~m2~17;
    havoc node2_~m2~17;
    node2_~m2~17 := ~nomsg;
    goto loc4;
  loc4:
  ...
  loc4_1:
    ...
    goto loc5;
  loc5:
    havoc node3_#t~ite3, node3_#t~ite4, node3_~m3~28;
    havoc node3_~m3~28;
    node3_~m3~28 := ~nomsg;
    goto loc6;
  loc6:
  ...
  loc6_1:
    ...
    goto loc7;
  loc7:
    havoc node4_#t~ite5, node4_#t~ite6, node4_~m4~39;
    havoc node4_~m4~39;
    node4_~m4~39 := ~nomsg;
    goto loc8;
  loc8:
  ...
  loc8_1:
    ...
    goto loc9;
  loc9:
    havoc node5_#t~ite7, node5_#t~ite8, node5_~m5~50;
    havoc node5_~m5~50;
    node5_~m5~50 := ~nomsg;
    goto loc10;
  loc10:
  ...
  loc10_1:
    ...
    goto loc11;
  loc11:
    havoc node6_#t~ite9, node6_#t~ite10, node6_~m6~61;
    havoc node6_~m6~61;
    node6_~m6~61 := ~nomsg;
    goto loc12;
  loc12:
  ...
  loc14_1:
    ...
    goto loc15;
  loc15:
    check_#res := check_~tmp~156;
    main_#t~ret43 := check_#res;
    assume -2147483648 <= main_#t~ret43 && main_#t~ret43 <= 2147483647;
    main_~c1~163 := main_#t~ret43;
    havoc main_#t~ret43;
    assert_#in~arg := (if main_~c1~163 == 0 then 0 else 1);
    havoc assert_~arg;
  ...
  loc16_1:
    assume !(assert_~arg % 256 == 0);
    main_#t~post44 := main_~i2~163;
    main_~i2~163 := main_#t~post44 + 1;
    havoc main_#t~post44;
    goto loc1;
  loc17:
    assert false;
}
