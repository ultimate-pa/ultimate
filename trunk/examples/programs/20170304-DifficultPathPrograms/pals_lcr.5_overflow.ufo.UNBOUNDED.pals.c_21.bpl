...
implementation ULTIMATE.start() returns (){
    ...
    var main_~c1~118 : int;
    var main_~i2~118 : int;
    var init_#res : int;
    var init_~tmp~44 : int;
  ...
  loc13_1:
    ...
    goto loc14;
  loc14:
    check_#res := check_~tmp~108;
    main_#t~ret27 := check_#res;
    assume -2147483648 <= main_#t~ret27 && main_#t~ret27 <= 2147483647;
    main_~c1~118 := main_#t~ret27;
    havoc main_#t~ret27;
    assert_#in~arg := (if main_~c1~118 == 0 then 0 else 1);
    havoc assert_~arg;
