implementation ULTIMATE.start() returns (){
  ...
  loc0:
    havoc main_#res;
    havoc main_#t~nondet0, main_#t~nondet1, main_#t~post2, main_#t~post3, main_~i~5, main_~j~5, main_~x~5, main_~y~5, main_~z~5;
    havoc main_~i~5;
    havoc main_~j~5;
    ...
    assume !!(main_~i~5 >= 0 && main_~i~5 <= 1000000);
    assume !!(main_~j~5 >= 0);
    main_~x~5 := main_~i~5;
    main_~y~5 := main_~j~5;
    main_~z~5 := 0;
