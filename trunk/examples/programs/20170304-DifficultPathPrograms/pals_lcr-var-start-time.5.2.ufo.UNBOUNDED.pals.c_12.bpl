...
implementation ULTIMATE.start() returns (){
    ...
    var main_#t~ret35 : int;
    var main_#t~ret36 : int;
    var main_~c1~135 : int;
    var main_~i2~135 : int;
    var init_#res : int;
    var init_~tmp~62 : int;
  ...
  loc0:
    ...
    assume ~id4 != ~id5;
    init_~tmp~62 := 1;
    init_#res := init_~tmp~62;
    main_#t~ret35 := init_#res;
    assume -2147483648 <= main_#t~ret35 && main_#t~ret35 <= 2147483647;
    main_~i2~135 := main_#t~ret35;
    havoc main_#t~ret35;
    assume main_~i2~135 != 0;
    ~p1_old := ~nomsg;
    ~p1_new := ~nomsg;
    ~p2_old := ~nomsg;
    ~p2_new := ~nomsg;
  ...
  loc6_1:
    ...
    goto loc7;
  loc7:
    havoc node4_#t~ite5, node4_#t~ite6, node4_~m4~40;
    havoc node4_~m4~40;
    node4_~m4~40 := ~nomsg;
    goto loc8;
  loc8:
  ...
  loc8_1:
    ...
    goto loc9;
  loc9:
    havoc node5_#t~ite7, node5_#t~ite8, node5_~m5~51;
    havoc node5_~m5~51;
    node5_~m5~51 := ~nomsg;
    goto loc10;
  loc10:
  ...
  loc12_1:
    ...
    goto loc13;
  loc13:
    check_#res := check_~tmp~128;
    main_#t~ret36 := check_#res;
    assume -2147483648 <= main_#t~ret36 && main_#t~ret36 <= 2147483647;
    main_~c1~135 := main_#t~ret36;
    havoc main_#t~ret36;
    assert_#in~arg := (if main_~c1~135 == 0 then 0 else 1);
    havoc assert_~arg;
