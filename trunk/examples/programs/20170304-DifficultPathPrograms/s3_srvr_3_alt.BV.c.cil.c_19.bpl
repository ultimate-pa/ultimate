...
implementation ULTIMATE.start() returns (){
  ...
  loc0:
    ...
    assume !(~bitwiseAnd(ssl3_accept_~tmp___1~4, 12288) != 0);
  ...
  loc5_0:
    ...
    assume ~bitwiseAnd(ssl3_accept_~s__s3__tmp__new_cipher__algorithms~4, 256) % 18446744073709551616 != 0;
  ...
  loc6_0:
    ...
    assume ~bitwiseAnd(ssl3_accept_~s__options~4, 2097152) % 18446744073709551616 != 0;
  ...
  loc7_0:
    ...
    assume ~bitwiseAnd(ssl3_accept_~s__verify_mode~4, 1) != 0;
    assume !(ssl3_accept_~s__session__peer~4 != 0);
    assume !(~bitwiseAnd(ssl3_accept_~s__s3__tmp__new_cipher__algorithms~4, 256) % 18446744073709551616 != 0);
    ssl3_accept_~s__s3__tmp__cert_request~4 := 1;
    assume -2147483648 <= ssl3_accept_#t~nondet32 && ssl3_accept_#t~nondet32 <= 2147483647;
  ...
  loc10_0:
    ...
    assume -2147483648 <= ssl3_accept_#t~nondet36 && ssl3_accept_#t~nondet36 <= 2147483647;
