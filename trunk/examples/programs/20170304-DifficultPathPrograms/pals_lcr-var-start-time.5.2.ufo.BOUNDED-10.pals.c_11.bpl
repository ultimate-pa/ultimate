...
implementation ULTIMATE.start() returns (){
    ...
    var main_~c1~134 : int;
    var main_~i2~134 : int;
    var init_#res : int;
    var init_~tmp~61 : int;
  ...
  loc12_1:
    ...
    goto loc13;
  loc13:
    check_#res := check_~tmp~127;
    main_#t~ret36 := check_#res;
    assume -2147483648 <= main_#t~ret36 && main_#t~ret36 <= 2147483647;
    main_~c1~134 := main_#t~ret36;
    havoc main_#t~ret36;
    assert_#in~arg := (if main_~c1~134 == 0 then 0 else 1);
    havoc assert_~arg;
  ...
  loc14_0:
    ...
    main_#t~post37 := main_~i2~134;
    main_~i2~134 := main_#t~post37 + 1;
