...
implementation ULTIMATE.start() returns (){
  ...
  loc0:
    ...
    main_~i2~85 := main_#t~ret22;
    havoc main_#t~ret22;
    assume main_~i2~85 != 0;
    ~p1_old := ~nomsg;
    ~p1_new := ~nomsg;
    ~p2_old := ~nomsg;
    ~p2_new := ~nomsg;
  ...
  loc4_1:
    ...
    node2_#t~ite2 := ~send2;
    ~p2_new := (if node2_#t~ite2 % 256 <= 127 then node2_#t~ite2 % 256 else node2_#t~ite2 % 256 - 256);
    havoc node2_#t~ite2;
    ~mode2 := 1;
    goto loc5;
  loc5:
  ...
  loc8_1:
    ...
    goto loc9;
  loc9:
    check_#res := check_~tmp~78;
    main_#t~ret23 := check_#res;
    assume -2147483648 <= main_#t~ret23 && main_#t~ret23 <= 2147483647;
    main_~c1~85 := main_#t~ret23;
    havoc main_#t~ret23;
    assert_#in~arg := (if main_~c1~85 == 0 then 0 else 1);
    havoc assert_~arg;
