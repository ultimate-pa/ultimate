...
implementation ULTIMATE.start() returns (){
    ...
    var main_~c1~166 : int;
    var main_~i2~166 : int;
    var init_#res : int;
    var init_~tmp~75 : int;
    ...
    var node6_~m6~64 : ~msg_t;
    var check_#res : int;
    var check_~tmp~159 : int;
  ...
  loc10_1:
    ...
    goto loc11;
  loc11:
    havoc node6_#t~ite10, node6_#t~ite11, node6_~m6~64;
    havoc node6_~m6~64;
    node6_~m6~64 := ~nomsg;
    goto loc12;
  loc12:
  ...
  loc14_1:
    ...
    goto loc15;
  loc15:
    check_#res := check_~tmp~159;
    main_#t~ret44 := check_#res;
    assume -2147483648 <= main_#t~ret44 && main_#t~ret44 <= 2147483647;
    main_~c1~166 := main_#t~ret44;
    havoc main_#t~ret44;
    assert_#in~arg := (if main_~c1~166 == 0 then 0 else 1);
    havoc assert_~arg;
