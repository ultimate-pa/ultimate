...
implementation ULTIMATE.start() returns (){
    ...
    var main_~c1~143 : int;
    var main_~i2~143 : int;
    var init_#res : int;
    ...
    var node5_~m5~37 : ~msg_t;
    var node6_#t~ite5 : int;
    var node6_~m6~44 : ~msg_t;
    var check_#res : int;
    var check_~tmp~133 : int;
  ...
  loc0:
    ...
    main_~i2~143 := main_#t~ret31;
    havoc main_#t~ret31;
    assume main_~i2~143 != 0;
    ~p1_old := ~nomsg;
    ~p1_new := ~nomsg;
    ~p2_old := ~nomsg;
    ~p2_new := ~nomsg;
  ...
  loc8_1:
    ...
    goto loc9;
  loc9:
    havoc node5_#t~ite4, node5_~m5~37;
    havoc node5_~m5~37;
    node5_~m5~37 := ~nomsg;
    goto loc10;
  loc10:
  ...
  loc10_1:
    ...
    goto loc11;
  loc11:
    havoc node6_#t~ite5, node6_~m6~44;
    havoc node6_~m6~44;
    node6_~m6~44 := ~nomsg;
    goto loc12;
  loc12:
  ...
  loc15_1:
    ...
    goto loc16;
  loc16:
    check_#res := check_~tmp~133;
    main_#t~ret32 := check_#res;
    assume -2147483648 <= main_#t~ret32 && main_#t~ret32 <= 2147483647;
    main_~c1~143 := main_#t~ret32;
    havoc main_#t~ret32;
    assert_#in~arg := (if main_~c1~143 == 0 then 0 else 1);
    havoc assert_~arg;
