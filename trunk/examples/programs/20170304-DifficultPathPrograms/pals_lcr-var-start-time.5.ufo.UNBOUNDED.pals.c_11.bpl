...
implementation ULTIMATE.start() returns (){
    ...
    var main_~c1~136 : int;
    var main_~i2~136 : int;
    var init_#res : int;
    var init_~tmp~63 : int;
  ...
  loc12_1:
    ...
    goto loc13;
  loc13:
    check_#res := check_~tmp~129;
    main_#t~ret37 := check_#res;
    assume -2147483648 <= main_#t~ret37 && main_#t~ret37 <= 2147483647;
    main_~c1~136 := main_#t~ret37;
    havoc main_#t~ret37;
    assert_#in~arg := (if main_~c1~136 == 0 then 0 else 1);
    havoc assert_~arg;
