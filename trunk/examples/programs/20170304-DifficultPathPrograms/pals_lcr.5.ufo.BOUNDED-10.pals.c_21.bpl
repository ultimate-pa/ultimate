...
implementation ULTIMATE.start() returns (){
    ...
    var main_#t~post28 : int;
    var main_~c1~116 : int;
    var main_~i2~116 : int;
    var init_#res : int;
    var init_~tmp~42 : int;
    ...
    var node4_~m4~28 : ~msg_t;
    var node5_#t~ite4 : int;
    var node5_~m5~35 : ~msg_t;
    var check_#res : int;
    var check_~tmp~106 : int;
  ...
  loc6_1:
    ...
    goto loc7;
  loc7:
    havoc node4_#t~ite3, node4_~m4~28;
    havoc node4_~m4~28;
    node4_~m4~28 := ~nomsg;
    goto loc8;
  loc8:
  ...
  loc8_1:
    ...
    goto loc9;
  loc9:
    havoc node5_#t~ite4, node5_~m5~35;
    havoc node5_~m5~35;
    node5_~m5~35 := ~nomsg;
    goto loc10;
  loc10:
  ...
  loc13_1:
    ...
    goto loc14;
  loc14:
    check_#res := check_~tmp~106;
    main_#t~ret27 := check_#res;
    assume -2147483648 <= main_#t~ret27 && main_#t~ret27 <= 2147483647;
    main_~c1~116 := main_#t~ret27;
    havoc main_#t~ret27;
    assert_#in~arg := (if main_~c1~116 == 0 then 0 else 1);
    havoc assert_~arg;
  ...
  loc15_1:
    assume !(assert_~arg % 256 == 0);
    main_#t~post28 := main_~i2~116;
    main_~i2~116 := main_#t~post28 + 1;
    havoc main_#t~post28;
    goto loc1;
  loc16:
    assert false;
}
