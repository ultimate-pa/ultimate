...
implementation ULTIMATE.start() returns (){
  ...
  loc14_1:
    assume !(assert_~arg % 256 == 0);
    main_#t~post38 := main_~i2~135;
    main_~i2~135 := main_#t~post38 + 1;
    havoc main_#t~post38;
    goto loc1;
  loc15:
    assert false;
}
