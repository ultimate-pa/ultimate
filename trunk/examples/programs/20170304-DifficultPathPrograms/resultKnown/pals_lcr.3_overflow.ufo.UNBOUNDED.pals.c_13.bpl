...
implementation ULTIMATE.start() returns (){
  ...
  loc0:
    ...
    ~send3 := 0;
    havoc main_#res;
    havoc main_#t~nondet3, main_#t~nondet4, main_#t~nondet5, main_#t~nondet6, main_#t~nondet7, main_#t~nondet8, main_#t~nondet9, main_#t~nondet10, main_#t~nondet11, main_#t~nondet12, main_#t~nondet13, main_#t~nondet14, main_#t~nondet15, main_#t~ret16, main_#t~ret17, main_~c1~74, main_~i2~74;
    havoc main_~c1~74;
    havoc main_~i2~74;
    main_~c1~74 := 0;
    ~r1 := main_#t~nondet3;
  ...
  loc1:
    assume true;
    assume !false;
    havoc node1_#t~ite0, node1_~m1~9;
    havoc node1_~m1~9;
    node1_~m1~9 := ~nomsg;
    goto loc2;
  loc2:
  ...
  loc9_1:
    ...
    goto loc10;
  loc10:
    check_#res := check_~tmp~64;
    main_#t~ret17 := check_#res;
    assume -2147483648 <= main_#t~ret17 && main_#t~ret17 <= 2147483647;
    main_~c1~74 := main_#t~ret17;
    havoc main_#t~ret17;
    assert_#in~arg := (if main_~c1~74 == 0 then 0 else 1);
    havoc assert_~arg;
