...
implementation ULTIMATE.start() returns (){
  ...
  loc0:
    havoc main_#res;
    havoc main_#t~ret43, main_~s~209, main_~tmp~209;
    havoc main_~s~209;
    havoc main_~tmp~209;
    main_~s~209 := 8464;
    ...
    assume -9223372036854775808 <= ssl3_accept_#t~nondet20 && ssl3_accept_#t~nondet20 <= 9223372036854775807;
    ...
    assume !(~bitwiseAnd(ssl3_accept_~tmp___1~5, 12288) != 0);
  ...
  loc5_0:
    ...
    assume ~bitwiseAnd(ssl3_accept_~s__s3__tmp__new_cipher__algorithms~5, 256) % 18446744073709551616 != 0;
  ...
  loc6_0:
    ...
    assume ~bitwiseAnd(ssl3_accept_~s__options~5, 2097152) % 18446744073709551616 != 0;
  ...
  loc7_0:
    ...
    assume ~bitwiseAnd(ssl3_accept_~s__verify_mode~5, 1) != 0;
