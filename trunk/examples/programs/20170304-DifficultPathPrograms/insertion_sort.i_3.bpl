implementation ULTIMATE.start() returns (){
  ...
  loc0:
    havoc main_#res;
    havoc main_#t~nondet0, main_#t~post1, main_#t~post2, main_~SIZE~5, main_~i~5, main_~j~5, main_~k~5, main_~key~5, main_~v~5;
  ...
  loc2_0:
    ...
    __VERIFIER_assert_#in~cond := (if main_~v~5[main_~k~5 - 1] <= main_~v~5[main_~k~5] then 1 else 0);
  ...
  loc2_1:
    ...
    assume true;
    assume !(main_~i~5 >= 0 && main_~v~5[main_~i~5] > main_~key~5);
