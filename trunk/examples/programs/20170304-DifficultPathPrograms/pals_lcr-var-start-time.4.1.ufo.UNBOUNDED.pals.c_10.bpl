...
implementation ULTIMATE.start() returns (){
    ...
    var main_~c1~110 : int;
    var main_~i2~110 : int;
    var init_#res : int;
    var init_~tmp~53 : int;
  ...
  loc10_1:
    ...
    goto loc11;
  loc11:
    check_#res := check_~tmp~103;
    main_#t~ret30 := check_#res;
    assume -2147483648 <= main_#t~ret30 && main_#t~ret30 <= 2147483647;
    main_~c1~110 := main_#t~ret30;
    havoc main_#t~ret30;
    assert_#in~arg := (if main_~c1~110 == 0 then 0 else 1);
    havoc assert_~arg;
