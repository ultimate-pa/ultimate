implementation ULTIMATE.start() returns (){
  ...
  loc0:
    havoc main_#res;
    havoc main_#t~nondet0, main_#t~nondet1, main_~i~5, main_~n~5, main_~a~5, main_~b~5;
    havoc main_~i~5;
    havoc main_~n~5;
    havoc main_~a~5;
    havoc main_~b~5;
    ...
    assume !!(main_~n~5 >= 0 && main_~n~5 <= 1000000);
    goto loc1;
  loc1:
    assume true;
    goto loc2;
  ...
  loc2_0:
    ...
    __VERIFIER_assert_#in~cond := (if main_~a~5 + main_~b~5 == 3 * main_~n~5 then 1 else 0);
