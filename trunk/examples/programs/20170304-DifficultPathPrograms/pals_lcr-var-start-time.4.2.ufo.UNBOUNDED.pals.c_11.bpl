...
implementation ULTIMATE.start() returns (){
  ...
  loc11:
    ...
    main_~c1~108 := main_#t~ret29;
    havoc main_#t~ret29;
    assert_#in~arg := (if main_~c1~108 == 0 then 0 else 1);
    havoc assert_~arg;
