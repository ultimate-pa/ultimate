...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume !(main_~i~0 < 1023);
    #memory_int := #memory_int[main_~#A~0.base := #memory_int[main_~#A~0.base][main_~#A~0.offset + 4092 := 0]];
    main_~i~0 := 0;
    ...
    assume main_#t~mem3 == 0;
    havoc main_#t~mem3;
    __VERIFIER_assert_#in~cond := (if main_~i~0 <= 1024 then 1 else 0);
  ...
  loc2_1:
    ...
    #memory_int := #memory_int[main_~#A~0.base := #memory_int[main_~#A~0.base][main_~#A~0.offset + 4 * main_~i~0 := main_#t~nondet1]];
