...
procedure  three_times($n$1$4.20$three_times_.1:int) returns ($result.three_times$4.4$1$three_times:int)
...
var $i$3$10.5$three_times : int;
var $n$1$4.20$three_times : int;
var $result.assert$19.7$2$three_times : int;
var $s$2$9.5$three_times : int;
var tempBoogie0:int;
var tempBoogie1:int;
var tempBoogie2:int;
var tempBoogie3:int;
...
$n$1$4.20$three_times := $n$1$4.20$three_times_.1;
goto label_3;


// c$$poirot\examples\account\three_times.c(21)
label_1:
return;
...
// c$$poirot\examples\account\three_times.c(9)
label_3:
goto label_4;
...
// c$$poirot\examples\account\three_times.c(9)
label_4:
$s$2$9.5$three_times := 0 ;
goto label_5;


// c$$poirot\examples\account\three_times.c(10)
label_5:
goto label_6;
...
// c$$poirot\examples\account\three_times.c(10)
label_6:
$i$3$10.5$three_times := 0 ;
goto label_7;


// c$$poirot\examples\account\three_times.c(12)
label_7:
...
label_7_true :
assume (INT_LT($i$3$10.5$three_times, $n$1$4.20$three_times));
goto label_9;
...
// c$$poirot\examples\account\three_times.c(19)
label_8:
$assert.arg.1$3$ := LIFT(INT_EQ($i$3$10.5$three_times, $n$1$4.20$three_times)) ;
goto label_11;


// c$$poirot\examples\account\three_times.c(16)
label_9:
$s$2$9.5$three_times := PLUS($s$2$9.5$three_times, 1, 3) ;
goto label_10;


// c$$poirot\examples\account\three_times.c(17)
label_10:
$i$3$10.5$three_times := PLUS($i$3$10.5$three_times, 1, 1) ;
goto label_7_head;


// c$$poirot\examples\account\three_times.c(19)
label_11:
call $result.assert$19.7$2$three_times := assert ($assert.arg.1$3$);
goto label_14;


// c$$poirot\examples\account\three_times.c(20)
label_14:
$result.three_times$4.4$1$three_times := $s$2$9.5$three_times ;
goto label_1;
