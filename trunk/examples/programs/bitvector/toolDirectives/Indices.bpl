...
function { :builtin "sign_extend" } { :indices 2 } convertFrom2To4(in0 : bv2) returns (out : bv4);

function { :builtin "sign_extend" } { :indices 96 } convertFrom32To128(in0 : bv32) returns (out : bv128);
