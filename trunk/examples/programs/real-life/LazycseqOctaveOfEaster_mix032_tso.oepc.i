// Program that we obtained from Omar Inverso on 2020-04-20.
// The program was obtained by applying a sequentialization to 
// a concurrent SV-COMP benchmark.

# 1 "concurrency_2020/pthread-wmm/_cs_mix032_tso.oepc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "concurrency_2020/pthread-wmm/_cs_mix032_tso.oepc.c"
# 72 "concurrency_2020/pthread-wmm/_cs_mix032_tso.oepc.c"
                         ...
                         unsigned int __cs_thread_lines[] = {8, 4, 6, 6};
...
tP0_0_0: if ((__cs_pc[1] > 0) || (0 >= __cs_pc_cs[1])) goto tP0_0_1;
...
tP0_0_1: if ((__cs_pc[1] > 1) || (1 >= __cs_pc_cs[1])) goto tP0_0_2;
...
tP0_0_2: if ((__cs_pc[1] > 2) || (2 >= __cs_pc_cs[1])) goto tP0_0_3;
...
tP0_0_3: if ((__cs_pc[1] > 3) || (3 >= __cs_pc_cs[1])) goto tP0_0_4;
...
tP1_0_0: if ((__cs_pc[2] > 0) || (0 >= __cs_pc_cs[2])) goto tP1_0_1;
...
tP1_0_1: if ((__cs_pc[2] > 1) || (1 >= __cs_pc_cs[2])) goto tP1_0_2;
...
tP1_0_2: if ((__cs_pc[2] > 2) || (2 >= __cs_pc_cs[2])) goto tP1_0_3;
...
tP1_0_3: if ((__cs_pc[2] > 3) || (3 >= __cs_pc_cs[2])) goto tP1_0_4;
...
tP1_0_4: if ((__cs_pc[2] > 4) || (4 >= __cs_pc_cs[2])) goto tP1_0_5;
...
tP1_0_5: if ((__cs_pc[2] > 5) || (5 >= __cs_pc_cs[2])) goto tP1_0_6;
...
tP2_0_0: if ((__cs_pc[3] > 0) || (0 >= __cs_pc_cs[3])) goto tP2_0_1;
...
tP2_0_1: if ((__cs_pc[3] > 1) || (1 >= __cs_pc_cs[3])) goto tP2_0_2;
...
tP2_0_2: if ((__cs_pc[3] > 2) || (2 >= __cs_pc_cs[3])) goto tP2_0_3;
...
tP2_0_3: if ((__cs_pc[3] > 3) || (3 >= __cs_pc_cs[3])) goto tP2_0_4;
...
tP2_0_4: if ((__cs_pc[3] > 4) || (4 >= __cs_pc_cs[3])) goto tP2_0_5;
...
tP2_0_5: if ((__cs_pc[3] > 5) || (5 >= __cs_pc_cs[3])) goto tP2_0_6;
...
if ((__cs_pc[0] > 0) || (0 >= __cs_pc_cs[0])) goto tmain_1;
                                   ...
                                   static cspthread_t __cs_local_main_t867;
                                   __cs_init_scalar(& __cs_local_main_t867, sizeof(cspthread_t));

                                   pthread_create_2(& __cs_local_main_t867, (void *) 0, P0_0, (void *) 0, 1);

                                   static cspthread_t __cs_local_main_t868;
                                   __cs_init_scalar(& __cs_local_main_t868, sizeof(cspthread_t));

tmain_1: if ((__cs_pc[0] > 1) || (1 >= __cs_pc_cs[0])) goto tmain_2;

                                   pthread_create_2(& __cs_local_main_t868, (void *) 0, P1_0, (void *) 0, 2);

                                   static cspthread_t __cs_local_main_t869;
                                   __cs_init_scalar(& __cs_local_main_t869, sizeof(cspthread_t));

tmain_2: if ((__cs_pc[0] > 2) || (2 >= __cs_pc_cs[0])) goto tmain_3;

                                   pthread_create_2(& __cs_local_main_t869, (void *) 0, P2_0, (void *) 0, 3);
...
tmain_6: if ((__cs_pc[0] > 6) || (6 >= __cs_pc_cs[0])) goto tmain_7;
...
tmain_7: if ((__cs_pc[0] > 7) || (7 >= __cs_pc_cs[0])) goto tmain_8;
                                   ...
                                   __exit_main:
                                   __VERIFIER_assume(__cs_pc_cs[0] >= 8);
