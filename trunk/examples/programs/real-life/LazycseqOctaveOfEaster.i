// Program that we obtained from Omar Inverso on 2020-04-16.
// The program was obtained by applying a sequentialization to 
// a concurrent SV-COMP benchmark.
// Omar used our default SV-COMP settings but Ultimate
// did not provide a result within the timeout of 500s.
//
// Matthias' analysis showed that our integer-based analysis
// fails because of bitwise OR operators and the bitvector-based
