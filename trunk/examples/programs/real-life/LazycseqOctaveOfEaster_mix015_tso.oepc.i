...
# 1 "concurrency_2020/pthread-wmm/_cs_mix015_tso.oepc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "concurrency_2020/pthread-wmm/_cs_mix015_tso.oepc.c"
# 72 "concurrency_2020/pthread-wmm/_cs_mix015_tso.oepc.c"
                         ...
                         unsigned int __cs_thread_lines[] = {8, 6, 4, 5};
...
tP0_0_4: if ((__cs_pc[1] > 4) || (4 >= __cs_pc_cs[1])) goto tP0_0_5;
...
tP0_0_5: if ((__cs_pc[1] > 5) || (5 >= __cs_pc_cs[1])) goto tP0_0_6;
...
tP2_0_4: if ((__cs_pc[3] > 4) || (4 >= __cs_pc_cs[3])) goto tP2_0_5;
                                   ...
                                   __exit_P2:
                                   __VERIFIER_assume(__cs_pc_cs[3] >= 5);
...
if ((__cs_pc[0] > 0) || (0 >= __cs_pc_cs[0])) goto tmain_1;
                                   ...
                                   static cspthread_t __cs_local_main_t403;
                                   __cs_init_scalar(& __cs_local_main_t403, sizeof(cspthread_t));

                                   pthread_create_2(& __cs_local_main_t403, (void *) 0, P0_0, (void *) 0, 1);

                                   static cspthread_t __cs_local_main_t404;
                                   __cs_init_scalar(& __cs_local_main_t404, sizeof(cspthread_t));

tmain_1: if ((__cs_pc[0] > 1) || (1 >= __cs_pc_cs[0])) goto tmain_2;

                                   pthread_create_2(& __cs_local_main_t404, (void *) 0, P1_0, (void *) 0, 2);

                                   static cspthread_t __cs_local_main_t405;
                                   __cs_init_scalar(& __cs_local_main_t405, sizeof(cspthread_t));

tmain_2: if ((__cs_pc[0] > 2) || (2 >= __cs_pc_cs[0])) goto tmain_3;

                                   pthread_create_2(& __cs_local_main_t405, (void *) 0, P2_0, (void *) 0, 3);
