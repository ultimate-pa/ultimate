...
modifies ~p1_old, ~alive2, ~send2, ~alive1, ~send3, ~id3, ~alive3, ~send1, ~id2, ~st3, ~id1, ~st1, ~nomsg, ~st2, ~mode2, ~mode1, ~p2_new, ~mode3, ~p2_old, ~p1_new, ~p3_old, ~p3_new, ~r1;
{
  ...
  loc0:
    ...
    ~send3 := 0;
    havoc main_#res;
    havoc main_#t~nondet21, main_#t~nondet10, main_#t~nondet20, main_#t~nondet11, main_#t~nondet12, main_#t~nondet13, main_#t~nondet14, main_#t~nondet8, main_#t~nondet9, main_#t~nondet6, main_#t~nondet7, main_#t~post24, main_~i2~83, main_#t~ret23, main_#t~ret22, main_#t~nondet15, main_#t~nondet16, main_#t~nondet17, main_#t~nondet18, main_#t~nondet19, main_~c1~83;
    havoc main_~c1~83;
    havoc main_~i2~83;
    main_~c1~83 := 0;
    ...
    havoc init_~tmp~40;
    assume ~r1 == 0;
    assume (((0 <= ~alive3 + ~alive1 % 256 + ~alive2 % 256 + 255 && 256 + 256 <= ~alive2) && ~alive1 < -256) && -256 <= ~alive3) && ~alive3 < 0;
    assume 0 <= ~id1;
    assume ~st1 == 0;
    assume ~send1 == ~id1;
  ...
  loc9:
    ...
    main_~c1~83 := main_#t~ret23;
    havoc main_#t~ret23;
    goto loc10;
  loc10:
    goto loc10_0, loc10_1;
  loc10_0:
    assume main_~c1~83 == 0;
    assert_#in~arg := 0;
    goto loc11;
  loc10_1:
    assume !(main_~c1~83 == 0);
  ...
  loc12_0:
    ...
    main_#t~post24 := main_~i2~83;
    main_~i2~83 := main_#t~post24 + 1;
