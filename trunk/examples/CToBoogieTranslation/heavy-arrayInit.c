/*
 * nutz: copied ctrans-bug-NPE-constructStructFieldInfos.c to highlight its new purpose as a motivating example
 *  for a sophisticated array initialization (even an initialization with loops might help here).
 *
 *
